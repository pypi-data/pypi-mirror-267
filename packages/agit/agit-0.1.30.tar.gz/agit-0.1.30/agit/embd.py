...
def call_embedding(text:str|List[str], model:str, embd_type: EMBD_TYPE = EMBD_TYPE.ZHIPU_API,
    ...
    if embd_type == EMBD_TYPE.ZHIPU_API:
        ...
        return call_zhipu_api_embedding(text=text, model=model, norm=norm, batch_size=batch_size, **kwargs)
