...
If you experience bugs or general issues with ``internetnl_domain_analyse``, please have a look
...
or Miniconda_::
    ...
    conda create -n internetnl_domain_analyse python=3 six virtualenv pytest pytest-cov
    conda activate internetnl_domain_analyse
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/internetnl_domain_analyse.git
    cd internetnl_domain_analyse
