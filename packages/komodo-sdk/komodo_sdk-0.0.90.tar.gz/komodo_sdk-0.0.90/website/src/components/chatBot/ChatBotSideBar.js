...
const ChatBotSideBar = ({
  ...
  const getFileIcon = (fileType, path) => {
    if (fileType?.includes("pdf")) {
      ...
      return <img src={xlsx} width={25} alt="xlsx" />;
    } else if (fileType.includes("presentation")) {
      return <img src={pptLogo} width={25} alt="ppt" />;
      ...
      return <img src={imgLogo} width={25} alt="imgLogo" />;
    } else {
      return <img src={odtIcon} width={25} alt="txt" />;
    }
  };
