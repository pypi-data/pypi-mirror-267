    ...
    <div className="flex font-cerebriregular">
      ...
      <div className="flex-1 flex-col h-[100vh] overflow-auto  ">
        <div className="h-100 border-b border-customGray w-[100%] px-8 py-4 flex flex-col justify-between gap-3">
          <h2 className="text-[26px] font-cerebri text-[#000000] leading-[27px]">Privacy Policy</h2>
        ...
        <div className="px-6 py-3 flex-1">
          <div className="grid grid-cols-1">
            <div className="h-100 border-b border-customGray xl:w-[100%] w-[65%] py-7 flex flex-col justify-between gap-3">
              <h2 className="text-[21px] font-cerebri text-[#000000] leading-[27px]">Who we are</h2>
            ...
            <div className="h-100 border-b border-customGray xl:w-[100%] w-[65%] py-7 flex flex-col justify-between gap-3">
              <h2 className="text-[21px] font-cerebri text-[#000000] leading-[27px]">Comments</h2>
            ...
            <div className="h-100 border-b border-customGray xl:w-[100%] w-[65%] py-7 flex flex-col justify-between gap-3">
              <h2 className="text-[21px] font-cerebri text-[#000000] leading-[27px]">Media</h2>
            ...
            <div className="h-100 border-b border-customGray xl:w-[100%] w-[65%] py-7 flex flex-col justify-between gap-3">
              <h2 className="text-[21px] font-cerebri text-[#000000] leading-[27px]">Cookies</h2>
