...
class MongoDBQuery(KomodoTool):
    ...
    definition = {
        ...
        "function": {
            ...
            "returns": {
                "type": "string",
                "description": "The results of the query sorted by created_at DESCENDING order."
            }
        }
    }
    ...
    def action(self, args, runtime):
        try:
            ...
            sort_field = runtime.config.get_value("mongo_sort_field", "created_at")
            sort_order = runtime.config.get_value("mongo_sort_order", DESCENDING)
