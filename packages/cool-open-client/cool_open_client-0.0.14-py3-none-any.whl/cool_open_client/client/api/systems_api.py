...
class SystemsApi(object):
    ...
    def systems_get(self, origin, referer, x_access_token, **kwargs):  # noqa: E501
        """get my systems  # noqa: E501

        get my systems  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.systems_get(origin, referer, x_access_token, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.systems_get_with_http_info(origin, referer, x_access_token, **kwargs)  # noqa: E501
        else:
            (data) = self.systems_get_with_http_info(origin, referer, x_access_token, **kwargs)  # noqa: E501
            return data

    def systems_get_with_http_info(self, origin, referer, x_access_token, **kwargs):  # noqa: E501
        """get my systems  # noqa: E501

        get my systems  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.systems_get_with_http_info(origin, referer, x_access_token, async_req=True)
        >>> result = thread.get()
        ...
        if ('origin' not in params or
            ...
            raise ValueError("Missing the required parameter `origin` when calling `systems_get`")  # noqa: E501
        # verify the required parameter 'referer' is set
        if ('referer' not in params or
                params['referer'] is None):
            raise ValueError("Missing the required parameter `referer` when calling `systems_get`")  # noqa: E501
