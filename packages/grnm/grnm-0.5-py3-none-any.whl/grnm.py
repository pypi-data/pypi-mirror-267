...
class Grnm():
    ...
    def tf_target_scatterplot(self):
        ...
        # 生成更多的测试数据
        tf_list = ['TF1', 'TF2', 'TF3', 'TF4', 'TF5', 'TF6', 'TF7', 'TF8', 'TF9', 'TF10']
        tf_mou = ['1', '2', '1', '3', '2', '1', '3', '2', '1',
                  '3']
        tf_ratio = np.random.rand(len(tf_list))  # 随机生成比例数据
        tf_m = tf_moudle(tf_list, tf_mou, tf_ratio)
        tf_m.plot_scatter()
# #
# import pandas as pd
# time = '72'
...
# # 细胞类型标记数据
# celltype_markers = {
#     'CellType1': ['Gene2', 'Gene4', 'Gene6', 'Gene8'],
#     'CellType2': ['Gene1', 'Gene3', 'Gene5', 'Gene7'],
#     'CellType3': ['Gene9', 'Gene10', 'Gene11', 'Gene12'],
#     'CellType4': ['Gene9', 'Gene10', 'Gene11', 'Gene12']
# }
#
#
