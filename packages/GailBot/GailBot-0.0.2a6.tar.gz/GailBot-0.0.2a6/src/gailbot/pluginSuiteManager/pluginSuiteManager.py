...
# @Last Modified time: 2024-02-19 17:41:48
...
class PluginSuiteManager:
    ...
    def __init__(self, workspace: str):
        ...
        try:
            ...
            if num_subdirs(self.suites_dir) == 0:
    ...
    def modified_files_in_suite(self, suite_name) -> List[str]:
        ...
        try:
            ...
            suite_creation_time_datetime = datetime.fromtimestamp(creation_time).replace(second=0, microsecond=0)
            modified_files = []
            ...
            for file_path in get_subfiles(path=suite_path):
                ...
                file_modification_datetime = datetime.fromtimestamp(file_timestamp).replace(second=0, microsecond=0)
    ...
    def copy_modified_suite(self, suite_name):
        ...
        while os.path.exists(destination_dir):
            ...
            destination_dir = os.path.join(self.copy_suite_dir, versioned_destination_dir_name)
            counter += 1
        try:
