...
# @Last Modified time: 2024-04-03 21:17:14
import os.path
...
class ProfileManager:
    ...
    _default_data = ProfileSetting(
        ...
        plugin_suite_setting={
            "HiLabSuite": ["ChatPlugin", "TextPlugin", "CSVPlugin", "XmlPlugin"]
        },
    )
    ...
    def _load_existing_profile(self):
        ...
        for file in files:
            ...
            data = read_toml(file)
            try:
                self.profiles[name] = ProfileSetting(engine_setting_name=data["engine_setting_name"],
