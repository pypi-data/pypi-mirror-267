...
def servicefoundry_cli(ctx, json, debug):
    ...
    Deploy a Service: https://docs.truefoundry.com/docs/deploy-service-using-python-sdk

    Deploy a Job: https://docs.truefoundry.com/docs/deploy-job-using-python-sdk
