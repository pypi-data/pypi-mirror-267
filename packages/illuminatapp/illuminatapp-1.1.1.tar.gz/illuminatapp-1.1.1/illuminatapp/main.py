...
class Illuminat(MDApp):
    ...
    openai.api_key = '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'
...
7            device_id = str(uuid.uuid4())
    ...
    def chatClairty(self, prompt):
        client = OpenAI(api_key='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')
