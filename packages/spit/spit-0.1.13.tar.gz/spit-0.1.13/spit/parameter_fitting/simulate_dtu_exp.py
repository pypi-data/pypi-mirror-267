...
def select_dtu_genes(IFs, ctrl_samples, gene_names, n_splicotypes, n_dtu_genes):
    pot_dtu_genes = random.sample(gene_names, 10*(n_splicotypes)*n_dtu_genes)
...
def main(args):
    ...
    dtu_genes = select_dtu_genes(IFs, ctrl_samples, gene_names, args.n_splicotypes, args.n_dtu_genes)
