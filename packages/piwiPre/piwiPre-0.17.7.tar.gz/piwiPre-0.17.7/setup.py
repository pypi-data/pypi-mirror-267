...
setuptools.setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'pwpInstaller = piwiPre.pwpInstaller:installer_console', # noqa
            'pwpConfigurator = piwiPre.pwpConfigurator:configurator_console', # noqa
        ],
        'gui_scripts': [
            'pwpInstallerGui = piwiPre.pwpInstaller:installer_toplevel', # noqa
            'pwpConfiguratorGui = piwiPre.pwpConfigurator:configurator_gui', # noqa
        ]
    },
    python_requires='>=3.6',
)