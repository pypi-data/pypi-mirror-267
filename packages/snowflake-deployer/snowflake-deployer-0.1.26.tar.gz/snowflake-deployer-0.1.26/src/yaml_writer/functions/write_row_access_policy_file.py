...
def write_row_access_policy_file(self, database_name_sans_env:str, schema_name:str, d:dict):
    base_path = 'snowflake/data/' + database_name_sans_env + '/' + schema_name + '/ROW_ACCESS_POLICIES/' + database_name_sans_env + '__' + schema_name + '__' + d['ROW_ACCESS_POLICY_NAME']
