...
class PatchedansibleGitRemote(object):
    ...
    def __init__(self, url=None, max_retries=None, pulp_labels=None, proxy_url=None, proxy_password=None, username=None, sock_read_timeout=None, total_timeout=None, connect_timeout=None, password=None, headers=None, rate_limit=None, download_concurrency=None, client_key=None, name=None, client_cert=None, proxy_username=None, tls_validation=None, sock_connect_timeout=None, ca_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
