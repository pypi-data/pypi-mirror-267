...
class AnsibleGitRemoteResponse(object):
    ...
    def __init__(self, url=None, max_retries=None, pulp_labels=None, proxy_url=None, pulp_created=None, sock_read_timeout=None, pulp_last_updated=None, total_timeout=None, connect_timeout=None, hidden_fields=None, headers=None, rate_limit=None, download_concurrency=None, name=None, client_cert=None, tls_validation=None, sock_connect_timeout=None, pulp_href=None, ca_cert=None, metadata_only=None, git_ref=None, local_vars_configuration=None):  # noqa: E501
