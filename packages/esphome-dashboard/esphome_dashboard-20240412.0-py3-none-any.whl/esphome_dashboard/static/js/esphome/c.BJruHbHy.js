import{e as t,c as e,T as o,L as i,r as s,b as r,d as a,n,s as l,x as c,f as p,N as d,O as h,P as u,Q as m,I as _,J as v,l as g,S as w,E as y}from"./index-kkVM6S5M.js";import{g as f}from"./c.ByX5vs6K.js";import"./c.4io2-ZSw.js";import{o as b,c as $,g as S}from"./c.pY2V6Aje.js";import{m as P,s as x,b as k}from"./c.gDA4br3A.js";import{o as C}from"./c.XjPo9uZs.js";class E{constructor(t){this.G=t}disconnect(){this.G=void 0}reconnect(t){this.G=t}deref(){return this.G}}class j{constructor(){this.Y=void 0,this.Z=void 0}get(){return this.Y}pause(){var t;null!==(t=this.Y)&&void 0!==t||(this.Y=new Promise((t=>this.Z=t)))}resume(){var t;null===(t=this.Z)||void 0===t||t.call(this),this.Y=this.Z=void 0}}const W=t=>!i(t)&&"function"==typeof t.then,H=1073741823;const I=t(class extends e{constructor(){super(...arguments),this._$C_t=H,this._$Cwt=[],this._$Cq=new E(this),this._$CK=new j}render(...t){var e;return null!==(e=t.find((t=>!W(t))))&&void 0!==e?e:o}update(t,e){const i=this._$Cwt;let s=i.length;this._$Cwt=e;const r=this._$Cq,a=this._$CK;this.isConnected||this.disconnected();for(let t=0;t<e.length&&!(t>this._$C_t);t++){const o=e[t];if(!W(o))return this._$C_t=t,o;t<s&&o===i[t]||(this._$C_t=H,s=0,Promise.resolve(o).then((async t=>{for(;a.get();)await a.get();const e=r.deref();if(void 0!==e){const i=e._$Cwt.indexOf(o);i>-1&&i<e._$C_t&&(e._$C_t=i,e.setValue(t))}})))}return o}disconnected(){this._$Cq.disconnect(),this._$CK.pause()}reconnected(){this._$Cq.reconnect(this),this._$CK.resume()}}),D=(t,e)=>{import("./c.DnyVId5p.js");const o=document.createElement("esphome-compile-dialog");o.configuration=t,o.platformSupportsWebSerial=e,document.body.append(o)},T=async(t,e)=>{import("./c.Bnjq5gB_.js");let o=t.port;if(o)await o.close();else try{o=await navigator.serial.requestPort()}catch(o){return void("NotFoundError"===o.name?b((()=>T(t,e))):alert(`Unable to connect: ${o.message}`))}const i=$(o);e&&e();const s=document.createElement("esphome-install-web-dialog");s.params=t,s.esploader=i,document.body.append(s)},A={info:d,warning:h,error:u,success:m};let q=class extends l{constructor(){super(...arguments),this.title="",this.alertType="info",this.rtl=!1}render(){return c`
      <div
  ...
  `,r([a()],q.prototype,"title",void 0),r([a({attribute:"alert-type"})],q.prototype,"alertType",void 0),r([a({type:Boolean})],q.prototype,"rtl",void 0),q=r([n("esphome-alert")],q);const B=(t,e)=>{import("./c.BZplaNae.js");const o=document.createElement("esphome-download-type-dialog");o.configuration=t,o.platformSupportsWebSerial=e,document.body.append(o)};let U=class extends l{constructor(){super(...arguments),this._ethernet=!1,this._isPico=!1,this._shouldDownloadFactory=!1,this._state="pick_option"}get _platformSupportsWebSerial(){return!this._isPico}render(){let t,e;if("pick_option"===this._state)t=`How do you want to install ${this.configuration} on your device?`,e=c`
        <mwc-list-item
          twoline
          hasMeta
          .port=${"OTA"}
