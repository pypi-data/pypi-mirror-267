...
class ApplySubscriptionInput(BaseModel):
    ...
    budget_cap_configuration: Optional["BudgetCapConfigurationInput"] = Field(
        alias="budgetCapConfiguration", default=None
    )
...
class BudgetCapConfigurationInput(BaseModel):
