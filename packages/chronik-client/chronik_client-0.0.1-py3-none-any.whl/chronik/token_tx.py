...
# chronik_pb2.py is located at the root of the test directory when this module is
# used for Bitcoin ABC's functional tests via cmake.
# It is located at the root of the package when used via the chronik-client package.
try:
    import chronik_pb2 as pb
except ImportError:
    from . import chronik_pb2 as pb
