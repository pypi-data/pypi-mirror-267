...
from brainai.api_resources import (
    Audio,
    ChatCompletion,
    Completion,
    Customer,
...
from brainai.error import APIError, InvalidRequestError, brainaiError
from brainai.version import VERSION

if TYPE_CHECKING:
    import requests
    from aiohttp import ClientSession

api_key = os.environ.get("brainai_API_KEY")
...
api_key_path: Optional[str] = os.environ.get("brainai_API_KEY_PATH")

organization = os.environ.get("brainai_ORGANIZATION")
api_base = os.environ.get("brainai_API_BASE", "https://brain.thundersoft.com/brain/billing/v1")
api_type = os.environ.get("brainai_API_TYPE", "rubik_ai")
