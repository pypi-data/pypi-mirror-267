...
from brainai import Completion, Engine
...
def test_completions_url_composition_azure() -> None:
    ...
    assert (
        url
        == "/brainai/deployments/test_engine/completions?api-version=2021-11-01-preview"
    )
...
def test_completions_url_composition_instance_url_azure() -> None:
    ...
    assert (
        url
        == "/brainai/deployments/test_engine/completions/test_id?api-version=2021-11-01-preview"
    )
...
def test_completions_url_composition_instance_url_timeout_azure() -> None:
    ...
    assert (
        url
        == "/brainai/deployments/test_engine/completions/test_id?api-version=2021-11-01-preview&timeout=12"
    )


@pytest.mark.url
def test_completions_url_composition_instance_url_timeout_brainai() -> None:
...
def test_engine_search_url_composition_azure() -> None:
    ...
    assert (
        url
        == "/brainai/deployments/test_id/test_operation?api-version=2021-11-01-preview"
    )
...
def test_engine_search_url_composition_azure_no_operation() -> None:
    ...
    assert (
        engine.instance_url()
        == "/brainai/engines/test_id?api-version=2021-11-01-preview"
    )
