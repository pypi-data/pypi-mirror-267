...
from brainai import Model
from brainai.api_requestor import APIRequestor
...
def test_requestor_cycle_sessions(mocker: MockerFixture) -> None:
    ...
    # with other tests
    from brainai.api_requestor import _thread_context
    ...
    mocker.patch("brainai.api_requestor._make_session", lambda: mock_session)
    ...
    mocker.patch("brainai.api_requestor.MAX_SESSION_LIFETIME_SECS", 0)
    ...
    mocker.patch("brainai.api_requestor._make_session", lambda: mock_session_2)
    api_requestor.request_raw("get", "http://example.com")
