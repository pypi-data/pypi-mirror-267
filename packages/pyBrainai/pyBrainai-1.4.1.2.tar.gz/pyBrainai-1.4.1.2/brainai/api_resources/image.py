...
from brainai.api_resources.abstract import APIResource
...
class Image(APIResource):
    ...
    def create(
        ...
        **params,
        ...
        requestor = api_requestor.APIRequestor(
            api_key,
            api_base=api_base or brainai.api_base,
            api_type=api_type,
    ...
    def create_variation(
        ...
        **params,
        ...
        if api_type in (util.ApiType.AZURE, util.ApiType.AZURE_AD):
            raise error.InvalidAPIType("Variations are not supported by the Azure brainai API yet.")
    ...
    def create_edit(
        ...
        **params,
        ...
        if api_type in (util.ApiType.AZURE, util.ApiType.AZURE_AD):
            raise error.InvalidAPIType("Edits are not supported by the Azure brainai API yet.")
