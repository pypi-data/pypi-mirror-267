...
from .nostr import GetInfoResponseResult
from .nostr import Keys
from .nostr import ListTransactionsRequestParams
from .nostr import LookupInvoiceRequestParams
from .nostr import LookupInvoiceResponseResult
from .nostr import MakeInvoiceRequestParams
from .nostr import MakeInvoiceResponseResult
from .nostr import Metadata
from .nostr import NostrConnectUri
from .nostr import NostrWalletConnectUri
from .nostr import PayKeysendRequestParams
from .nostr import PayKeysendResponseResult
...
from .nostr import _UniffiConverterTypeCoordinate
...
from .nostr import _UniffiConverterTypeGetInfoResponseResult
from .nostr import _UniffiConverterTypeKeys
from .nostr import _UniffiConverterTypeListTransactionsRequestParams
from .nostr import _UniffiConverterTypeLookupInvoiceRequestParams
from .nostr import _UniffiConverterTypeLookupInvoiceResponseResult
from .nostr import _UniffiConverterTypeMakeInvoiceRequestParams
from .nostr import _UniffiConverterTypeMakeInvoiceResponseResult
...
from .nostr import _UniffiConverterTypePayKeysendRequestParams
from .nostr import _UniffiConverterTypePayKeysendResponseResult
...
from .nostr import _UniffiRustBuffer as _UniffiRustBufferCoordinate
...
from .nostr import _UniffiRustBuffer as _UniffiRustBufferGetInfoResponseResult
from .nostr import _UniffiRustBuffer as _UniffiRustBufferKeys
from .nostr import _UniffiRustBuffer as _UniffiRustBufferListTransactionsRequestParams
from .nostr import _UniffiRustBuffer as _UniffiRustBufferLookupInvoiceRequestParams
from .nostr import _UniffiRustBuffer as _UniffiRustBufferLookupInvoiceResponseResult
from .nostr import _UniffiRustBuffer as _UniffiRustBufferMakeInvoiceRequestParams
from .nostr import _UniffiRustBuffer as _UniffiRustBufferMakeInvoiceResponseResult
...
from .nostr import _UniffiRustBuffer as _UniffiRustBufferPayKeysendRequestParams
from .nostr import _UniffiRustBuffer as _UniffiRustBufferPayKeysendResponseResult
...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_aborthandle_is_aborted() != 57233:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_add_relay() != 55300:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_add_relay_with_opts() != 23524:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_add_relays() != 45072:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_connect() != 931:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_connect_relay() != 33775:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_repost() != 27770:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_direct_msg() != 12788:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_msg_to() != 48694:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_send_sealed_msg() != 15891:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_stop() != 46184:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_subscribe() != 7326:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_subscribe_with_id() != 43239:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_unsubscribe_all() != 27202:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_update_difficulty() != 40801:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_client_zap() != 9277:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relayoptions_ping() != 51607:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relayoptions_pow() != 22672:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relayoptions_update_adjust_retry_sec() != 1296:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relayoptions_update_pow_difficulty() != 50131:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_stop() != 37084:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_subscribe() != 21574:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_method_relaypool_subscribe_with_id() != 1822:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_method_zapdetails_message() != 43166:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_client_new() != 1292:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_proxy_new() != 51726:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_sdk_ffi_checksum_constructor_relay_custom() != 55798:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class ClientProtocol(typing.Protocol):
    ...
    def send_msg_to(self, urls: "typing.List[str]",msg: "ClientMessage"):
        raise NotImplementedError
    def send_sealed_msg(self, receiver: "PublicKey",message: "str",expiration: "typing.Optional[Timestamp]"):
        """
    ...
    def stop(self, ):
        raise NotImplementedError
    def subscribe(self, filters: "typing.List[Filter]",opts: "typing.Optional[SubscribeAutoCloseOptions]"):
        """
        ...
        raise NotImplementedError
    def subscribe_with_id(self, id: "str",filters: "typing.List[Filter]",opts: "typing.Optional[SubscribeAutoCloseOptions]"):
        """
...
class Client:
    ...
    def send_sealed_msg(self, receiver: "PublicKey",message: "str",expiration: "typing.Optional[Timestamp]") -> None:
        """
        Send GiftWrapper Sealed Direct message
        """
        ...
        _rust_call_with_error(_UniffiConverterTypeNostrSdkError,_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_client_send_sealed_msg,self._uniffi_clone_pointer(),
        _UniffiConverterTypePublicKey.lower(receiver),
    ...
    def subscribe(self, filters: "typing.List[Filter]",opts: "typing.Optional[SubscribeAutoCloseOptions]") -> "str":
        """
        Subscribe to filters
    ...
    def subscribe_with_id(self, id: "str",filters: "typing.List[Filter]",opts: "typing.Optional[SubscribeAutoCloseOptions]") -> None:
        """
        Subscribe to filters with custom subscription ID
...
class RelayOptionsProtocol(typing.Protocol):
    ...
    def update_adjust_retry_sec(self, adjust_retry_sec: "bool"):
        ...
        raise NotImplementedError
    def update_pow_difficulty(self, diffculty: "int"):
        """
        Update `pow` option
        """
...
class RelayOptions:
    ...
    def pow(self, diffculty: "int") -> "RelayOptions":
        """
        Minimum POW for received events (default: 0)
        """

        _UniffiConverterUInt8.check_lower(diffculty)
        
        return _UniffiConverterTypeRelayOptions.lift(
            _rust_call(_UniffiLib.uniffi_nostr_sdk_ffi_fn_method_relayoptions_pow,self._uniffi_clone_pointer(),
        _UniffiConverterUInt8.lower(diffculty))
        )
    ...
    def update_pow_difficulty(self, diffculty: "int") -> None:
        """
        Update `pow` option
        """
...
# External type Coordinate is in namespace "nostr", crate nostr_ffi
...
# External type GetInfoResponseResult is in namespace "nostr", crate nostr_ffi
...
# External type ListTransactionsRequestParams is in namespace "nostr", crate nostr_ffi




# External type LookupInvoiceRequestParams is in namespace "nostr", crate nostr_ffi




# External type LookupInvoiceResponseResult is in namespace "nostr", crate nostr_ffi




# External type MakeInvoiceRequestParams is in namespace "nostr", crate nostr_ffi




# External type MakeInvoiceResponseResult is in namespace "nostr", crate nostr_ffi
...
# External type PayKeysendRequestParams is in namespace "nostr", crate nostr_ffi




# External type PayKeysendResponseResult is in namespace "nostr", crate nostr_ffi
