...
class MonitoredPath(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "uuid", "path", "files", "harvester", "team", "permissions", "regex", "stable_time", "active", "max_partition_line_count", "read_access_level", "edit_access_level", "delete_access_level", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "uuid", "path", "files", "harvester", "team", "permissions", "regex", "stable_time", "active", "max_partition_line_count", "read_access_level", "edit_access_level", "delete_access_level", ], str]):
        return super().get_item_oapg(name)
