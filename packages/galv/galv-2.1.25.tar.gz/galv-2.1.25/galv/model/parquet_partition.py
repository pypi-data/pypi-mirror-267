...
class ParquetPartition(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "uuid", "observed_file", "partition_number", "uploaded", "upload_errors", "permissions", "parquet_file", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "uuid", "observed_file", "partition_number", "uploaded", "upload_errors", "permissions", "parquet_file", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        parquet_file: typing.Union[MetaOapg.properties.parquet_file, None, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ParquetPartition':
        return super().__new__(
