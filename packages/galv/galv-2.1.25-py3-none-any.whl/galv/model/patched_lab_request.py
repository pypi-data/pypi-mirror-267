...
class PatchedLabRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "description", "admin_group", "s3_bucket_name", "s3_location", "s3_custom_domain", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "description", "admin_group", "s3_bucket_name", "s3_location", "s3_custom_domain", ], str]):
