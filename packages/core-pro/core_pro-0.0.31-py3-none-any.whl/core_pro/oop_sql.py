...
class DataPipeLine:
    ...
    def run_presto_to_df(self, file_type: str = 'polars', save_path: Path = None, verbose: bool = True):
        ...
        dict_ = {'polars': pl.DataFrame, 'pandas': pd.DataFrame}
        df = dict_[file_type](records)
        df.columns = columns
