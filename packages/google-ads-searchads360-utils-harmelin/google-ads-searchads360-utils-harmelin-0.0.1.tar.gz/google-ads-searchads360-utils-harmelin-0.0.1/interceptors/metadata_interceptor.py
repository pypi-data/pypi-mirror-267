...
This class is initialized in the SearchAds360Client and passed into a grpc
intercept_channel whenever a new service is initialized. It intercepts requests
and updates the metadata in order to insert the developer token and login-
customer-id values.
"""
...
class MetadataInterceptor(Interceptor, UnaryUnaryClientInterceptor,
  ...
  def __init__(self, login_customer_id):
    ...
    """
    self.login_customer_id_meta = (("login-customer-id", login_customer_id)
  ...
  def intercept_unary_unary(self, continuation, client_call_details, request):
    ...
    Args:
        ...
        client_call_details: a grpc._interceptor._ClientCallDetails instance
          containing request metadata.
        request: a SearchSearchAds360Request or
          SearchSearchAds360StreamRequest message class instance.
