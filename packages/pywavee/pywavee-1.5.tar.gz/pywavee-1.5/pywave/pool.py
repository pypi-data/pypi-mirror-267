...
class Node:
    ...
    def __repr__(self) -> str:
        return f"<pywave Node: <{self.identifier}>, Region: <{self.region}>, Players: <{len(self._players)}>>"
    ...
    async def get_tracks(self, cls: Type[PT], query: str) -> List[PT]:
        ...
        List[:class:`abc.Playable`]:
            A list of pywave track objects.
    ...
    async def get_playlist(self, cls: Type[PLT], identifier: str) -> Optional[PLT]:
        ...
        Optional[:class:`abc.Playlist`]:
            The related pywave track object or ``None`` if none was found.
...
class NodePool:
    ...
    async def create_node(
        ...
        *,
        ...
        Classmethod that creates a :class:`Node` object and stores it for use with pywave.
        ...
        spotify_client: Optional[:class:`pywave.ext.spotify.SpotifyClient`]
