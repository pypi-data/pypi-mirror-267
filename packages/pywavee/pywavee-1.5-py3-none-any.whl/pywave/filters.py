...
class BaseFilter(abc.ABC):
    ...
    def __repr__(self) -> str:
        return f"<pywave.BaseFilter name={self.name}>"
...
class Equalizer(BaseFilter):
    ...
    def __repr__(self) -> str:
        return f"<pywave.Equalizer name={self.name}>"
...
class Karaoke(BaseFilter):
    ...
    def __repr__(self) -> str:
        return f"<pywave.Karaoke level={self.level}, mono_level={self.mono_level}, " \
...
class Timescale(BaseFilter):
    ...
    def __repr__(self) -> str:
        return f"<pywave.Timescale speed={self.speed}, pitch={self.pitch}, rate={self.rate}>"
...
class Tremolo(BaseFilter):
    ...
    def __repr__(self) -> str:
        return f"<pywave.Tremolo frequency={self.frequency}, depth={self.depth}>"
...
class Vibrato(BaseFilter):
    ...
    def __repr__(self) -> str:
        return f"<pywave.Vibrato frequency={self.frequency}, depth={self.depth}>"
...
class Rotation(BaseFilter):
    ...
    def __repr__(self) -> str:
        return f"<pywave.Rotation speed={self.speed}>"
...
class LowPass(BaseFilter):
    ...
    def __repr__(self) -> str:
        return f"<pywave.LowPass smoothing={self.smoothing}>"
...
class Filter:
    ...
    def __repr__(self) -> str:
        return f"<pywave.Filter volume={self.volume}, equalizer={self.equalizer}, " \
