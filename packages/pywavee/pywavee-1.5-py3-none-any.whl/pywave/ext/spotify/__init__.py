...
import pywave
from pywave import Node, NodePool, PartialTrack, YouTubeTrack
from pywave.tracks import SearchableTrack

from pywave.utils import MISSING
...
def decode_url(url: str) -> Optional[dict]:
    ...
    .. code:: python3
        ...
        from pywave.ext import spotify
...
class SpotifyTrack(YouTubeTrack):
    ...
    async def search(
        ...
        node: Optional[:class:`pywave.Node`]
    ...
    def iterator(cls,
        ...
        partial_tracks: Optional[bool]
            Whether or not to create :class:`pywave.tracks.PartialTrack` objects for search at playtime.
    ...
    async def convert(cls: Type[ST], ctx: commands.Context, argument: str) -> ST:
        ...
        Used as a type hint in a pycord command.
        """
