...
class QueryKnowledgeCard:
    ...
    def from_dict(obj: Any) -> 'QueryKnowledgeCard':
        ...
        return QueryKnowledgeCard(explanations, is_curation_request, is_marked_as_curated, query, query_id, title, is_same_as_original_query, parsed_statement, query_info_copy)
