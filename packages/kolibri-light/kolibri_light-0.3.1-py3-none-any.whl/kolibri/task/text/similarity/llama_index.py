...
class LlamaIndexSimilarity(BaseModel):
    ...
    async def aget_relevant_documents(self, query: str) -> List[Document]:
        raise NotImplementedError("LlamaIndexSimilarity does not support async")


class LlamaIndexGraphSimilarity(BaseModel):
    ...
    async def aget_relevant_documents(self, query: str) -> List[Document]:
        raise NotImplementedError("LlamaIndexGraphSimilarity does not support async")
