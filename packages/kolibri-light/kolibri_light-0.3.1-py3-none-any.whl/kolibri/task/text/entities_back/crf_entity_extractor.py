...
class CRFEntityExtractor(EntityExtractor):
    ...
    defaults = {
        ...
        "features": [
            ...
            ["bias", "low", "prefix5", "prefix2", "suffix5", "suffix3","pos", "pos2",
             "suffix2", "upper", "title", "digit", "regexes", "pos", "lemma"],
    ...
    def extract_entities(self, message):
        ...
        if self.ent_tagger is not None:
            ...
            ents = self.ent_tagger.model_type.predict_marginals_single(features)
    ...
    def __pattern_of_token(message, i):
        ...
        if message.tokens is not None:
            for key in message.tokens[i].regexes:
                patterns+=(message.tokens[i].regexes[key],)
    ...
    def _train_model(self, df_train):
        ...
        import sklearn_crfsuite
        logger.info('Start training CRF model_type')
