...
from bert4keras.backend import keras, ops, is_tf_keras,K,tf,enable_flashatt
if enable_flashatt:
    from bert4keras.backend import flash_mha
from bert4keras.backend import align, sequence_masking,backlib
from bert4keras.backend import recompute_grad,int_shape
from bert4keras.backend import attention_normalize,divide_no_nan
from bert4keras.backend import sinusoidal_embeddings,slices_index
...
if tf.__version__ < '1.15' and keras.__version__ < '3':
