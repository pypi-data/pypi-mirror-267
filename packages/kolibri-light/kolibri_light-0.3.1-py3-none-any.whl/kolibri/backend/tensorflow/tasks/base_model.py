...
#            self.label_indexer = LabelIndexer(multi_label=multi_label)
    ...
    def save(self, model_path= None):
        ...
        full_config_path=os.path.join(full_path, config_file)
        ...
        self.tf_model.save(os.path.join(full_path, model_file))  # type: ignore
        logger.info('model saved to {}'.format(os.path.abspath(full_path)))
