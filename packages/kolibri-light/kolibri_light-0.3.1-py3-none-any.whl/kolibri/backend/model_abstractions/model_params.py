...
class ModelParams(ImmutableExtModel):
    ...
    Feel free to extend this class and add more hyper-parameters and architecture parameters for your model like:
        ...
        - etc.
    """
    version: constr(pattern=r"^v1\.0\.0$", strict=True) = "v1.0.0"
    ...
    # Total number of steps (batches of data) before declaring one epoch finished and starting the next epoch.
