...
from kolibri.backend.pytorch.data import Dictionary, Sentence, Span, Token
...
class TokenClassifier(DefaultClassifier[Sentence, Token]):
...
@deprecated(reason="The WordTagger was renamed to :class:`kolibri.backend.pytorch.models.TokenClassifier`.", version="0.12.2")
