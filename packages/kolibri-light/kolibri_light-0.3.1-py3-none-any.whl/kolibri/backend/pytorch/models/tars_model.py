...
from kolibri.backend.pytorch.data import Corpus, Dictionary, Sentence, Span
from kolibri.backend.pytorch.datasets import DataLoader, FlairDatapointDataset
from kolibri.backend.pytorch.embeddings import (
    TokenEmbeddings,
    TransformerDocumentEmbeddings,
    TransformerWordEmbeddings,
)
from kolibri.backend.pytorch.file_utils import cached_path
from kolibri.backend.pytorch.models.sequence_tagger_model import SequenceTagger
from kolibri.backend.pytorch.models.text_classification_model import TextClassifier
from kolibri.backend.pytorch.training_utils import store_embeddings
from kolibri.backend.pytorch.nn import DefaultClassifier
log = logging.getLogger("kolibri")


class FewshotClassifier(Classifier[Sentence], ABC):
    def __init__(self) -> None:
        self._current_task = None
        self._task_specific_attributes: Dict[str, Dict[str, Any]] = {}
        self.label_nearest_map = None
        self.tars_model: Classifier[Sentence]
        self.separator: str
