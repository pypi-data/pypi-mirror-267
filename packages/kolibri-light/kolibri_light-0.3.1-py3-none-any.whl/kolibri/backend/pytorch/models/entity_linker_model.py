...
import kolibri
from kolibri.backend.pytorch.data import Dictionary, Sentence, Span
...
class SpanClassifier(kolibri.backend.pytorch.nn.DefaultClassifier[Sentence, Span]):
    ...
    def __init__(
        self,
        embeddings: kolibri.backend.pytorch.embeddings.TokenEmbeddings,
        ...
        **classifierargs,
        ...
        Args:
            ...
            **classifierargs: The arguments propagated to :meth:`kolibri.backend.pytorch.nn.DefaultClassifier.__init__`
        """
        super().__init__(
    ...
    def _mask_scores(self, scores: torch.Tensor, data_points: List[Span]):
        ...
        masked_scores = -torch.inf * torch.ones(scores.size(), requires_grad=True, device=kolibri.backend.pytorch.device)
...
@deprecated(reason="The EntityLinker was renamed to :class:`kolibri.backend.pytorch.models.SpanClassifier`.", version="0.12.2")
