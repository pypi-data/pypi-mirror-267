...
from kolibri.backend.pytorch.data import DT, Corpus, Sentence
from kolibri.backend.pytorch.file_utils import cached_path
from kolibri.backend.pytorch.nn import Classifier
from kolibri.backend.pytorch.training_utils import Result
from kolibri.backend.pytorch.nn import Classifier
log = logging.getLogger("kolibri")


class MultitaskModel(Classifier):
    ...
    def __init__(
        ...
        self.tasks: Dict[str, Classifier] = {}
    ...
    def forward_loss(self, sentences: Union[List[Sentence], Sentence]) -> Tuple[torch.Tensor, int]:
        ...
        loss = torch.tensor(0.0, device=kolibri.backend.pytorch.device)
        count = 0
    ...
    def evaluate(  # type: ignore[override]
        ...
        **evalargs,
        ...
        Args:
            ...
            **evalargs: arguments propagated to :meth:`kolibri.backend.pytorch.nn.Model.evaluate`
