...
cache_root = Path(os.getenv("FLAIR_CACHE_ROOT", Path(Path.home(), ".kolibri")))
...
from kolibri.backend.pytorch import (  # noqa: E402 import after setting device
    data,
    models,
    nn,
    trainers,
...
logging.config.dictConfig(
    {
        ...
        "loggers": {"kolibri": {"handlers": ["console"], "level": "INFO", "propagate": False}},
    }
)
