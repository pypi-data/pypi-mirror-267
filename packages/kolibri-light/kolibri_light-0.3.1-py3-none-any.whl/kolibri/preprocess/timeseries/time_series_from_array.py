...
def timeseries_dataset_from_array(
  ...
  indices_map = lambda i, positions: range(  # pylint: disable=g-long-lambda
      positions[i],
      positions[i] + sequence_length * sampling_rate, sampling_rate)

  indices = [indices_map(i, start_positions) for i in start_positions]
  return sequences_from_indices(data, indices, start_index, end_index)



def sequences_from_indices(array, indices_ds, start_index, end_index):
  dataset = array[start_index : end_index]
  dataset= np.array([dataset[indice] for indice in indices_ds])
