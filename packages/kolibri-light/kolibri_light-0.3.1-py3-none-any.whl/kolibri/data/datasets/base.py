...
from kolibri.data.data_base import DT, FlairDataset, Sentence, Tokenizer
...
class DatapointDataset(FlairDataset, Generic[DT]):
    ...
    def __init__(self, datapoints: Union[DT, List[DT]]) -> None:
        """Instantiate DatapointDataset.

        Args:
            datapoints: DT or List of DT that make up DatapointDataset
        """
...
class SentenceDataset(DatapointDataset):
    @deprecated(version="0.11", reason="The 'SentenceDataset' class was renamed to 'DatapointDataset'")
...
class StringDataset(FlairDataset):
    ...
    def __init__(
        ...
        use_tokenizer: Union[bool, Tokenizer] = WordTokenizer(),
    ) -> None:
        ...
        Args:
            ...
            use_tokenizer:
                ...
                :class:`kolibri.backend.pytorch.tokenization.SegTokTokenizer` will be used.
        """
        # cast to list if necessary
