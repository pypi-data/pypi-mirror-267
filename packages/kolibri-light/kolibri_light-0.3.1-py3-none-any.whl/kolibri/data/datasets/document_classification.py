...
from kolibri.utils.file_utils import cached_path, unpack_file, unzip_file
from kolibri.tokenizers import SegtokTokenizer, WordTokenizer
...
class AMAZON_REVIEWS(ClassificationCorpus):
    ...
    def __init__(
        ...
        **corpusargs,
        ...
        data_folder = kolibri.cache_root / "datasets" / dataset_name
    ...
    def download_and_prepare_amazon_product_file(
        ...
        with open(data_folder / "train.txt", "a") as train_file:
            ...
            with gzip.open(kolibri.cache_root / "datasets" / "Amazon_Product_Reviews" / part_name, "rb") as f_in:
                for line in f_in:
    ...
    def __init__(
        ...
        **corpusargs,
        ...
        if not train_data_file.is_file() or (not rebalance_corpus and not test_data_file.is_file()):
            ...
            with tarfile.open(kolibri.cache_root / "datasets" / dataset_name / "aclImdb_v1.tar.gz", "r:gz") as f_in:
                datasets = ["train", "test"]
                labels = ["pos", "neg"]
    ...
    def __init__(
        ...
        **corpusargs,
        ...
        if not data_file.is_file():
            ...
            with tarfile.open(
                kolibri.cache_root / "datasets" / dataset_name / "original" / "20news-bydate.tar.gz", "r:gz"
            ) as f_in:
...
class AGNEWS(ClassificationCorpus):
    ...
    def __init__(
        self,
        base_path: Optional[Union[str, Path]] = None,
        tokenizer: Union[bool, Tokenizer] = WordTokenizer(),
        memory_mode="partial",
        **corpusargs,
    ):
        ...
        :param tokenizer: Custom tokenizer to use (default is WordTokenizer)
        ...
        if not data_file.is_file():
            ...
            with (data_path / "original" / "title_StackOverflow.txt").open(encoding="latin1") as open_fp, (
                ...
                for idx, line in enumerate(open_fp):
                    ...
                    # Create kolibri compatible labels
...
class SENTIMENT_140(ClassificationCorpus):
    ...
    def __init__(
        ...
        if True:
            ...
            senteval_folder = kolibri.cache_root / "datasets" / dataset_name / "raw"
    ...
    def __init__(
        ...
        **corpusargs,
        ...
        if not (data_folder / "train.txt").is_file():
            ...
            senteval_folder = kolibri.cache_root / "datasets" / "senteval"
    ...
    def __init__(
        ...
        **corpusargs,
        ...
        if not (data_folder / "train.txt").is_file():
            ...
            data_path = kolibri.cache_root / "datasets" / dataset_name / "raw"
...
class YAHOO_ANSWERS(ClassificationCorpus):
    ...
    def __init__(
        ...
        **corpusargs,
        ...
        original = kolibri.cache_root / "datasets" / dataset_name / "original"
