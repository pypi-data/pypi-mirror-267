...
class PlotSHAP:
    ...
    def get_explainer(algorithm, X_train):
        ...
        if algorithm.algorithm_short_name in [
            ...
            explainer = shap.TreeExplainer(algorithm.model_type)
        elif algorithm.algorithm_short_name in ["Linear"]:
            explainer = shap.LinearExplainer(algorithm.model_type, X_train)
        # elif algorithm.algorithm_short_name in ["Neural Network"]:
        #    explainer = shap.KernelExplainer(algorithm.model_type.predict, X_train)  # slow
