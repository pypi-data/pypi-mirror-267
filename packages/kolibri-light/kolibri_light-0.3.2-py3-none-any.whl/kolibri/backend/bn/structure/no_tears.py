...
from kolibri.backend.bn.utils import rank_transform, mean_var_normalize
from kolibri.backend.bn.structure.structure_model import StructureModel
from kolibri.backend.bn.structure.notears_tf2 import NoTears
...
def from_numpy_tf(
    ...
    return _learn_structure_tf(X, w_threshold)
