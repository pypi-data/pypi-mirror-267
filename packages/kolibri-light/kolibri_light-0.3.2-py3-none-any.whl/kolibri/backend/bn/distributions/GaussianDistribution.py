...
class GaussianDistribution(BaseDistribution):
    ...
    def __init__(self, variables, mean, cov):
        ...
        --------
        >>> import numpy as np
        >>> from kolibri.backend.bn.distributions import GaussianDistribution as GD
    ...
    def pdf(self):
        ...
        Examples
        --------
        >>> from kolibri.backend.bn.distributions import GaussianDistribution
        ...
        ...                [-2, -5, 8]])
        >>> dist.pdf
        <function kolibri.backend.bn.distributions.GaussianDistribution.GaussianDistribution.pdf.<locals>.<lambda>>
        >>> dist.pdf([0, 0, 0])
        0.0014805631279234139
        """
    ...
    def to_canonical_factor(self):
        ...
        """
        from kolibri.backend.bn.distributions import CanonicalDistribution
