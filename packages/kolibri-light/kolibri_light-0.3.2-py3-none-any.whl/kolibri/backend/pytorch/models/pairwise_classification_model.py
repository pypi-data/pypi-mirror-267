...
from kolibri.backend.pytorch.data import Corpus, Sentence, TextPair, _iter_dataset
...
class TextPairClassifier(DefaultClassifier[TextPair, TextPair]):
    ...
    def __init__(
        ...
        **classifierargs,
        ...
        Args:
            ...
            **classifierargs: The arguments propagated to :meth:`DefaultClassifier.__init__`
        """
        super().__init__(
            **classifierargs,
        ...
        if not self.embed_separately:
            ...
            if isinstance(
                self.embeddings,
                kolibri.backend.pytorch.embeddings.document.TransformerDocumentEmbeddings,
            ):
