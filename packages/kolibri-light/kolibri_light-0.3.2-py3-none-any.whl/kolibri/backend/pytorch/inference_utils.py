...
from kolibri.backend.pytorch.embeddings import WordEmbeddings
...
class WordEmbeddingsStore:
    """Class to simulate a WordEmbeddings class from kolibri.backend.pytorch.

    Run this to generate a headless (without word embeddings) model as well a stored word embeddings:

    >>> from kolibri.backend.pytorch.inference_utils import WordEmbeddingsStore
