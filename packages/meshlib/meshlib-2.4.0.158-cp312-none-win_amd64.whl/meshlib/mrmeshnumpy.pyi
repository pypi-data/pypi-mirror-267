...
def getNumpyVerts(mesh: meshlib.mrmeshpy.Mesh) -> numpy.ndarray[numpy.float64]:
    ...
    """
def meshFromFacesVerts(faces: typing_extensions.Buffer, verts: typing_extensions.Buffer, settings: meshlib.mrmeshpy.MeshBuilderSettings = ..., duplicateNonManifoldVertices: bool = True) -> meshlib.mrmeshpy.Mesh:
    """
...
def toNumpyArray(coords: meshlib.mrmeshpy.FaceNormals) -> numpy.ndarray[numpy.float64]:
    ...
    """
@typing.overload
def toNumpyArray(coords: meshlib.mrmeshpy.Contour3f) -> numpy.ndarray[numpy.float64]:
    """
    // returns numpy array shapes [num coords,3] which represents coordinates from given vector
    """
