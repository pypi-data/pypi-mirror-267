...
class SubscriptionDataConfig(System.Object, System.IEquatable[QuantConnect_Data_SubscriptionDataConfig]):
    ...
    @overload
    def __init__(self, config: QuantConnect.Data.SubscriptionDataConfig, object_type: typing.Type = None, symbol: typing.Union[QuantConnect.Symbol, str] = None, resolution: typing.Optional[QuantConnect.Resolution] = None, data_time_zone: typing.Any = None, exchange_time_zone: typing.Any = None, fill_forward: typing.Optional[bool] = None, extended_hours: typing.Optional[bool] = None, is_internal_feed: typing.Optional[bool] = None, is_custom: typing.Optional[bool] = None, tick_type: typing.Optional[QuantConnect.TickType] = None, is_filtered_subscription: typing.Optional[bool] = None, data_normalization_mode: typing.Optional[QuantConnect.DataNormalizationMode] = None, data_mapping_mode: typing.Optional[QuantConnect.DataMappingMode] = None, contract_depth_offset: typing.Optional[int] = None, mapped_config: typing.Optional[bool] = None) -> None:
        """
...
class SubscriptionDataSource(System.Object, System.IEquatable[QuantConnect_Data_SubscriptionDataSource]):
    ...
    @overload
    def __init__(self, source: str, transport_medium: QuantConnect.SubscriptionTransportMedium, format: QuantConnect.Data.FileFormat, headers: System.Collections.Generic.IEnumerable[System.Collections.Generic.KeyValuePair[str, str]]) -> None:
        """
...
class Slice(QuantConnect.ExtendedDictionary[typing.Any], typing.Iterable[System.Collections.Generic.KeyValuePair[QuantConnect.Symbol, QuantConnect.Data.BaseData]]):
    ...
    @overload
    def __init__(self, time: typing.Union[datetime.datetime, datetime.date], data: System.Collections.Generic.IEnumerable[QuantConnect.Data.BaseData], utc_time: typing.Union[datetime.datetime, datetime.date]) -> None:
        """
    ...
    @overload
    def __init__(self, time: typing.Union[datetime.datetime, datetime.date], data: System.Collections.Generic.List[QuantConnect.Data.BaseData], utc_time: typing.Union[datetime.datetime, datetime.date]) -> None:
        """
        Initializes a new instance of the Slice class, lazily
        instantiating the Slice.Bars and Slice.Ticks
        collections on demand
...
class BaseDataRequest(System.Object, metaclass=abc.ABCMeta):
    ...
    def __init__(self, start_time_utc: typing.Union[datetime.datetime, datetime.date], end_time_utc: typing.Union[datetime.datetime, datetime.date], exchange_hours: QuantConnect.Securities.SecurityExchangeHours, tick_type: QuantConnect.TickType) -> None:
        """
...
class HistoryRequest(QuantConnect.Data.BaseDataRequest):
    ...
    @overload
    def __init__(self, request: QuantConnect.Data.HistoryRequest, new_symbol: typing.Union[QuantConnect.Symbol, str], new_start_time_utc: typing.Union[datetime.datetime, datetime.date], new_end_time_utc: typing.Union[datetime.datetime, datetime.date]) -> None:
        """
...
class Channel(System.Object):
    ...
    def __init__(self, channel_name: str, symbol: typing.Union[QuantConnect.Symbol, str]) -> None:
        """
