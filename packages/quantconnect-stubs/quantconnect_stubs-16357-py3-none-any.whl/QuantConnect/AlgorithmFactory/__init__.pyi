...
class Loader(System.MarshalByRefObject):
    ...
    @overload
    def __init__(self, debugging: bool, language: QuantConnect.Language, loader_time_limit: datetime.timedelta, multiple_type_name_resolver_function: typing.Callable[[System.Collections.Generic.List[str]], str], worker_thread: QuantConnect.Util.WorkerThread = None) -> None:
        """
