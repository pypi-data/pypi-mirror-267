...
class DataFeedPacket(System.Object):
    ...
    @overload
    def __init__(self, security: QuantConnect.Interfaces.ISecurityPrice, configuration: QuantConnect.Data.SubscriptionDataConfig, data: System.Collections.Generic.List[QuantConnect.Data.BaseData], is_subscription_removed: QuantConnect.Util.IReadOnlyRef[bool] = None) -> None:
        """
        Initializes a new instance of the DataFeedPacket class
...
class UpdateData(typing.Generic[QuantConnect_Lean_Engine_DataFeeds_UpdateData_T], System.Object):
    ...
    def __init__(self, target: QuantConnect_Lean_Engine_DataFeeds_UpdateData_T, data_type: typing.Type, data: System.Collections.Generic.IReadOnlyList[QuantConnect.Data.BaseData], is_internal_config: bool, contains_fill_forward_data: typing.Optional[bool] = None) -> None:
        """
...
class BacktestingChainProvider(System.Object, metaclass=abc.ABCMeta):
    ...
    def __init__(self, data_cache_provider: QuantConnect.Interfaces.IDataCacheProvider) -> None:
        """
        Creates a new instance
...
class BaseDataExchange(System.Object):
    ...
    class EnumeratorHandler(System.Object):
        ...
        def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], enumerator: System.Collections.Generic.IEnumerator[QuantConnect.Data.BaseData], should_move_next: typing.Callable[[], bool] = None, handle_data: typing.Callable[[QuantConnect.Data.BaseData], None] = None) -> None:
            """
...
class BacktestingOptionChainProvider(QuantConnect.Lean.Engine.DataFeeds.BacktestingChainProvider, QuantConnect.Interfaces.IOptionChainProvider):
    ...
    def __init__(self, data_cache_provider: QuantConnect.Interfaces.IDataCacheProvider, map_file_provider: QuantConnect.Interfaces.IMapFileProvider) -> None:
        """
        Creates a new instance
...
class CompositeTimeProvider(System.Object, QuantConnect.ITimeProvider):
    ...
    def __init__(self, time_providers: System.Collections.Generic.IEnumerable[QuantConnect.ITimeProvider]) -> None:
        """
        Creates a new instance
