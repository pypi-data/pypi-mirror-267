...
class OptionContract(System.Object):
    ...
    @staticmethod
    @overload
    def Create(underlyingSymbol: typing.Union[QuantConnect.Symbol, str], endTime: typing.Union[datetime.datetime, datetime.date], security: QuantConnect.Interfaces.ISecurityPrice, underlyingLastPrice: float) -> QuantConnect.Data.Market.OptionContract:
        """
        Creates a OptionContract
