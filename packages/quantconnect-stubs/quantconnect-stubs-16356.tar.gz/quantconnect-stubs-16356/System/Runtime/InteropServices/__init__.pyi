...
class ComSourceInterfacesAttribute(System.Attribute):
    ...
    @overload
    def __init__(self, source_interface1: typing.Type, source_interface2: typing.Type) -> None:
        ...

    @overload
    def __init__(self, source_interface1: typing.Type, source_interface2: typing.Type, source_interface3: typing.Type) -> None:
        ...

    @overload
    def __init__(self, source_interface1: typing.Type, source_interface2: typing.Type, source_interface3: typing.Type, source_interface4: typing.Type) -> None:
        ...
