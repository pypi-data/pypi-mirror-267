...
class PositionGroupKey(System.Object, System.IEquatable[QuantConnect_Securities_Positions_PositionGroupKey]):
    ...
    @overload
    def __init__(self, buying_power_model: QuantConnect.Securities.Positions.IPositionGroupBuyingPowerModel, positions: System.Collections.Generic.IReadOnlyCollection[QuantConnect.Securities.Positions.IPosition]) -> None:
        """
...
class PositionGroup(System.Object, QuantConnect.Securities.Positions.IPositionGroup, typing.Iterable[QuantConnect.Securities.Positions.IPosition]):
    ...
    @overload
    def __init__(self, buying_power_model: QuantConnect.Securities.Positions.IPositionGroupBuyingPowerModel, quantity: float, *positions: QuantConnect.Securities.Positions.IPosition) -> None:
        """
...
class ReservedBuyingPowerImpact(System.Object):
    ...
    def __init__(self, current: float, contemplated: float, impacted_groups: System.Collections.Generic.IReadOnlyCollection[QuantConnect.Securities.Positions.IPositionGroup], contemplated_changes: System.Collections.Generic.IReadOnlyCollection[QuantConnect.Securities.Positions.IPosition], contemplated_groups: System.Collections.Generic.IReadOnlyCollection[QuantConnect.Securities.Positions.IPositionGroup]) -> None:
        """
...
class ReservedBuyingPowerImpactParameters(System.Object):
    ...
    def __init__(self, portfolio: QuantConnect.Securities.SecurityPortfolioManager, contemplated_changes: QuantConnect.Securities.Positions.IPositionGroup, orders: System.Collections.Generic.List[QuantConnect.Orders.Order]) -> None:
        """
...
class HasSufficientPositionGroupBuyingPowerForOrderParameters(System.Object):
    ...
    def __init__(self, portfolio: QuantConnect.Securities.SecurityPortfolioManager, position_group: QuantConnect.Securities.Positions.IPositionGroup, orders: System.Collections.Generic.List[QuantConnect.Orders.Order]) -> None:
        """
...
class Position(System.Object, QuantConnect.Securities.Positions.IPosition):
    ...
    @overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], quantity: float, unit_quantity: float) -> None:
        """
