...
class CompositeRiskManagementModel(QuantConnect.Algorithm.Framework.Risk.RiskManagementModel):
    ...
    @overload
    def __init__(self, *risk_management_models: QuantConnect.Algorithm.Framework.Risk.IRiskManagementModel) -> None:
        """
    ...
    @overload
    def __init__(self, risk_management_models: System.Collections.Generic.IEnumerable[QuantConnect.Algorithm.Framework.Risk.IRiskManagementModel]) -> None:
        """
        Initializes a new instance of the CompositeRiskManagementModel class
    ...
    @overload
    def __init__(self, *risk_management_models: PyObject) -> None:
        """
        Initializes a new instance of the CompositeRiskManagementModel class
