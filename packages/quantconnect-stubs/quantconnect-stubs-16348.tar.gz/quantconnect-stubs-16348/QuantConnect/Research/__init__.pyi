...
class QuantBook(QuantConnect.Algorithm.QCAlgorithm):
    ...
    @overload
    def UniverseHistory(self, universe: QuantConnect.Data.UniverseSelection.Universe, start: typing.Union[datetime.datetime, datetime.date], end: typing.Optional[datetime.datetime] = None) -> System.Collections.Generic.IEnumerable[System.Collections.Generic.IEnumerable[QuantConnect.Data.BaseData]]:
        """
        Will return the universe selection data and will optionally perform selection
    ...
    @overload
    def UniverseHistory(self, universe: typing.Any, start: typing.Union[datetime.datetime, datetime.date], end: typing.Optional[datetime.datetime] = None, func: typing.Any = None) -> typing.Any:
        """
        Will return the universe selection data and will optionally perform selection
