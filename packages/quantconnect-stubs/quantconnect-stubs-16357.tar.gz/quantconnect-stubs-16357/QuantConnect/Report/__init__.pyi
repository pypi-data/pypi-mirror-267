...
class PointInTimePortfolio(System.Object):
    ...
    class PointInTimeHolding(System.Object):
        ...
        def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], holdings_value: float, holdings_quantity: float) -> None:
            """
...
class PortfolioLooperAlgorithm(QuantConnect.Algorithm.QCAlgorithm):
    ...
    def __init__(self, starting_cash: float, orders: System.Collections.Generic.IEnumerable[QuantConnect.Orders.Order], algorithm_configuration: QuantConnect.AlgorithmConfiguration = None) -> None:
        """
