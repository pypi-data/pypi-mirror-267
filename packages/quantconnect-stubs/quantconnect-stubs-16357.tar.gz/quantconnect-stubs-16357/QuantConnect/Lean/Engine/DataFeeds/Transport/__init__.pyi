...
class RemoteFileSubscriptionStreamReader(System.Object, QuantConnect.Interfaces.IStreamReader):
    ...
    def __init__(self, data_cache_provider: QuantConnect.Interfaces.IDataCacheProvider, source: str, download_directory: str, headers: System.Collections.Generic.IEnumerable[System.Collections.Generic.KeyValuePair[str, str]]) -> None:
        """
...
class RestSubscriptionStreamReader(System.Object, QuantConnect.Interfaces.IStreamReader):
    ...
    def __init__(self, source: str, headers: System.Collections.Generic.IEnumerable[System.Collections.Generic.KeyValuePair[str, str]], is_live_mode: bool) -> None:
        """
