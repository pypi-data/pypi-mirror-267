...
class Rune(System.IComparable[System_Text_Rune], System.IEquatable[System_Text_Rune]):
    ...
    @overload
    def __init__(self, high_surrogate: str, low_surrogate: str) -> None:
...
class UTF8Encoding(System.Text.Encoding):
    ...
    @overload
    def __init__(self, encoder_should_emit_utf8identifier: bool) -> None:
        ...

    @overload
    def __init__(self, encoder_should_emit_utf8identifier: bool, throw_on_invalid_bytes: bool) -> None:
        ...
