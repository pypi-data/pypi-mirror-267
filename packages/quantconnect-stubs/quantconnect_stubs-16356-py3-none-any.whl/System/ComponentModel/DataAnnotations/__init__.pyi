...
class UIHintAttribute(System.Attribute):
    ...
    @overload
    def __init__(self, ui_hint: str, presentation_layer: str, *control_parameters: typing.Any) -> None:
        """
...
class FilterUIHintAttribute(System.Attribute):
    ...
    @overload
    def __init__(self, filter_ui_hint: str, presentation_layer: str, *control_parameters: typing.Any) -> None:
        """
