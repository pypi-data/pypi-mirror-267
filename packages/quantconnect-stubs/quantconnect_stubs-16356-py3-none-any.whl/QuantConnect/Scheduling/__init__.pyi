...
class ScheduledEvent(System.Object, System.IDisposable):
    ...
    @overload
    def __init__(self, name: str, ordered_event_utc_times: System.Collections.Generic.IEnumerable[datetime.datetime], callback: typing.Callable[[str, datetime.datetime], None] = None) -> None:
        """
        Initializes a new instance of the ScheduledEvent class
...
class CompositeTimeRule(System.Object, QuantConnect.Scheduling.ITimeRule):
    ...
    @overload
    def __init__(self, *time_rules: QuantConnect.Scheduling.ITimeRule) -> None:
        """
    ...
    @overload
    def __init__(self, time_rules: System.Collections.Generic.IEnumerable[QuantConnect.Scheduling.ITimeRule]) -> None:
        """
        Initializes a new instance of the CompositeTimeRule class
...
class FuncTimeRule(System.Object, QuantConnect.Scheduling.ITimeRule):
    ...
    def __init__(self, name: str, create_utc_event_times_function: typing.Callable[[System.Collections.Generic.IEnumerable[datetime.datetime]], System.Collections.Generic.IEnumerable[datetime.datetime]]) -> None:
        """
...
class FuncDateRule(System.Object, QuantConnect.Scheduling.IDateRule):
    ...
    def __init__(self, name: str, get_dates_function: typing.Callable[[datetime.datetime, datetime.datetime], System.Collections.Generic.IEnumerable[datetime.datetime]]) -> None:
        """
