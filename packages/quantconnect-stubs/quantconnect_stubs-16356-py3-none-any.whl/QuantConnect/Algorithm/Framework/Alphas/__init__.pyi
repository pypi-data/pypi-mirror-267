...
class Insight(System.Object):
    ...
    @overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], period: datetime.timedelta, type: QuantConnect.Algorithm.Framework.Alphas.InsightType, direction: QuantConnect.Algorithm.Framework.Alphas.InsightDirection, magnitude: typing.Optional[float], confidence: typing.Optional[float], source_model: str = None, weight: typing.Optional[float] = None, tag: str = ...) -> None:
        """
        Initializes a new instance of the Insight class
    ...
    @overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], expiry_func: typing.Callable[[datetime.datetime], datetime.datetime], type: QuantConnect.Algorithm.Framework.Alphas.InsightType, direction: QuantConnect.Algorithm.Framework.Alphas.InsightDirection, tag: str = ...) -> None:
        """
        Initializes a new instance of the Insight class
    ...
    @overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], expiry_func: typing.Callable[[datetime.datetime], datetime.datetime], type: QuantConnect.Algorithm.Framework.Alphas.InsightType, direction: QuantConnect.Algorithm.Framework.Alphas.InsightDirection, magnitude: typing.Optional[float], confidence: typing.Optional[float], source_model: str = None, weight: typing.Optional[float] = None, tag: str = ...) -> None:
        """
        Initializes a new instance of the Insight class
...
class CompositeAlphaModel(QuantConnect.Algorithm.Framework.Alphas.AlphaModel):
    ...
    @overload
    def __init__(self, *alpha_models: QuantConnect.Algorithm.Framework.Alphas.IAlphaModel) -> None:
        """
    ...
    @overload
    def __init__(self, *alpha_models: PyObject) -> None:
        """
        Initializes a new instance of the CompositeAlphaModel class
