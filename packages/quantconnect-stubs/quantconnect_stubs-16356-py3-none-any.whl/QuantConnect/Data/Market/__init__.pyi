...
class DataDictionary(typing.Generic[QuantConnect_Data_Market_DataDictionary_T], QuantConnect.ExtendedDictionary[QuantConnect_Data_Market_DataDictionary_T], System.Collections.Generic.IDictionary[QuantConnect.Symbol, QuantConnect_Data_Market_DataDictionary_T], typing.Iterable[System.Collections.Generic.KeyValuePair[QuantConnect.Symbol, QuantConnect_Data_Market_DataDictionary_T]]):
    ...
    @overload
    def __init__(self, data: System.Collections.Generic.IEnumerable[QuantConnect_Data_Market_DataDictionary_T], key_selector: typing.Callable[[QuantConnect_Data_Market_DataDictionary_T], QuantConnect.Symbol]) -> None:
        """
        Initializes a new instance of the QuantConnect.Data.Market.DataDictionary{T} class
...
class Split(QuantConnect.Data.BaseData):
    ...
    @overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], date: typing.Union[datetime.datetime, datetime.date], price: float, split_factor: float, type: QuantConnect.SplitType) -> None:
        """
        Initializes a new instance of the Split class
...
class Tick(QuantConnect.Data.BaseData):
    ...
    @overload
    def __init__(self, time: typing.Union[datetime.datetime, datetime.date], symbol: typing.Union[QuantConnect.Symbol, str], sale_condition: str, exchange: str, quantity: float, price: float) -> None:
        """
    ...
    @overload
    def __init__(self, time: typing.Union[datetime.datetime, datetime.date], symbol: typing.Union[QuantConnect.Symbol, str], sale_condition: str, exchange: QuantConnect.Exchange, quantity: float, price: float) -> None:
        """
        Trade tick type constructor
    ...
    @overload
    def __init__(self, time: typing.Union[datetime.datetime, datetime.date], symbol: typing.Union[QuantConnect.Symbol, str], sale_condition: str, exchange: str, bid_size: float, bid_price: float, ask_size: float, ask_price: float) -> None:
        """
    ...
    @overload
    def __init__(self, time: typing.Union[datetime.datetime, datetime.date], symbol: typing.Union[QuantConnect.Symbol, str], sale_condition: str, exchange: QuantConnect.Exchange, bid_size: float, bid_price: float, ask_size: float, ask_price: float) -> None:
        """
        Quote tick type constructor
    ...
    @overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], line: str, base_date: typing.Union[datetime.datetime, datetime.date]) -> None:
        """
...
class OpenInterest(QuantConnect.Data.Market.Tick):
    ...
    @overload
    def __init__(self, time: typing.Union[datetime.datetime, datetime.date], symbol: typing.Union[QuantConnect.Symbol, str], open_interest: float) -> None:
        """
    ...
    @overload
    def __init__(self, config: QuantConnect.Data.SubscriptionDataConfig, symbol: typing.Union[QuantConnect.Symbol, str], line: str, base_date: typing.Union[datetime.datetime, datetime.date]) -> None:
        """
...
class Dividend(QuantConnect.Data.BaseData):
    ...
    @overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], date: typing.Union[datetime.datetime, datetime.date], distribution: float, reference_price: float) -> None:
        """
        Initializes a new instance of the Dividend class
...
class RenkoBar(QuantConnect.Data.Market.BaseRenkoBar):
    ...
    @overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], time: typing.Union[datetime.datetime, datetime.date], brick_size: float, open: float, volume: float) -> None:
        """
    ...
    @overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], start: typing.Union[datetime.datetime, datetime.date], end_time: typing.Union[datetime.datetime, datetime.date], brick_size: float, open: float, high: float, low: float, close: float) -> None:
        """
        Initializes a new instance of the RenkoBar class with the specified values
...
class FuturesContract(System.Object):
    ...
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], underlying_symbol: typing.Union[QuantConnect.Symbol, str]) -> None:
        """
...
class QuoteBar(QuantConnect.Data.BaseData, QuantConnect.Data.Market.IBaseDataBar):
    ...
    @overload
    def __init__(self, time: typing.Union[datetime.datetime, datetime.date], symbol: typing.Union[QuantConnect.Symbol, str], bid: QuantConnect.Data.Market.IBar, last_bid_size: float, ask: QuantConnect.Data.Market.IBar, last_ask_size: float, period: typing.Optional[datetime.timedelta] = None) -> None:
        """
...
class FuturesChain(QuantConnect.Data.BaseData, typing.Iterable[QuantConnect.Data.Market.FuturesContract]):
    ...
    @overload
    def __init__(self, canonical_future_symbol: typing.Union[QuantConnect.Symbol, str], time: typing.Union[datetime.datetime, datetime.date]) -> None:
        """
    ...
    @overload
    def __init__(self, canonical_future_symbol: typing.Union[QuantConnect.Symbol, str], time: typing.Union[datetime.datetime, datetime.date], trades: System.Collections.Generic.IEnumerable[QuantConnect.Data.BaseData], quotes: System.Collections.Generic.IEnumerable[QuantConnect.Data.BaseData], contracts: System.Collections.Generic.IEnumerable[QuantConnect.Data.Market.FuturesContract], filtered_contracts: System.Collections.Generic.IEnumerable[QuantConnect.Symbol]) -> None:
        """
        Initializes a new instance of the FuturesChain class
...
class VolumeRenkoBar(QuantConnect.Data.Market.BaseRenkoBar):
    ...
    @overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], start: typing.Union[datetime.datetime, datetime.date], end_time: typing.Union[datetime.datetime, datetime.date], brick_size: float, open: float, high: float, low: float, close: float, volume: float) -> None:
        """
...
class RangeBar(QuantConnect.Data.Market.TradeBar):
    ...
    @overload
    def __init__(self, symbol: typing.Union[QuantConnect.Symbol, str], end_time: typing.Union[datetime.datetime, datetime.date], range_size: float, open: float, high: typing.Optional[float] = None, low: typing.Optional[float] = None, close: typing.Optional[float] = None, volume: float = 0) -> None:
        """
...
class Greeks(System.Object):
    ...
    @overload
    def __init__(self, delta_gamma: typing.Callable[[], System.Tuple[float, float]], vega: typing.Callable[[], float], theta: typing.Callable[[], float], rho: typing.Callable[[], float], _lambda: typing.Callable[[], float]) -> None:
        """Initializes a new instance of the Greeks class"""
        ...
...
class OptionContract(System.Object):
    ...
    def __init__(self, security: QuantConnect.Interfaces.ISecurityPrice, underlying_symbol: typing.Union[QuantConnect.Symbol, str]) -> None:
        """
...
class OptionChain(QuantConnect.Data.BaseData, typing.Iterable[QuantConnect.Data.Market.OptionContract]):
    ...
    @overload
    def __init__(self, canonical_option_symbol: typing.Union[QuantConnect.Symbol, str], time: typing.Union[datetime.datetime, datetime.date]) -> None:
        """
...
class SymbolChangedEvent(QuantConnect.Data.BaseData):
    ...
    @overload
    def __init__(self, requested_symbol: typing.Union[QuantConnect.Symbol, str], date: typing.Union[datetime.datetime, datetime.date], old_symbol: str, new_symbol: str) -> None:
        """
