...
class PortfolioStatistics(System.Object):
    ...
    @overload
    def __init__(self, profit_loss: System.Collections.Generic.SortedDictionary[datetime.datetime, float], equity: System.Collections.Generic.SortedDictionary[datetime.datetime, float], portfolio_turnover: System.Collections.Generic.SortedDictionary[datetime.datetime, float], list_performance: System.Collections.Generic.List[float], list_benchmark: System.Collections.Generic.List[float], starting_capital: float, risk_free_interest_rate_model: QuantConnect.Data.IRiskFreeInterestRateModel, trading_days_per_year: int, win_count: typing.Optional[int] = None, loss_count: typing.Optional[int] = None) -> None:
        """
...
class AlgorithmPerformance(System.Object):
    ...
    @overload
    def __init__(self, trades: System.Collections.Generic.List[QuantConnect.Statistics.Trade], profit_loss: System.Collections.Generic.SortedDictionary[datetime.datetime, float], equity: System.Collections.Generic.SortedDictionary[datetime.datetime, float], portfolio_turnover: System.Collections.Generic.SortedDictionary[datetime.datetime, float], list_performance: System.Collections.Generic.List[float], list_benchmark: System.Collections.Generic.List[float], starting_capital: float, winning_transactions: int, losing_transactions: int, risk_free_interest_rate_model: QuantConnect.Data.IRiskFreeInterestRateModel, trading_days_per_year: int) -> None:
        """
