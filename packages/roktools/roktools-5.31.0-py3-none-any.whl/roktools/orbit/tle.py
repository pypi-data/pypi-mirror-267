...
class TLE(object):
    ...
    def to_kepler(self) -> Kepler:
        ...
        return Kepler(self.toe, self.arg_perigee_rad, self.eccentricity,
                      self.inclination_rad, self.mean_anomaly_rad,
                      self.mean_motion_rad_per_s, self.RAAN_rad, self.n_dot_rad_per_s)
