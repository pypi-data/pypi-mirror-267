...
from typing import List, Generic, TypeVar, TypeAlias
...
class _Aspect(TypedDict):
    """Container class to handle Aspect struct (num, denum)"""
    num: int
    denum: int


class _WmNormalHints(TypedDict):
    """
...
class Structs:
    ScreensInfo = _ScreensInfo
    DisplaysInfo = _DisplaysInfo
    WmHints = _WmHints
    Aspect = _Aspect
    WmNormalHints = _WmNormalHints
