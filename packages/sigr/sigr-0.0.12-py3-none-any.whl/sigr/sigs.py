...
__all__ = ['in_lookup', 'put_var_in_parameters', 'put_var_in_signature', 'init_from_annot', 'prep_parameter',
           ...
           'get_keywords_from_reference', 'get_keywords_from_attributes']
...
@wraps(get_keywords_from_reference, assigned=WRAPS_ASSIGN_ANNDOCS)
def get_keywords_from_attributes(
    ref: Callable, 
    obj: object | None = None, 
    __refkws: str | dict | None = None, 
    **kwargs: P.kwargs
) -> dict:
    return get_keywords_from_reference(ref, obj, __refkws, **kwargs)
