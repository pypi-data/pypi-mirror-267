...
from file_system.file import File as CoreFile
...
class Product:
    ...
    def _image_name(self) -> str:
        # eğer kategori varsa, kategoriyi de ekle; eğer açıksa
        if self.has_category_path and hasattr(self, "category") and self.category:
            self._image_path = f"{self._image_path}/{self.category}"
            CoreFile.create_directory(self._image_path)
