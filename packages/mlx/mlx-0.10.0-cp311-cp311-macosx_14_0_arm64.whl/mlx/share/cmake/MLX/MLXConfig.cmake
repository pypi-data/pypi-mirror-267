...
include(${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_1}/share/cmake/MLX/MLXTargets.cmake)
include(${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_1}/share/cmake/MLX/extension.cmake)

set_and_check(MLX_LIBRARY_DIRS ${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_1}/lib)
set_and_check(MLX_INCLUDE_DIRS ${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_1}/include)
...
if (ON)
    ...
    set_and_check(MLX_INCLUDE_DIRS 
        ${MLX_INCLUDE_DIRS} 
        ${PACKAGE_${CMAKE_FIND_PACKAGE_NAME}_COUNTER_1}/include/metal_cpp
    )
endif()
