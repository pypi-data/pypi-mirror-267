...
from fastapi_jwt import JwtAccessBearerCookie, jwt
from pydantic import BaseModel
import hashlib

class Jwt:
    
    def __init__(self, secret: str, algorithm = jwt.ALGORITHMS.HS256):
    ...
    def decode_token(self, token: str, full: bool = True):
