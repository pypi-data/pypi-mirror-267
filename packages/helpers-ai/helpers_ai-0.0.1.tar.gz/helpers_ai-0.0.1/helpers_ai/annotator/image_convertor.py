...
def img2vid(images_path:str, destination_path:str="", filename:str="output", fps:int=25, size:tuple=(640,640)):
...
def img2gif(images_path:str, destination_path:str=".", filename:str="output.gif", size:tuple=(640,640),
            duration_of_frame:int=100, loop:int=10):
    ...
    print("The video file is saved at {} named {}.".format(destination_path, filename))
...
def coco_annotator(image_folder:str, json_path:str, destination_path:str,
                   ...
                   video_out:bool=False, vid_name:str="output.mp4", fps:int=24, size:tuple[int,int]=(640,640)):
...
def yolo_annotator(image_folder:str, labels_folder:str, cls_file_path:str, destination_path:str, n_classes:int,
                   segmentation:bool=False, bbox:bool=True, class_names:tuple[str]=(),
                   video_out:bool=False, vid_name:str="output.mp4", fps:int=24, size:tuple[int,int]=(640,640)):
