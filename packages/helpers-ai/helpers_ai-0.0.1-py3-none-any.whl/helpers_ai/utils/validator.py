...
def class_getter(label_path:str):
...
def coco_validator(coco, image_path:str):
...
def voc_validator(image_path:str, labels_path:str):
...
def yolo_validator(image_path:str, labels_path:str, n_classes:list[int]):
