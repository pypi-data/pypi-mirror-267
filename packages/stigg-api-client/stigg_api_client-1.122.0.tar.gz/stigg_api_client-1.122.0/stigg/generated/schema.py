...
class ApplySubscriptionInput(sgqlc.types.Input):
    ...
    budget_cap_configuration = sgqlc.types.Field('BudgetCapConfigurationInput', graphql_name='budgetCapConfiguration')
...
class BudgetCapConfigurationInput(sgqlc.types.Input):
    __schema__ = schema
...
class ProvisionCustomerSubscriptionInput(sgqlc.types.Input):
    __schema__ = schema
    __field_names__ = ('additional_meta_data', 'addons', 'await_payment_confirmation', 'billable_features', 'billing_country_code', 'billing_id', 'billing_information', 'billing_period', 'budget_cap_configuration', 'plan_id', 'price_overrides', 'price_unit_amount', 'promotion_code', 'ref_id', 'resource_id', 'salesforce_id', 'start_date', 'subscription_entitlements', 'subscription_id', 'trial_override_configuration', 'unit_quantity')
    additional_meta_data = sgqlc.types.Field(JSON, graphql_name='additionalMetaData')
    addons = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null('SubscriptionAddonInput')), graphql_name='addons')
...
class ProvisionSubscription(sgqlc.types.Input):
    __schema__ = schema
    __field_names__ = ('additional_meta_data', 'addons', 'await_payment_confirmation', 'billable_features', 'billing_country_code', 'billing_id', 'billing_information', 'billing_period', 'budget_cap_configuration', 'checkout_options', 'customer_id', 'plan_id', 'price_overrides', 'price_unit_amount', 'promotion_code', 'ref_id', 'resource_id', 'salesforce_id', 'schedule_strategy', 'skip_trial', 'start_date', 'subscription_entitlements', 'subscription_id', 'trial_override_configuration', 'unit_quantity')
    additional_meta_data = sgqlc.types.Field(JSON, graphql_name='additionalMetaData')
    addons = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null('SubscriptionAddonInput')), graphql_name='addons')
    await_payment_confirmation = sgqlc.types.Field(Boolean, graphql_name='awaitPaymentConfirmation')
    billable_features = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(BillableFeatureInput)), graphql_name='billableFeatures')
...
class SubscriptionInput(sgqlc.types.Input):
    __schema__ = schema
    __field_names__ = ('additional_meta_data', 'addons', 'await_payment_confirmation', 'billable_features', 'billing_country_code', 'billing_id', 'billing_information', 'billing_period', 'budget_cap_configuration', 'crm_id', 'customer_id', 'end_date', 'environment_id', 'is_custom_price_subscription', 'is_overriding_trial_config', 'is_trial', 'plan_id', 'price_overrides', 'price_unit_amount', 'promotion_code', 'ref_id', 'resource_id', 'salesforce_id', 'schedule_strategy', 'start_date', 'subscription_entitlements', 'subscription_id', 'unit_quantity')
    additional_meta_data = sgqlc.types.Field(JSON, graphql_name='additionalMetaData')
    addons = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(SubscriptionAddonInput)), graphql_name='addons')
    await_payment_confirmation = sgqlc.types.Field(Boolean, graphql_name='awaitPaymentConfirmation')
    billable_features = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(BillableFeatureInput)), graphql_name='billableFeatures')
...
class UpdateSubscriptionInput(sgqlc.types.Input):
    __schema__ = schema
    __field_names__ = ('additional_meta_data', 'addons', 'await_payment_confirmation', 'billable_features', 'billing_information', 'billing_period', 'budget_cap_configuration', 'environment_id', 'price_overrides', 'promotion_code', 'ref_id', 'schedule_strategy', 'subscription_entitlements', 'subscription_id', 'trial_end_date', 'unit_quantity')
    additional_meta_data = sgqlc.types.Field(JSON, graphql_name='additionalMetaData')
    addons = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(SubscriptionAddonInput)), graphql_name='addons')
    await_payment_confirmation = sgqlc.types.Field(Boolean, graphql_name='awaitPaymentConfirmation')
    billable_features = sgqlc.types.Field(sgqlc.types.list_of(sgqlc.types.non_null(BillableFeatureInput)), graphql_name='billableFeatures')
...
class BudgetCapConfiguration(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('has_soft_limit', 'limit')
    has_soft_limit = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='hasSoftLimit')
    limit = sgqlc.types.Field(sgqlc.types.non_null(Float), graphql_name='limit')
...
class CustomerSubscription(sgqlc.types.Type):
    ...
    budget_cap_configuration = sgqlc.types.Field(BudgetCapConfiguration, graphql_name='budgetCapConfiguration')
    budget_cap_exceeded = sgqlc.types.Field(Boolean, graphql_name='budgetCapExceeded')
