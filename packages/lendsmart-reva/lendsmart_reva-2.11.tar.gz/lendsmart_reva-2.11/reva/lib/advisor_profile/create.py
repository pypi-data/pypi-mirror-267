    ...
    def get_branch_ids(self, branch_codes: list) -> list:
        ...
        for branch_code in branch_codes:
            ...
            data = {
                "branches" : [
                {
                    "code" : path_or("", ["id"], branch)
                }
                ]
            }
            branch_ids.append(data)
        return branch_ids
    ...
    def _mk_advisor_data(self, account_data: dict, advisor_profile_data: dict):
        ...
        data = {
            ...
            "metadata": {
                ...
                "lendsmart_sh/officer_id" : path_or("",["officer_id"], advisor_profile_data),
                ...
                "lendsmart_sh/laserpro_officer_last_name":path_or("",["laserpro_officer_last_name"], advisor_profile_data),
