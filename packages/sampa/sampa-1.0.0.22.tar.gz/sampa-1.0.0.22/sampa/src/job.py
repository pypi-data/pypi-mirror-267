...
job.write(f') \n')
job.write(f' \n')
job.write(f'declare -a folders \n')
job.write(f'for folder in $dir0/*; do \n')
job.write(f'    if [ -d "$folder" ]; then \n')
job.write(f'       folders+=("$(basename "$folder")") \n')
job.write(f'    fi \n')
job.write(f'done \n')
job.write(f'#--------------------------- \n')
job.write(f'for i in "{folders}"; do \n')
...
job.write(f'           #---------------------- \n')
job.write(f'           declare -a folders2 \n')
...
job.write(f'           for k in "{tasks}"; do \n')
job.write(f'               if [[ "$k" != "relax" && "$k" != "z-scan"  ]]; then \n')
