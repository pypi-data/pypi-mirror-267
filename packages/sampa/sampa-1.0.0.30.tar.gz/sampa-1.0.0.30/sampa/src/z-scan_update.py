...
os.rename('energy_scan.txt', 'z-scan.dat')
...
fig, ax = plt.subplots()
plt.plot(date_z, date_E, color = 'black', linestyle = '-', linewidth = 0.25)
plt.plot([delta_z, delta_z]], [-1000.0, +1000.0], color = 'red', linestyle = '--', linewidth = 0.25, alpha = 1.0)
plt.title('z-scan')
