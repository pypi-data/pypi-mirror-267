...
class CertoraBuildGenerator:
    ...
    def _handle_optimize(self, contract_file_path: str, settings_dict: Dict[str, Any]) -> None:
        ...
        if self.context.solc_optimize_map:
            ...
            if self.context.finder_friendly_optimizer:
                ...
                settings_dict["optimizer"]["details"] = {"inliner": False, "yulDetails": {
                    "optimizerSteps": "dhfoDgvulfnTUtnIf[xa[r]EscLMcCTUtTOntnfDIulLculVcul [j]T"
                                      "peulxa[rul]xa[r]cLgvfCTUca[r]LSsTFOtfDnca[r]Iulc]jmul[jul]VcTOculjmul"
                }}

    def _fill_codegen_related_options(self, contract_file_path: str, settings_dict: Dict[str, Any]) -> None:
        """
        ...
        self._handle_optimize(contract_file_path, settings_dict)
    ...
    def standard_json(self,
        ...
        self._fill_codegen_related_options(contract_file_as_provided, settings_dict)
