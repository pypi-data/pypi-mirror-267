...
def match_semver_regex(version_str: str) -> Optional[semver.VersionInfo]:
    """Take a semver version string and returns a semver object, or None if the string is not in the correct format.
    ...
    Returns:
        Semver:
            A semver version object that describes the version string passed in,
    ...
    Example:
        .. code-block:: python
            ...
            # version.VersionInfo() yields VersionInfo(major=2, minor=7, patch=1)

    """
    comparable = re.match(SEMVER_REGEX, version_str)
    if comparable:
        return semver.VersionInfo.parse(comparable.group())
    return None
