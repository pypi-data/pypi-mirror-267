...
class FoodEstablishment(LocalBusiness):
    ...
    servesCuisine: list[str | Text] | str | Text | None = Field(
        default=None,
        description="The cuisine of the restaurant.",
    )
    menu: None | (
        list[AnyUrl | URL | str | Text | Menu] | AnyUrl | URL | str | Text | Menu
    ) = Field(
        default=None,
        description="Either the actual menu as a structured representation, as text, or a URL of the menu.",
    )
    acceptsReservations: None | (
        list[AnyUrl | URL | str | Text | StrictBool | Boolean]
        | AnyUrl
        | URL
        | str
        | Text
