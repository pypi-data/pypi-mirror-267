...
class LocalBusiness(Place, Organization):
    ...
    currenciesAccepted: list[str | Text] | str | Text | None = Field(
        default=None,
    ...
    branchOf: None | (list[Organization | str] | Organization | str) = Field(
        default=None,
    ...
    priceRange: list[str | Text] | str | Text | None = Field(
        default=None,
        description="The price range of the business, for example ```$$$```.",
    )
    openingHours: list[str | Text] | str | Text | None = Field(
        default=None,
    ...
    paymentAccepted: list[str | Text] | str | Text | None = Field(
        default=None,
