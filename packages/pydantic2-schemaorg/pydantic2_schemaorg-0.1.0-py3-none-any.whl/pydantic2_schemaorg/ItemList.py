...
class ItemList(Intangible):
    ...
    numberOfItems: None | (list[int | Integer | str] | int | Integer | str) = Field(
        default=None,
    ...
    itemListElement: None | (
        list[str | Text | ListItem | Thing] | str | Text | ListItem | Thing
    ) = Field(
        default=None,
    ...
    itemListOrder: None | (
        list[str | Text | ItemListOrderType] | str | Text | ItemListOrderType
    ) = Field(
        default=None,
