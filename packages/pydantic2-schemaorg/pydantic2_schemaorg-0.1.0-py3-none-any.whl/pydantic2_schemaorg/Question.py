...
class Question(Comment):
    ...
    answerCount: None | (list[int | Integer | str] | int | Integer | str) = Field(
        default=None,
        description="The number of answers this question has received.",
    )
    eduQuestionType: list[str | Text] | str | Text | None = Field(
        default=None,
    ...
    acceptedAnswer: None | (
        list[Answer | ItemList | str] | Answer | ItemList | str
    ) = Field(
        default=None,
