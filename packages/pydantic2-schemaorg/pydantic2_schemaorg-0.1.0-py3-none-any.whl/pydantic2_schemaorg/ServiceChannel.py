...
class ServiceChannel(Intangible):
    ...
    servicePostalAddress: None | (
        list[PostalAddress | str] | PostalAddress | str
    ) = Field(
        default=None,
    ...
    providesService: None | (list[Service | str] | Service | str) = Field(
        default=None,
        description="The service provided by this channel.",
    )
    servicePhone: None | (list[ContactPoint | str] | ContactPoint | str) = Field(
        default=None,
        description="The phone number to use to access the service.",
    )
    processingTime: None | (list[Duration | str] | Duration | str) = Field(
        default=None,
        description="Estimated processing time for the service using this channel.",
    )
    serviceSmsNumber: None | (list[ContactPoint | str] | ContactPoint | str) = Field(
        default=None,
        description="The number to access the service by text message.",
    )
    serviceUrl: None | (list[AnyUrl | URL | str] | AnyUrl | URL | str) = Field(
        default=None,
        description="The website to access the service.",
    )
    serviceLocation: list[Place | str] | Place | str | None = Field(
        default=None,
