...
class Dataset(CreativeWork):
    ...
    includedDataCatalog: None | (list[DataCatalog | str] | DataCatalog | str) = Field(
        default=None,
    ...
    variablesMeasured: None | (
        ...
        default=None,
        description="Originally named [[variablesMeasured]], the [[variableMeasured]] property can"
        "indicate (repeated as necessary) the variables that are measured in some dataset, either"
        "described as text or as pairs of identifier and description using PropertyValue.",
    )
    catalog: None | (list[DataCatalog | str] | DataCatalog | str) = Field(
        default=None,
        description="A data catalog which contains this dataset.",
    )
    distribution: None | (list[DataDownload | str] | DataDownload | str) = Field(
        default=None,
    ...
    includedInDataCatalog: None | (list[DataCatalog | str] | DataCatalog | str) = Field(
        default=None,
        description="A data catalog which contains this dataset.",
    )
