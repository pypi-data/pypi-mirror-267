...
class WebPage(CreativeWork):
    ...
    speakable: None | (
        list[AnyUrl | URL | SpeakableSpecification | str]
        | AnyUrl
        | URL
    ...
    primaryImageOfPage: None | (list[ImageObject | str] | ImageObject | str) = Field(
        default=None,
        description="Indicates the main image on the page.",
    )
    relatedLink: None | (list[AnyUrl | URL | str] | AnyUrl | URL | str) = Field(
        default=None,
        description="A link related to this web page, for example to other related web pages.",
    )
    mainContentOfPage: None | (
        list[WebPageElement | str] | WebPageElement | str
    ) = Field(
        default=None,
        description="Indicates if this web page element is the main subject of the page.",
    )
    specialty: list[Specialty | str] | Specialty | str | None = Field(
        default=None,
        description="One of the domain specialities to which this web page's content applies.",
    )
    significantLink: None | (list[AnyUrl | URL | str] | AnyUrl | URL | str) = Field(
        default=None,
    ...
    significantLinks: None | (list[AnyUrl | URL | str] | AnyUrl | URL | str) = Field(
        default=None,
    ...
    breadcrumb: None | (
        list[str | Text | BreadcrumbList] | str | Text | BreadcrumbList
    ) = Field(
        default=None,
        description="A set of links that can help a user understand and navigate a website hierarchy.",
    )
    lastReviewed: None | (list[date | Date | str] | date | Date | str) = Field(
        default=None,
