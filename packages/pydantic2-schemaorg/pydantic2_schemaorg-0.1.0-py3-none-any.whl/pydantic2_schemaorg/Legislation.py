...
class Legislation(CreativeWork):
    ...
    legislationLegalForce: None | (
        list[LegalForceStatus | str] | LegalForceStatus | str
    ) = Field(
        default=None,
        description="Whether the legislation is currently in force, not in force, or partially in force.",
    )
    legislationDateVersion: None | (
    ...
    legislationChanges: None | (list[Legislation | str] | Legislation | str) = Field(
        default=None,
    ...
    legislationJurisdiction: None | (
        list[str | Text | AdministrativeArea] | str | Text | AdministrativeArea
    ) = Field(
        default=None,
        description="The jurisdiction from which the legislation originates.",
    )
    legislationConsolidates: None | (
        list[Legislation | str] | Legislation | str
    ) = Field(
        default=None,
    ...
    legislationTransposes: None | (list[Legislation | str] | Legislation | str) = Field(
        default=None,
    ...
    legislationDate: None | (list[date | Date | str] | date | Date | str) = Field(
        default=None,
    ...
    legislationApplies: None | (list[Legislation | str] | Legislation | str) = Field(
        default=None,
