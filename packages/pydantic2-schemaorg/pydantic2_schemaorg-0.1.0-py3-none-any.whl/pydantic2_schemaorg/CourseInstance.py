...
class CourseInstance(Event):
    ...
    courseSchedule: None | (list[Schedule | str] | Schedule | str) = Field(
        default=None,
        description="Represents the length and pace of a course, expressed as a [[Schedule]].",
    )
    courseWorkload: list[str | Text] | str | Text | None = Field(
        default=None,
    ...
    instructor: list[Person | str] | Person | str | None = Field(
        default=None,
