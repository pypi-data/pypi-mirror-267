...
class Article(CreativeWork):
    ...
    articleBody: list[str | Text] | str | Text | None = Field(
        default=None,
    ...
    articleSection: list[str | Text] | str | Text | None = Field(
        default=None,
        description="Articles may belong to one or more 'sections' in a magazine or newspaper, such as Sports,"
        "Lifestyle, etc.",
    )
    wordCount: None | (list[int | Integer | str] | int | Integer | str) = Field(
        default=None,
