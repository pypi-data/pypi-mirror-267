...
class MediaReview(Review):
    ...
    originalMediaContextDescription: None | (list[str | Text] | str | Text) = Field(
        default=None,
    ...
    originalMediaLink: None | (
        list[AnyUrl | URL | WebPage | MediaObject | str]
        | AnyUrl
        | URL
        | WebPage
        | MediaObject
    ...
    mediaAuthenticityCategory: None | (
