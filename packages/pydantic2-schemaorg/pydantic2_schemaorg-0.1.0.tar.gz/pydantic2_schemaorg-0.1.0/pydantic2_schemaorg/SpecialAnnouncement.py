...
class SpecialAnnouncement(CreativeWork):
    ...
    publicTransportClosuresInfo: None | (
        list[AnyUrl | URL | WebContent | str] | AnyUrl | URL | WebContent | str
    ) = Field(
        default=None,
        description="Information about public transport closures.",
    )
    announcementLocation: None | (
    ...
    diseasePreventionInfo: None | (
        list[AnyUrl | URL | WebContent | str] | AnyUrl | URL | WebContent | str
    ) = Field(
        default=None,
        description="Information about disease prevention.",
    )
    governmentBenefitsInfo: None | (
        list[GovernmentService | str] | GovernmentService | str
    ) = Field(
        default=None,
    ...
    diseaseSpreadStatistics: None | (
        list[AnyUrl | URL | Observation | Dataset | WebContent | str]
        | AnyUrl
        | URL
        | Observation
        | Dataset
