...
class SchemaOrgBase(BaseModel):
    # JSON-LD fields
    reverse_: Any | None = Field(default=None, alias="@reverse")
    id_: Any | None = Field(default=None, alias="@id")
    context_: Any | None = Field(default=None, alias="@context")
    graph_: Any | None = Field(default=None, alias="@graph")
