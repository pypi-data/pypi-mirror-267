...
class NewsArticle(Article):
    ...
    printPage: list[str | Text] | str | Text | None = Field(
        default=None,
    ...
    printEdition: list[str | Text] | str | Text | None = Field(
        default=None,
        description="The edition of the print product in which the NewsArticle appears.",
    )
    printSection: list[str | Text] | str | Text | None = Field(
        default=None,
