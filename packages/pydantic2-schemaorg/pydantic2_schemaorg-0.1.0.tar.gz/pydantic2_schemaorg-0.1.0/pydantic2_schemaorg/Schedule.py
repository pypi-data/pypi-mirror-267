...
class Schedule(Intangible):
    ...
    byMonthDay: None | (list[int | Integer | str] | int | Integer | str) = Field(
        default=None,
    ...
    byDay: None | (list[str | Text | DayOfWeek] | str | Text | DayOfWeek) = Field(
        default=None,
    ...
    byMonthWeek: None | (list[int | Integer | str] | int | Integer | str) = Field(
        default=None,
    ...
    repeatCount: None | (list[int | Integer | str] | int | Integer | str) = Field(
        default=None,
        description="Defines the number of times a recurring [[Event]] will take place.",
    )
    scheduleTimezone: list[str | Text] | str | Text | None = Field(
        default=None,
    ...
    byMonth: None | (list[int | Integer | str] | int | Integer | str) = Field(
        default=None,
