...
class EnergyConsumptionDetails(Intangible):
    ...
    energyEfficiencyScaleMax: None | (
        list[EUEnergyEfficiencyEnumeration | str] | EUEnergyEfficiencyEnumeration | str
    ) = Field(
        default=None,
    ...
    hasEnergyEfficiencyCategory: None | (
        list[EnergyEfficiencyEnumeration | str] | EnergyEfficiencyEnumeration | str
    ) = Field(
        default=None,
