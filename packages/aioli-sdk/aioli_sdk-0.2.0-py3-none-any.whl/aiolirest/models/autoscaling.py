...
class Autoscaling(BaseModel):
    ...
    metric: Optional[StrictStr] = Field(default='concurrency', description="Metric name which controls autoscaling.")
    ...
    def metric_validate_enum(cls, value):
        ...
        if value not in ('concurrency', 'rps', 'cpu', 'memory'):
            raise ValueError("must be one of enum values ('concurrency', 'rps', 'cpu', 'memory')")
        return value
