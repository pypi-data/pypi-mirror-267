...
class Deployment(BaseModel):
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in ('Deploying', 'Ready', 'Updating', 'UpdateFailed', 'Failed', 'Deleting', 'Paused', 'Unknown'):
            raise ValueError("must be one of enum values ('Deploying', 'Ready', 'Updating', 'UpdateFailed', 'Failed', 'Deleting', 'Paused', 'Unknown')")
        return value
