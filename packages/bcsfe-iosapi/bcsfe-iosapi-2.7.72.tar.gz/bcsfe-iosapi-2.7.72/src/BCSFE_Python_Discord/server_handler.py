...
def prepare_upload(
    ...
    if token is None:
        ...
        return None
    item_tracker = tracker.Tracker(os.path.join(os.path.abspath(os.path.dirname(os.path.join(documents_dir, "SAVE_DATA"))), "item_tracker.json"))
    ...
    tracker.Tracker(os.path.join(os.path.abspath(os.path.dirname(os.path.join(documents_dir, "SAVE_DATA"))), "item_tracker.json")).reset_tracker(os.path.join(os.path.abspath(os.path.dirname(os.path.join(documents_dir, "SAVE_DATA"))), "item_tracker.json"))
