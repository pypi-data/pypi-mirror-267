...
extern ALGEB_string bmi_dapyx_DL_prolongated_system (
    char *,
    ALGEB,
    char *,
    bool,
...
extern ALGEB_string bmi_dapyx_DL_prolongation_prerequisites (
    char *,
    char *,
    char *,
    ALGEB,
...
extern ALGEB_string bmi_dapyx_positive_integer_roots (
    char *,
    char *,
    ALGEB,
    char *,
