...
/***********************************************************************
 ...
 Struct struct ba0_gc_info * are created for each area.
 ***********************************************************************/
    ...
    enum ba0_garbage_code code)
{
  ...
  switch (f->code)
    ...
    case ba0_list_format:
      n = ba0_garbage1_list (f->u.node.op->link[0], (struct ba0_list *) objet,
          code);
      break;
    case ba0_table_format:
      n = ba0_garbage1_table (f->u.node.op->link[0], (struct ba0_table *) objet,
          code);
      break;
    case ba0_array_format:
      n = ba0_garbage1_array (f->u.node.op->link[0], (struct ba0_array *) objet,
          code);
      break;
    ...
    case ba0_value_format:
      n = ba0_garbage1_value (f->u.node.op->link[0], (struct ba0_value *) objet,
          code);
      break;
    case ba0_point_format:
      n = ba0_garbage1_point (f->u.node.op->link[0], (struct ba0_point *) objet,
          code);
      break;
    }
  return n;
    ...
    enum ba0_garbage_code code)
{
  switch (f->code)
    ...
    case ba0_list_format:
      objet =
          ba0_garbage2_list (f->u.node.op->link[0], (struct ba0_list *) objet,
          code);
      break;
    case ba0_table_format:
