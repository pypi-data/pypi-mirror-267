...
// if vers == ba0_file_device
  FILE *file_flux;
// if vers == ba0_string_device
  char *string_flux;
// index in string_flux
  ba0_int_p indice;
// if vers == ba0_counter_device (number of output characters)
  ba0_int_p counter;
};
 ...
 * @code{%l[%t[%z]]} (lists of tables of variables).
 */
