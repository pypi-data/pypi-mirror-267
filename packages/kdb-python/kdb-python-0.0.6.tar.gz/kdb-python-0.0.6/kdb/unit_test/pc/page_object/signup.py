...
class Signup:
    def __init__(self):
        self._page_url = 'https://automationexercise.com/signup'
        self._page_title = 'Automation Exercise - Signup'
        #
    ...
    def hide_google_ads(self):
        ...
        if kdb_driver.is_displayed(div_google_ads, timeout=3, log=False):
