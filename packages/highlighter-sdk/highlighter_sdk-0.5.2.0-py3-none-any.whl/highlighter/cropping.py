...
def crop_rect_from_poly(data_file: Union[np.ndarray, Image.Image],
                        poly: gm.Polygon,
                        crop_args: Union[CropArgs, Dict],
                        ):
    crop_fns = {False: crop_rectangle,
...
def crop_rotated_rectangle(data_file: Union[np.ndarray, Image.Image],
                           poly: gm.Polygon,
                           scale: Optional[float]=None,
                           pad: Optional[int]=None,
    ...
    """
    assert isinstance(pad, int) or (pad is None), f"Croping rotated rec only support a int for 'pad', got: {pad}"
...
def crop_rectangle(data_file: Union[np.ndarray, Image.Image],
