...
def fin_save_basetick_list(instrument_id, df, **kwargs):
    ...
    Args:
        ...
        包含列
        ['ExchangeID':str, 'InstrumentID':str, 'ActionDay':str, 'ActionTime':str, 'UpdateMillisec':int,
    ...
    Returns:
        _type_: [bool,str]
    """
    return FinClient.instance().market_handle().fin_save_basetick_list(instrument_id=instrument_id, df=df, kwargs=kwargs)
