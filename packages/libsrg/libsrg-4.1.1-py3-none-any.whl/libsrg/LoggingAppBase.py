...
from libsrg.LoggingUtils import level2str, level2int
...
class LoggingAppBase:
    ...
    def __init__(self, level=logging.INFO, logfile=None, parser_args: Optional[dict[str, str]] = None):
        ...
        try:
            ...
            if parser_args is None:
                parser_args = {}
            parser_args.setdefault("epilog", f"Build using libsrg {version('libsrg')}")
