...
class NotaPedidoTransaction:
    ...
    def execute(self, sapGuiLib, nota_pedido):
        ...
        for sintese_de_iten in nota_pedido['sintese_itens']: 
            ...
            if sapGuiLib.session.findById("wnd[0]/usr/subSUB0:SAPLMEGUI:0015/subSUB3:SAPLMEVIEWS:1100/subSUB2:SAPLMEVIEWS:1200/subSUB1:SAPLMEGUI:1301/subSUB2:SAPLMEGUI:1303/tabsITEM_DETAIL/tabpTABIDT8", False) != None:
