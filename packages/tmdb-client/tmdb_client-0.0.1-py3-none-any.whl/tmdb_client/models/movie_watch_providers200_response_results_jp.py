...
class MovieWatchProviders200ResponseResultsJP(BaseModel):
    ...
    flatrate: Optional[List[MovieWatchProviders200ResponseResultsJPFlatrateInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "link": obj.get("link"),
            "flatrate": [MovieWatchProviders200ResponseResultsJPFlatrateInner.from_dict(_item) for _item in obj["flatrate"]] if obj.get("flatrate") is not None else None,
            "rent": [MovieWatchProviders200ResponseResultsJPRentInner.from_dict(_item) for _item in obj["rent"]] if obj.get("rent") is not None else None,
            "buy": [MovieWatchProviders200ResponseResultsDKRentInner.from_dict(_item) for _item in obj["buy"]] if obj.get("buy") is not None else None
        })
        return _obj
