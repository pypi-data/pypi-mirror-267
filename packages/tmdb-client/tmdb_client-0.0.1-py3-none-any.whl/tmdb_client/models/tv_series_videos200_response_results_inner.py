...
class TvSeriesVideos200ResponseResultsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["iso_639_1", "iso_3166_1", "name", "key", "site", "size", "type", "official", "published_at", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "official": obj.get("official") if obj.get("official") is not None else True,
