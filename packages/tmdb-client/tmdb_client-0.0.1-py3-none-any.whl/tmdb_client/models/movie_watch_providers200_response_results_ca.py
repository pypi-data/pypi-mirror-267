...
class MovieWatchProviders200ResponseResultsCA(BaseModel):
    ...
    flatrate: Optional[List[MovieWatchProviders200ResponseResultsCAFlatrateInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "link": obj.get("link"),
            "rent": [MovieWatchProviders200ResponseResultsCARentInner.from_dict(_item) for _item in obj["rent"]] if obj.get("rent") is not None else None,
            ...
            "flatrate": [MovieWatchProviders200ResponseResultsCAFlatrateInner.from_dict(_item) for _item in obj["flatrate"]] if obj.get("flatrate") is not None else None
        })
        return _obj
