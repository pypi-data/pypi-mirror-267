...
class GuestSessionRatedTv200ResponseResultsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["adult", "backdrop_path", "genre_ids", "id", "origin_country", "original_language", "original_name", "overview", "popularity", "poster_path", "first_air_date", "name", "vote_average", "vote_count", "rating"]
