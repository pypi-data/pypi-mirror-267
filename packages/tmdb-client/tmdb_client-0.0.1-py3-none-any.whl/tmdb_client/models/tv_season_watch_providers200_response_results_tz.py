...
class TvSeasonWatchProviders200ResponseResultsTZ(BaseModel):
    """
    TvSeasonWatchProviders200ResponseResultsTZ
    """ # noqa: E501
    link: Optional[StrictStr] = None
    flatrate: Optional[List[TvSeriesWatchProviders200ResponseResultsSCFlatrateInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "link": obj.get("link"),
            "flatrate": [TvSeriesWatchProviders200ResponseResultsSCFlatrateInner.from_dict(_item) for _item in obj["flatrate"]] if obj.get("flatrate") is not None else None
        })
        return _obj
