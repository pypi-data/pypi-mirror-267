...
class ChangesPeopleList200Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["results", "page", "total_pages", "total_results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ChangesPeopleList200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
