...
class PersonCombinedCredits200ResponseCastInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["adult", "backdrop_path", "genre_ids", "id", "original_language", "original_title", "overview", "popularity", "poster_path", "release_date", "title", "video", "vote_average", "vote_count", "character", "credit_id", "order", "media_type"]
