...
class TvEpisodeCredits200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cast": [TvSeriesCredits200ResponseCastInner.from_dict(_item) for _item in obj["cast"]] if obj.get("cast") is not None else None,
            "crew": [TvEpisodeCredits200ResponseCrewInner.from_dict(_item) for _item in obj["crew"]] if obj.get("crew") is not None else None,
            "guest_stars": [TvEpisodeCredits200ResponseGuestStarsInner.from_dict(_item) for _item in obj["guest_stars"]] if obj.get("guest_stars") is not None else None,
