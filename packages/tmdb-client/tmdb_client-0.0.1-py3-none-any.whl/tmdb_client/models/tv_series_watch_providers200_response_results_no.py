...
class TvSeriesWatchProviders200ResponseResultsNO(BaseModel):
    ...
    flatrate: Optional[List[TvSeriesWatchProviders200ResponseResultsARFlatrateInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "link": obj.get("link"),
            "flatrate": [TvSeriesWatchProviders200ResponseResultsARFlatrateInner.from_dict(_item) for _item in obj["flatrate"]] if obj.get("flatrate") is not None else None,
            "buy": [TvSeriesWatchProviders200ResponseResultsNOBuyInner.from_dict(_item) for _item in obj["buy"]] if obj.get("buy") is not None else None
        })
        return _obj
