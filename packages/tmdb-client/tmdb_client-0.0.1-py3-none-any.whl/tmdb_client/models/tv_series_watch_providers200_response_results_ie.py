...
class TvSeriesWatchProviders200ResponseResultsIE(BaseModel):
    ...
    flatrate: Optional[List[TvSeriesWatchProviders200ResponseResultsIEFlatrateInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "link": obj.get("link"),
            "flatrate": [TvSeriesWatchProviders200ResponseResultsIEFlatrateInner.from_dict(_item) for _item in obj["flatrate"]] if obj.get("flatrate") is not None else None,
            "buy": [TvSeriesWatchProviders200ResponseResultsIEBuyInner.from_dict(_item) for _item in obj["buy"]] if obj.get("buy") is not None else None
        })
        return _obj
