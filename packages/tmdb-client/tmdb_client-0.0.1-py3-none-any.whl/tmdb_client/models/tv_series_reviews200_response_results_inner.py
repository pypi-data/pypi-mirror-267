...
class TvSeriesReviews200ResponseResultsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["author", "author_details", "content", "created_at", "id", "updated_at", "url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "author_details": TvSeriesReviews200ResponseResultsInnerAuthorDetails.from_dict(obj["author_details"]) if obj.get("author_details") is not None else None,
