...
class MovieChanges200ResponseChangesInnerItemsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "action", "time", "iso_639_1", "iso_3166_1", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": MovieChanges200ResponseChangesInnerItemsInnerValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
