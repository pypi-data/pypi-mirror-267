...
class TvSeriesWatchProviders200ResponseResultsBE(BaseModel):
    ...
    flatrate: Optional[List[TvSeriesWatchProviders200ResponseResultsBEFlatrateInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "link": obj.get("link"),
            "flatrate": [TvSeriesWatchProviders200ResponseResultsBEFlatrateInner.from_dict(_item) for _item in obj["flatrate"]] if obj.get("flatrate") is not None else None
        })
        return _obj
