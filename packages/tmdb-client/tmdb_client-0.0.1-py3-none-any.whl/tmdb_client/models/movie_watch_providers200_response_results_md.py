...
class MovieWatchProviders200ResponseResultsMD(BaseModel):
    ...
    flatrate: Optional[List[MovieWatchProviders200ResponseResultsMDFlatrateInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flatrate": [MovieWatchProviders200ResponseResultsMDFlatrateInner.from_dict(_item) for _item in obj["flatrate"]] if obj.get("flatrate") is not None else None
        })
        return _obj
