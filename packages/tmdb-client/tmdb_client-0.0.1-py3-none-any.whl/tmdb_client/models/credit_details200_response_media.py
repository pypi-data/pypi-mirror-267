...
class CreditDetails200ResponseMedia(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["adult", "backdrop_path", "id", "name", "original_language", "original_name", "overview", "poster_path", "media_type", "genre_ids", "popularity", "first_air_date", "vote_average", "vote_count", "origin_country", "character", "episodes", "seasons"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seasons": [CreditDetails200ResponseMediaSeasonsInner.from_dict(_item) for _item in obj["seasons"]] if obj.get("seasons") is not None else None
        })
        return _obj
