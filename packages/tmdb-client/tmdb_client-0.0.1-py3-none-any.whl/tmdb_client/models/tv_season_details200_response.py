...
class TvSeasonDetails200Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["_id", "air_date", "episodes", "name", "overview", "id", "poster_path", "season_number", "vote_average"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "episodes": [TvSeasonDetails200ResponseEpisodesInner.from_dict(_item) for _item in obj["episodes"]] if obj.get("episodes") is not None else None,
            "name": obj.get("name"),
