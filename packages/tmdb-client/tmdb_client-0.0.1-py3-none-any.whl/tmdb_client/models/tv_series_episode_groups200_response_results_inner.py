...
class TvSeriesEpisodeGroups200ResponseResultsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "episode_count", "group_count", "id", "name", "network", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "network": TvSeriesDetails200ResponseNetworksInner.from_dict(obj["network"]) if obj.get("network") is not None else None,
