...
class TvSeriesWatchProviders200ResponseResultsFR(BaseModel):
    ...
    flatrate: Optional[List[TvSeriesWatchProviders200ResponseResultsFRFlatrateInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "flatrate": [TvSeriesWatchProviders200ResponseResultsFRFlatrateInner.from_dict(_item) for _item in obj["flatrate"]] if obj.get("flatrate") is not None else None
        })
        return _obj
