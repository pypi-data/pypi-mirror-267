...
class MovieUpcomingList200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dates": MovieUpcomingList200ResponseDates.from_dict(obj["dates"]) if obj.get("dates") is not None else None,
            "page": obj.get("page") if obj.get("page") is not None else 0,
            "results": [MovieUpcomingList200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
