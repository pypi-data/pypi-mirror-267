...
class TvSeriesWatchProviders200ResponseResults(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["AE", "AR", "AT", "AU", "BA", "BB", "BE", "BG", "BO", "BR", "BS", "CA", "CH", "CI", "CL", "CO", "CR", "CZ", "DE", "DK", "DO", "DZ", "EC", "EG", "ES", "FI", "FR", "GB", "GF", "GH", "GQ", "GT", "HK", "HN", "HR", "HU", "ID", "IE", "IL", "IQ", "IT", "JM", "JP", "KE", "KR", "LB", "LT", "LY", "MD", "MK", "MU", "MX", "MY", "MZ", "NE", "NG", "NL", "NO", "NZ", "PA", "PE", "PH", "PL", "PS", "PT", "PY", "RO", "RS", "RU", "SA", "SC", "SE", "SG", "SI", "SK", "SN", "SV", "TH", "TR", "TT", "TW", "TZ", "UG", "US", "UY", "VE", "ZA", "ZM"]
