...
class TvSeasonWatchProviders200ResponseResultsFI(BaseModel):
    ...
    flatrate: Optional[List[TvSeriesWatchProviders200ResponseResultsCRFlatrateInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "link": obj.get("link"),
            "flatrate": [TvSeriesWatchProviders200ResponseResultsCRFlatrateInner.from_dict(_item) for _item in obj["flatrate"]] if obj.get("flatrate") is not None else None,
            "buy": [TvSeriesWatchProviders200ResponseResultsFIBuyInner.from_dict(_item) for _item in obj["buy"]] if obj.get("buy") is not None else None
        })
        return _obj
