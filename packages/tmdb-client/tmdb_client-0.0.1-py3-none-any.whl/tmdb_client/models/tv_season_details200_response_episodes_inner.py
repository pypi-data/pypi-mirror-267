...
class TvSeasonDetails200ResponseEpisodesInner(BaseModel):
    ...
    guest_stars: Optional[List[TvSeasonDetails200ResponseEpisodesInnerGuestStarsInner]] = None
    __properties: ClassVar[List[str]] = ["air_date", "episode_number", "id", "name", "overview", "production_code", "runtime", "season_number", "show_id", "still_path", "vote_average", "vote_count", "crew", "guest_stars"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "crew": [TvSeasonDetails200ResponseEpisodesInnerCrewInner.from_dict(_item) for _item in obj["crew"]] if obj.get("crew") is not None else None,
            "guest_stars": [TvSeasonDetails200ResponseEpisodesInnerGuestStarsInner.from_dict(_item) for _item in obj["guest_stars"]] if obj.get("guest_stars") is not None else None
        })
        return _obj
