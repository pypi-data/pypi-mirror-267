...
class TestGuestSessionRatedTv200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GuestSessionRatedTv200Response:
        """Test GuestSessionRatedTv200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestSessionRatedTv200Response`
        """
        model = GuestSessionRatedTv200Response()
        if include_optional:
    ...
    def testGuestSessionRatedTv200Response(self):
        """Test GuestSessionRatedTv200Response"""
