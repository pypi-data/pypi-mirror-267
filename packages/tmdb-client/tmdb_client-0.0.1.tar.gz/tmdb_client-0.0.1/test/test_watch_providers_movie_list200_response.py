...
class TestWatchProvidersMovieList200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WatchProvidersMovieList200Response:
        """Test WatchProvidersMovieList200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WatchProvidersMovieList200Response`
        """
        model = WatchProvidersMovieList200Response()
        if include_optional:
    ...
    def testWatchProvidersMovieList200Response(self):
        """Test WatchProvidersMovieList200Response"""
