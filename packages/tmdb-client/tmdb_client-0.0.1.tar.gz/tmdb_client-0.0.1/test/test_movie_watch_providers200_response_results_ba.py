...
class TestMovieWatchProviders200ResponseResultsBA(unittest.TestCase):
    """MovieWatchProviders200ResponseResultsBA unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MovieWatchProviders200ResponseResultsBA:
        """Test MovieWatchProviders200ResponseResultsBA
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MovieWatchProviders200ResponseResultsBA`
        """
        model = MovieWatchProviders200ResponseResultsBA()
        if include_optional:
            return MovieWatchProviders200ResponseResultsBA(
    ...
    def testMovieWatchProviders200ResponseResultsBA(self):
        """Test MovieWatchProviders200ResponseResultsBA"""
