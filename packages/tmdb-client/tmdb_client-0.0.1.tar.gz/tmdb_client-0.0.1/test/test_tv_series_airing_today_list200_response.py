...
class TestTvSeriesAiringTodayList200Response(unittest.TestCase):
    """TvSeriesAiringTodayList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TvSeriesAiringTodayList200Response:
        """Test TvSeriesAiringTodayList200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TvSeriesAiringTodayList200Response`
        """
        model = TvSeriesAiringTodayList200Response()
        if include_optional:
            return TvSeriesAiringTodayList200Response(
                page = 1,
                results = [
    ...
    def testTvSeriesAiringTodayList200Response(self):
        """Test TvSeriesAiringTodayList200Response"""
