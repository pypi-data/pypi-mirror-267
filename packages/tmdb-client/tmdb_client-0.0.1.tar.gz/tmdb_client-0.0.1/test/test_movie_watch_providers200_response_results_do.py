...
class TestMovieWatchProviders200ResponseResultsDO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MovieWatchProviders200ResponseResultsDO:
        """Test MovieWatchProviders200ResponseResultsDO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MovieWatchProviders200ResponseResultsDO`
        """
        model = MovieWatchProviders200ResponseResultsDO()
        if include_optional:
    ...
    def testMovieWatchProviders200ResponseResultsDO(self):
        """Test MovieWatchProviders200ResponseResultsDO"""
