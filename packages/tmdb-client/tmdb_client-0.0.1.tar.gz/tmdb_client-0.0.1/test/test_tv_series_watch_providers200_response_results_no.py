...
class TestTvSeriesWatchProviders200ResponseResultsNO(unittest.TestCase):
    """TvSeriesWatchProviders200ResponseResultsNO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TvSeriesWatchProviders200ResponseResultsNO:
        """Test TvSeriesWatchProviders200ResponseResultsNO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TvSeriesWatchProviders200ResponseResultsNO`
        """
        model = TvSeriesWatchProviders200ResponseResultsNO()
        if include_optional:
            return TvSeriesWatchProviders200ResponseResultsNO(
    ...
    def testTvSeriesWatchProviders200ResponseResultsNO(self):
        """Test TvSeriesWatchProviders200ResponseResultsNO"""
