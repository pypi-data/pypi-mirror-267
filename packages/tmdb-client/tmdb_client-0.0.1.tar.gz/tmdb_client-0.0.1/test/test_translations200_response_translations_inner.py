...
class TestTranslations200ResponseTranslationsInner(unittest.TestCase):
    """Translations200ResponseTranslationsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Translations200ResponseTranslationsInner:
        """Test Translations200ResponseTranslationsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Translations200ResponseTranslationsInner`
        """
        model = Translations200ResponseTranslationsInner()
        if include_optional:
            return Translations200ResponseTranslationsInner(
                iso_3166_1 = 'US',
                iso_639_1 = 'en',
                name = 'English',
...
Description above from the Wikipedia article Tom Hanks, licensed under CC-BY-SA, full list of contributors on Wikipedia.', )
    ...
    def testTranslations200ResponseTranslationsInner(self):
        """Test Translations200ResponseTranslationsInner"""
