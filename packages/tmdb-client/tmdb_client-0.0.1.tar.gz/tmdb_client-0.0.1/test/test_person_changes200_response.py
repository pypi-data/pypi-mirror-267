...
class TestPersonChanges200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PersonChanges200Response:
        """Test PersonChanges200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonChanges200Response`
        """
        model = PersonChanges200Response()
        if include_optional:
...
Hanks és l'actor que més diners ha guanyat de tota la història del cinema amb un total de gairebé sis mil milions de dòlars (setembre 2006). És també copropietari de Playtone, una companyia de producció de pel·lícules.', )
    ...
    def testPersonChanges200Response(self):
        """Test PersonChanges200Response"""
