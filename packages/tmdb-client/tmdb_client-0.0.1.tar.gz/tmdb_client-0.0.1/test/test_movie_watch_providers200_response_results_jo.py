...
class TestMovieWatchProviders200ResponseResultsJO(unittest.TestCase):
    """MovieWatchProviders200ResponseResultsJO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MovieWatchProviders200ResponseResultsJO:
        """Test MovieWatchProviders200ResponseResultsJO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MovieWatchProviders200ResponseResultsJO`
        """
        model = MovieWatchProviders200ResponseResultsJO()
        if include_optional:
            return MovieWatchProviders200ResponseResultsJO(
    ...
    def testMovieWatchProviders200ResponseResultsJO(self):
        """Test MovieWatchProviders200ResponseResultsJO"""
