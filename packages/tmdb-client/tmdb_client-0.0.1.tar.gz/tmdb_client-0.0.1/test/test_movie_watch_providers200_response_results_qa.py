...
class TestMovieWatchProviders200ResponseResultsQA(unittest.TestCase):
    """MovieWatchProviders200ResponseResultsQA unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MovieWatchProviders200ResponseResultsQA:
        """Test MovieWatchProviders200ResponseResultsQA
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MovieWatchProviders200ResponseResultsQA`
        """
        model = MovieWatchProviders200ResponseResultsQA()
        if include_optional:
            return MovieWatchProviders200ResponseResultsQA(
    ...
    def testMovieWatchProviders200ResponseResultsQA(self):
        """Test MovieWatchProviders200ResponseResultsQA"""
