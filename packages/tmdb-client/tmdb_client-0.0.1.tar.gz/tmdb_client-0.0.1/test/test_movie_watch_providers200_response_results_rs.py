...
class TestMovieWatchProviders200ResponseResultsRS(unittest.TestCase):
    """MovieWatchProviders200ResponseResultsRS unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MovieWatchProviders200ResponseResultsRS:
        """Test MovieWatchProviders200ResponseResultsRS
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MovieWatchProviders200ResponseResultsRS`
        """
        model = MovieWatchProviders200ResponseResultsRS()
        if include_optional:
            return MovieWatchProviders200ResponseResultsRS(
    ...
    def testMovieWatchProviders200ResponseResultsRS(self):
        """Test MovieWatchProviders200ResponseResultsRS"""
