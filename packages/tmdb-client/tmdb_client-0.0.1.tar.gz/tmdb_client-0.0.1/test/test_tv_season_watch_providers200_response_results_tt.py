...
class TestTvSeasonWatchProviders200ResponseResultsTT(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TvSeasonWatchProviders200ResponseResultsTT:
        """Test TvSeasonWatchProviders200ResponseResultsTT
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TvSeasonWatchProviders200ResponseResultsTT`
        """
        model = TvSeasonWatchProviders200ResponseResultsTT()
        if include_optional:
    ...
    def testTvSeasonWatchProviders200ResponseResultsTT(self):
        """Test TvSeasonWatchProviders200ResponseResultsTT"""
