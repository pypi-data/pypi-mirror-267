...
class TestCertificationMovieList200Response(unittest.TestCase):
    """CertificationMovieList200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CertificationMovieList200Response:
        """Test CertificationMovieList200Response
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CertificationMovieList200Response`
        """
        model = CertificationMovieList200Response()
        if include_optional:
            return CertificationMovieList200Response(
                certifications = tmdb_client.models.certification_movie_list_200_response_certifications.certification_movie_list_200_response_certifications(
                    au = [
    ...
    def testCertificationMovieList200Response(self):
        """Test CertificationMovieList200Response"""
