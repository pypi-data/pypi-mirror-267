...
class TestTvSeriesReviews200ResponseResultsInner(unittest.TestCase):
    """TvSeriesReviews200ResponseResultsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TvSeriesReviews200ResponseResultsInner:
        """Test TvSeriesReviews200ResponseResultsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TvSeriesReviews200ResponseResultsInner`
        """
        model = TvSeriesReviews200ResponseResultsInner()
        if include_optional:
            return TvSeriesReviews200ResponseResultsInner(
                author = 'lmao7',
...
Fantasy, action, drama, comedy, love...and lots of surprises!',
    ...
    def testTvSeriesReviews200ResponseResultsInner(self):
        """Test TvSeriesReviews200ResponseResultsInner"""
