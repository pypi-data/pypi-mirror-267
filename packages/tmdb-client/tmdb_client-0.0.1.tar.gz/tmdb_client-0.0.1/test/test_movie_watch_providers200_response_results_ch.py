...
class TestMovieWatchProviders200ResponseResultsCH(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MovieWatchProviders200ResponseResultsCH:
        """Test MovieWatchProviders200ResponseResultsCH
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MovieWatchProviders200ResponseResultsCH`
        """
        model = MovieWatchProviders200ResponseResultsCH()
        if include_optional:
    ...
    def testMovieWatchProviders200ResponseResultsCH(self):
        """Test MovieWatchProviders200ResponseResultsCH"""
