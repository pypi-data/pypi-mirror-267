...
class TestMovieWatchProviders200ResponseResultsKW(unittest.TestCase):
    """MovieWatchProviders200ResponseResultsKW unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MovieWatchProviders200ResponseResultsKW:
        """Test MovieWatchProviders200ResponseResultsKW
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MovieWatchProviders200ResponseResultsKW`
        """
        model = MovieWatchProviders200ResponseResultsKW()
        if include_optional:
            return MovieWatchProviders200ResponseResultsKW(
    ...
    def testMovieWatchProviders200ResponseResultsKW(self):
        """Test MovieWatchProviders200ResponseResultsKW"""
