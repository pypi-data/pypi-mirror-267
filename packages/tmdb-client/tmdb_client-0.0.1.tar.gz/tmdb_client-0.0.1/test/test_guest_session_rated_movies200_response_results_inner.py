...
class TestGuestSessionRatedMovies200ResponseResultsInner(unittest.TestCase):
    """GuestSessionRatedMovies200ResponseResultsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GuestSessionRatedMovies200ResponseResultsInner:
        """Test GuestSessionRatedMovies200ResponseResultsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GuestSessionRatedMovies200ResponseResultsInner`
        """
        model = GuestSessionRatedMovies200ResponseResultsInner()
        if include_optional:
            return GuestSessionRatedMovies200ResponseResultsInner(
                adult = False,
    ...
    def testGuestSessionRatedMovies200ResponseResultsInner(self):
        """Test GuestSessionRatedMovies200ResponseResultsInner"""
