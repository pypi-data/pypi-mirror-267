...
class TvSeriesTranslations200Response(BaseModel):
    ...
    translations: Optional[List[TvSeriesTranslations200ResponseTranslationsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "translations": [TvSeriesTranslations200ResponseTranslationsInner.from_dict(_item) for _item in obj["translations"]] if obj.get("translations") is not None else None
        })
        return _obj
