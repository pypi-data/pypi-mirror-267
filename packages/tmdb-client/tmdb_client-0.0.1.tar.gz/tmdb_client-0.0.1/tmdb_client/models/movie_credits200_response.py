...
class MovieCredits200Response(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cast": [MovieCredits200ResponseCastInner.from_dict(_item) for _item in obj["cast"]] if obj.get("cast") is not None else None,
            "crew": [MovieCredits200ResponseCrewInner.from_dict(_item) for _item in obj["crew"]] if obj.get("crew") is not None else None
        })
        return _obj
