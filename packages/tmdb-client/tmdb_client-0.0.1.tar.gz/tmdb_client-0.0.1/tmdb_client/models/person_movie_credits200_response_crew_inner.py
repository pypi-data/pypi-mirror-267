...
class PersonMovieCredits200ResponseCrewInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["adult", "backdrop_path", "genre_ids", "id", "original_language", "original_title", "overview", "popularity", "poster_path", "release_date", "title", "video", "vote_average", "vote_count", "credit_id", "department", "job"]
