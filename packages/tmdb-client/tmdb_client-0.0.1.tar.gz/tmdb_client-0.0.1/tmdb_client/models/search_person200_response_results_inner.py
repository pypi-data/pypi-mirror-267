...
class SearchPerson200ResponseResultsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["adult", "gender", "id", "known_for_department", "name", "original_name", "popularity", "profile_path", "known_for"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "known_for": [SearchPerson200ResponseResultsInnerKnownForInner.from_dict(_item) for _item in obj["known_for"]] if obj.get("known_for") is not None else None
        })
        return _obj
