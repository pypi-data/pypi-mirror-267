...
class TvSeriesChanges200ResponseChangesInnerItemsInnerOriginalValue(BaseModel):
    ...
    """ # noqa: E501
    poster: Optional[TvSeriesChanges200ResponseChangesInnerItemsInnerOriginalValuePoster] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "poster": TvSeriesChanges200ResponseChangesInnerItemsInnerOriginalValuePoster.from_dict(obj["poster"]) if obj.get("poster") is not None else None
        })
        return _obj
