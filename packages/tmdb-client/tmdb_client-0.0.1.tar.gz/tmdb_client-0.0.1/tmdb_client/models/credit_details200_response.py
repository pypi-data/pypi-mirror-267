...
class CreditDetails200Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["credit_type", "department", "job", "media", "media_type", "id", "person"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "job": obj.get("job"),
            "media": CreditDetails200ResponseMedia.from_dict(obj["media"]) if obj.get("media") is not None else None,
            "media_type": obj.get("media_type"),
            "id": obj.get("id"),
            "person": CreditDetails200ResponsePerson.from_dict(obj["person"]) if obj.get("person") is not None else None
        })
        return _obj
