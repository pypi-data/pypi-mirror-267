...
class TvSeriesAggregateCredits200ResponseCastInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["adult", "gender", "id", "known_for_department", "name", "original_name", "popularity", "profile_path", "roles", "total_episode_count", "order"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "roles": [TvSeriesAggregateCredits200ResponseCastInnerRolesInner.from_dict(_item) for _item in obj["roles"]] if obj.get("roles") is not None else None,
