...
class TvSeriesLatestId200ResponseLastEpisodeToAir(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "overview", "vote_average", "vote_count", "air_date", "episode_number", "production_code", "runtime", "season_number", "show_id", "still_path"]
