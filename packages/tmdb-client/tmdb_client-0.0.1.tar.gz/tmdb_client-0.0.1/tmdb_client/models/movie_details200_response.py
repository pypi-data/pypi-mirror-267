...
class MovieDetails200Response(BaseModel):
    ...
    production_companies: Optional[List[MovieDetails200ResponseProductionCompaniesInner]] = None
    production_countries: Optional[List[MovieDetails200ResponseProductionCountriesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "genres": [MovieDetails200ResponseGenresInner.from_dict(_item) for _item in obj["genres"]] if obj.get("genres") is not None else None,
            ...
            "production_companies": [MovieDetails200ResponseProductionCompaniesInner.from_dict(_item) for _item in obj["production_companies"]] if obj.get("production_companies") is not None else None,
            "production_countries": [MovieDetails200ResponseProductionCountriesInner.from_dict(_item) for _item in obj["production_countries"]] if obj.get("production_countries") is not None else None,
