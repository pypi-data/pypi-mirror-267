...
class MovieWatchProviders200ResponseResultsLT(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "link": obj.get("link"),
            "rent": [MovieWatchProviders200ResponseResultsLTRentInner.from_dict(_item) for _item in obj["rent"]] if obj.get("rent") is not None else None,
            "buy": [MovieWatchProviders200ResponseResultsCZBuyInner.from_dict(_item) for _item in obj["buy"]] if obj.get("buy") is not None else None,
