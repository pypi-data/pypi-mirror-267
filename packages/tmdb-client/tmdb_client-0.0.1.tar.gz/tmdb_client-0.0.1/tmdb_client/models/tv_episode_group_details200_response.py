...
class TvEpisodeGroupDetails200Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "episode_count", "group_count", "groups", "id", "name", "network", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "group_count": obj.get("group_count") if obj.get("group_count") is not None else 0,
            "groups": [TvEpisodeGroupDetails200ResponseGroupsInner.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name"),
            "network": TvEpisodeGroupDetails200ResponseNetwork.from_dict(obj["network"]) if obj.get("network") is not None else None,
