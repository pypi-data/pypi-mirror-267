...
class MovieReleaseDates200ResponseResultsInner(BaseModel):
    ...
    release_dates: Optional[List[MovieReleaseDates200ResponseResultsInnerReleaseDatesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "release_dates": [MovieReleaseDates200ResponseResultsInnerReleaseDatesInner.from_dict(_item) for _item in obj["release_dates"]] if obj.get("release_dates") is not None else None
        })
        return _obj
