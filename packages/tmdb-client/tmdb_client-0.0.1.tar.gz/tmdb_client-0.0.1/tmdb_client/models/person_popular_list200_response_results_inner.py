...
class PersonPopularList200ResponseResultsInner(BaseModel):
    ...
    known_for: Optional[List[PersonPopularList200ResponseResultsInnerKnownForInner]] = None
    ...
    __properties: ClassVar[List[str]] = ["adult", "gender", "id", "known_for", "known_for_department", "name", "popularity", "profile_path"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "known_for": [PersonPopularList200ResponseResultsInnerKnownForInner.from_dict(_item) for _item in obj["known_for"]] if obj.get("known_for") is not None else None,
