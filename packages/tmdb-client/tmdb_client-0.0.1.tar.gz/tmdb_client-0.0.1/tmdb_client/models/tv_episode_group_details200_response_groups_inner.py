...
class TvEpisodeGroupDetails200ResponseGroupsInner(BaseModel):
    ...
    episodes: Optional[List[TvEpisodeGroupDetails200ResponseGroupsInnerEpisodesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "episodes": [TvEpisodeGroupDetails200ResponseGroupsInnerEpisodesInner.from_dict(_item) for _item in obj["episodes"]] if obj.get("episodes") is not None else None,
