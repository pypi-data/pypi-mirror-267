...
class PersonTaggedImages200ResponseResultsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["aspect_ratio", "file_path", "height", "id", "iso_639_1", "vote_average", "vote_count", "width", "image_type", "media", "media_type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aspect_ratio": obj.get("aspect_ratio") if obj.get("aspect_ratio") is not None else 0,
            ...
            "media": PersonTaggedImages200ResponseResultsInnerMedia.from_dict(obj["media"]) if obj.get("media") is not None else None,
