...
class WatchProvidersAvailableRegions200Response(BaseModel):
    ...
    """ # noqa: E501
    results: Optional[List[WatchProvidersAvailableRegions200ResponseResultsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [WatchProvidersAvailableRegions200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
