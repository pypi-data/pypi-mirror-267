...
class MovieWatchProviders200ResponseResultsUS(BaseModel):
    ...
    flatrate: Optional[List[MovieWatchProviders200ResponseResultsUSFlatrateInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "link": obj.get("link"),
            "rent": [MovieWatchProviders200ResponseResultsUSRentInner.from_dict(_item) for _item in obj["rent"]] if obj.get("rent") is not None else None,
            "flatrate": [MovieWatchProviders200ResponseResultsUSFlatrateInner.from_dict(_item) for _item in obj["flatrate"]] if obj.get("flatrate") is not None else None,
