...
class TvSeasonAggregateCredits200ResponseCrewInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["adult", "gender", "id", "known_for_department", "name", "original_name", "popularity", "profile_path", "jobs", "department", "total_episode_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobs": [TvSeasonAggregateCredits200ResponseCrewInnerJobsInner.from_dict(_item) for _item in obj["jobs"]] if obj.get("jobs") is not None else None,
            "department": obj.get("department"),
            "total_episode_count": obj.get("total_episode_count") if obj.get("total_episode_count") is not None else 0
        })
        return _obj
