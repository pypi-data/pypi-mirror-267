...
from braincore._state import State, StateTrace, StateDictManager
...
class GradientTransform(object):
  ...
  """
  __module__ = "braincore.transform"
...
def vector_grad(
  ...
  state_auto_finding: bool
    Whether to automatically find the states in the function.
