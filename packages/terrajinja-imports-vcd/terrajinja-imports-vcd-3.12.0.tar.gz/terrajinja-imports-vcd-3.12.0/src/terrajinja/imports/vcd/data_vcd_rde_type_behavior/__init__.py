...
Refer to the Terraform Registry for docs: [`data_vcd_rde_type_behavior`](https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/rde_type_behavior).
'''
import abc
import builtins
import datetime
...
class DataVcdRdeTypeBehavior(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/rde_type_behavior vcd_rde_type_behavior}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/rde_type_behavior vcd_rde_type_behavior} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param behavior_id: The ID of either a RDE Interface Behavior or RDE Type Behavior. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/rde_type_behavior#behavior_id DataVcdRdeTypeBehavior#behavior_id}
        :param rde_type_id: The ID of the RDE Type that owns the Behavior to fetch. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/rde_type_behavior#rde_type_id DataVcdRdeTypeBehavior#rde_type_id}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/rde_type_behavior#id DataVcdRdeTypeBehavior#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataVcdRdeTypeBehavior that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/rde_type_behavior#import import section} in the documentation of this resource for the id to use
...
class DataVcdRdeTypeBehaviorConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def behavior_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/rde_type_behavior#behavior_id DataVcdRdeTypeBehavior#behavior_id}
        '''
    ...
    def rde_type_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/rde_type_behavior#rde_type_id DataVcdRdeTypeBehavior#rde_type_id}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/rde_type_behavior#id DataVcdRdeTypeBehavior#id}.
