...
Refer to the Terraform Registry for docs: [`data_vcd_nsxt_segment_mac_discovery_profile`](https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/nsxt_segment_mac_discovery_profile).
'''
import abc
import builtins
import datetime
...
class DataVcdNsxtSegmentMacDiscoveryProfile(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/nsxt_segment_mac_discovery_profile vcd_nsxt_segment_mac_discovery_profile}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/nsxt_segment_mac_discovery_profile vcd_nsxt_segment_mac_discovery_profile} Data Source.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param name: Name of Segment MAC Discovery Profile. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/nsxt_segment_mac_discovery_profile#name DataVcdNsxtSegmentMacDiscoveryProfile#name}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/nsxt_segment_mac_discovery_profile#id DataVcdNsxtSegmentMacDiscoveryProfile#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param nsxt_manager_id: ID of NSX-T Manager. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/nsxt_segment_mac_discovery_profile#nsxt_manager_id DataVcdNsxtSegmentMacDiscoveryProfile#nsxt_manager_id}
        :param vdc_group_id: ID of VDC Group. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/nsxt_segment_mac_discovery_profile#vdc_group_id DataVcdNsxtSegmentMacDiscoveryProfile#vdc_group_id}
        :param vdc_id: ID of VDC. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/nsxt_segment_mac_discovery_profile#vdc_id DataVcdNsxtSegmentMacDiscoveryProfile#vdc_id}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing DataVcdNsxtSegmentMacDiscoveryProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/nsxt_segment_mac_discovery_profile#import import section} in the documentation of this resource for the id to use
...
class DataVcdNsxtSegmentMacDiscoveryProfileConfig(
    ...
    def name(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/nsxt_segment_mac_discovery_profile#name DataVcdNsxtSegmentMacDiscoveryProfile#name}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/nsxt_segment_mac_discovery_profile#id DataVcdNsxtSegmentMacDiscoveryProfile#id}.
    ...
    def nsxt_manager_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/nsxt_segment_mac_discovery_profile#nsxt_manager_id DataVcdNsxtSegmentMacDiscoveryProfile#nsxt_manager_id}
        '''
    ...
    def vdc_group_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/nsxt_segment_mac_discovery_profile#vdc_group_id DataVcdNsxtSegmentMacDiscoveryProfile#vdc_group_id}
        '''
    ...
    def vdc_id(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/data-sources/nsxt_segment_mac_discovery_profile#vdc_id DataVcdNsxtSegmentMacDiscoveryProfile#vdc_id}
        '''
