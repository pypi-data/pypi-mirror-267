...
Refer to the Terraform Registry for docs: [`vcd_rde_type_behavior`](https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/resources/rde_type_behavior).
'''
import abc
import builtins
import datetime
...
class RdeTypeBehavior(
    ...
    '''Represents a {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/resources/rde_type_behavior vcd_rde_type_behavior}.'''
    ...
    def __init__(
        ...
        *,
        ...
        '''Create a new {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/resources/rde_type_behavior vcd_rde_type_behavior} Resource.

        :param scope: The scope in which to define this construct.
        :param id_: The scoped construct ID. Must be unique amongst siblings in the same scope
        :param rde_interface_behavior_id: The ID of the original RDE Interface Behavior to override. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/resources/rde_type_behavior#rde_interface_behavior_id RdeTypeBehavior#rde_interface_behavior_id}
        :param rde_type_id: The ID of the RDE Type that owns the Behavior override. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/resources/rde_type_behavior#rde_type_id RdeTypeBehavior#rde_type_id}
        :param description: The description of the contract of the overridden Behavior. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/resources/rde_type_behavior#description RdeTypeBehavior#description}
        :param execution: Execution map of the Behavior that overrides the original. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/resources/rde_type_behavior#execution RdeTypeBehavior#execution}
        :param id: Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/resources/rde_type_behavior#id RdeTypeBehavior#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing RdeTypeBehavior that should be imported. Refer to the {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/resources/rde_type_behavior#import import section} in the documentation of this resource for the id to use
...
class RdeTypeBehaviorConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def rde_interface_behavior_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/resources/rde_type_behavior#rde_interface_behavior_id RdeTypeBehavior#rde_interface_behavior_id}
        '''
    ...
    def rde_type_id(self) -> builtins.str:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/resources/rde_type_behavior#rde_type_id RdeTypeBehavior#rde_type_id}
        '''
    ...
    def description(self) -> typing.Optional[builtins.str]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/resources/rde_type_behavior#description RdeTypeBehavior#description}
        '''
    ...
    def execution(self) -> typing.Optional[typing.Mapping[builtins.str, builtins.str]]:
        ...
        Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/resources/rde_type_behavior#execution RdeTypeBehavior#execution}
        '''
    ...
    def id(self) -> typing.Optional[builtins.str]:
        '''Docs at Terraform Registry: {@link https://registry.terraform.io/providers/vmware/vcd/3.12.0/docs/resources/rde_type_behavior#id RdeTypeBehavior#id}.
