...
def replace_column_type(column: exp.ColumnDef):
    ...
    if column.kind and column.kind.this in (
        ...
        # todo ARRAY, STRUCT, and MAP need to be considered later.
    ...
    class Generator(MySQL.Generator):
        ...
        def properties(
            ...
            for prop in properties.expressions:
                if str(prop.this.this).lower() not in self.DORIS_SURROPT_PROPERTIES:
        ...
        def create_sql(self, expression: exp.Create) -> str:
            ...
            for e in expression.this.expressions:
                if (
                    isinstance(e, exp.ColumnDef)
                    and e.kind
                    and not e.kind.is_type(
