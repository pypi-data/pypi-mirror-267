...
from .methods import Connect, Login, Resume, GetChannels, SendMessage,\
...
class RealTime:
    ...
    def __init__(self):
        self.user_id = None
        self.username = None
        self._dispatcher: Dispatcher = Dispatcher(verbose=False)
    ...
    async def subscribe_to_channel_messages(self, channel_id, channel_type, callback):
        """
