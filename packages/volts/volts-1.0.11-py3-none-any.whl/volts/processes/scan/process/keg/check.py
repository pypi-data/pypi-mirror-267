...
try:
	______volts ["checks"] = checks;	
	______volts ["checks found"] = True;
except Exception as E:
	print (E)
	______volts ["checks found"] = False;
		'''

	return contents


import volts.topics.exceptions as bs_exceptions
