...
def choose_method():
    ...
    button_continue.pack(side=tk.BOTTOM, padx=60, pady=0.01)
...
def mainWindow():
    ...
    center_frame.place(relx=0.5, rely=0.49, anchor=tk.CENTER)
    ...
    low_frame.place(relx=0.01, rely=0.72, anchor=tk.NW)
