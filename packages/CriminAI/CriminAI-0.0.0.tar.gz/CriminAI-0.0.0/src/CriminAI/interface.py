...
from CriminAI.VAE.autoencodeur import VAE, CustomDataset # from autoencodeur_BW import VAE, CustomDataset
...
print(os.path.join(os.path.dirname(__file__), 'celebA_mix_MSE_lossL1.pth'))
checkpoint = torch.load(os.path.join(os.path.dirname(__file__), 'celebA_mix_MSE_lossL1.pth'))
...
def create_portrait():
    ...
    for i in range(1, n + 1):
        ...
        img = Image.fromarray(img_array.transpose(1, 2, 0)) # img_array.reshape(64,64)
