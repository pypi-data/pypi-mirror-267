...
def save_toy_data(data): 
    ...
    # Change this dst_path to where this . folder is on your PC.
    # Make sure this location has a "___test" folder.
    dst_path = "C:/Users/g_gna/Documents/TCD/Modules/CS7CS3_AdvancedSoftwareEngineering/GitHub/ETLPipelinePy3.11Mod/tests"
    csv_file = (f'{dst_path}/data.csv') 
