...
AIXBLOCK_ML_BACKEND_V2_DEFAULT = False
...
class JobManager(object):
    """Job Manager provides a facility to spin up background jobs for AIxBlockMLBase models"""
...
class AIxBlockMLManager(object):
    ...
    def initialize(
        ...
        **init_kwargs
        ...
        if not issubclass(model_class, AIxBlockMLBase):
            raise ValueError('Inference class should be the subclass of ' + AIxBlockMLBase.__class__.__name__)
