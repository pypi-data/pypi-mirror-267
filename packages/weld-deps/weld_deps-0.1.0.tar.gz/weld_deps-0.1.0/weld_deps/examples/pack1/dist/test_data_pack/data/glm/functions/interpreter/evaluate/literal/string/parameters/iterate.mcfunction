...
execute if score .index glm.interpreter matches 0 run data modify storage glm:interpreter evaluate.parameters.result.value append from storage glm:interpreter evaluate.stack[-1].value[0]
execute if score .index glm.interpreter matches 0 run return -1

execute if score .index glm.interpreter matches -1 run data modify storage glm:interpreter evaluate.parameters.result.value append from storage glm:interpreter evaluate.stack[-1].value[-1]
