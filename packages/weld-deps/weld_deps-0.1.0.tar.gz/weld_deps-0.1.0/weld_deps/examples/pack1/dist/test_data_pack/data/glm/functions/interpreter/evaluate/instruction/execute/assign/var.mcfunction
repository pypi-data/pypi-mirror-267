...
scoreboard players operation $scope_current glm.interpreter = $scope glm.interpreter
scoreboard players set $scope glm.interpreter 0

function glm:interpreter/evaluate/instruction/execute/assign/assign

scoreboard players operation $scope glm.interpreter = $scope_current glm.interpreter