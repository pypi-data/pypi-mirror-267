data modify storage glm:interpreter utils.stringify.stack append from storage glm:interpreter utils.stringify.stack[-1].value[0]
...
data modify storage glm:interpreter utils.stringify.result append value " "
function glm:interpreter/utils/stringify/array/iterate