data modify storage moxlib:api/data/collect target set from storage glm:interpreter evaluate.stack[-1].value
...
data modify storage glm:interpreter evaluate.stack[-1].value set from storage moxlib:api/data/collect output.remain