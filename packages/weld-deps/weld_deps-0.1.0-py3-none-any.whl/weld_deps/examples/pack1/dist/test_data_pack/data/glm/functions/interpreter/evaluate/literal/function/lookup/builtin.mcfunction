data modify storage moxlib:api/data/get target set from storage glm:interpreter registry.builtin
data modify storage moxlib:api/data/get target append from storage glm:interpreter registry.external[]
