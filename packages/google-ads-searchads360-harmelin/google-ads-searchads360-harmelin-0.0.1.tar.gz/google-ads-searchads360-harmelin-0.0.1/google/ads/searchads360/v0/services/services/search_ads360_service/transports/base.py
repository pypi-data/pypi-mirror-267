...
class SearchAds360ServiceTransport(abc.ABC):
    """Abstract transport class for SearchAds360Service."""
    ...
    def search(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[search_ads360_service.SearchSearchAds360Response]
            ]]:
        raise NotImplementedError()
    ...
    def search_stream(self) -> Callable[
            ...
            Union[
                ...
                Awaitable[search_ads360_service.SearchSearchAds360StreamResponse]
            ]]:
        raise NotImplementedError()


__all__ = (
    'SearchAds360ServiceTransport',
)
