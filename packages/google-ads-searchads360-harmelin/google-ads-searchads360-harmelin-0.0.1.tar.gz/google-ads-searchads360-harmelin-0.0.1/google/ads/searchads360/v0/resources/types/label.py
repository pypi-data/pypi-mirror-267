...
from google.ads.searchads360.v0.common.types import text_label as gasc_text_label
from google.ads.searchads360.v0.enums.types import label_status
...
class Label(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.searchads360.v0.enums.types.LabelStatusEnum.LabelStatus):
            Output only. Status of the label. Read only.
        text_label (google.ads.searchads360.v0.common.types.TextLabel):
    ...
    text_label: gasc_text_label.TextLabel = proto.Field(
        proto.MESSAGE,
        number=5,
        message=gasc_text_label.TextLabel,
    )
