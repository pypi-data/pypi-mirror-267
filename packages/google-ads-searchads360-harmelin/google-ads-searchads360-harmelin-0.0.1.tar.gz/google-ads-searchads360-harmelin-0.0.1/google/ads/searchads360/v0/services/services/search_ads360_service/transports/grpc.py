...
from .base import SearchAds360ServiceTransport, DEFAULT_CLIENT_INFO


class SearchAds360ServiceGrpcTransport(SearchAds360ServiceTransport):
    """gRPC backend transport for SearchAds360Service.
    ...
    def search(self) -> Callable[
        ...
        Returns:
            Callable[[~.SearchSearchAds360Request],
        ...
        if 'search' not in self._stubs:
            self._stubs['search'] = self.grpc_channel.unary_unary(
                ...
                request_serializer=search_ads360_service.SearchSearchAds360Request.serialize,
                response_deserializer=search_ads360_service.SearchSearchAds360Response.deserialize,
            )
    ...
    def search_stream(self) -> Callable[
            ...
            search_ads360_service.SearchSearchAds360StreamResponse]:
        ...
        Returns:
            Callable[[~.SearchSearchAds360StreamRequest],
        ...
        if 'search_stream' not in self._stubs:
            self._stubs['search_stream'] = self.grpc_channel.unary_stream(
                ...
                request_serializer=search_ads360_service.SearchSearchAds360StreamRequest.serialize,
                response_deserializer=search_ads360_service.SearchSearchAds360StreamResponse.deserialize,
            )
...
__all__ = (
    'SearchAds360ServiceGrpcTransport',
)
