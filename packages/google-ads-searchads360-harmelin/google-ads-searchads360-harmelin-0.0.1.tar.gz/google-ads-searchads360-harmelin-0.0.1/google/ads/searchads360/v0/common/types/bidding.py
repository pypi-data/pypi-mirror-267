...
from google.ads.searchads360.v0.enums.types import target_impression_share_location
...
class TargetImpressionShare(proto.Message):
    ...
    Attributes:
        location (google.ads.searchads360.v0.enums.types.TargetImpressionShareLocationEnum.TargetImpressionShareLocation):
...
class TargetOutrankShare(proto.Message):
    r"""An automated bidding strategy that sets bids based on the
    target fraction of auctions where the advertiser should outrank
    a specific competitor. This strategy is deprecated.

    Attributes:
        cpc_bid_ceiling_micros (google.protobuf.wrappers_pb2.Int64Value):
            Maximum bid limit that can be set by the bid
            strategy. The limit applies to all keywords
            managed by the strategy.
    """

    cpc_bid_ceiling_micros: wrappers_pb2.Int64Value = proto.Field(
        proto.MESSAGE,
        number=3,
