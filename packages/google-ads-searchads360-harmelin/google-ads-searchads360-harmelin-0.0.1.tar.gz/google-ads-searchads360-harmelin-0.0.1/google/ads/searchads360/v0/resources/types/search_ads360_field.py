...
class SearchAds360Field(proto.Message):
    ...
    Attributes:
        ...
        category (google.ads.searchads360.v0.enums.types.SearchAds360FieldCategoryEnum.SearchAds360FieldCategory):
        ...
        data_type (google.ads.searchads360.v0.enums.types.SearchAds360FieldDataTypeEnum.SearchAds360FieldDataType):
    ...
    category: search_ads360_field_category.SearchAds360FieldCategoryEnum.SearchAds360FieldCategory = proto.Field(
        proto.ENUM,
        number=3,
        enum=search_ads360_field_category.SearchAds360FieldCategoryEnum.SearchAds360FieldCategory,
    )
    ...
    data_type: search_ads360_field_data_type.SearchAds360FieldDataTypeEnum.SearchAds360FieldDataType = proto.Field(
        proto.ENUM,
        number=12,
        enum=search_ads360_field_data_type.SearchAds360FieldDataTypeEnum.SearchAds360FieldDataType,
    )
