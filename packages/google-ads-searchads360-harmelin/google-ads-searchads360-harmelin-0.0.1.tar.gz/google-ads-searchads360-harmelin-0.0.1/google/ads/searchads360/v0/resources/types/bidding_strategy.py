...
from google.ads.searchads360.v0.enums.types import bidding_strategy_status
from google.ads.searchads360.v0.enums.types import bidding_strategy_type
...
class BiddingStrategy(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.searchads360.v0.enums.types.BiddingStrategyStatusEnum.BiddingStrategyStatus):
            Output only. The status of the bidding
            strategy.
            This field is read-only.
        type_ (google.ads.searchads360.v0.enums.types.BiddingStrategyTypeEnum.BiddingStrategyType):
        ...
        enhanced_cpc (google.ads.searchads360.v0.common.types.EnhancedCpc):
        ...
        target_impression_share (google.ads.searchads360.v0.common.types.TargetImpressionShare):
            ...
            This field is a member of `oneof`_ ``scheme``.
        target_outrank_share (google.ads.searchads360.v0.common.types.TargetOutrankShare):
            A bidding strategy that sets bids based on
            the target fraction of auctions where the
            advertiser should outrank a specific competitor.
            This field is deprecated. Creating a new bidding
            strategy with this field or attaching bidding
            strategies with this field to a campaign will
            fail. Mutates to strategies that already have
            this scheme populated are allowed.
    ...
    target_outrank_share: bidding.TargetOutrankShare = proto.Field(
        proto.MESSAGE,
        number=10,
        oneof='scheme',
        message=bidding.TargetOutrankShare,
    )
