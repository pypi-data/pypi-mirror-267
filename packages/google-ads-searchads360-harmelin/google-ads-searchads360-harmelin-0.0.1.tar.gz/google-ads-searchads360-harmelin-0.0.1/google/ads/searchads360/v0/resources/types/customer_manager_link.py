...
from google.ads.searchads360.v0.enums.types import manager_link_status
...
class CustomerManagerLink(proto.Message):
    ...
    Attributes:
        ...
        status (google.ads.searchads360.v0.enums.types.ManagerLinkStatusEnum.ManagerLinkStatus):
