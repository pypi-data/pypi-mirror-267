...
def create_account(
    ...
    def _request(ctx: typer.Context, data: schema.CreateAccount) -> httpx.Response:
        return util.post(
            ctx,
            constant.IAM,
            _iam_url(ctx.obj.get_hub_api_url(), "account"),
...
def delete_account(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.delete(
            ctx,
            constant.IAM,
            _iam_url(ctx.obj.get_hub_api_url(), f"account/{identifier}"),
        )
...
def list_policies(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        ...
        return util.get(
            ctx,
            constant.IAM,
            _iam_url(ctx.obj.get_hub_api_url(), "policy/users"),
            params=params,
            account=account,
        )
...
def create_from_json(
    ...
    def _request(ctx: typer.Context, user_policy: schema.UserPolicy) -> httpx.Response:
        return util.post(
            ctx,
            constant.IAM,
            "{iam_url}".format(iam_url=_iam_url(ctx.obj.get_hub_api_url(), "policy/user")),
...
def create_user(
    ...
    def _request(ctx: typer.Context, user: schema.CreateUser) -> httpx.Response:
        return util.post(
            ctx,
            constant.IAM,
            _iam_url(ctx.obj.get_hub_api_url(), "user"),
...
def delete_user(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.delete(
            ctx,
            constant.IAM,
            _iam_url(ctx.obj.get_hub_api_url(), f"user/{user_id}"),
            account=account,
            timeout=30,
        )
...
def purge_user(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.delete(
            ctx,
            constant.IAM,
            _iam_url(ctx.obj.get_hub_api_url(), f"user/{user_id}/purge"),
            account=account,
            timeout=30,
        )
...
def create_key_pair(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.post(
            ctx,
            constant.IAM,
            _iam_url(ctx.obj.get_hub_api_url(), f"user/{user_nrn}/key_pair"),
            account=account,
            timeout=30,
        )
...
def delete_key_pair(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.delete(
            ctx,
            constant.IAM,
            _iam_url(ctx.obj.get_hub_api_url(), f"user/{user_nrn}/key_pair/{access_key_id}"),
            account=account,
            timeout=30,
        )
...
def list_users(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        ...
        return util.get(
            ctx,
            constant.IAM,
            _iam_url(ctx.obj.get_hub_api_url(), "users"),
            params=params,
            account=account,
        )
...
def reset_password(
    ...
    def _request(ctx: typer.Context) -> httpx.Response:
        return util.post(
            ctx,
            constant.IAM,
            _iam_url(ctx.obj.get_hub_api_url(), "user/password/reset"),
...
def create_group(
    ...
    def _request(ctx: typer.Context, group: schema.CreateUpdateGroup) -> httpx.Response:
        return util.post(
            ctx,
            constant.IAM,
            _iam_url(ctx.obj.get_hub_api_url(), "group"),
...
def update_group(
    ...
    def _request(ctx: typer.Context, group: schema.CreateUpdateGroup) -> httpx.Response:
        return util.post(
            ctx,
            constant.IAM,
            _iam_url(ctx.obj.get_hub_api_url(), f"group/{identifier}"),
            json=group.model_dump(mode="json"),
            account=account,
        )
...
def add_principals(
    ...
    def _request(ctx: typer.Context, update: schema.Principals) -> httpx.Response:
        return util.post(
            ctx,
            constant.IAM,
            _iam_url(ctx.obj.get_hub_api_url(), f"group/{identifier}/principals"),
