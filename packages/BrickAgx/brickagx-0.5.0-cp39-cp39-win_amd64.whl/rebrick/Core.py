...
class Node(object):
    ...
    def isModelInitializer(self):
        r"""isModelInitializer(Node self) -> bool"""
    ...
    def asModelInitializer(self):
        r"""asModelInitializer(Node self) -> Brick::ModelInitPtr"""
...
class ModelDeclaration(object):
    ...
    def create(qualifier_token, name_token, extends_qualifier_token, parent_segments, annotations, members):
        r"""
        create(Token qualifier_token, Token name_token, Token extends_qualifier_token, TokenVector parent_segments, std::vector< Brick::AnnotationPtr,std::allocator< Brick::AnnotationPtr > > const & annotations, std::vector< Brick::NodePtr,std::allocator< Brick::NodePtr > > const & members) -> Brick::ModelDeclPtr
    ...
    def findAnnotations(self, name):
        r"""
        findAnnotations(ModelDeclaration self, std::string const & name) -> std::vector< Brick::AnnotationPtr,std::allocator< Brick::AnnotationPtr > >
...
def ModelDeclaration_create(qualifier_token, name_token, extends_qualifier_token, parent_segments, annotations, members):
    r"""
    ModelDeclaration_create(Token qualifier_token, Token name_token, Token extends_qualifier_token, TokenVector parent_segments, std::vector< Brick::AnnotationPtr,std::allocator< Brick::AnnotationPtr > > const & annotations, std::vector< Brick::NodePtr,std::allocator< Brick::NodePtr > > const & members) -> Brick::ModelDeclPtr
...
class Plugin(object):
    ...
    def parse(self, key, error_reporter):
        r"""
        parse(Plugin self, std::string const & key, ErrorReporter & error_reporter) -> Brick::DocPtr
        ...
        """
        return _CorePythonSwig.Plugin_parse(self, key, error_reporter)
