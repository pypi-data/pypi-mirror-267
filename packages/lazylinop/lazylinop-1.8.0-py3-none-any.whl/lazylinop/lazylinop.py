    ...
    def check(self):
        ...
        **Notations**:
        ...
        The function verifies that:
            ...
            3. ``op.H @ Y`` is equal to the horizontal concatenation of all
        ...
        .. admonition:: Necessary condition but not sufficient
            ...
            according to the four assertions above but it cannot ensure a
            ...
            an operator unit tests, complementary tests are necessary.
