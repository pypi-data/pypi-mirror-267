...
class MaterializedViewGrant(
    ...
    def __init__(
        ...
        *,
        ...
        :param roles: Grants privilege to these roles. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.88.0/docs/resources/materialized_view_grant#roles MaterializedViewGrant#roles}
        ...
        :param shares: Grants privilege to these shares (only valid if on_future and on_all are false). Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.88.0/docs/resources/materialized_view_grant#shares MaterializedViewGrant#shares}
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing MaterializedViewGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.88.0/docs/resources/materialized_view_grant#import import section} in the documentation of this resource for the id to use
