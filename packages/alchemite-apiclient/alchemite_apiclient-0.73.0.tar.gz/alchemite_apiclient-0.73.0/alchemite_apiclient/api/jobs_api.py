...
class JobsApi(object):
    ...
    def suggest_additional_metadata_put(
        self,
        **kwargs
    ):
        """List sorted and filtered suggest-additional metadata  # noqa: E501

        Returns all suggest-additional jobs matching the query passed.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.suggest_additional_metadata_put(async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            ...
            suggest_additional_query (SuggestAdditionalQuery): [optional]
        ...
        return self.suggest_additional_metadata_put_endpoint.call_with_http_info(**kwargs)
