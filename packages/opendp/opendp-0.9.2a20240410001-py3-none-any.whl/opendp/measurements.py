...
def make_alp_queryable(
    ...
    [make_alp_queryable in Rust documentation.](https://docs.rs/opendp/0.9.2-nightly.20240410.1/opendp/measurements/fn.make_alp_queryable.html)
...
def make_base_laplace_threshold(
    ...
    [make_base_laplace_threshold in Rust documentation.](https://docs.rs/opendp/0.9.2-nightly.20240410.1/opendp/measurements/fn.make_base_laplace_threshold.html)
...
def make_gaussian(
    ...
    [make_gaussian in Rust documentation.](https://docs.rs/opendp/0.9.2-nightly.20240410.1/opendp/measurements/fn.make_gaussian.html)
...
def make_geometric(
    ...
    [make_geometric in Rust documentation.](https://docs.rs/opendp/0.9.2-nightly.20240410.1/opendp/measurements/fn.make_geometric.html)
...
def make_laplace(
    ...
    [make_laplace in Rust documentation.](https://docs.rs/opendp/0.9.2-nightly.20240410.1/opendp/measurements/fn.make_laplace.html)
...
def make_randomized_response(
    ...
    [make_randomized_response in Rust documentation.](https://docs.rs/opendp/0.9.2-nightly.20240410.1/opendp/measurements/fn.make_randomized_response.html)
...
def make_randomized_response_bool(
    ...
    [make_randomized_response_bool in Rust documentation.](https://docs.rs/opendp/0.9.2-nightly.20240410.1/opendp/measurements/fn.make_randomized_response_bool.html)
...
def make_report_noisy_max_gumbel(
    ...
    [make_report_noisy_max_gumbel in Rust documentation.](https://docs.rs/opendp/0.9.2-nightly.20240410.1/opendp/measurements/fn.make_report_noisy_max_gumbel.html)
