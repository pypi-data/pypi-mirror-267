...
class PadOp(_ods_ir.OpView):
  ...
  def __init__(self, padded, pad, copy, target, *, padding_values=None, padding_dimensions=None, pad_to_multiple_of=None, pack_paddings=None, transpose_paddings=None, copy_back_op=None, loc=None, ip=None):
    ...
    if pad_to_multiple_of is not None: attributes["pad_to_multiple_of"] = (pad_to_multiple_of if (
        isinstance(pad_to_multiple_of, _ods_ir.Attribute) or
        not _ods_ir.AttrBuilder.contains('I64ArrayAttr')) else
...
def structured_pad(padded, pad, copy, target, *, padding_values=None, padding_dimensions=None, pad_to_multiple_of=None, pack_paddings=None, transpose_paddings=None, copy_back_op=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
