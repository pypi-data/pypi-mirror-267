...
if globs.LIBNUMVERSION not in versions:
    raise ImportError(f"EndersUtils - Version {globs.LIBNUMVERSION} is not up to date! Please use any of the following versions: {versions}")
