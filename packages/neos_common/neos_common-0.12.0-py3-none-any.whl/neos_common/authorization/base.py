...
from neos_common.client import HubClient, KeycloakClient
...
class SignatureValidator(typing.Protocol):
    ...
    async def validate(
        ...
        action: list[typing.Union[Action, str]],
...
class AccessValidator:
    async def validate(
        self,
        user_id: uuid.UUID,
        actions: list[typing.Union[Action, str]],
...
class ActionResource:
    ...
    resource_extractor: typing.Union[typing.Callable[[fastapi.Request], dict[str, str]], None] = None
