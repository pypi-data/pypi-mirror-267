...
def GetStockTradeInfo(*args, **kwargs):
    ...
    ## 특정 종목 기간 조회
        ...
        urlTmp = 'http://data.krx.co.kr/comm/bldAttendant/getJsonData.cmd?bld=dbms/MDC/STAT/standard/MDCSTAT01701&locale=ko_KR&'
        urlTmp += 'tboxisuCd_finder_stkisu0_15={}&isuCd={}&isuCd2=&codeNmisuCd_finder_stkisu0_15={}'
        urlTmp += '&param1isuCd_finder_stkisu0_15=ALL&strtDd='
        urlTmp += '{}&endDd={}&share=1&money=1&csvxls_isNo=false'
        if kwargs.get('sujung', 'N') == 'Y':
            urlTmp += '&adjStkPrc_check=Y&adjStkPrc=2'
        else:
            urlTmp += '&adjStkPrc=1'

        url = urlTmp.format(shCode, isuCd, shName, frDt, toDt)
        res = urlProc.requests_url_call(url)    
        dList = json.loads(res.text)['output']
...
def GetTradeVolumeByInvestor(shCode, sDate, eDate, shName='', isuCd=''):
    ...
    # 투자자별 거래량
    url = "http://data.krx.co.kr/comm/bldAttendant/getJsonData.cmd?"
    url += 'bld=dbms/MDC/STAT/standard/MDCSTAT02303&locale=ko_KR&inqTpCd=2&trdVolVal=1&askBid=3&'
    url += 'tboxisuCd_finder_stkisu0_2={}%2F{}&isuCd={}&isuCd2={}&codeNmisuCd_finder_stkisu0_2={}&'
    url += 'param1isuCd_finder_stkisu0_2=ALL&strtDd={}&endDd={}&detailView=1&share=1&csvxls_isNo=false'
    
    res = urlProc.requests_url_call(url.format(shCode, shName, isuCd, isuCd, shName, sDate, eDate) )
    ...
    # 외국인 보유량
    url = "http://data.krx.co.kr/comm/bldAttendant/getJsonData.cmd?"
    url += 'bld=dbms/MDC/STAT/standard/MDCSTAT03702&locale=ko_KR&searchType=2&mktId=ALL&trdDd={}&'
    url += 'tboxisuCd_finder_stkisu0_11={}/{}&isuCd={}&isuCd2={}&codeNmisuCd_finder_stkisu0_11={}&'
    url += 'param1isuCd_finder_stkisu0_11=ALL&strtDd={}&endDd={}&share=1&csvxls_isNo=false'
    
    res = urlProc.requests_url_call(url.format(eDate,  shCode, shName, isuCd, isuCd, shName, sDate, eDate) )
    dList = json.loads(res.text)['output']
...
def GetShortSelling(shCode, sDate, eDate, shName='', isuCd=''):
    ...
    # 공매도 거래량
    url = "http://data.krx.co.kr/comm/bldAttendant/getJsonData.cmd?"
    url += 'bld=dbms/MDC/STAT/srt/MDCSTAT30102&locale=ko_KR&searchType=2&mktId=STK&secugrpId=STMFRTSCIFDRFS&'
    url += 'secugrpId=SRSW&secugrpId=BC&inqCond=STMFRTSCIFDRFSSRSWBC&trdDd={}&'
    url += 'tboxisuCd_finder_srtisu1_4={}/{}&isuCd={}&isuCd2={}&codeNmisuCd_finder_srtisu1_4={}&'
    url += 'param1isuCd_finder_srtisu1_4=&strtDd={}&endDd={}&share=1&money=1&csvxls_isNo=false'

    res = urlProc.requests_url_call(url.format(eDate, shCode, shName, isuCd, shCode, shName, sDate, eDate) )
    dList = json.loads(res.text)['OutBlock_1']
    ...
    # 공매도 잔고
    url = "http://data.krx.co.kr/comm/bldAttendant/getJsonData.cmd?"
    url += 'bld=dbms/MDC/STAT/srt/MDCSTAT30502&locale=ko_KR&searchType=2&mktTpCd=1&trdDd={}&'
    url += 'tboxisuCd_finder_srtisu0_5={}/{}&isuCd={}&isuCd2={}&codeNmisuCd_finder_srtisu0_5={}&'
    url += 'param1isuCd_finder_srtisu0_5=&strtDd={}&endDd={}&share=1&money=1&csvxls_isNo=false'
...
def CompareStockPrice(frDt, toDt):
    urlTmp = "http://data.krx.co.kr/comm/bldAttendant/getJsonData.cmd?bld=dbms/MDC/STAT/standard/MDCSTAT01602&locale=ko_KR&mktId=ALL&strtDd={}&endDd={}&adjStkPrc_check=Y&adjStkPrc=2&share=1&money=1&csvxls_isNo=false"
    url = urlTmp.format(frDt, toDt)
    res = urlProc.requests_url_call(url)    
    dList = json.loads(res.text)['OutBlock_1']
