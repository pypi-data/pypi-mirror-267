...
class DatameshUI extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_1__.ReactWidget {
    render() {
        return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("iframe", { src: `${"https://ui.datamesh.oceanum.io"}`, className: "datamesh-iframe" }));
    }
}
...
/* harmony import */ var _phosphor_icons_react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @phosphor-icons/react */ "webpack/sharing/consume/default/@phosphor-icons/react/@phosphor-icons/react");
/* harmony import */ var _phosphor_icons_react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_phosphor_icons_react__WEBPACK_IMPORTED_MODULE_2__);
...
const DatasourceItem = ({ datasource, insertDatasource, onMouseDown }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { className: expanded ? 'expanded' : '' },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { key: datasource.id, className: "datasource-item-title" },
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", { title: datasource.description, className: isDragging
                    ? 'datasource-item-name'
                    : 'datasource-item-name draggable', onClick: handleToggleExpand, onMouseDown: startDrag, onMouseUp: () => setIsDragging(false) }, datasource.description),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", { title: "Insert code to load datasource", onClick: handleToggleExpand, className: "datasource-item-action" },
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_phosphor_icons_react__WEBPACK_IMPORTED_MODULE_2__.ArrowBendDownRight, { size: 18, onClick: e => insertDatasource(datasource) }))),
...
async function requestAPI(endPoint = '', init = {}) {
    ...
    const requestUrl = _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__.URLExt.join(settings.baseUrl, 'oceanum', // API Namespace
    endPoint);
    let response;
    try {
...
const oceanumIcon = new _jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_2__.LabIcon({
    name: 'oceanum:icon',
    svgstr: _style_icons_oceanum_svg__WEBPACK_IMPORTED_MODULE_7__
});
    ...
    activate: (app, palette, restorer, status, settingRegistry, themeManager) => {
        ...
        const updateSettings = (set) => {
            ...
            if (token && token.user) {
                ...
                (0,_handler__WEBPACK_IMPORTED_MODULE_8__.requestAPI)('env/', {
                    method: 'POST',
        ...
        const openDatameshUI = (event) => {
            ...
            const openWidget = (0,_lumino_algorithm__WEBPACK_IMPORTED_MODULE_3__.find)(app.shell.widgets('main'), (widget, index) => {
...
//# sourceMappingURL=lib_index_js.204d6ed2f070403848e8.js.map