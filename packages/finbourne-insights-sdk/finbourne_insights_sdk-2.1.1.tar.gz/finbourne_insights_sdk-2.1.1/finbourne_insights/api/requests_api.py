...
class RequestsApi:
    ...
    @overload
    async def get_request(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The identifier of the request to obtain the content for.")], **kwargs) -> Request:  # noqa: E501
        ...
    ...
    @overload
    async def get_request_log(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The identifier of the request to obtain the log for.")], **kwargs) -> RequestLog:  # noqa: E501
        ...
    ...
    @overload
    async def get_response(self, id : Annotated[constr(strict=True, max_length=64, min_length=1), Field(..., description="The identifier of the request to obtain the response for.")], **kwargs) -> Response:  # noqa: E501
        ...
