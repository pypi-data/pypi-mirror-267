...
class Banner(ctk.CTkFrame):
    ...
    def update_widget(self):
        ...
        if self.banner_content is not None:
            self.numOfChars = 40
            self.banner_content = textwrap.fill(self.banner_content, width=(self.numOfChars/697)*(self.s[0]//2)) # 45 characters per line, 697 is the width available for the text 
