...
print("THIS REPO IS NO LONGER MAINTAINED, THE PROJECT IS MOVED TO https://codeberg.org/librecell/lclayout")
print("Continuing installation in 10 seconds...")
time.sleep(10)
