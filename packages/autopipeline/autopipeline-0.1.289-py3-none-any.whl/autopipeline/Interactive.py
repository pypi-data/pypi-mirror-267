...
def leap(query, table_ptr, description, verbose = False, udf = None, gpt4=True):
    ...
    if udf == None:
        precheck, functions = check_vague(query, columns, description, verbose, client, gpt4)
    else:
        func_desc = ""
        for f in udf:
        ...
        precheck, functions = check_vague(query, columns, description, verbose, client, gpt4, func_desc)
