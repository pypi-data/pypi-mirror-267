...
def volume(name: str, vtype: Optional[str] = "OBJECT_STORAGE", settings: Optional[Settings] = settings):
    """
    ...
    try:
        ...
        response = client.post("/api/v2/volumes", request_options={"json": {"name": volume_name, "vtype": vtype}})
