...
def geçen_süreyi_hesapla(start_time, end_time):
    ...
    if salise == False:
        zaman_değeri = "Zaman Bilinmiyor"
        zaman_değeri_sistemsel = None
        zaman_değeri_daha_sistemsel = None
    elif seconds == False:  
        zaman_değeri = f"Salise = {salise}"
        zaman_değeri_sistemsel = 'Only salise'
        zaman_değeri_daha_sistemsel = 1
    elif minutes == False:
        zaman_değeri = f"Saniye = {seconds}, Salise = {salise}"
        zaman_değeri_sistemsel = "Only salise And saniye"
        zaman_değeri_daha_sistemsel = 2
    elif hours == False:
        zaman_değeri = f"Dakika = {minutes}, Saniye = {seconds}, Salise = {salise}"
        zaman_değeri_sistemsel = "Only salise And saniye And minutes"
        zaman_değeri_daha_sistemsel = 3
    elif days == False:
        zaman_değeri = f"Saat = {hours}, Dakika = {minutes}, Saniye = {seconds}, Salise = {salise}"
        zaman_değeri_sistemsel = "Only salise And saniye And minutes And hours"
        zaman_değeri_daha_sistemsel = 4
    else:
        zaman_değeri = f"{days} gün, {hours} saat, {minutes} dakika, {seconds} saniye, {salise} salise geçti."
        zaman_değeri_sistemsel = "Only salise And saniye And minutes And hours And days"
        zaman_değeri_daha_sistemsel = 5
    ...
    def hız_kontrol():
        if Hız != None:
            if Hız == 'Yavaş' or Hız == 'Slow' or Hız == 'Hızlı':
                ...
                raise ValueError("Hız değerinizi doğru girmeniz gerekir. Hız değeri 'Yavaş' = 'Slow', None veya 'Hızlı' olmalıdır.")
    ...
    def bölüm_kontrol():
        if bölüm != None:
            if bölüm == 'Tam' or bölüm == 'Yarı' or bölüm == 'Çeyrek':
                ...
                raise ValueError("Hız değerinizi doğru girmeniz gerekir. bölüm değeri 'Tam', 'Yarı', None veya 'Çeyrek' olmalıdır.")
