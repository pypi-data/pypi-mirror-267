...
class Chromastone:
    ...
    def send_sms(self, source_number: str, destination_number: str, message: str):
        '''destination_number must be of the form 263xxxxxxxxx, message must not exceed 160 characters, source_number is optional, it is the number that will be displayed as the sender of the SMS, it must be of the form 263xxxxxxxxx, if it is not provided, the default sender number will be used.'''
    ...
    def send_innbucks(self, destination_number: str, message: str, source_number=None):
        '''send InnBucks to a user, destination_number must be of the form 263xxxxxxxxx, message must not exceed 160 characters.'''
    ...
    def send_mukuru(self, destination_number: str, message: str):
        '''send mukuru to a user, destination_number must be of the form 263xxxxxxxxx, message must not exceed 160 characters.'''
