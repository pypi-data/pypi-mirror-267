...
import typing
__all__ = ['Atom', 'AtomData', 'Bond', 'BondData', 'BondOrder', 'Element', 'Hyb', 'Isotope', 'Molecule', 'Mutator', 'Neighbor', 'PeriodicTable', 'ProxySubAtom', 'ProxySubBond', 'ProxySubNeighbor', 'ProxySubstructure', 'SubAtom', 'SubBond', 'SubNeighbor', 'Substructure', 'SubstructureCategory', 'SubstructureContainer', 'periodic_table']
class Atom:
    """
    ...
    def chiral(self) -> bool:
        ...
        """
    @chiral.setter
    def chiral(self, arg1: bool) -> None:
        ...
    @property
    ...
    def right_handed(self) -> bool:
        ...
        """
    @right_handed.setter
    def right_handed(self, arg1: bool) -> None:
        ...
    @property
    def ring(self) -> bool:
        """
...
class AtomData:
    ...
    def set_isotope(self, isotope: Isotope) -> AtomData:
        ...
        :param isotope: The isotope to set.
        """
    def update(self, *, hyb: Hyb | None = None, implicit_hydrogens: int | None = None, formal_charge: int | None = None, partial_charge: float | None = None, atomic_number: int | None = None, element: Element = None, aromatic: bool | None = None, conjugated: bool | None = None, ring: bool | None = None, chiral: bool | None = None, right_handed: bool | None = None, name: str | None = None) -> AtomData:
        """
        Update the atom data. If any of the arguments are not given, the corresponding
        property is not updated.
...
class Bond:
    ...
    def sqlen(self, conf: int = 0) -> float:
        ...
        """
    def update(self, *, order: BondOrder | None = None, aromatic: bool | None = None, conjugated: bool | None = None, ring: bool | None = None, trans: bool | None = None, name: str | None = None) -> Bond:
        """
...
class BondData:
    ...
    def rotable(self) -> bool:
        ...
        .. note::
          ...
          :data:`BondOrder.Other`, and the bond is not a conjugated or a ring bond.
        """
    def update(self, *, order: BondOrder | None = None, aromatic: bool | None = None, conjugated: bool | None = None, ring: bool | None = None, trans: bool | None = None, name: str | None = None) -> BondData:
        """
        Update the bond data. If any of the arguments are not given, the corresponding
        property is not updated.
        """
...
class ProxySubAtom:
    ...
    def set_pos(self, pos: typing.Any, conf: int = 0) -> None:
        ...
        :param conf: The index of the conformation to set the position to. Defaults to
          0.
        """
    def update(self, *, hyb: Hyb | None = None, implicit_hydrogens: int | None = None, formal_charge: int | None = None, partial_charge: float | None = None, atomic_number: int | None = None, element: Element = None, aromatic: bool | None = None, conjugated: bool | None = None, ring: bool | None = None, chiral: bool | None = None, right_handed: bool | None = None, name: str | None = None) -> ProxySubAtom:
        """
        Update the atom data. If any of the arguments are not given, the corresponding
        property is not updated.
...
class ProxySubBond:
    ...
    def sqlen(self, conf: int = 0) -> float:
        ...
        :returns: The square of the length of the bond.
        """
    def update(self, *, order: BondOrder | None = None, aromatic: bool | None = None, conjugated: bool | None = None, ring: bool | None = None, trans: bool | None = None, name: str | None = None) -> ProxySubBond:
        """
        Update the bond data. If any of the arguments are not given, the corresponding
        property is not updated.
        """
...
class SubAtom:
    ...
    def set_pos(self, pos: typing.Any, conf: int = 0) -> None:
        ...
        :param conf: The index of the conformation to set the position to. Defaults to
          0.
        """
    def update(self, *, hyb: Hyb | None = None, implicit_hydrogens: int | None = None, formal_charge: int | None = None, partial_charge: float | None = None, atomic_number: int | None = None, element: Element = None, aromatic: bool | None = None, conjugated: bool | None = None, ring: bool | None = None, chiral: bool | None = None, right_handed: bool | None = None, name: str | None = None) -> SubAtom:
        """
        Update the atom data. If any of the arguments are not given, the corresponding
        property is not updated.
...
class SubBond:
    ...
    def sqlen(self, conf: int = 0) -> float:
        ...
        :returns: The square of the length of the bond.
        """
    def update(self, *, order: BondOrder | None = None, aromatic: bool | None = None, conjugated: bool | None = None, ring: bool | None = None, trans: bool | None = None, name: str | None = None) -> SubBond:
        """
        Update the bond data. If any of the arguments are not given, the corresponding
        property is not updated.
        """
