...
from acceldata_sdk.constants import PolicyType, FailureStrategy, RuleExecutionStatus, MIN_TORCH_BACKEND_VERSION_FOR_RULE_ID_API
...
class TorchHttpClient(TorchClientInterFace, ABC):
    ...
    def get_policy(self, identifier) -> RuleResource:
        ...
        if Version(MIN_TORCH_BACKEND_VERSION_FOR_RULE_ID_API) in SimpleSpec(f'<={actual_version}'):
            ...
            raise TorchSdkException(f'This API is supported starting version: {self.MIN_TORCH_BACKEND_VERSION_FOR_RULE_ID_API}')
