...
"""
Code taken from https://github.com/maplightrx/MapLight-TDC/blob/main/maplight.py
Calculates a set of RDKit features, which together with a Catboost model, score consistently 
high on various TDC ADMET benchmarks, so replicating it here.
"""
