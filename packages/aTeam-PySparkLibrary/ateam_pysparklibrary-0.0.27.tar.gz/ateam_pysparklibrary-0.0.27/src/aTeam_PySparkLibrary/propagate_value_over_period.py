...
def propagate_value_over_period(storage_account_name, silver_path, new_silver_path,start_date_column_in_input_table, end_date_column_in_input_table, business_key_in_input_table, date_column_in_output_table,months_added_in_case_of_null_end_date,time_period, spark, debugBool = False):
