    ...
    with tempfile.TemporaryDirectory(dir=args.output.parent, prefix='tmp_pdfs-', delete=(not args.keep_intermediate)) as temp_dir:
        ...
        with ThreadPoolExecutor(max_workers=os.cpu_count()) as executor:
            ...
            for idx, file in enumerate(file_paths):
                ...
                executor.submit(process_image, file=file, output_filename=output_filename, idx=idx, args=args, global_palette=(color_palette, kmeans_model) if args.global_palette else None)
