...
class ModelRunner:
    ...
    def _prepare_decode(
        ...
        for seq_group_metadata in seq_group_metadata_list:
            ...
            for seq_id in seq_ids:
                ...
                if seq_group_metadata.block_tables is None:
                    # During pad mode(pad to same batch), the block tables are not initialized
                    # yet. In this case, we just use a dummy slot mapping.
    ...
    def _prepare_sample(
        ...
        for seq_group_metadata in seq_group_metadata_list:
            ...
            generators.append(seq_group_metadata.generator)
    ...
    def execute_model(
        ...
        # torch.save(hidden_states[-1,-1,:], "hdvllm" + str(hidden_states.size(1))+".pt")
