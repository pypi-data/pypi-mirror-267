...
def get_version():
    ...
    return get_distribution("xgw").version
...
@click.argument("password", type=click.STRING, default="mxchip-gateway-admin")
...
def info(ip: str, password: str, save: str) -> None:
    ...
    Arguments:
        ...
        PASSWORD: Password of the server, default is "mxchip-gateway-admin".

        -s/--save: save the home model to a file in JSON format.

    Example:

        $ xgw info 192.168.31.66 mxchip-gateway-admin
    """
...
def attr(ip: str, password: str, did: int, sid: int, typ: int, value: int) -> None:
    ...
    Example:
        ...
        $ xgw attr 192.168.31.66 mxchip-gateway-admin 66 0 256 1
    """
...
def scene(ip: str, password: str, sid: int) -> None:
    ...
    Example:
        ...
        $ xgw scene 192.168.31.66 mxchip-gateway-admin 6
    """
