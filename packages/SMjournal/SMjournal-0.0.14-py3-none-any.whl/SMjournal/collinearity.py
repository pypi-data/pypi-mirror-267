...
def collinearity_test(df1,tounderstand='not',distance="vif",match=False,threshold=0.7,streamlit=False,filter=0):   #full test of collinearity, corr-abs interesting
  ...
  # generate heatmap
  corrplot=sns.heatmap(finalCorr, annot=True, mask=mask, vmin=-1, vmax=1,cmap="rocket_r").set(title='Correlation Coefficient Of Predictors',rc={'axes.facecolor':'#fafafa', 'figure.facecolor':'#fafafa'})
