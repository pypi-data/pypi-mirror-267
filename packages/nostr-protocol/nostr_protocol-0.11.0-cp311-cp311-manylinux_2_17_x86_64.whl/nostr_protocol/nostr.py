...
def _uniffi_check_api_checksums(lib):
    if lib.uniffi_nostr_ffi_checksum_func_create_delegation_tag() != 41859:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_decrypt_received_private_zap_message() != 31929:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_decrypt_sent_private_zap_message() != 57065:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_func_generate_shared_key() != 16959:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_get_leading_zero_bits() != 55983:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_get_nip05_profile() != 19936:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_get_prefixes_for_difficulty() != 14470:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_gift_wrap() != 12272:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_nip04_decrypt() != 38491:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_nip04_encrypt() != 24648:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_nip44_decrypt() != 37647:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_nip44_encrypt() != 2053:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_nip57_anonymous_zap_request() != 51353:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_nip57_private_zap_request() != 31681:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_sign_delegation() != 10662:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_validate_delegation_tag() != 60898:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_verify_delegation_signature() != 52976:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_func_verify_nip05() != 8113:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_clientmessage_as_enum() != 33173:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_clientmessage_as_json() != 2801:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_contact_alias() != 19227:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_contact_public_key() != 12349:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_coordinate_identifier() != 48595:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_coordinate_kind() != 52111:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_coordinate_public_key() != 23569:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_encryptedsecretkey_to_bech32() != 47366:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_encryptedsecretkey_to_secret_key() != 45470:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_event_as_json() != 13177:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_event_author() != 55205:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_event_content() != 3434:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_event_coordinates() != 43155:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_event_created_at() != 20644:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_event_event_ids() != 22478:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_event_expiration() != 26242:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_event_id() != 64311:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_event_is_replaceable() != 57468:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_event_kind() != 15262:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_event_public_keys() != 37409:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_event_signature() != 11666:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_event_tags() != 47189:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_event_verify_signature() != 63925:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_eventbuilder_custom_created_at() != 25828:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_eventbuilder_to_event() != 27477:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_eventbuilder_to_pow_event() != 361:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_eventbuilder_to_unsigned_event() != 12334:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_eventbuilder_to_unsigned_pow_event() != 38142:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_eventid_to_nostr_uri() != 46695:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filemetadata_aes_256_gcm() != 47596:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filemetadata_blurhash() != 22155:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filemetadata_dimensions() != 43810:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filemetadata_magnet() != 19539:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filemetadata_size() != 25033:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_as_json() != 460:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_as_record() != 10817:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_author() != 2123:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_authors() != 56938:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_custom_tag() != 53153:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_event() != 9878:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_events() != 58098:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_hashtag() != 37311:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_hashtags() != 18297:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_id() != 44226:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_identifier() != 49862:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_identifiers() != 51204:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_ids() != 8911:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_is_empty() != 26481:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_kind() != 56023:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_kinds() != 58074:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_limit() != 10602:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_match_event() != 9337:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_pubkey() != 49251:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_pubkeys() != 54202:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_reference() != 5468:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_references() != 37241:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_remove_authors() != 19914:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_remove_custom_tag() != 9906:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_remove_events() != 12945:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_remove_hashtags() != 14229:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_remove_identifiers() != 54851:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_remove_ids() != 895:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_remove_kinds() != 46527:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_remove_limit() != 49122:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_remove_pubkeys() != 47794:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_remove_references() != 318:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_remove_search() != 51973:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_remove_since() != 41179:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_remove_until() != 8584:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_search() != 43387:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_since() != 59944:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_filter_until() != 519:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_imagedimensions_width() != 1901:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_keys_public_key() != 8351:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_keys_secret_key() != 10917:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_keys_sign_schnorr() != 38932:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_kind_as_enum() != 37013:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_kind_as_u64() != 13063:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_kind_match() != 5512:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_kind_match_enum() != 42538:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_kind_match_u64() != 59222:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_metadata_as_json() != 65508:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_metadata_as_record() != 14817:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_metadata_get_banner() != 8981:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_metadata_get_custom_field() != 46605:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_metadata_get_website() != 33949:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_metadata_set_about() != 51614:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_metadata_set_banner() != 24250:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_metadata_set_custom_field() != 55088:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_metadata_set_display_name() != 39071:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_metadata_set_lud06() != 14055:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_metadata_set_lud16() != 6913:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_metadata_set_name() != 17602:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_metadata_set_nip05() != 48621:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_metadata_set_picture() != 55880:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_metadata_set_website() != 21361:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_nip19_as_enum() != 16291:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_nip19event_author() != 18411:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_nip19event_event_id() != 2218:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_nip19event_to_nostr_uri() != 17113:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_nip19profile_public_key() != 57418:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_nostrconnectmetadata_as_json() != 44995:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_nostrconnectmetadata_description() != 20591:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_nostrconnectmetadata_icons() != 35460:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_nostrconnectmetadata_url() != 38230:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_nostrconnecturi_as_string() != 50623:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_nostrwalletconnecturi_lud16() != 46259:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_nostrwalletconnecturi_public_key() != 42711:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_nostrwalletconnecturi_relay_url() != 45352:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_nostrwalletconnecturi_secret() != 54573:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_publickey_to_nostr_uri() != 23126:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_rawevent_as_json() != 48986:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_rawevent_as_record() != 15974:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_relayinformationdocument_version() != 8680:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_relaymessage_as_enum() != 56517:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_relaymessage_as_json() != 58619:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_request_method() != 18547:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_request_params() != 61907:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_secretkey_encrypt() != 24648:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_shippingmethod_get_shipping_cost() != 1960:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_shippingmethod_name() != 29:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_shippingmethod_regions() != 17040:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_singlelettertag_is_uppercase() != 50218:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_stalldata_as_json() != 23354:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_stalldata_as_record() != 56802:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_stalldata_currency() != 47328:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_stalldata_description() != 56576:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_stalldata_id() != 41895:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_stalldata_name() != 14568:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_stalldata_shipping() != 57313:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_tag_as_enum() != 27944:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_tag_as_vec() != 44400:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_tag_is_reply() != 11447:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    ...
    if lib.uniffi_nostr_ffi_checksum_method_timestamp_to_human_datetime() != 33432:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_unsignedevent_add_signature() != 65391:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_unsignedevent_as_json() != 632:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_unsignedevent_author() != 15518:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_unsignedevent_content() != 59369:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_unsignedevent_created_at() != 52665:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_unsignedevent_id() != 59439:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_unsignedevent_kind() != 46769:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_unsignedevent_sign() != 52286:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_unsignedevent_tags() != 19159:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_unwrappedgift_rumor() != 18174:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_unwrappedgift_sender() != 36759:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_zaprequestdata_amount() != 57086:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_zaprequestdata_event_id() != 38377:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_zaprequestdata_lnurl() != 14270:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_method_zaprequestdata_message() != 22547:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_clientmessage_auth() != 52193:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_clientmessage_close() != 12730:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_clientmessage_count() != 17443:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_clientmessage_event() != 34212:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_clientmessage_from_enum() != 24237:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_clientmessage_from_json() != 23906:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_clientmessage_req() != 29877:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_contact_new() != 40535:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_coordinate_from_bech32() != 20802:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_coordinate_from_nostr_uri() != 29111:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_coordinate_new() != 12320:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_coordinate_parse() != 24703:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_encryptedsecretkey_from_bech32() != 48746:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_encryptedsecretkey_new() != 63240:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_event_from_json() != 25979:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_articles_curation_sets() != 16928:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_auth() != 34135:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_award_badge() != 36328:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_blocked_relays() != 35361:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_bookmarks() != 19909:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_bookmarks_sets() != 9871:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_channel() != 21301:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_channel_metadata() != 26640:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_channel_msg() != 46295:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_communities() != 13346:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_contact_list() != 9790:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_define_badge() != 2433:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_delete() != 13098:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_emoji_sets() != 12072:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_emojis() != 32679:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_encrypted_direct_msg() != 9960:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_file_metadata() != 5575:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_follow_sets() != 1429:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_hide_channel_msg() != 22099:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_http_auth() != 49716:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_interests() != 25709:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_job_feedback() != 60551:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_job_request() != 14465:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_job_result() != 58268:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_label() != 47535:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_live_event() != 34212:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_live_event_msg() != 9139:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_long_form_text_note() != 18893:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_metadata() != 35356:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_mute_channel_user() != 35702:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_mute_list() != 13594:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_new() != 11099:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_nostr_connect() != 41623:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_pinned_notes() != 22014:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_product_data() != 54242:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_profile_badges() != 824:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_public_chats() != 47562:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_public_zap_request() != 43070:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_reaction() != 45033:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_reaction_extended() != 18337:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_relay_list() != 8813:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_relay_sets() != 62101:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_report() != 49328:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_repost() != 58942:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_sealed_direct() != 15019:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_search_relays() != 35576:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_stall_data() != 52935:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_text_note() != 21682:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_text_note_reply() != 49537:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_videos_curation_sets() != 55053:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_zap_receipt() != 9732:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventid_from_bech32() != 58481:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventid_from_bytes() != 26070:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventid_from_hex() != 34860:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventid_from_nostr_uri() != 47915:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventid_new() != 31406:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_eventid_parse() != 31805:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_filemetadata_new() != 32554:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_filter_from_json() != 8004:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_filter_from_record() != 20357:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_filter_new() != 63951:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_imagedimensions_new() != 24393:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_keys_from_mnemonic() != 2337:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_keys_from_mnemonic_advanced() != 46078:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_keys_from_mnemonic_with_account() != 844:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_keys_from_public_key() != 57552:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_keys_generate() != 34326:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_keys_new() != 32326:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_keys_parse() != 16239:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_keys_vanity() != 20910:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_kind_from_enum() != 24008:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_kind_new() != 54771:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_metadata_from_json() != 45694:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_metadata_from_record() != 39316:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_metadata_new() != 37576:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_nip19_from_bech32() != 25248:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_nip19event_from_bech32() != 50101:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_nip19event_from_nostr_uri() != 60241:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_nip19event_new() != 28597:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_nip19profile_from_bech32() != 30442:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_nip19profile_from_nostr_uri() != 33427:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_nip19profile_new() != 3173:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_nip21_parse() != 30203:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_nostrconnectmetadata_new() != 37150:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_nostrconnecturi_parse() != 49790:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_nostrlibrary_new() != 54546:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_nostrwalletconnecturi_new() != 64158:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_nostrwalletconnecturi_parse() != 62225:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_publickey_from_bech32() != 16497:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_publickey_from_bytes() != 15604:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_publickey_from_hex() != 21577:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_publickey_from_nostr_uri() != 21697:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_publickey_parse() != 1285:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_rawevent_from_json() != 26027:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_rawevent_from_record() != 51955:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_relayinformationdocument_get() != 5776:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_relayinformationdocument_new() != 46265:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_relaymessage_auth() != 29124:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_relaymessage_closed() != 55009:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_relaymessage_count() != 42279:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_relaymessage_eose() != 10440:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_relaymessage_event() != 24541:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_relaymessage_from_enum() != 62038:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_relaymessage_from_json() != 21031:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_relaymessage_notice() != 34446:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_relaymessage_ok() != 17767:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_request_new() != 59137:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_request_parse() != 35736:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_secretkey_from_bech32() != 57257:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_secretkey_from_bytes() != 61333:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_secretkey_from_hex() != 11652:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_secretkey_parse() != 23943:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_shippingmethod_new() != 65060:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_singlelettertag_lowercase() != 59471:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_singlelettertag_uppercase() != 23850:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_stalldata_from_json() != 22214:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_stalldata_from_record() != 38214:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_stalldata_new() != 34499:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_event() != 55763:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_from_enum() != 5202:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_parse() != 22845:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_tag_public_key() != 29803:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_timestamp_from_secs() != 46579:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_timestamp_now() != 63297:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_timestamp_tweaked() != 15983:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_unsignedevent_from_json() != 39161:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_unwrappedgift_from_gift_wrap() != 32822:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_nostr_ffi_checksum_constructor_zaprequestdata_new() != 55311:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
_UniffiLib.uniffi_nostr_ffi_fn_clone_clientmessage.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_clone_clientmessage.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_free_clientmessage.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_free_clientmessage.restype = None
_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_auth.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_auth.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_close.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_close.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_count.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_count.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_event.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_event.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_from_enum.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_from_enum.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_from_json.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_from_json.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_req.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_req.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_as_enum.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_as_enum.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_as_json.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_as_json.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_uniffi_trait_eq_ne.restype = ctypes.c_int8
...
_UniffiLib.uniffi_nostr_ffi_fn_method_contact_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_contact_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_contact_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_contact_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_contact_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_contact_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_contact_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_contact_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_method_coordinate_kind.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_method_coordinate_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_coordinate_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_coordinate_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_coordinate_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_coordinate_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_coordinate_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_coordinate_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_coordinate_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_method_encryptedsecretkey_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_encryptedsecretkey_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_encryptedsecretkey_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_encryptedsecretkey_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_encryptedsecretkey_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_encryptedsecretkey_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_encryptedsecretkey_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_encryptedsecretkey_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_method_event_kind.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_method_event_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_event_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_event_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_event_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_event_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_event_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_event_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_event_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_articles_curation_sets.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_articles_curation_sets.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_blocked_relays.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_blocked_relays.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_bookmarks.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_bookmarks.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_bookmarks_sets.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_bookmarks_sets.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_communities.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_communities.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_emoji_sets.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_emoji_sets.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_emojis.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_emojis.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_follow_sets.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_follow_sets.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_interests.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_interests.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_label.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_label.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_mute_list.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_mute_list.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_pinned_notes.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_pinned_notes.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_public_chats.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_public_chats.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_reaction_extended.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.c_void_p,
    _UniffiRustBuffer,
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_reaction_extended.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_relay_sets.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_relay_sets.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_search_relays.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_search_relays.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_text_note_reply.argtypes = (
    _UniffiRustBuffer,
    ctypes.c_void_p,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_text_note_reply.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_videos_curation_sets.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_videos_curation_sets.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_method_eventbuilder_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_eventbuilder_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_eventbuilder_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_eventbuilder_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_eventbuilder_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_eventbuilder_uniffi_trait_eq_ne.restype = ctypes.c_int8
...
_UniffiLib.uniffi_nostr_ffi_fn_method_eventid_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_eventid_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_eventid_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_eventid_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_eventid_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_eventid_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_eventid_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_eventid_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_method_filemetadata_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_filemetadata_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_filemetadata_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_filemetadata_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_filemetadata_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_filemetadata_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_filemetadata_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_filemetadata_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_filter_from_record.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_filter_from_record.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_method_filter_as_record.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_filter_as_record.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_nostr_ffi_fn_method_filter_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_filter_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_filter_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_filter_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_filter_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_filter_uniffi_trait_eq_ne.restype = ctypes.c_int8
...
_UniffiLib.uniffi_nostr_ffi_fn_method_imagedimensions_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_imagedimensions_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_imagedimensions_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_imagedimensions_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_imagedimensions_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_imagedimensions_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_imagedimensions_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_imagedimensions_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_keys_from_mnemonic_advanced.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_keys_from_mnemonic_advanced.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_keys_from_mnemonic_with_account.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_keys_from_mnemonic_with_account.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_method_keys_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_keys_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_keys_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_keys_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_keys_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_keys_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_clone_kind.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_clone_kind.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_free_kind.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_free_kind.restype = None
_UniffiLib.uniffi_nostr_ffi_fn_constructor_kind_from_enum.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_kind_from_enum.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_kind_new.argtypes = (
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_kind_new.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_as_enum.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_as_enum.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_as_u64.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_as_u64.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_match.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_match.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_match_enum.argtypes = (
    ctypes.c_void_p,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_match_enum.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_match_u64.argtypes = (
    ctypes.c_void_p,
    ctypes.c_uint64,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_match_u64.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_kind_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_metadata_from_record.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_metadata_from_record.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_as_record.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_as_record.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_uniffi_trait_eq_ne.restype = ctypes.c_int8
...
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19_uniffi_trait_eq_ne.restype = ctypes.c_int8
...
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19event_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19event_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19event_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19event_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19event_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19event_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19event_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19event_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19profile_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19profile_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19profile_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19profile_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19profile_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19profile_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19profile_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nip19profile_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_method_nip21_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nip21_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_nip21_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nip21_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_nip21_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nip21_uniffi_trait_eq_ne.restype = ctypes.c_int8
...
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnectmetadata_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnectmetadata_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnectmetadata_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnectmetadata_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnectmetadata_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnectmetadata_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnectmetadata_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnectmetadata_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_nostrconnecturi_parse.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_nostrconnecturi_parse.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnecturi_as_string.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnecturi_as_string.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnecturi_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnecturi_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnecturi_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnecturi_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnecturi_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnecturi_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnecturi_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnecturi_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrwalletconnecturi_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrwalletconnecturi_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrwalletconnecturi_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrwalletconnecturi_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrwalletconnecturi_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_nostrwalletconnecturi_uniffi_trait_eq_ne.restype = ctypes.c_int8
...
_UniffiLib.uniffi_nostr_ffi_fn_method_publickey_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_publickey_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_publickey_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_publickey_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_publickey_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_publickey_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_publickey_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_publickey_uniffi_trait_hash.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_ffi_fn_clone_rawevent.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_clone_rawevent.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_free_rawevent.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_free_rawevent.restype = None
_UniffiLib.uniffi_nostr_ffi_fn_constructor_rawevent_from_json.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_rawevent_from_json.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_rawevent_from_record.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_rawevent_from_record.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_as_json.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_as_json.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_as_record.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_as_record.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_method_relayinformationdocument_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_relayinformationdocument_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_relayinformationdocument_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_relayinformationdocument_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_relayinformationdocument_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_relayinformationdocument_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_relayinformationdocument_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_relayinformationdocument_uniffi_trait_hash.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_ffi_fn_clone_relaymessage.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_clone_relaymessage.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_free_relaymessage.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_free_relaymessage.restype = None
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_auth.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_auth.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_closed.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_closed.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_count.argtypes = (
    _UniffiRustBuffer,
    ctypes.c_double,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_count.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_eose.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_eose.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_event.argtypes = (
    _UniffiRustBuffer,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_event.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_from_enum.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_from_enum.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_from_json.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_from_json.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_notice.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_notice.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_ok.argtypes = (
    ctypes.c_void_p,
    ctypes.c_int8,
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_ok.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_as_enum.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_as_enum.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_as_json.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_as_json.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_method_request_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_request_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_request_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_request_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_request_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_request_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_request_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_request_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_method_response_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_response_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_response_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_response_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_response_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_response_uniffi_trait_eq_ne.restype = ctypes.c_int8
...
_UniffiLib.uniffi_nostr_ffi_fn_method_secretkey_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_secretkey_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_secretkey_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_secretkey_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_secretkey_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_secretkey_uniffi_trait_eq_ne.restype = ctypes.c_int8
...
_UniffiLib.uniffi_nostr_ffi_fn_method_singlelettertag_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_singlelettertag_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_singlelettertag_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_singlelettertag_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_singlelettertag_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_singlelettertag_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_singlelettertag_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_singlelettertag_uniffi_trait_hash.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_ffi_fn_clone_stalldata.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_clone_stalldata.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_free_stalldata.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_free_stalldata.restype = None
_UniffiLib.uniffi_nostr_ffi_fn_constructor_stalldata_from_json.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_stalldata_from_json.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_stalldata_from_record.argtypes = (
    _UniffiRustBuffer,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_stalldata_from_record.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_constructor_stalldata_new.argtypes = (
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
    _UniffiRustBuffer,
...
_UniffiLib.uniffi_nostr_ffi_fn_constructor_stalldata_new.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_as_json.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_as_json.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_as_record.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_as_record.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_currency.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_currency.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_description.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_description.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_id.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_id.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_name.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_name.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_shipping.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_shipping.restype = _UniffiRustBuffer
...
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_is_reply.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_is_reply.restype = ctypes.c_int8
...
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_tag_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_method_timestamp_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_timestamp_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_timestamp_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_timestamp_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_timestamp_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_timestamp_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_timestamp_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_timestamp_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_id.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_kind.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_kind.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_uniffi_trait_hash.restype = ctypes.c_uint64
_UniffiLib.uniffi_nostr_ffi_fn_clone_unwrappedgift.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_clone_unwrappedgift.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_free_unwrappedgift.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_free_unwrappedgift.restype = None
_UniffiLib.uniffi_nostr_ffi_fn_constructor_unwrappedgift_from_gift_wrap.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_constructor_unwrappedgift_from_gift_wrap.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_rumor.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_rumor.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_sender.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_sender.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_method_zaprequestdata_uniffi_trait_debug.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_zaprequestdata_uniffi_trait_debug.restype = _UniffiRustBuffer
_UniffiLib.uniffi_nostr_ffi_fn_method_zaprequestdata_uniffi_trait_eq_eq.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_zaprequestdata_uniffi_trait_eq_eq.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_zaprequestdata_uniffi_trait_eq_ne.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_zaprequestdata_uniffi_trait_eq_ne.restype = ctypes.c_int8
_UniffiLib.uniffi_nostr_ffi_fn_method_zaprequestdata_uniffi_trait_hash.argtypes = (
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_method_zaprequestdata_uniffi_trait_hash.restype = ctypes.c_uint64
...
_UniffiLib.uniffi_nostr_ffi_fn_func_decrypt_received_private_zap_message.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_func_decrypt_received_private_zap_message.restype = ctypes.c_void_p
_UniffiLib.uniffi_nostr_ffi_fn_func_decrypt_sent_private_zap_message.argtypes = (
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.c_void_p,
    ctypes.POINTER(_UniffiRustCallStatus),
)
_UniffiLib.uniffi_nostr_ffi_fn_func_decrypt_sent_private_zap_message.restype = ctypes.c_void_p
...
_UniffiLib.uniffi_nostr_ffi_checksum_func_decrypt_received_private_zap_message.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_func_decrypt_received_private_zap_message.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_func_decrypt_sent_private_zap_message.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_func_decrypt_sent_private_zap_message.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_method_clientmessage_as_enum.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_clientmessage_as_enum.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_method_clientmessage_as_json.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_clientmessage_as_json.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_method_filter_as_record.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_filter_as_record.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_method_kind_as_enum.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_kind_as_enum.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_method_kind_as_u64.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_kind_as_u64.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_method_kind_match.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_kind_match.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_method_kind_match_enum.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_kind_match_enum.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_method_kind_match_u64.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_kind_match_u64.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_method_metadata_as_record.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_metadata_as_record.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_method_nostrconnecturi_as_string.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_nostrconnecturi_as_string.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_method_rawevent_as_json.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_rawevent_as_json.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_method_rawevent_as_record.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_rawevent_as_record.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_method_relaymessage_as_enum.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_relaymessage_as_enum.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_method_relaymessage_as_json.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_relaymessage_as_json.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_method_stalldata_as_json.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_stalldata_as_json.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_method_stalldata_as_record.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_stalldata_as_record.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_method_stalldata_currency.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_stalldata_currency.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_method_stalldata_description.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_stalldata_description.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_method_stalldata_id.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_stalldata_id.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_method_stalldata_name.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_stalldata_name.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_method_stalldata_shipping.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_stalldata_shipping.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_method_tag_is_reply.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_tag_is_reply.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_method_unwrappedgift_rumor.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_unwrappedgift_rumor.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_method_unwrappedgift_sender.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_method_unwrappedgift_sender.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_clientmessage_auth.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_clientmessage_auth.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_clientmessage_close.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_clientmessage_close.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_clientmessage_count.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_clientmessage_count.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_clientmessage_event.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_clientmessage_event.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_clientmessage_from_enum.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_clientmessage_from_enum.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_clientmessage_from_json.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_clientmessage_from_json.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_clientmessage_req.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_clientmessage_req.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_articles_curation_sets.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_articles_curation_sets.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_blocked_relays.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_blocked_relays.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_bookmarks.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_bookmarks.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_bookmarks_sets.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_bookmarks_sets.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_communities.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_communities.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_emoji_sets.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_emoji_sets.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_emojis.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_emojis.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_follow_sets.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_follow_sets.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_interests.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_interests.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_label.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_label.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_mute_list.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_mute_list.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_pinned_notes.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_pinned_notes.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_public_chats.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_public_chats.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_reaction_extended.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_reaction_extended.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_relay_sets.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_relay_sets.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_search_relays.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_search_relays.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_text_note_reply.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_text_note_reply.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_videos_curation_sets.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_eventbuilder_videos_curation_sets.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_filter_from_record.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_filter_from_record.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_keys_from_mnemonic_advanced.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_keys_from_mnemonic_advanced.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_keys_from_mnemonic_with_account.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_keys_from_mnemonic_with_account.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_kind_from_enum.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_kind_from_enum.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_kind_new.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_kind_new.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_metadata_from_record.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_metadata_from_record.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_nostrconnecturi_parse.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_nostrconnecturi_parse.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_rawevent_from_json.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_rawevent_from_json.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_rawevent_from_record.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_rawevent_from_record.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_auth.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_auth.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_closed.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_closed.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_count.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_count.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_eose.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_eose.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_event.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_event.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_from_enum.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_from_enum.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_from_json.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_from_json.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_notice.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_notice.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_ok.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_relaymessage_ok.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_stalldata_from_json.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_stalldata_from_json.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_stalldata_from_record.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_stalldata_from_record.restype = ctypes.c_uint16
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_stalldata_new.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_stalldata_new.restype = ctypes.c_uint16
...
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_unwrappedgift_from_gift_wrap.argtypes = (
)
_UniffiLib.uniffi_nostr_ffi_checksum_constructor_unwrappedgift_from_gift_wrap.restype = ctypes.c_uint16
...
class ClientMessage:
    ...
    def __del__(self):
        ...
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_free_clientmessage, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_clone_clientmessage, self._pointer)
    ...
    def auth(cls, event: "Event"):
        ...
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_auth,
    ...
    def close(cls, subscription_id: "str"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_close,
        _UniffiConverterString.lower(subscription_id))
        return cls._make_instance_(pointer)


    @classmethod
    def count(cls, subscription_id: "str",filters: "typing.List[Filter]"):
        """
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_count,
        _UniffiConverterString.lower(subscription_id),
    ...
    def event(cls, event: "Event"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_event,
        _UniffiConverterTypeEvent.lower(event))
        return cls._make_instance_(pointer)
    ...
    def from_enum(cls, e: "ClientMessageEnum"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_from_enum,
    ...
    def from_json(cls, json: "str"):
        ...
        **This method NOT verify the event signature!**
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_from_json,
        _UniffiConverterString.lower(json))
        return cls._make_instance_(pointer)


    @classmethod
    def req(cls, subscription_id: "str",filters: "typing.List[Filter]"):
        """
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_clientmessage_req,
        _UniffiConverterString.lower(subscription_id),
        _UniffiConverterSequenceTypeFilter.lower(filters))
        return cls._make_instance_(pointer)
    ...
    def as_enum(self, ) -> "ClientMessageEnum":
        ...
        return _UniffiConverterTypeClientMessageEnum.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_as_enum,self._uniffi_clone_pointer(),)
        )
    ...
    def as_json(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_as_json,self._uniffi_clone_pointer(),)
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_clientmessage_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeClientMessage.lower(other)))
...
class Contact:
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_contact_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_contact_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
        _UniffiConverterTypeContact.lower(other)))

    def __ne__(self, other: object) -> bool:
        if not isinstance(other, Contact):
            return NotImplemented

        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_contact_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeContact.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_contact_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class Coordinate:
    ...
    _pointer: ctypes.c_void_p
    def __init__(self, kind: "Kind",public_key: "PublicKey"):
    ...
    def to_bech32(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_coordinate_to_bech32,self._uniffi_clone_pointer(),)
        )
    ...
    def to_nostr_uri(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_coordinate_to_nostr_uri,self._uniffi_clone_pointer(),)
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_coordinate_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_coordinate_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_coordinate_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeCoordinate.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_coordinate_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class EncryptedSecretKey:
    ...
    def to_bech32(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_encryptedsecretkey_to_bech32,self._uniffi_clone_pointer(),)
        )
    ...
    def to_secret_key(self, password: "str") -> "SecretKey":
        ...
        return _UniffiConverterTypeSecretKey.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_encryptedsecretkey_to_secret_key,self._uniffi_clone_pointer(),
        _UniffiConverterString.lower(password))
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_encryptedsecretkey_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_encryptedsecretkey_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_encryptedsecretkey_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeEncryptedSecretKey.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_encryptedsecretkey_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class Event:
    ...
    def verify_id(self, ) -> None:
        ...
        _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_event_verify_id,self._uniffi_clone_pointer(),)
    ...
    def verify_signature(self, ) -> None:
        ...
        _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_event_verify_signature,self._uniffi_clone_pointer(),)
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_event_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_event_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_event_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeEvent.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_event_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class EventBuilder:
    _pointer: ctypes.c_void_p
    def __init__(self, kind: "Kind",content: "str",tags: "typing.List[Tag]"):
        _UniffiConverterTypeKind.check_lower(kind)
        ...
        self._pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_new,
        _UniffiConverterTypeKind.lower(kind),
    ...
    @classmethod
    def articles_curation_sets(cls, list: "ArticlesCuration"):
        """
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_articles_curation_sets,
    ...
    @classmethod
    def blocked_relays(cls, relay: "typing.List[str]"):
        """
        Blocked relays
        ...
        _UniffiConverterSequenceString.check_lower(relay)
        
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_blocked_relays,
        _UniffiConverterSequenceString.lower(relay))
        return cls._make_instance_(pointer)
    ...
    def bookmarks(cls, list: "Bookmarks"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_bookmarks,
        _UniffiConverterTypeBookmarks.lower(list))
        return cls._make_instance_(pointer)


    @classmethod
    def bookmarks_sets(cls, list: "Bookmarks"):
        """
        Bookmark sets
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_bookmarks_sets,
        _UniffiConverterTypeBookmarks.lower(list))
        return cls._make_instance_(pointer)
    ...
    def communities(cls, communities: "typing.List[Coordinate]"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_communities,
    ...
    @classmethod
    def emoji_sets(cls, emojis: "typing.List[EmojiInfo]"):
        """
        Emoji sets
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_emoji_sets,
    ...
    def emojis(cls, list: "Emojis"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_emojis,
    ...
    @classmethod
    def follow_sets(cls, publick_keys: "typing.List[PublicKey]"):
        """
        Follow sets
        ...
        _UniffiConverterSequenceTypePublicKey.check_lower(publick_keys)
        
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_follow_sets,
        _UniffiConverterSequenceTypePublicKey.lower(publick_keys))
        return cls._make_instance_(pointer)
    ...
    def interests(cls, list: "Interests"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_interests,
    ...
    @classmethod
    def job_request(cls, kind: "Kind",tags: "typing.List[Tag]"):
        """
    ...
    @classmethod
    def label(cls, label_namespace: "str",labels: "typing.List[str]"):
        """
        Label
        ...
        _UniffiConverterSequenceString.check_lower(labels)
        
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_label,
        _UniffiConverterString.lower(label_namespace),
        _UniffiConverterSequenceString.lower(labels))
        return cls._make_instance_(pointer)
    ...
    def long_form_text_note(cls, content: "str",tags: "typing.List[Tag]"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_long_form_text_note,
        _UniffiConverterString.lower(content),
        _UniffiConverterSequenceTypeTag.lower(tags))
        return cls._make_instance_(pointer)
    ...
    def mute_list(cls, list: "MuteList"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_mute_list,
    ...
    def pinned_notes(cls, ids: "typing.List[EventId]"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_pinned_notes,
        _UniffiConverterSequenceTypeEventId.lower(ids))
        return cls._make_instance_(pointer)
    ...
    def public_chats(cls, chat: "typing.List[EventId]"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_public_chats,
    ...
    @classmethod
    def reaction_extended(cls, event_id: "EventId",public_key: "PublicKey",kind: "Kind",reaction: "str"):
        """
        Add reaction (like/upvote, dislike/downvote or emoji) to an event
        """
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_reaction_extended,
    ...
    @classmethod
    def relay_list(cls, list: "dict[str, typing.Optional[RelayMetadata]]"):
    ...
    @classmethod
    def relay_sets(cls, relay: "typing.List[str]"):
        """
        Relay sets
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_relay_sets,
        _UniffiConverterSequenceString.lower(relay))
        return cls._make_instance_(pointer)
    ...
    @classmethod
    def repost(cls, event: "Event",relay_url: "typing.Optional[str]"):
        _UniffiConverterTypeEvent.check_lower(event)
    ...
    @classmethod
    def search_relays(cls, relay: "typing.List[str]"):
        """
        Search relays
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_search_relays,
        _UniffiConverterSequenceString.lower(relay))
        return cls._make_instance_(pointer)
    ...
    def text_note(cls, content: "str",tags: "typing.List[Tag]"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_text_note,
        _UniffiConverterString.lower(content),
        _UniffiConverterSequenceTypeTag.lower(tags))
        return cls._make_instance_(pointer)
    ...
    @classmethod
    def text_note_reply(cls, content: "str",reply_to: "Event",root: "typing.Optional[Event]",relay_url: "typing.Optional[str]"):
        """
        Text note reply
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_text_note_reply,
        _UniffiConverterString.lower(content),
    ...
    @classmethod
    def videos_curation_sets(cls, video: "typing.List[Coordinate]"):
        """
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_eventbuilder_videos_curation_sets,
    ...
    def to_event(self, keys: "Keys") -> "Event":
        ...
        return _UniffiConverterTypeEvent.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_eventbuilder_to_event,self._uniffi_clone_pointer(),
    ...
    def to_pow_event(self, keys: "Keys",difficulty: "int") -> "Event":
        ...
        return _UniffiConverterTypeEvent.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_eventbuilder_to_pow_event,self._uniffi_clone_pointer(),
        _UniffiConverterTypeKeys.lower(keys),
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_eventbuilder_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_eventbuilder_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_eventbuilder_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeEventBuilder.lower(other)))
...
class EventId:
    _pointer: ctypes.c_void_p
    def __init__(self, public_key: "PublicKey",created_at: "Timestamp",kind: "Kind",tags: "typing.List[Tag]",content: "str"):
        _UniffiConverterTypePublicKey.check_lower(public_key)
    ...
    def to_bech32(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_eventid_to_bech32,self._uniffi_clone_pointer(),)
        )
    ...
    def to_nostr_uri(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_eventid_to_nostr_uri,self._uniffi_clone_pointer(),)
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_eventid_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_eventid_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_eventid_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeEventId.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_eventid_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class FileMetadata:
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_filemetadata_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_filemetadata_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_filemetadata_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeFileMetadata.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_filemetadata_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class Filter:
    ...
    def from_record(cls, record: "FilterRecord"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_filter_from_record,
    ...
    def as_record(self, ) -> "FilterRecord":
        return _UniffiConverterTypeFilterRecord.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_filter_as_record,self._uniffi_clone_pointer(),)
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_filter_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_filter_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_filter_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeFilter.lower(other)))
...
class ImageDimensions:
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_imagedimensions_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_imagedimensions_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
        _UniffiConverterTypeImageDimensions.lower(other)))

    def __ne__(self, other: object) -> bool:
        if not isinstance(other, ImageDimensions):
            return NotImplemented

        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_imagedimensions_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeImageDimensions.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_imagedimensions_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class Keys:
    ...
    @classmethod
    def from_mnemonic(cls, mnemonic: "str",passphrase: "typing.Optional[str]"):
        """
    ...
    @classmethod
    def from_mnemonic_advanced(cls, mnemonic: "str",passphrase: "typing.Optional[str]",account: "typing.Optional[int]",typ: "typing.Optional[int]",index: "typing.Optional[int]"):
        """
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_constructor_keys_from_mnemonic_advanced,
        _UniffiConverterString.lower(mnemonic),
        _UniffiConverterOptionalString.lower(passphrase),
    ...
    @classmethod
    def from_mnemonic_with_account(cls, mnemonic: "str",passphrase: "typing.Optional[str]",account: "typing.Optional[int]"):
        """
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_constructor_keys_from_mnemonic_with_account,
        _UniffiConverterString.lower(mnemonic),
        _UniffiConverterOptionalString.lower(passphrase),
        _UniffiConverterOptionalUInt32.lower(account))
        return cls._make_instance_(pointer)
    ...
    @classmethod
    def from_public_key(cls, public_key: "PublicKey"):
        _UniffiConverterTypePublicKey.check_lower(public_key)
    ...
    def secret_key(self, ) -> "SecretKey":
        return _UniffiConverterTypeSecretKey.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_keys_secret_key,self._uniffi_clone_pointer(),)
        )
    ...
    def sign_schnorr(self, message: "bytes") -> "str":
        ...
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_keys_sign_schnorr,self._uniffi_clone_pointer(),
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_keys_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_keys_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_keys_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeKeys.lower(other)))
...
class KindProtocol(typing.Protocol):
    ...
    * `kind1.match_enum(KindEnum.TEXT_NOTE())` or `kind1.as_enum() = KindEnum.TEXT_NOTE()`
    ...
    def as_u64(self, ):
        raise NotImplementedError
    def match(self, other: "Kind"):
        """
        Check if `Kind` match another `Kind`
        """

        raise NotImplementedError
    def match_enum(self, e: "KindEnum"):
        """
        Check if `Kind` match `KindEnum`
        """

        raise NotImplementedError
    def match_u64(self, kind: "int"):
        """
...
class Kind:
    ...
    * `kind1.match_enum(KindEnum.TEXT_NOTE())` or `kind1.as_enum() = KindEnum.TEXT_NOTE()`
    ...
    def __init__(self, kind: "int"):
        ...
        self._pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_kind_new,
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_free_kind, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_clone_kind, self._pointer)
    ...
    @classmethod
    def from_enum(cls, e: "KindEnum"):
        _UniffiConverterTypeKindEnum.check_lower(e)
        
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_kind_from_enum,
        _UniffiConverterTypeKindEnum.lower(e))
        return cls._make_instance_(pointer)



    def as_enum(self, ) -> "KindEnum":
        return _UniffiConverterTypeKindEnum.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_kind_as_enum,self._uniffi_clone_pointer(),)
        )
    ...
    def as_u64(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_kind_as_u64,self._uniffi_clone_pointer(),)
        )
    ...
    def match(self, other: "Kind") -> "bool":
        """
        Check if `Kind` match another `Kind`
        """

        _UniffiConverterTypeKind.check_lower(other)
        
        return _UniffiConverterBool.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_kind_match,self._uniffi_clone_pointer(),
    ...
    def match_enum(self, e: "KindEnum") -> "bool":
        """
        Check if `Kind` match `KindEnum`
        """
        ...
        return _UniffiConverterBool.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_kind_match_enum,self._uniffi_clone_pointer(),
        _UniffiConverterTypeKindEnum.lower(e))
        )
    ...
    def match_u64(self, kind: "int") -> "bool":
        """
        Check if `Kind` match `u64`
        """
        ...
        return _UniffiConverterBool.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_kind_match_u64,self._uniffi_clone_pointer(),
        _UniffiConverterUInt64.lower(kind))
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_kind_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_kind_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
        _UniffiConverterTypeKind.lower(other)))
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_kind_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeKind.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_kind_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class Metadata:
    ...
    def from_record(cls, r: "MetadataRecord"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_metadata_from_record,
    ...
    def as_record(self, ) -> "MetadataRecord":
        return _UniffiConverterTypeMetadataRecord.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_as_record,self._uniffi_clone_pointer(),)
        )
    ...
    def get_custom_field(self, key: "str") -> "typing.Optional[JsonValue]":
        ...
        return _UniffiConverterOptionalTypeJsonValue.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_get_custom_field,self._uniffi_clone_pointer(),
        _UniffiConverterString.lower(key))
        )
    ...
    def set_banner(self, banner: "str") -> "Metadata":
        ...
        return _UniffiConverterTypeMetadata.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_set_banner,self._uniffi_clone_pointer(),
    ...
    def set_custom_field(self, key: "str",value: "JsonValue") -> "Metadata":
        ...
        return _UniffiConverterTypeMetadata.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_set_custom_field,self._uniffi_clone_pointer(),
        _UniffiConverterString.lower(key),
    ...
    def set_picture(self, picture: "str") -> "Metadata":
        ...
        return _UniffiConverterTypeMetadata.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_set_picture,self._uniffi_clone_pointer(),
    ...
    def set_website(self, website: "str") -> "Metadata":
        ...
        return _UniffiConverterTypeMetadata.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_set_website,self._uniffi_clone_pointer(),
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_metadata_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeMetadata.lower(other)))
...
class Nip19:
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nip19_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nip19_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nip19_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeNip19.lower(other)))
...
class Nip19Event:
    ...
    def to_bech32(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_nip19event_to_bech32,self._uniffi_clone_pointer(),)
        )
    ...
    def to_nostr_uri(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_nip19event_to_nostr_uri,self._uniffi_clone_pointer(),)
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nip19event_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nip19event_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nip19event_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeNip19Event.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nip19event_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class Nip19Profile:
    ...
    def __init__(self, public_key: "PublicKey",relays: "typing.List[str]"):
        ...
        self._pointer = _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_constructor_nip19profile_new,
        _UniffiConverterTypePublicKey.lower(public_key),
        _UniffiConverterSequenceString.lower(relays))
    ...
    def to_bech32(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_nip19profile_to_bech32,self._uniffi_clone_pointer(),)
        )
    ...
    def to_nostr_uri(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_nip19profile_to_nostr_uri,self._uniffi_clone_pointer(),)
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nip19profile_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nip19profile_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nip19profile_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeNip19Profile.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nip19profile_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class Nip21:
    ...
    def to_nostr_uri(self, ) -> "str":
        ...
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_nip21_to_nostr_uri,self._uniffi_clone_pointer(),)
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nip21_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nip21_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nip21_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeNip21.lower(other)))
...
class NostrConnectMetadata:
    ...
    def url(self, url: "str") -> "NostrConnectMetadata":
        ...
        return _UniffiConverterTypeNostrConnectMetadata.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnectmetadata_url,self._uniffi_clone_pointer(),
        _UniffiConverterString.lower(url))
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnectmetadata_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnectmetadata_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnectmetadata_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeNostrConnectMetadata.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnectmetadata_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class NostrConnectUri:
    ...
    def parse(cls, uri: "str"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_constructor_nostrconnecturi_parse,
        _UniffiConverterString.lower(uri))
        return cls._make_instance_(pointer)
    ...
    def as_string(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnecturi_as_string,self._uniffi_clone_pointer(),)
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnecturi_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnecturi_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnecturi_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeNostrConnectURI.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nostrconnecturi_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class NostrWalletConnectUri:
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nostrwalletconnecturi_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nostrwalletconnecturi_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_nostrwalletconnecturi_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeNostrWalletConnectURI.lower(other)))
...
class PublicKey:
    ...
    def to_bech32(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_publickey_to_bech32,self._uniffi_clone_pointer(),)
        )
    ...
    def to_nostr_uri(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_publickey_to_nostr_uri,self._uniffi_clone_pointer(),)
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_publickey_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_publickey_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_publickey_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypePublicKey.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_publickey_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class RawEventProtocol(typing.Protocol):
    def as_json(self, ):
        raise NotImplementedError
    def as_record(self, ):
        raise NotImplementedError
...
class RawEvent:
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_free_rawevent, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_clone_rawevent, self._pointer)
    ...
    def from_json(cls, json: "str"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_constructor_rawevent_from_json,
        _UniffiConverterString.lower(json))
        return cls._make_instance_(pointer)


    @classmethod
    def from_record(cls, r: "RawEventRecord"):
        _UniffiConverterTypeRawEventRecord.check_lower(r)
        
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_rawevent_from_record,
        _UniffiConverterTypeRawEventRecord.lower(r))
        return cls._make_instance_(pointer)
    ...
    def as_json(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_as_json,self._uniffi_clone_pointer(),)
        )
    ...
    def as_record(self, ) -> "RawEventRecord":
        return _UniffiConverterTypeRawEventRecord.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_as_record,self._uniffi_clone_pointer(),)
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )



    def __eq__(self, other: object) -> bool:
        if not isinstance(other, RawEvent):
            return NotImplemented

        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
        _UniffiConverterTypeRawEvent.lower(other)))

    def __ne__(self, other: object) -> bool:
        if not isinstance(other, RawEvent):
            return NotImplemented

        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeRawEvent.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_rawevent_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class _UniffiConverterTypeRawEvent:

    @staticmethod
    def lift(value: int):
        return RawEvent._make_instance_(value)

    @staticmethod
    def check_lower(value: RawEvent):
        if not isinstance(value, RawEvent):
            raise TypeError("Expected RawEvent instance, {} found".format(type(value).__name__))

    @staticmethod
    def lower(value: RawEventProtocol):
        if not isinstance(value, RawEvent):
            raise TypeError("Expected RawEvent instance, {} found".format(type(value).__name__))
        return value._uniffi_clone_pointer()
    ...
    @classmethod
    def write(cls, value: RawEventProtocol, buf: _UniffiRustBuffer):
        buf.write_u64(cls.lower(value))
...
class RelayInformationDocument:
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_relayinformationdocument_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_relayinformationdocument_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_relayinformationdocument_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeRelayInformationDocument.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_relayinformationdocument_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class RelayMessage:
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_free_relaymessage, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_clone_relaymessage, self._pointer)
    ...
    def auth(cls, challenge: "str"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_auth,
        _UniffiConverterString.lower(challenge))
        return cls._make_instance_(pointer)
    ...
    def closed(cls, subscription_id: "str",message: "str"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_closed,
        _UniffiConverterString.lower(subscription_id),
        _UniffiConverterString.lower(message))
        return cls._make_instance_(pointer)
    ...
    def count(cls, subscription_id: "str",count: "float"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_count,
        _UniffiConverterString.lower(subscription_id),
    ...
    def eose(cls, subscription_id: "str"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_eose,
        _UniffiConverterString.lower(subscription_id))
        return cls._make_instance_(pointer)
    ...
    def event(cls, subscription_id: "str",event: "Event"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_event,
        _UniffiConverterString.lower(subscription_id),
        _UniffiConverterTypeEvent.lower(event))
        return cls._make_instance_(pointer)
    ...
    def from_enum(cls, e: "RelayMessageEnum"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_from_enum,
    ...
    def from_json(cls, json: "str"):
        ...
        **This method NOT verify the event signature!**
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_from_json,
        _UniffiConverterString.lower(json))
        return cls._make_instance_(pointer)
    ...
    def notice(cls, message: "str"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_notice,
        _UniffiConverterString.lower(message))
        return cls._make_instance_(pointer)
    ...
    def ok(cls, event_id: "EventId",status: "bool",message: "str"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_relaymessage_ok,
        _UniffiConverterTypeEventId.lower(event_id),
    ...
    def as_enum(self, ) -> "RelayMessageEnum":
        ...
        return _UniffiConverterTypeRelayMessageEnum.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_as_enum,self._uniffi_clone_pointer(),)
        )
    ...
    def as_json(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_as_json,self._uniffi_clone_pointer(),)
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeRelayMessage.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_relaymessage_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class Request:
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_request_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_request_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_request_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeRequest.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_request_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class Response:
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_response_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_response_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_response_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeResponse.lower(other)))
...
class SecretKey:
    ...
    def encrypt(self, password: "str") -> "EncryptedSecretKey":
        ...
        return _UniffiConverterTypeEncryptedSecretKey.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_secretkey_encrypt,self._uniffi_clone_pointer(),
        _UniffiConverterString.lower(password))
        )
    ...
    def to_bech32(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_secretkey_to_bech32,self._uniffi_clone_pointer(),)
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_secretkey_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_secretkey_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_secretkey_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeSecretKey.lower(other)))
...
class SingleLetterTag:
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_singlelettertag_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_singlelettertag_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_singlelettertag_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeSingleLetterTag.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_singlelettertag_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class StallData:
    ...
    def __init__(self, id: "str",name: "str",description: "typing.Optional[str]",currency: "str",shipping: "typing.List[ShippingMethod]"):
        ...
        self._pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_stalldata_new,
        _UniffiConverterString.lower(id),
        _UniffiConverterString.lower(name),
        _UniffiConverterOptionalString.lower(description),
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_free_stalldata, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_clone_stalldata, self._pointer)
    ...
    def from_json(cls, json: "str"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_constructor_stalldata_from_json,
        _UniffiConverterString.lower(json))
        return cls._make_instance_(pointer)
    ...
    def from_record(cls, r: "StallDataRecord"):
        ...
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_constructor_stalldata_from_record,
    ...
    def as_json(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_as_json,self._uniffi_clone_pointer(),)
        )
    ...
    def as_record(self, ) -> "StallDataRecord":
        return _UniffiConverterTypeStallDataRecord.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_as_record,self._uniffi_clone_pointer(),)
        )
    ...
    def currency(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_currency,self._uniffi_clone_pointer(),)
        )
    ...
    def description(self, ) -> "typing.Optional[str]":
        return _UniffiConverterOptionalString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_description,self._uniffi_clone_pointer(),)
        )
    ...
    def id(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_id,self._uniffi_clone_pointer(),)
        )
    ...
    def name(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_name,self._uniffi_clone_pointer(),)
        )
    ...
    def shipping(self, ) -> "typing.List[ShippingMethod]":
        return _UniffiConverterSequenceTypeShippingMethod.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_stalldata_shipping,self._uniffi_clone_pointer(),)
        )
...
class Tag:
    ...
    def is_reply(self, ) -> "bool":
        ...
        return _UniffiConverterBool.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_tag_is_reply,self._uniffi_clone_pointer(),)
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_tag_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_tag_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_tag_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeTag.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_tag_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class Timestamp:
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_timestamp_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_timestamp_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_timestamp_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeTimestamp.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_timestamp_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class UnsignedEvent:
    ...
    def add_signature(self, sig: "str") -> "Event":
        ...
        return _UniffiConverterTypeEvent.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_add_signature,self._uniffi_clone_pointer(),
    ...
    def sign(self, keys: "Keys") -> "Event":
        ...
        return _UniffiConverterTypeEvent.lift(
            _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_sign,self._uniffi_clone_pointer(),
        _UniffiConverterTypeKeys.lower(keys))
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeUnsignedEvent.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_unsignedevent_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class UnwrappedGift:
    ...
    def __del__(self):
        ...
        pointer = getattr(self, "_pointer", None)
        if pointer is not None:
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_free_unwrappedgift, pointer)

    def _uniffi_clone_pointer(self):
        return _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_clone_unwrappedgift, self._pointer)
    ...
    @classmethod
    def from_gift_wrap(cls, receiver_keys: "Keys",gift_wrap: "Event"):
        """
        ...
        _UniffiConverterTypeKeys.check_lower(receiver_keys)
        
        _UniffiConverterTypeEvent.check_lower(gift_wrap)
        
        # Call the (fallible) function before creating any half-baked object instances.
        pointer = _rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_constructor_unwrappedgift_from_gift_wrap,
        _UniffiConverterTypeKeys.lower(receiver_keys),
    ...
    def rumor(self, ) -> "UnsignedEvent":
        ...
        return _UniffiConverterTypeUnsignedEvent.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_rumor,self._uniffi_clone_pointer(),)
        )
    ...
    def sender(self, ) -> "PublicKey":
        ...
        return _UniffiConverterTypePublicKey.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_sender,self._uniffi_clone_pointer(),)
        )
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeUnwrappedGift.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_unwrappedgift_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class ZapRequestData:
    ...
    def __repr__(self, ) -> "str":
        return _UniffiConverterString.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_zaprequestdata_uniffi_trait_debug,self._uniffi_clone_pointer(),)
        )
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_zaprequestdata_uniffi_trait_eq_eq,self._uniffi_clone_pointer(),
    ...
    def __ne__(self, other: object) -> bool:
        ...
        return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_zaprequestdata_uniffi_trait_eq_ne,self._uniffi_clone_pointer(),
        _UniffiConverterTypeZapRequestData.lower(other)))


    def __hash__(self, ) -> "int":
        return _UniffiConverterUInt64.lift(
            _rust_call(_UniffiLib.uniffi_nostr_ffi_fn_method_zaprequestdata_uniffi_trait_hash,self._uniffi_clone_pointer(),)
        )
...
class ArticlesCuration:
    ...
    def __init__(self, *, coordinate: "typing.List[Coordinate]", event_ids: "typing.List[EventId]"):
...
class Bookmarks:
    ...
    @typing.no_type_check
    def __init__(self, *, event_ids: "typing.List[EventId]", coordinate: "typing.List[Coordinate]", hashtags: "typing.List[str]", urls: "typing.List[str]"):
        self.event_ids = event_ids
        self.coordinate = coordinate
...
class Emojis:
    ...
    @typing.no_type_check
    def __init__(self, *, emojis: "typing.List[EmojiInfo]", coordinate: "typing.List[Coordinate]"):
        self.emojis = emojis
        self.coordinate = coordinate
...
class Interests:
    ...
    coordinate: "typing.List[Coordinate]"
    @typing.no_type_check
    def __init__(self, *, hashtags: "typing.List[str]", coordinate: "typing.List[Coordinate]"):
        self.hashtags = hashtags
        self.coordinate = coordinate
...
class LookupInvoiceRequestParams:
    ...
    def __str__(self):
        return "LookupInvoiceRequestParams(payment_hash={}, invoice={})".format(self.payment_hash, self.invoice)
...
class MetadataRecord:
    ...
    @typing.no_type_check
    def __init__(self, *, name: "typing.Optional[str]", display_name: "typing.Optional[str]", about: "typing.Optional[str]", website: "typing.Optional[str]", picture: "typing.Optional[str]", banner: "typing.Optional[str]", nip05: "typing.Optional[str]", lud06: "typing.Optional[str]", lud16: "typing.Optional[str]"):
        self.name = name
    ...
    def __str__(self):
        return "MetadataRecord(name={}, display_name={}, about={}, website={}, picture={}, banner={}, nip05={}, lud06={}, lud16={})".format(self.name, self.display_name, self.about, self.website, self.picture, self.banner, self.nip05, self.lud06, self.lud16)
...
class MuteList:
    ...
    @typing.no_type_check
    def __init__(self, *, public_keys: "typing.List[PublicKey]", hashtags: "typing.List[str]", event_ids: "typing.List[EventId]", words: "typing.List[str]"):
...
class RawEventRecord:
    ...
    tags: "typing.List[typing.List[str]]"
    """
    Vector of strings
    """
    ...
    @typing.no_type_check
    def __init__(self, *, id: "str", pubkey: "str", created_at: "int", kind: "int", tags: "typing.List[typing.List[str]]", content: "str", sig: "str"):
        self.id = id
        self.pubkey = pubkey
        self.created_at = created_at
        self.kind = kind
    ...
    def __str__(self):
        return "RawEventRecord(id={}, pubkey={}, created_at={}, kind={}, tags={}, content={}, sig={})".format(self.id, self.pubkey, self.created_at, self.kind, self.tags, self.content, self.sig)
...
class _UniffiConverterTypeRawEventRecord(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        return RawEventRecord(
            ...
            tags=_UniffiConverterSequenceSequenceString.read(buf),
            content=_UniffiConverterString.read(buf),
            sig=_UniffiConverterString.read(buf),
        )
    ...
    def check_lower(value):
        ...
        _UniffiConverterSequenceSequenceString.check_lower(value.tags)
    ...
    def write(value, buf):
        ...
        _UniffiConverterSequenceSequenceString.write(value.tags, buf)
...
class ClientMessageEnum:
    ...
    class COUNT:
        ...
        def __str__(self):
            return "ClientMessageEnum.COUNT(subscription_id={}, filters={})".format(self.subscription_id, self.filters)
...
class KindEnum:
    def __init__(self):
        raise RuntimeError("KindEnum cannot be instantiated directly")
    ...
    class METADATA:
        ...
        def __str__(self):
            return "KindEnum.METADATA()".format()
    ...
    class TEXT_NOTE:
        ...
        def __str__(self):
            return "KindEnum.TEXT_NOTE()".format()

        def __eq__(self, other):
            if not other.is_text_note():
                return False
            return True
    
    class RECOMMEND_RELAY:
        """
        ...
        def __str__(self):
            return "KindEnum.RECOMMEND_RELAY()".format()

        def __eq__(self, other):
            if not other.is_recommend_relay():
                return False
            return True
    ...
    class CONTACT_LIST:
        ...
        def __str__(self):
            return "KindEnum.CONTACT_LIST()".format()
    ...
    class OPEN_TIMESTAMPS:
        ...
        def __str__(self):
            return "KindEnum.OPEN_TIMESTAMPS()".format()

        def __eq__(self, other):
            if not other.is_open_timestamps():
                return False
            return True
    
    class ENCRYPTED_DIRECT_MESSAGE:
        """
        ...
        def __str__(self):
            return "KindEnum.ENCRYPTED_DIRECT_MESSAGE()".format()

        def __eq__(self, other):
            if not other.is_encrypted_direct_message():
                return False
            return True
    
    class EVENT_DELETION:
        """
        ...
        def __str__(self):
            return "KindEnum.EVENT_DELETION()".format()

        def __eq__(self, other):
            if not other.is_event_deletion():
                return False
            return True
    ...
    class REPOST:
        ...
        def __str__(self):
            return "KindEnum.REPOST()".format()

        def __eq__(self, other):
            if not other.is_repost():
                return False
            return True
    
    class GENERIC_REPOST:
        """
        ...
        def __str__(self):
            return "KindEnum.GENERIC_REPOST()".format()

        def __eq__(self, other):
            if not other.is_generic_repost():
                return False
            return True
    ...
    class REACTION:
        ...
        def __str__(self):
            return "KindEnum.REACTION()".format()
    ...
    class BADGE_AWARD:
        ...
        def __str__(self):
            return "KindEnum.BADGE_AWARD()".format()

        def __eq__(self, other):
            if not other.is_badge_award():
                return False
            return True
    
    class CHANNEL_CREATION:
        """
        ...
        def __str__(self):
            return "KindEnum.CHANNEL_CREATION()".format()

        def __eq__(self, other):
            if not other.is_channel_creation():
                return False
            return True
    ...
    class CHANNEL_METADATA:
        ...
        def __str__(self):
            return "KindEnum.CHANNEL_METADATA()".format()

        def __eq__(self, other):
            if not other.is_channel_metadata():
                return False
            return True
    ...
    class CHANNEL_MESSAGE:
        ...
        def __str__(self):
            return "KindEnum.CHANNEL_MESSAGE()".format()

        def __eq__(self, other):
            if not other.is_channel_message():
                return False
            return True
    
    class CHANNEL_HIDE_MESSAGE:
        """
        ...
        def __str__(self):
            return "KindEnum.CHANNEL_HIDE_MESSAGE()".format()

        def __eq__(self, other):
            if not other.is_channel_hide_message():
                return False
            return True
    
    class CHANNEL_MUTE_USER:
        """
        ...
        def __str__(self):
            return "KindEnum.CHANNEL_MUTE_USER()".format()

        def __eq__(self, other):
            if not other.is_channel_mute_user():
                return False
            return True
    
    class PUBLIC_CHAT_RESERVED45:
        """
        ...
        def __str__(self):
            return "KindEnum.PUBLIC_CHAT_RESERVED45()".format()

        def __eq__(self, other):
            if not other.is_public_chat_reserved45():
                return False
            return True
    
    class PUBLIC_CHAT_RESERVED46:
        """
        Public Chat Reserved (NIP28)
        """
        ...
        def __str__(self):
            return "KindEnum.PUBLIC_CHAT_RESERVED46()".format()

        def __eq__(self, other):
            if not other.is_public_chat_reserved46():
                return False
            return True
    
    class PUBLIC_CHAT_RESERVED47:
        """
        Public Chat Reserved (NIP28)
        """
        ...
        def __str__(self):
            return "KindEnum.PUBLIC_CHAT_RESERVED47()".format()

        def __eq__(self, other):
            if not other.is_public_chat_reserved47():
                return False
            return True
    
    class PUBLIC_CHAT_RESERVED48:
        """
        Public Chat Reserved (NIP28)
        """
        ...
        def __str__(self):
            return "KindEnum.PUBLIC_CHAT_RESERVED48()".format()

        def __eq__(self, other):
            if not other.is_public_chat_reserved48():
                return False
            return True
    
    class PUBLIC_CHAT_RESERVED49:
        """
        Public Chat Reserved (NIP28)
        """
        ...
        def __str__(self):
            return "KindEnum.PUBLIC_CHAT_RESERVED49()".format()

        def __eq__(self, other):
            if not other.is_public_chat_reserved49():
                return False
            return True
    ...
    class WALLET_CONNECT_INFO:
        ...
        def __str__(self):
            return "KindEnum.WALLET_CONNECT_INFO()".format()

        def __eq__(self, other):
            if not other.is_wallet_connect_info():
                return False
            return True
    ...
    class REPORTING:
        ...
        def __str__(self):
            return "KindEnum.REPORTING()".format()

        def __eq__(self, other):
            if not other.is_reporting():
                return False
            return True
    
    class ZAP_PRIVATE_MESSAGE:
        """
        ...
        def __str__(self):
            return "KindEnum.ZAP_PRIVATE_MESSAGE()".format()

        def __eq__(self, other):
            if not other.is_zap_private_message():
                return False
            return True
    ...
    class ZAP_REQUEST:
        ...
        def __str__(self):
            return "KindEnum.ZAP_REQUEST()".format()

        def __eq__(self, other):
            if not other.is_zap_request():
                return False
            return True
    ...
    class ZAP_RECEIPT:
        ...
        def __str__(self):
            return "KindEnum.ZAP_RECEIPT()".format()

        def __eq__(self, other):
            if not other.is_zap_receipt():
                return False
            return True
    ...
    class MUTE_LIST:
        ...
        def __str__(self):
            return "KindEnum.MUTE_LIST()".format()

        def __eq__(self, other):
            if not other.is_mute_list():
                return False
            return True
    ...
    class PIN_LIST:
        ...
        def __str__(self):
            return "KindEnum.PIN_LIST()".format()

        def __eq__(self, other):
            if not other.is_pin_list():
                return False
            return True
    ...
    class BOOKMARKS:
        ...
        def __str__(self):
            return "KindEnum.BOOKMARKS()".format()

        def __eq__(self, other):
            if not other.is_bookmarks():
                return False
            return True
    ...
    class COMMUNITIES:
        ...
        def __str__(self):
            return "KindEnum.COMMUNITIES()".format()

        def __eq__(self, other):
            if not other.is_communities():
                return False
            return True
    ...
    class PUBLIC_CHATS:
        ...
        def __str__(self):
            return "KindEnum.PUBLIC_CHATS()".format()

        def __eq__(self, other):
            if not other.is_public_chats():
                return False
            return True
    
    class BLOCKED_RELAYS:
        """
        Blocked Relays
        ...
        def __str__(self):
            return "KindEnum.BLOCKED_RELAYS()".format()

        def __eq__(self, other):
            if not other.is_blocked_relays():
                return False
            return True
    ...
    class SEARCH_RELAYS:
        ...
        def __str__(self):
            return "KindEnum.SEARCH_RELAYS()".format()

        def __eq__(self, other):
            if not other.is_search_relays():
                return False
            return True
    ...
    class SIMPLE_GROUPS:
        ...
        def __str__(self):
            return "KindEnum.SIMPLE_GROUPS()".format()

        def __eq__(self, other):
            if not other.is_simple_groups():
                return False
            return True
    ...
    class INTERESTS:
        ...
        def __str__(self):
            return "KindEnum.INTERESTS()".format()

        def __eq__(self, other):
            if not other.is_interests():
                return False
            return True
    ...
    class EMOJIS:
        ...
        def __str__(self):
            return "KindEnum.EMOJIS()".format()

        def __eq__(self, other):
            if not other.is_emojis():
                return False
            return True
    ...
    class FOLLOW_SETS:
        ...
        def __str__(self):
            return "KindEnum.FOLLOW_SETS()".format()

        def __eq__(self, other):
            if not other.is_follow_sets():
                return False
            return True
    ...
    class RELAY_SETS:
        ...
        def __str__(self):
            return "KindEnum.RELAY_SETS()".format()

        def __eq__(self, other):
            if not other.is_relay_sets():
                return False
            return True
    ...
    class BOOKMARK_SETS:
        ...
        def __str__(self):
            return "KindEnum.BOOKMARK_SETS()".format()

        def __eq__(self, other):
            if not other.is_bookmark_sets():
                return False
            return True
    
    class ARTICLES_CURATION_SETS:
        """
        ...
        def __str__(self):
            return "KindEnum.ARTICLES_CURATION_SETS()".format()

        def __eq__(self, other):
            if not other.is_articles_curation_sets():
                return False
            return True
    
    class VIDEOS_CURATION_SETS:
        """
        Videos Curation Sets
        ...
        def __str__(self):
            return "KindEnum.VIDEOS_CURATION_SETS()".format()

        def __eq__(self, other):
            if not other.is_videos_curation_sets():
                return False
            return True
    ...
    class INTEREST_SETS:
        ...
        def __str__(self):
            return "KindEnum.INTEREST_SETS()".format()

        def __eq__(self, other):
            if not other.is_interest_sets():
                return False
            return True
    ...
    class EMOJI_SETS:
        ...
        def __str__(self):
            return "KindEnum.EMOJI_SETS()".format()

        def __eq__(self, other):
            if not other.is_emoji_sets():
                return False
            return True
    
    class RELEASE_ARTIFACT_SETS:
        """
        ...
        def __str__(self):
            return "KindEnum.RELEASE_ARTIFACT_SETS()".format()

        def __eq__(self, other):
            if not other.is_release_artifact_sets():
                return False
            return True
    ...
    class RELAY_LIST:
        ...
        def __str__(self):
            return "KindEnum.RELAY_LIST()".format()

        def __eq__(self, other):
            if not other.is_relay_list():
                return False
            return True
    ...
    class AUTHENTICATION:
        ...
        def __str__(self):
            return "KindEnum.AUTHENTICATION()".format()

        def __eq__(self, other):
            if not other.is_authentication():
                return False
            return True
    
    class WALLET_CONNECT_REQUEST:
        """
        ...
        def __str__(self):
            return "KindEnum.WALLET_CONNECT_REQUEST()".format()

        def __eq__(self, other):
            if not other.is_wallet_connect_request():
                return False
            return True
    
    class WALLET_CONNECT_RESPONSE:
        """
        ...
        def __str__(self):
            return "KindEnum.WALLET_CONNECT_RESPONSE()".format()

        def __eq__(self, other):
            if not other.is_wallet_connect_response():
                return False
            return True
    ...
    class NOSTR_CONNECT:
        ...
        def __str__(self):
            return "KindEnum.NOSTR_CONNECT()".format()
    ...
    class LIVE_EVENT:
        ...
        def __str__(self):
            return "KindEnum.LIVE_EVENT()".format()

        def __eq__(self, other):
            if not other.is_live_event():
                return False
            return True
    
    class LIVE_EVENT_MESSAGE:
        """
        ...
        def __str__(self):
            return "KindEnum.LIVE_EVENT_MESSAGE()".format()

        def __eq__(self, other):
            if not other.is_live_event_message():
                return False
            return True
    ...
    class PROFILE_BADGES:
        ...
        def __str__(self):
            return "KindEnum.PROFILE_BADGES()".format()

        def __eq__(self, other):
            if not other.is_profile_badges():
                return False
            return True
    
    class BADGE_DEFINITION:
        """
        ...
        def __str__(self):
            return "KindEnum.BADGE_DEFINITION()".format()

        def __eq__(self, other):
            if not other.is_badge_definition():
                return False
            return True
    ...
    class SEAL:
        ...
        def __str__(self):
            return "KindEnum.SEAL()".format()

        def __eq__(self, other):
            if not other.is_seal():
                return False
            return True
    ...
    class GIFT_WRAP:
        ...
        def __str__(self):
            return "KindEnum.GIFT_WRAP()".format()

        def __eq__(self, other):
            if not other.is_gift_wrap():
                return False
            return True
    ...
    class SEALED_DIRECT:
        ...
        def __str__(self):
            return "KindEnum.SEALED_DIRECT()".format()

        def __eq__(self, other):
            if not other.is_sealed_direct():
                return False
            return True
    
    class LONG_FORM_TEXT_NOTE:
        """
        ...
        def __str__(self):
            return "KindEnum.LONG_FORM_TEXT_NOTE()".format()

        def __eq__(self, other):
            if not other.is_long_form_text_note():
                return False
            return True
    
    class APPLICATION_SPECIFIC_DATA:
        """
        ...
        def __str__(self):
            return "KindEnum.APPLICATION_SPECIFIC_DATA()".format()

        def __eq__(self, other):
            if not other.is_application_specific_data():
                return False
            return True
    ...
    class FILE_METADATA:
        ...
        def __str__(self):
            return "KindEnum.FILE_METADATA()".format()

        def __eq__(self, other):
            if not other.is_file_metadata():
                return False
            return True
    ...
    class HTTP_AUTH:
        ...
        def __str__(self):
            return "KindEnum.HTTP_AUTH()".format()

        def __eq__(self, other):
            if not other.is_http_auth():
                return False
            return True
    ...
    class SET_STALL:
        ...
        def __str__(self):
            return "KindEnum.SET_STALL()".format()

        def __eq__(self, other):
            if not other.is_set_stall():
                return False
            return True
    ...
    class SET_PRODUCT:
        ...
        def __str__(self):
            return "KindEnum.SET_PRODUCT()".format()

        def __eq__(self, other):
            if not other.is_set_product():
                return False
            return True
    ...
    class JOB_FEEDBACK:
        ...
        def __str__(self):
            return "KindEnum.JOB_FEEDBACK()".format()

        def __eq__(self, other):
            if not other.is_job_feedback():
                return False
            return True
    ...
    class JOB_REQUEST:
        ...
        def __str__(self):
            return "KindEnum.JOB_REQUEST(kind={})".format(self.kind)

        def __eq__(self, other):
            if not other.is_job_request():
                return False
            if self.kind != other.kind:
                return False
            return True
    ...
    class JOB_RESULT:
        ...
        def __str__(self):
            return "KindEnum.JOB_RESULT(kind={})".format(self.kind)

        def __eq__(self, other):
            if not other.is_job_result():
                return False
            if self.kind != other.kind:
                return False
            return True
    ...
    class REGULAR:
        ...
        def __str__(self):
            return "KindEnum.REGULAR(kind={})".format(self.kind)
    ...
    class REPLACEABLE:
        ...
        def __str__(self):
            return "KindEnum.REPLACEABLE(kind={})".format(self.kind)

        def __eq__(self, other):
            if not other.is_replaceable():
                return False
            if self.kind != other.kind:
                return False
            return True
    ...
    class EPHEMERAL:
        ...
        def __str__(self):
            return "KindEnum.EPHEMERAL(kind={})".format(self.kind)

        def __eq__(self, other):
            if not other.is_ephemeral():
                return False
            if self.kind != other.kind:
                return False
            return True
    
    class PARAMETERIZED_REPLACEABLE:
        kind: "int"
        ...
        def __str__(self):
            return "KindEnum.PARAMETERIZED_REPLACEABLE(kind={})".format(self.kind)

        def __eq__(self, other):
            if not other.is_parameterized_replaceable():
                return False
            if self.kind != other.kind:
                return False
            return True
    ...
    class CUSTOM:
        ...
        def __str__(self):
            return "KindEnum.CUSTOM(kind={})".format(self.kind)
    ...
    def is_metadata(self) -> bool:
        return isinstance(self, KindEnum.METADATA)
    def is_text_note(self) -> bool:
        return isinstance(self, KindEnum.TEXT_NOTE)
    def is_recommend_relay(self) -> bool:
        return isinstance(self, KindEnum.RECOMMEND_RELAY)
    def is_contact_list(self) -> bool:
        return isinstance(self, KindEnum.CONTACT_LIST)
    def is_open_timestamps(self) -> bool:
        return isinstance(self, KindEnum.OPEN_TIMESTAMPS)
    def is_encrypted_direct_message(self) -> bool:
        return isinstance(self, KindEnum.ENCRYPTED_DIRECT_MESSAGE)
    def is_event_deletion(self) -> bool:
        return isinstance(self, KindEnum.EVENT_DELETION)
    def is_repost(self) -> bool:
        return isinstance(self, KindEnum.REPOST)
    def is_generic_repost(self) -> bool:
        return isinstance(self, KindEnum.GENERIC_REPOST)
    def is_reaction(self) -> bool:
        return isinstance(self, KindEnum.REACTION)
    def is_badge_award(self) -> bool:
        return isinstance(self, KindEnum.BADGE_AWARD)
    def is_channel_creation(self) -> bool:
        return isinstance(self, KindEnum.CHANNEL_CREATION)
    def is_channel_metadata(self) -> bool:
        return isinstance(self, KindEnum.CHANNEL_METADATA)
    def is_channel_message(self) -> bool:
        return isinstance(self, KindEnum.CHANNEL_MESSAGE)
    def is_channel_hide_message(self) -> bool:
        return isinstance(self, KindEnum.CHANNEL_HIDE_MESSAGE)
    def is_channel_mute_user(self) -> bool:
        return isinstance(self, KindEnum.CHANNEL_MUTE_USER)
    def is_public_chat_reserved45(self) -> bool:
        return isinstance(self, KindEnum.PUBLIC_CHAT_RESERVED45)
    def is_public_chat_reserved46(self) -> bool:
        return isinstance(self, KindEnum.PUBLIC_CHAT_RESERVED46)
    def is_public_chat_reserved47(self) -> bool:
        return isinstance(self, KindEnum.PUBLIC_CHAT_RESERVED47)
    def is_public_chat_reserved48(self) -> bool:
        return isinstance(self, KindEnum.PUBLIC_CHAT_RESERVED48)
    def is_public_chat_reserved49(self) -> bool:
        return isinstance(self, KindEnum.PUBLIC_CHAT_RESERVED49)
    def is_label(self) -> bool:
        return isinstance(self, KindEnum.LABEL)
    def is_wallet_connect_info(self) -> bool:
        return isinstance(self, KindEnum.WALLET_CONNECT_INFO)
    def is_reporting(self) -> bool:
        return isinstance(self, KindEnum.REPORTING)
    def is_zap_private_message(self) -> bool:
        return isinstance(self, KindEnum.ZAP_PRIVATE_MESSAGE)
    def is_zap_request(self) -> bool:
        return isinstance(self, KindEnum.ZAP_REQUEST)
    def is_zap_receipt(self) -> bool:
        return isinstance(self, KindEnum.ZAP_RECEIPT)
    def is_mute_list(self) -> bool:
        return isinstance(self, KindEnum.MUTE_LIST)
    def is_pin_list(self) -> bool:
        return isinstance(self, KindEnum.PIN_LIST)
    def is_bookmarks(self) -> bool:
        return isinstance(self, KindEnum.BOOKMARKS)
    def is_communities(self) -> bool:
        return isinstance(self, KindEnum.COMMUNITIES)
    def is_public_chats(self) -> bool:
        return isinstance(self, KindEnum.PUBLIC_CHATS)
    def is_blocked_relays(self) -> bool:
        return isinstance(self, KindEnum.BLOCKED_RELAYS)
    def is_search_relays(self) -> bool:
        return isinstance(self, KindEnum.SEARCH_RELAYS)
    def is_simple_groups(self) -> bool:
        return isinstance(self, KindEnum.SIMPLE_GROUPS)
    def is_interests(self) -> bool:
        return isinstance(self, KindEnum.INTERESTS)
    def is_emojis(self) -> bool:
        return isinstance(self, KindEnum.EMOJIS)
    def is_follow_sets(self) -> bool:
        return isinstance(self, KindEnum.FOLLOW_SETS)
    def is_relay_sets(self) -> bool:
        return isinstance(self, KindEnum.RELAY_SETS)
    def is_bookmark_sets(self) -> bool:
        return isinstance(self, KindEnum.BOOKMARK_SETS)
    def is_articles_curation_sets(self) -> bool:
        return isinstance(self, KindEnum.ARTICLES_CURATION_SETS)
    def is_videos_curation_sets(self) -> bool:
        return isinstance(self, KindEnum.VIDEOS_CURATION_SETS)
    def is_interest_sets(self) -> bool:
        return isinstance(self, KindEnum.INTEREST_SETS)
    def is_emoji_sets(self) -> bool:
        return isinstance(self, KindEnum.EMOJI_SETS)
    def is_release_artifact_sets(self) -> bool:
        return isinstance(self, KindEnum.RELEASE_ARTIFACT_SETS)
    def is_relay_list(self) -> bool:
        return isinstance(self, KindEnum.RELAY_LIST)
    def is_authentication(self) -> bool:
        return isinstance(self, KindEnum.AUTHENTICATION)
    def is_wallet_connect_request(self) -> bool:
        return isinstance(self, KindEnum.WALLET_CONNECT_REQUEST)
    def is_wallet_connect_response(self) -> bool:
        return isinstance(self, KindEnum.WALLET_CONNECT_RESPONSE)
    def is_nostr_connect(self) -> bool:
        return isinstance(self, KindEnum.NOSTR_CONNECT)
    def is_live_event(self) -> bool:
        return isinstance(self, KindEnum.LIVE_EVENT)
    def is_live_event_message(self) -> bool:
        return isinstance(self, KindEnum.LIVE_EVENT_MESSAGE)
    def is_profile_badges(self) -> bool:
        return isinstance(self, KindEnum.PROFILE_BADGES)
    def is_badge_definition(self) -> bool:
        return isinstance(self, KindEnum.BADGE_DEFINITION)
    def is_seal(self) -> bool:
        return isinstance(self, KindEnum.SEAL)
    def is_gift_wrap(self) -> bool:
        return isinstance(self, KindEnum.GIFT_WRAP)
    def is_sealed_direct(self) -> bool:
        return isinstance(self, KindEnum.SEALED_DIRECT)
    def is_long_form_text_note(self) -> bool:
        return isinstance(self, KindEnum.LONG_FORM_TEXT_NOTE)
    def is_application_specific_data(self) -> bool:
        return isinstance(self, KindEnum.APPLICATION_SPECIFIC_DATA)
    def is_file_metadata(self) -> bool:
        return isinstance(self, KindEnum.FILE_METADATA)
    def is_http_auth(self) -> bool:
        return isinstance(self, KindEnum.HTTP_AUTH)
    def is_set_stall(self) -> bool:
        return isinstance(self, KindEnum.SET_STALL)
    def is_set_product(self) -> bool:
        return isinstance(self, KindEnum.SET_PRODUCT)
    def is_job_feedback(self) -> bool:
        return isinstance(self, KindEnum.JOB_FEEDBACK)
    def is_job_request(self) -> bool:
        return isinstance(self, KindEnum.JOB_REQUEST)
    def is_job_result(self) -> bool:
        return isinstance(self, KindEnum.JOB_RESULT)
    def is_regular(self) -> bool:
        return isinstance(self, KindEnum.REGULAR)
    def is_replaceable(self) -> bool:
        return isinstance(self, KindEnum.REPLACEABLE)
    def is_ephemeral(self) -> bool:
        return isinstance(self, KindEnum.EPHEMERAL)
    def is_parameterized_replaceable(self) -> bool:
        return isinstance(self, KindEnum.PARAMETERIZED_REPLACEABLE)
    def is_custom(self) -> bool:
        return isinstance(self, KindEnum.CUSTOM)
    

# Now, a little trick - we make each nested variant class be a subclass of the main
# enum class, so that method calls and instance checks etc will work intuitively.
# We might be able to do this a little more neatly with a metaclass, but this'll do.
KindEnum.METADATA = type("KindEnum.METADATA", (KindEnum.METADATA, KindEnum,), {})  # type: ignore
KindEnum.TEXT_NOTE = type("KindEnum.TEXT_NOTE", (KindEnum.TEXT_NOTE, KindEnum,), {})  # type: ignore
KindEnum.RECOMMEND_RELAY = type("KindEnum.RECOMMEND_RELAY", (KindEnum.RECOMMEND_RELAY, KindEnum,), {})  # type: ignore
KindEnum.CONTACT_LIST = type("KindEnum.CONTACT_LIST", (KindEnum.CONTACT_LIST, KindEnum,), {})  # type: ignore
KindEnum.OPEN_TIMESTAMPS = type("KindEnum.OPEN_TIMESTAMPS", (KindEnum.OPEN_TIMESTAMPS, KindEnum,), {})  # type: ignore
KindEnum.ENCRYPTED_DIRECT_MESSAGE = type("KindEnum.ENCRYPTED_DIRECT_MESSAGE", (KindEnum.ENCRYPTED_DIRECT_MESSAGE, KindEnum,), {})  # type: ignore
KindEnum.EVENT_DELETION = type("KindEnum.EVENT_DELETION", (KindEnum.EVENT_DELETION, KindEnum,), {})  # type: ignore
KindEnum.REPOST = type("KindEnum.REPOST", (KindEnum.REPOST, KindEnum,), {})  # type: ignore
KindEnum.GENERIC_REPOST = type("KindEnum.GENERIC_REPOST", (KindEnum.GENERIC_REPOST, KindEnum,), {})  # type: ignore
KindEnum.REACTION = type("KindEnum.REACTION", (KindEnum.REACTION, KindEnum,), {})  # type: ignore
KindEnum.BADGE_AWARD = type("KindEnum.BADGE_AWARD", (KindEnum.BADGE_AWARD, KindEnum,), {})  # type: ignore
KindEnum.CHANNEL_CREATION = type("KindEnum.CHANNEL_CREATION", (KindEnum.CHANNEL_CREATION, KindEnum,), {})  # type: ignore
KindEnum.CHANNEL_METADATA = type("KindEnum.CHANNEL_METADATA", (KindEnum.CHANNEL_METADATA, KindEnum,), {})  # type: ignore
KindEnum.CHANNEL_MESSAGE = type("KindEnum.CHANNEL_MESSAGE", (KindEnum.CHANNEL_MESSAGE, KindEnum,), {})  # type: ignore
KindEnum.CHANNEL_HIDE_MESSAGE = type("KindEnum.CHANNEL_HIDE_MESSAGE", (KindEnum.CHANNEL_HIDE_MESSAGE, KindEnum,), {})  # type: ignore
KindEnum.CHANNEL_MUTE_USER = type("KindEnum.CHANNEL_MUTE_USER", (KindEnum.CHANNEL_MUTE_USER, KindEnum,), {})  # type: ignore
KindEnum.PUBLIC_CHAT_RESERVED45 = type("KindEnum.PUBLIC_CHAT_RESERVED45", (KindEnum.PUBLIC_CHAT_RESERVED45, KindEnum,), {})  # type: ignore
KindEnum.PUBLIC_CHAT_RESERVED46 = type("KindEnum.PUBLIC_CHAT_RESERVED46", (KindEnum.PUBLIC_CHAT_RESERVED46, KindEnum,), {})  # type: ignore
KindEnum.PUBLIC_CHAT_RESERVED47 = type("KindEnum.PUBLIC_CHAT_RESERVED47", (KindEnum.PUBLIC_CHAT_RESERVED47, KindEnum,), {})  # type: ignore
KindEnum.PUBLIC_CHAT_RESERVED48 = type("KindEnum.PUBLIC_CHAT_RESERVED48", (KindEnum.PUBLIC_CHAT_RESERVED48, KindEnum,), {})  # type: ignore
KindEnum.PUBLIC_CHAT_RESERVED49 = type("KindEnum.PUBLIC_CHAT_RESERVED49", (KindEnum.PUBLIC_CHAT_RESERVED49, KindEnum,), {})  # type: ignore
KindEnum.LABEL = type("KindEnum.LABEL", (KindEnum.LABEL, KindEnum,), {})  # type: ignore
KindEnum.WALLET_CONNECT_INFO = type("KindEnum.WALLET_CONNECT_INFO", (KindEnum.WALLET_CONNECT_INFO, KindEnum,), {})  # type: ignore
KindEnum.REPORTING = type("KindEnum.REPORTING", (KindEnum.REPORTING, KindEnum,), {})  # type: ignore
KindEnum.ZAP_PRIVATE_MESSAGE = type("KindEnum.ZAP_PRIVATE_MESSAGE", (KindEnum.ZAP_PRIVATE_MESSAGE, KindEnum,), {})  # type: ignore
KindEnum.ZAP_REQUEST = type("KindEnum.ZAP_REQUEST", (KindEnum.ZAP_REQUEST, KindEnum,), {})  # type: ignore
KindEnum.ZAP_RECEIPT = type("KindEnum.ZAP_RECEIPT", (KindEnum.ZAP_RECEIPT, KindEnum,), {})  # type: ignore
KindEnum.MUTE_LIST = type("KindEnum.MUTE_LIST", (KindEnum.MUTE_LIST, KindEnum,), {})  # type: ignore
KindEnum.PIN_LIST = type("KindEnum.PIN_LIST", (KindEnum.PIN_LIST, KindEnum,), {})  # type: ignore
KindEnum.BOOKMARKS = type("KindEnum.BOOKMARKS", (KindEnum.BOOKMARKS, KindEnum,), {})  # type: ignore
KindEnum.COMMUNITIES = type("KindEnum.COMMUNITIES", (KindEnum.COMMUNITIES, KindEnum,), {})  # type: ignore
KindEnum.PUBLIC_CHATS = type("KindEnum.PUBLIC_CHATS", (KindEnum.PUBLIC_CHATS, KindEnum,), {})  # type: ignore
KindEnum.BLOCKED_RELAYS = type("KindEnum.BLOCKED_RELAYS", (KindEnum.BLOCKED_RELAYS, KindEnum,), {})  # type: ignore
KindEnum.SEARCH_RELAYS = type("KindEnum.SEARCH_RELAYS", (KindEnum.SEARCH_RELAYS, KindEnum,), {})  # type: ignore
KindEnum.SIMPLE_GROUPS = type("KindEnum.SIMPLE_GROUPS", (KindEnum.SIMPLE_GROUPS, KindEnum,), {})  # type: ignore
KindEnum.INTERESTS = type("KindEnum.INTERESTS", (KindEnum.INTERESTS, KindEnum,), {})  # type: ignore
KindEnum.EMOJIS = type("KindEnum.EMOJIS", (KindEnum.EMOJIS, KindEnum,), {})  # type: ignore
KindEnum.FOLLOW_SETS = type("KindEnum.FOLLOW_SETS", (KindEnum.FOLLOW_SETS, KindEnum,), {})  # type: ignore
KindEnum.RELAY_SETS = type("KindEnum.RELAY_SETS", (KindEnum.RELAY_SETS, KindEnum,), {})  # type: ignore
KindEnum.BOOKMARK_SETS = type("KindEnum.BOOKMARK_SETS", (KindEnum.BOOKMARK_SETS, KindEnum,), {})  # type: ignore
KindEnum.ARTICLES_CURATION_SETS = type("KindEnum.ARTICLES_CURATION_SETS", (KindEnum.ARTICLES_CURATION_SETS, KindEnum,), {})  # type: ignore
KindEnum.VIDEOS_CURATION_SETS = type("KindEnum.VIDEOS_CURATION_SETS", (KindEnum.VIDEOS_CURATION_SETS, KindEnum,), {})  # type: ignore
KindEnum.INTEREST_SETS = type("KindEnum.INTEREST_SETS", (KindEnum.INTEREST_SETS, KindEnum,), {})  # type: ignore
KindEnum.EMOJI_SETS = type("KindEnum.EMOJI_SETS", (KindEnum.EMOJI_SETS, KindEnum,), {})  # type: ignore
KindEnum.RELEASE_ARTIFACT_SETS = type("KindEnum.RELEASE_ARTIFACT_SETS", (KindEnum.RELEASE_ARTIFACT_SETS, KindEnum,), {})  # type: ignore
KindEnum.RELAY_LIST = type("KindEnum.RELAY_LIST", (KindEnum.RELAY_LIST, KindEnum,), {})  # type: ignore
KindEnum.AUTHENTICATION = type("KindEnum.AUTHENTICATION", (KindEnum.AUTHENTICATION, KindEnum,), {})  # type: ignore
KindEnum.WALLET_CONNECT_REQUEST = type("KindEnum.WALLET_CONNECT_REQUEST", (KindEnum.WALLET_CONNECT_REQUEST, KindEnum,), {})  # type: ignore
KindEnum.WALLET_CONNECT_RESPONSE = type("KindEnum.WALLET_CONNECT_RESPONSE", (KindEnum.WALLET_CONNECT_RESPONSE, KindEnum,), {})  # type: ignore
KindEnum.NOSTR_CONNECT = type("KindEnum.NOSTR_CONNECT", (KindEnum.NOSTR_CONNECT, KindEnum,), {})  # type: ignore
KindEnum.LIVE_EVENT = type("KindEnum.LIVE_EVENT", (KindEnum.LIVE_EVENT, KindEnum,), {})  # type: ignore
KindEnum.LIVE_EVENT_MESSAGE = type("KindEnum.LIVE_EVENT_MESSAGE", (KindEnum.LIVE_EVENT_MESSAGE, KindEnum,), {})  # type: ignore
KindEnum.PROFILE_BADGES = type("KindEnum.PROFILE_BADGES", (KindEnum.PROFILE_BADGES, KindEnum,), {})  # type: ignore
KindEnum.BADGE_DEFINITION = type("KindEnum.BADGE_DEFINITION", (KindEnum.BADGE_DEFINITION, KindEnum,), {})  # type: ignore
KindEnum.SEAL = type("KindEnum.SEAL", (KindEnum.SEAL, KindEnum,), {})  # type: ignore
KindEnum.GIFT_WRAP = type("KindEnum.GIFT_WRAP", (KindEnum.GIFT_WRAP, KindEnum,), {})  # type: ignore
KindEnum.SEALED_DIRECT = type("KindEnum.SEALED_DIRECT", (KindEnum.SEALED_DIRECT, KindEnum,), {})  # type: ignore
KindEnum.LONG_FORM_TEXT_NOTE = type("KindEnum.LONG_FORM_TEXT_NOTE", (KindEnum.LONG_FORM_TEXT_NOTE, KindEnum,), {})  # type: ignore
KindEnum.APPLICATION_SPECIFIC_DATA = type("KindEnum.APPLICATION_SPECIFIC_DATA", (KindEnum.APPLICATION_SPECIFIC_DATA, KindEnum,), {})  # type: ignore
KindEnum.FILE_METADATA = type("KindEnum.FILE_METADATA", (KindEnum.FILE_METADATA, KindEnum,), {})  # type: ignore
KindEnum.HTTP_AUTH = type("KindEnum.HTTP_AUTH", (KindEnum.HTTP_AUTH, KindEnum,), {})  # type: ignore
KindEnum.SET_STALL = type("KindEnum.SET_STALL", (KindEnum.SET_STALL, KindEnum,), {})  # type: ignore
KindEnum.SET_PRODUCT = type("KindEnum.SET_PRODUCT", (KindEnum.SET_PRODUCT, KindEnum,), {})  # type: ignore
KindEnum.JOB_FEEDBACK = type("KindEnum.JOB_FEEDBACK", (KindEnum.JOB_FEEDBACK, KindEnum,), {})  # type: ignore
KindEnum.JOB_REQUEST = type("KindEnum.JOB_REQUEST", (KindEnum.JOB_REQUEST, KindEnum,), {})  # type: ignore
KindEnum.JOB_RESULT = type("KindEnum.JOB_RESULT", (KindEnum.JOB_RESULT, KindEnum,), {})  # type: ignore
KindEnum.REGULAR = type("KindEnum.REGULAR", (KindEnum.REGULAR, KindEnum,), {})  # type: ignore
KindEnum.REPLACEABLE = type("KindEnum.REPLACEABLE", (KindEnum.REPLACEABLE, KindEnum,), {})  # type: ignore
KindEnum.EPHEMERAL = type("KindEnum.EPHEMERAL", (KindEnum.EPHEMERAL, KindEnum,), {})  # type: ignore
KindEnum.PARAMETERIZED_REPLACEABLE = type("KindEnum.PARAMETERIZED_REPLACEABLE", (KindEnum.PARAMETERIZED_REPLACEABLE, KindEnum,), {})  # type: ignore
KindEnum.CUSTOM = type("KindEnum.CUSTOM", (KindEnum.CUSTOM, KindEnum,), {})  # type: ignore




class _UniffiConverterTypeKindEnum(_UniffiConverterRustBuffer):
    @staticmethod
    def read(buf):
        variant = buf.read_i32()
        if variant == 1:
            return KindEnum.METADATA(
            )
        if variant == 2:
            return KindEnum.TEXT_NOTE(
            )
        if variant == 3:
            return KindEnum.RECOMMEND_RELAY(
            )
        if variant == 4:
            return KindEnum.CONTACT_LIST(
            )
        if variant == 5:
            return KindEnum.OPEN_TIMESTAMPS(
            )
        if variant == 6:
            return KindEnum.ENCRYPTED_DIRECT_MESSAGE(
            )
        if variant == 7:
            return KindEnum.EVENT_DELETION(
            )
        if variant == 8:
            return KindEnum.REPOST(
            )
        if variant == 9:
            return KindEnum.GENERIC_REPOST(
            )
        if variant == 10:
            return KindEnum.REACTION(
            )
        if variant == 11:
            return KindEnum.BADGE_AWARD(
            )
        if variant == 12:
            return KindEnum.CHANNEL_CREATION(
            )
        if variant == 13:
            return KindEnum.CHANNEL_METADATA(
            )
        if variant == 14:
            return KindEnum.CHANNEL_MESSAGE(
            )
        if variant == 15:
            return KindEnum.CHANNEL_HIDE_MESSAGE(
            )
        if variant == 16:
            return KindEnum.CHANNEL_MUTE_USER(
            )
        if variant == 17:
            return KindEnum.PUBLIC_CHAT_RESERVED45(
            )
        if variant == 18:
            return KindEnum.PUBLIC_CHAT_RESERVED46(
            )
        if variant == 19:
            return KindEnum.PUBLIC_CHAT_RESERVED47(
            )
        if variant == 20:
            return KindEnum.PUBLIC_CHAT_RESERVED48(
            )
        if variant == 21:
            return KindEnum.PUBLIC_CHAT_RESERVED49(
            )
        if variant == 22:
            return KindEnum.LABEL(
            )
        if variant == 23:
            return KindEnum.WALLET_CONNECT_INFO(
            )
        if variant == 24:
            return KindEnum.REPORTING(
            )
        if variant == 25:
            return KindEnum.ZAP_PRIVATE_MESSAGE(
            )
        if variant == 26:
            return KindEnum.ZAP_REQUEST(
            )
        if variant == 27:
            return KindEnum.ZAP_RECEIPT(
            )
        if variant == 28:
            return KindEnum.MUTE_LIST(
            )
        if variant == 29:
            return KindEnum.PIN_LIST(
            )
        if variant == 30:
            return KindEnum.BOOKMARKS(
            )
        if variant == 31:
            return KindEnum.COMMUNITIES(
            )
        if variant == 32:
            return KindEnum.PUBLIC_CHATS(
            )
        if variant == 33:
            return KindEnum.BLOCKED_RELAYS(
            )
        if variant == 34:
            return KindEnum.SEARCH_RELAYS(
            )
        if variant == 35:
            return KindEnum.SIMPLE_GROUPS(
            )
        if variant == 36:
            return KindEnum.INTERESTS(
            )
        if variant == 37:
            return KindEnum.EMOJIS(
            )
        if variant == 38:
            return KindEnum.FOLLOW_SETS(
            )
        if variant == 39:
            return KindEnum.RELAY_SETS(
            )
        if variant == 40:
            return KindEnum.BOOKMARK_SETS(
            )
        if variant == 41:
            return KindEnum.ARTICLES_CURATION_SETS(
            )
        if variant == 42:
            return KindEnum.VIDEOS_CURATION_SETS(
            )
        if variant == 43:
            return KindEnum.INTEREST_SETS(
            )
        if variant == 44:
            return KindEnum.EMOJI_SETS(
            )
        if variant == 45:
            return KindEnum.RELEASE_ARTIFACT_SETS(
            )
        if variant == 46:
            return KindEnum.RELAY_LIST(
            )
        if variant == 47:
            return KindEnum.AUTHENTICATION(
            )
        if variant == 48:
            return KindEnum.WALLET_CONNECT_REQUEST(
            )
        if variant == 49:
            return KindEnum.WALLET_CONNECT_RESPONSE(
            )
        if variant == 50:
            return KindEnum.NOSTR_CONNECT(
            )
        if variant == 51:
            return KindEnum.LIVE_EVENT(
            )
        if variant == 52:
            return KindEnum.LIVE_EVENT_MESSAGE(
            )
        if variant == 53:
            return KindEnum.PROFILE_BADGES(
            )
        if variant == 54:
            return KindEnum.BADGE_DEFINITION(
            )
        if variant == 55:
            return KindEnum.SEAL(
            )
        if variant == 56:
            return KindEnum.GIFT_WRAP(
            )
        if variant == 57:
            return KindEnum.SEALED_DIRECT(
            )
        if variant == 58:
            return KindEnum.LONG_FORM_TEXT_NOTE(
            )
        if variant == 59:
            return KindEnum.APPLICATION_SPECIFIC_DATA(
            )
        if variant == 60:
            return KindEnum.FILE_METADATA(
            )
        if variant == 61:
            return KindEnum.HTTP_AUTH(
            )
        if variant == 62:
            return KindEnum.SET_STALL(
            )
        if variant == 63:
            return KindEnum.SET_PRODUCT(
            )
        if variant == 64:
            return KindEnum.JOB_FEEDBACK(
            )
        if variant == 65:
            return KindEnum.JOB_REQUEST(
                _UniffiConverterUInt16.read(buf),
            )
        if variant == 66:
            return KindEnum.JOB_RESULT(
                _UniffiConverterUInt16.read(buf),
            )
        if variant == 67:
            return KindEnum.REGULAR(
                _UniffiConverterUInt16.read(buf),
            )
        if variant == 68:
            return KindEnum.REPLACEABLE(
                _UniffiConverterUInt16.read(buf),
            )
        if variant == 69:
            return KindEnum.EPHEMERAL(
                _UniffiConverterUInt16.read(buf),
            )
        if variant == 70:
            return KindEnum.PARAMETERIZED_REPLACEABLE(
                _UniffiConverterUInt16.read(buf),
            )
        if variant == 71:
    ...
    def check_lower(value):
        if value.is_metadata():
            return
        if value.is_text_note():
            return
        if value.is_recommend_relay():
            return
        if value.is_contact_list():
            return
        if value.is_open_timestamps():
            return
        if value.is_encrypted_direct_message():
            return
        if value.is_event_deletion():
            return
        if value.is_repost():
            return
        if value.is_generic_repost():
            return
        if value.is_reaction():
            return
        if value.is_badge_award():
            return
        if value.is_channel_creation():
            return
        if value.is_channel_metadata():
            return
        if value.is_channel_message():
            return
        if value.is_channel_hide_message():
            return
        if value.is_channel_mute_user():
            return
        if value.is_public_chat_reserved45():
            return
        if value.is_public_chat_reserved46():
            return
        if value.is_public_chat_reserved47():
            return
        if value.is_public_chat_reserved48():
            return
        if value.is_public_chat_reserved49():
            return
        if value.is_label():
            return
        if value.is_wallet_connect_info():
            return
        if value.is_reporting():
            return
        if value.is_zap_private_message():
            return
        if value.is_zap_request():
            return
        if value.is_zap_receipt():
            return
        if value.is_mute_list():
            return
        if value.is_pin_list():
            return
        if value.is_bookmarks():
            return
        if value.is_communities():
            return
        if value.is_public_chats():
            return
        if value.is_blocked_relays():
            return
        if value.is_search_relays():
            return
        if value.is_simple_groups():
            return
        if value.is_interests():
            return
        if value.is_emojis():
            return
        if value.is_follow_sets():
            return
        if value.is_relay_sets():
            return
        if value.is_bookmark_sets():
            return
        if value.is_articles_curation_sets():
            return
        if value.is_videos_curation_sets():
            return
        if value.is_interest_sets():
            return
        if value.is_emoji_sets():
            return
        if value.is_release_artifact_sets():
            return
        if value.is_relay_list():
            return
        if value.is_authentication():
            return
        if value.is_wallet_connect_request():
            return
        if value.is_wallet_connect_response():
            return
        if value.is_nostr_connect():
            return
        if value.is_live_event():
            return
        if value.is_live_event_message():
            return
        if value.is_profile_badges():
            return
        if value.is_badge_definition():
            return
        if value.is_seal():
            return
        if value.is_gift_wrap():
            return
        if value.is_sealed_direct():
            return
        if value.is_long_form_text_note():
            return
        if value.is_application_specific_data():
            return
        if value.is_file_metadata():
            return
        if value.is_http_auth():
            return
        if value.is_set_stall():
            return
        if value.is_set_product():
            return
        if value.is_job_feedback():
            return
        if value.is_job_request():
            _UniffiConverterUInt16.check_lower(value.kind)
            return
        if value.is_job_result():
            _UniffiConverterUInt16.check_lower(value.kind)
            return
        if value.is_regular():
            _UniffiConverterUInt16.check_lower(value.kind)
            return
        if value.is_replaceable():
            _UniffiConverterUInt16.check_lower(value.kind)
            return
        if value.is_ephemeral():
            _UniffiConverterUInt16.check_lower(value.kind)
            return
        if value.is_parameterized_replaceable():
            _UniffiConverterUInt16.check_lower(value.kind)
            return
        if value.is_custom():
            _UniffiConverterUInt64.check_lower(value.kind)
    ...
    def write(value, buf):
        ...
        if value.is_job_request():
            buf.write_i32(65)
            _UniffiConverterUInt16.write(value.kind, buf)
        if value.is_job_result():
            buf.write_i32(66)
            _UniffiConverterUInt16.write(value.kind, buf)
        if value.is_regular():
...
class Marker:
    ...
    class MENTION:
        ...
        def __str__(self):
            return "Marker.MENTION()".format()

        def __eq__(self, other):
            if not other.is_mention():
                return False
            return True
    ...
    def is_mention(self) -> bool:
        return isinstance(self, Marker.MENTION)
    def is_custom(self) -> bool:
...
Marker.MENTION = type("Marker.MENTION", (Marker.MENTION, Marker,), {})  # type: ignore
...
class RelayMessageEnum:
    ...
    class NEG_ERR:
        ...
        def __str__(self):
            return "RelayMessageEnum.NEG_ERR(subscription_id={}, code={})".format(self.subscription_id, self.code)
...
class TagEnum:
    ...
    class A:
        ...
        @typing.no_type_check
        def __init__(self,coordinate: "Coordinate", relay_url: "typing.Optional[str]"):
            self.coordinate = coordinate
            self.relay_url = relay_url

        def __str__(self):
            return "TagEnum.A(coordinate={}, relay_url={})".format(self.coordinate, self.relay_url)
    ...
    class KIND:
        ...
        @typing.no_type_check
        def __init__(self,kind: "KindEnum"):
            self.kind = kind

        def __str__(self):
            return "TagEnum.KIND(kind={})".format(self.kind)

        def __eq__(self, other):
            if not other.is_kind():
                return False
            if self.kind != other.kind:
                return False
            return True
    ...
    class WORD:
        ...
        def __str__(self):
            return "TagEnum.WORD(word={})".format(self.word)
    ...
    class LABEL_NAMESPACE:
        ...
        def __str__(self):
            return "TagEnum.LABEL_NAMESPACE(namespace={})".format(self.namespace)
    ...
    class LABEL:
        ...
        @typing.no_type_check
        def __init__(self,label: "typing.List[str]"):
            self.label = label

        def __str__(self):
            return "TagEnum.LABEL(label={})".format(self.label)
    ...
    def is_kind(self) -> bool:
        return isinstance(self, TagEnum.KIND)
    ...
    def is_word(self) -> bool:
        return isinstance(self, TagEnum.WORD)
    def is_label_namespace(self) -> bool:
        return isinstance(self, TagEnum.LABEL_NAMESPACE)
    def is_label(self) -> bool:
        return isinstance(self, TagEnum.LABEL)
...
TagEnum.KIND = type("TagEnum.KIND", (TagEnum.KIND, TagEnum,), {})  # type: ignore
...
TagEnum.WORD = type("TagEnum.WORD", (TagEnum.WORD, TagEnum,), {})  # type: ignore
TagEnum.LABEL_NAMESPACE = type("TagEnum.LABEL_NAMESPACE", (TagEnum.LABEL_NAMESPACE, TagEnum,), {})  # type: ignore
TagEnum.LABEL = type("TagEnum.LABEL", (TagEnum.LABEL, TagEnum,), {})  # type: ignore
...
class _UniffiConverterTypeTagEnum(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        ...
        if variant == 14:
            return TagEnum.KIND(
                _UniffiConverterTypeKindEnum.read(buf),
            )
        if variant == 15:
        ...
        if variant == 59:
            return TagEnum.LABEL_NAMESPACE(
                _UniffiConverterString.read(buf),
            )
        if variant == 60:
    ...
    def check_lower(value):
        ...
        if value.is_a():
            ...
            return
        if value.is_kind():
            _UniffiConverterTypeKindEnum.check_lower(value.kind)
            return
        ...
        if value.is_label_namespace():
            ...
            return
        if value.is_label():
            _UniffiConverterSequenceString.check_lower(value.label)
            return
        raise ValueError(value)
    ...
    def write(value, buf):
        ...
        if value.is_kind():
            buf.write_i32(14)
            _UniffiConverterTypeKindEnum.write(value.kind, buf)
        if value.is_relay_url():
            buf.write_i32(15)
            _UniffiConverterString.write(value.relay_url, buf)
        if value.is_pow():
        ...
        if value.is_label():
            buf.write_i32(60)
            _UniffiConverterSequenceString.write(value.label, buf)
...
def decrypt_received_private_zap_message(secret_key: "SecretKey",private_zap: "Event") -> "Event":
    ...
    return _UniffiConverterTypeEvent.lift(_rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_func_decrypt_received_private_zap_message,
        _UniffiConverterTypeSecretKey.lower(secret_key),
...
def decrypt_sent_private_zap_message(secret_key: "SecretKey",public_key: "PublicKey",private_zap: "Event") -> "Event":
    ...
    return _UniffiConverterTypeEvent.lift(_rust_call_with_error(_UniffiConverterTypeNostrError,_UniffiLib.uniffi_nostr_ffi_fn_func_decrypt_sent_private_zap_message,
        _UniffiConverterTypeSecretKey.lower(secret_key),
        _UniffiConverterTypePublicKey.lower(public_key),
        _UniffiConverterTypeEvent.lower(private_zap)))


def extract_relay_list(event: "Event") -> "dict[str, typing.Optional[RelayMetadata]]":
    """
...
def gift_wrap(sender_keys: "Keys",receiver_pubkey: "PublicKey",rumor: "UnsignedEvent",expiration: "typing.Optional[Timestamp]") -> "Event":
    """
    Build Gift Wrap
...
def validate_delegation_tag(delegation_tag: "str",delegatee_pubkey: "PublicKey",event_kind: "Kind",created_at: "int") -> "bool":
    """
    ...
    _UniffiConverterTypeKind.check_lower(event_kind)
    ...
    return _UniffiConverterBool.lift(_rust_call(_UniffiLib.uniffi_nostr_ffi_fn_func_validate_delegation_tag,
        ...
        _UniffiConverterTypePublicKey.lower(delegatee_pubkey),
        _UniffiConverterTypeKind.lower(event_kind),
...
def verify_nip05(public_key: "PublicKey",nip05: "str",proxy: "typing.Optional[str]") -> None:
    _UniffiConverterTypePublicKey.check_lower(public_key)
