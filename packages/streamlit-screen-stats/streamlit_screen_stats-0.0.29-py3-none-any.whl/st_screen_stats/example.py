...
from ScreenData.__init__ import ScreenData

# st_screen_stats import ScreenData, StreamlitNativeWidgetScreen, WindowQuerySize, WindowScreenRange # ScreenData, StreamlitNativeWidgetScreen

st.set_page_config(layout="wide")

screenD = ScreenData()
screen_d = screenD.screen_size_data()
st.write(screen_d)
...
# screen_d = screenD.st_screen_data_window(default="Hiya!")  #st_screen_data_window_top()
# time.sleep(2)
