...
class UpdateQuestionnaireRequest(object):
    ...
    def __init__(self, lc_questionnaire_name=None, questionnaire_name=None, question_ids=None, questionnaire_details=None, date_created=None, last_updated=None, questions=None, recruiter_user_id=None):  # noqa: E501
