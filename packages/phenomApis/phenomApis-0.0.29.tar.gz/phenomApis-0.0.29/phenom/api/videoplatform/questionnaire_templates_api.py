...
class QuestionnaireTemplatesApi(object):
    ...
    def publish_questionnaire(self, questionnaire_id, **kwargs):  # noqa: E501
        """Publish Questionnaire  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.publish_questionnaire(questionnaire_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.publish_questionnaire_with_http_info(questionnaire_id, **kwargs)  # noqa: E501
        else:
            (data) = self.publish_questionnaire_with_http_info(questionnaire_id, **kwargs)  # noqa: E501
            return data

    def publish_questionnaire_with_http_info(self, questionnaire_id, **kwargs):  # noqa: E501
        """Publish Questionnaire  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.publish_questionnaire_with_http_info(questionnaire_id, async_req=True)
        >>> result = thread.get()
