...
def main():
    ...
    parser.add_argument("-v", "--variables", default="x,y,z", help="Comma-separated list of variables")
    parser.add_argument("-d", "--degree", type=int, default=2, help="Degree of the polynomial")
