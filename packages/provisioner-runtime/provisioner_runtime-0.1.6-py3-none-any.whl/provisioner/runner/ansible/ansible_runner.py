...
ANSIBLE_CFG_PYTHON_PACKAGE = "provisioner.runner.ansible.resources"
ANSIBLE_CFG_FILE_NAME = "ansible.cfg"

ANSIBLE_CALLBACK_PLUGINS_PYTHON_PACKAGE = "provisioner.runner.ansible.resources.callback_plugins"
