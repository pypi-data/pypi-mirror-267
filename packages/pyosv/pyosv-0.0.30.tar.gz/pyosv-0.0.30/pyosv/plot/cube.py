...
def stacked_cube_plot(imgs : list, save_path : str, cmaps : list, band_thickness : int = 3, spacing : int = 10, show : bool = True) -> None:
    '''
        ...
        stacked_cube_plot([img_1, img_2], 'img.png', band_thickness=10, spacing=10, cmap='jet', show=True)
...
if __name__ == "__main__":
    ...
    stacked_cube_plot([img, img2, img, img2, img], None, cmaps=['jet','jet','jet', 'jet', 'jet'], band_thickness=10, spacing=30, show=True)
