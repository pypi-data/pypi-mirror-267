...
def stacked_cube_plot(imgs : list, save_path : str, band_thinkness : int = 3, spacing : int = 10, cmap : str = 'jet', show : bool = True) -> None:
    '''
    ...
    for i, img in enumerate(imgs):
        ...
        # Depth slices
        mlab.volume_slice(scalars, slice_index=img.shape[-1] + i*spacing, plane_orientation='z_axes', figure=fig, colormap=cmap)  # depth slice
        mlab.volume_slice(scalars, slice_index=0, plane_orientation='z_axes', figure=fig, colormap=cmap)  # depth slice
