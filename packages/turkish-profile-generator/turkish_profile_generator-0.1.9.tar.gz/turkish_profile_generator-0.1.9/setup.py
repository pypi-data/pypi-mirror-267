...
setuptools.setup(
    ...
    project_urls={
        ...
        'Bug Reports':
        'https://github.com/bossturk/turkish-profile-generator/issues',
    ...
    #         'run=turkish_profile_generator:main',
    # You can execute `run` in bash to run `main()` in src/turkish_profile_generator/__init__.py
    #     ],
    # },
)
