...
pymupdf_git_sha = 'fddd4eac529b19a642564222e4d4aed64af3ce36'
pymupdf_git_comment = f'whatever'
pymupdf_git_diff = f'diff --git a/fitz/table.py b/fitz/table.py\nindex b62e533..fadb7ab 100644\n--- a/fitz/table.py\n+++ b/fitz/table.py\n@@ -1,4 +1,5 @@\n """\n+MOD\n Copyright (C) 2023 Artifex Software, Inc.\n \n This file is part of PyMuPDF.\ndiff --git a/setup.py b/setup.py\nindex 0887dfb..f093a3f 100755\n--- a/setup.py\n+++ b/setup.py\n@@ -1212,14 +1212,13 @@ else:\n     assert 0, f\'Unrecognised flavour: {{g_flavour}}\'\n \n p = pipcl.Package(\n-        name,\n-        version,\n+        \'AqPyMuPdf\',\n+        \'1.23.7\',\n         summary = summary,\n         description = readme,\n         description_content_type = \'text/markdown\',\n         classifier = classifier,\n-        author = \'Artifex\',\n-        author_email = \'support@artifex.com\',\n+        author = \'Lili\',\n         requires_dist = requires_dist,\n         requires_python = \'>=3.8\',\n         license = \'GNU AFFERO GPL 3.0\',\n'
pymupdf_git_branch = f'main'

mupdf_git_sha = 'fddd4eac529b19a642564222e4d4aed64af3ce36'
mupdf_git_comment = f'whatever'
mupdf_git_diff = f'diff --git a/fitz/table.py b/fitz/table.py\nindex b62e533..fadb7ab 100644\n--- a/fitz/table.py\n+++ b/fitz/table.py\n@@ -1,4 +1,5 @@\n """\n+MOD\n Copyright (C) 2023 Artifex Software, Inc.\n \n This file is part of PyMuPDF.\ndiff --git a/setup.py b/setup.py\nindex 0887dfb..f093a3f 100755\n--- a/setup.py\n+++ b/setup.py\n@@ -1212,14 +1212,13 @@ else:\n     assert 0, f\'Unrecognised flavour: {{g_flavour}}\'\n \n p = pipcl.Package(\n-        name,\n-        version,\n+        \'AqPyMuPdf\',\n+        \'1.23.7\',\n         summary = summary,\n         description = readme,\n         description_content_type = \'text/markdown\',\n         classifier = classifier,\n-        author = \'Artifex\',\n-        author_email = \'support@artifex.com\',\n+        author = \'Lili\',\n         requires_dist = requires_dist,\n         requires_python = \'>=3.8\',\n         license = \'GNU AFFERO GPL 3.0\',\n'
