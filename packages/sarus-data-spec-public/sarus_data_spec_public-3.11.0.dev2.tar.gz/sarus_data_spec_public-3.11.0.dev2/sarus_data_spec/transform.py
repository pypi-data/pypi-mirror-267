...
def transform_id(transform: st.Transform) -> str:
    ...
    if transform.protobuf().name == "push_sql":
        # transform id of push_sql use parameter
        dataconnection_name = spec.push_sql.dataconnection_name
        schema_name = spec.push_sql.schema_name
        table_name = spec.push_sql.table_name
        return f"{spec_type}.{dataconnection_name}.{schema_name}.{table_name}"
