...
def analyze_group_differences(meta_ome, 
    ...
    ome_type_annotations = ["clustering"]*len(meta_ome.cat_omes_full) + ["test"] * len(test_cat) + ["clustering"] * len(meta_ome.num_omes_full) + ["test"] * len(test_num)
