    ...
    def pub_date(self):
        if self._pub_date is None:
            self._pub_date = self.get_via_config_value(
                "date", self.config.optional["publication"]
            )
    ...
    def pub_place(self):
        if self._pub_place is None:
            self._pub_place = self.get_via_config_value(
                "place", self.config.optional["publication"]
            )
    ...
    def pub_date_edition(self):
        if self._pub_date_edition is None:
            self._pub_date_edition = self.get_via_config_value(
                "date", self.config.optional["edition"]
            )
    ...
    def edition_pub_place(self):
        if self._edtion_pub_place is None:
            self._edtion_pub_place = self.get_via_config_value(
                "place", self.config.optional["edition"]
            )
    ...
    def author_gender(self):
        if self._author_gender is None:
            self._author_gender = self.get_via_config_value(
                "gender", self.config.optional["author"]
            )
    ...
    def as_dict(self):
        if self._as_dict is None:
            self._as_dict = {
                ...
                "base_classifications": self.config.base_classifications(),
                "edition": {
