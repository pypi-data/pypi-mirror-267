...
class PostInvite200ResponseWg(BaseModel):
    """
    PostInvite200ResponseWg
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostInvite200ResponseWg from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostInvite200ResponseWg from a dict"""
        if obj is None:
            return None
