...
class GetWg200Response(BaseModel):
    """
    GetWg200Response
    """ # noqa: E501
    ...
    flatmates: Optional[List[GetWg200ResponseFlatmatesInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetWg200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetWg200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "flatmates": [GetWg200ResponseFlatmatesInner.from_dict(_item) for _item in obj["flatmates"]] if obj.get("flatmates") is not None else None
        })
        return _obj
