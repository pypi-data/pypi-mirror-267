...
class PostShouts200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "creatorId", "insertDate", "shout", "shoutType", "numLikes", "numComments", "commentsUnread", "comments", "likes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostShouts200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostShouts200Response from a dict"""
        if obj is None:
            return None
