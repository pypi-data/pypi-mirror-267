...
class GetShoppinglist200ResponseInner(BaseModel):
    """
    GetShoppinglist200ResponseInner
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetShoppinglist200ResponseInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetShoppinglist200ResponseInner from a dict"""
        if obj is None:
            return None
