...
class GetWg200ResponseFlatmatesInner(BaseModel):
    """
    GetWg200ResponseFlatmatesInner
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetWg200ResponseFlatmatesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetWg200ResponseFlatmatesInner from a dict"""
        if obj is None:
            return None
