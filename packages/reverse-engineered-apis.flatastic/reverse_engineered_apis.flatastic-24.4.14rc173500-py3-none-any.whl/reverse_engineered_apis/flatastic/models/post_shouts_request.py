...
class PostShoutsRequest(BaseModel):
    """
    PostShoutsRequest
    """ # noqa: E501
    shout: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["shout"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostShoutsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostShoutsRequest from a dict"""
        if obj is None:
            return None
