...
class PostInvite200ResponseNewFlatmate(BaseModel):
    """
    PostInvite200ResponseNewFlatmate
    """ # noqa: E501
    ...
    last_name: Optional[Dict[str, Any]] = Field(default=None, alias="lastName")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostInvite200ResponseNewFlatmate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostInvite200ResponseNewFlatmate from a dict"""
        if obj is None:
            return None
