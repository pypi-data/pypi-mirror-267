...
class PostShoppinglistRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "isChecked", "inserterId", "details", "bought"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostShoppinglistRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostShoppinglistRequest from a dict"""
        if obj is None:
            return None
