...
class PostRegisterDeviceRequest(BaseModel):
    """
    PostRegisterDeviceRequest
    """ # noqa: E501
    ...
    apns_token: Optional[StrictStr] = Field(default=None, alias="apnsToken")
    __properties: ClassVar[List[str]] = ["deviceToken", "platform", "senderId", "apnsToken"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostRegisterDeviceRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostRegisterDeviceRequest from a dict"""
        if obj is None:
            return None
