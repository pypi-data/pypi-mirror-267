...
class PostLogin200ResponseWg(BaseModel):
    """
    PostLogin200ResponseWg
    """ # noqa: E501
    ...
    flatmates: Optional[List[PostLogin200ResponseWgFlatmatesInner]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostLogin200ResponseWg from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostLogin200ResponseWg from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "flatmates": [PostLogin200ResponseWgFlatmatesInner.from_dict(_item) for _item in obj["flatmates"]] if obj.get("flatmates") is not None else None
        })
        return _obj
