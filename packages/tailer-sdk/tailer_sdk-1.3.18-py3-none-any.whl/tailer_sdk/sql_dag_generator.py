...
def build_copy_bq_table_task(
    ...
    # Write mode
    #
    write_disposition = payload.get("write_disposition", None)
...
def build_delete_bq_table_task(
    ...
    try:
        bq_table_date_suffix = str(payload["bq_table_date_suffix"])
        bq_table_date_suffix_format = payload["bq_table_date_suffix_format"].strip()

    except Exception:
        bq_table_date_suffix = "False"
        bq_table_date_suffix_format = ""
    ...
    execute_bq_delete_table(gcp_project_id = \"""" + gcp_project_id.strip() + """\",
        ...
        bq_table_date_suffix = """ + bq_table_date_suffix + """,
        bq_table_date_suffix_format = \"""" + bq_table_date_suffix_format + """\",
        default_bq_data_location = \"""" + default_bq_data_location + """\",
        firestore_com_id=firestore_com_id,
        task_id = \"""" + task_id + """\"
        )
...
def build_create_bq_table_task(
    ...
    #
    try:
        bq_table_timepartitioning_require_partition_filter = payload_ddl['bq_table_timepartitioning_require_partition_filter']
    except:
    ...
    #
    try:
        bq_table_require_partition_filter = payload_ddl['bq_table_require_partition_filter']
    except:
        bq_table_require_partition_filter = bq_table_timepartitioning_require_partition_filter
