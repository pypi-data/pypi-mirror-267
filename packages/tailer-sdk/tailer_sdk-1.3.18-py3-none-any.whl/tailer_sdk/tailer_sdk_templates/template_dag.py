...
def execute_bq_delete_table(  
        ...
        bq_dataset: str,
        bq_table: str,
        bq_table_date_suffix: bool,
        bq_table_date_suffix_format: str,
    ...
    try:
        ...
        logging.info("{} bq_table_date_suffix : {}".format(caller_task_id_for_logging, str(bq_table_date_suffix)))
        logging.info("{} bq_table_date_suffix_format : {}".format(caller_task_id_for_logging, bq_table_date_suffix_format))
        ...
        # Process table suffix if required
        #
        if bq_table_date_suffix is True:
            today = datetime.datetime.now().strftime(bq_table_date_suffix_format)
            logging.info("{} Today : {}".format(caller_task_id_for_logging, today))
            bq_table += "_" + today
            logging.info("{} modified table name : {}".format(caller_task_id_for_logging, bq_table))
...
def execute_bq_create_table(
    ...
    try:
        ...
        if force_delete is True:
            ...
            # table_tmp.require_partition_filter
