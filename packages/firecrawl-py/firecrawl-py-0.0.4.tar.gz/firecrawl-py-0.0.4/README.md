...
To use the Firecrawl Python SDK, you need to have an API key. You can either provide the API key when initializing the `FirecrawlApp` class or set it as an environment variable named `FIRECRAWL_API_KEY`.
