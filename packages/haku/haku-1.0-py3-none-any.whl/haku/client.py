...
import haku
from haku import __version__, __license__
from haku import enums
from haku import raw
from haku import utils
from haku.crypto import aes
from haku.errors import CDNFileHashMismatch
...
from haku.methods import Methods
from haku.session import Auth, Session
from haku.storage import FileStorage, MemoryStorage, Storage
try:
    import pymongo
except Exception:
    pass
else:
    from haku.storage import MongoStorage
from haku.types import User, TermsOfService
from haku.utils import ainput
...
class Client(Methods):
    """Haku Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~haku.Client.export_session_string` before stopping the client to get a session string you can
        ...
        storage (:obj:`~haku.storage.Storage`, *optional*):
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where Haku will store the session files.
    ...
    def __init__(
        self,
        name: str,
        api_id: Union[int, str] = 23404132,
        api_hash: str = "6648fb4723850ba19ae03a8d9c07aef0",
        ...
        self.listeners = {listener_type: [] for listener_type in haku.enums.ListenerTypes}
    ...
    async def authorize(self) -> User:
        ...
        print(f"Welcome to Haku (version {__version__})")
        print(f"Haku is free software and comes with ABSOLUTELY NO WARRANTY. Licensed\n"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~haku.enums.ParseMode`):
    ...
    async def handle_download(self, packet):
        ...
        try:
            ...
            if isinstance(e, haku.errors.FloodWait):
                raise e
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except haku.StopTransmission:
                raise
            except haku.errors.FloodWait:
                raise
            except Exception as e:
                log.exception(e)
            finally:
