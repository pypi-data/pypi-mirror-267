...
from test_tele.web_ui.utils import hide_st
...
if check_password(st):
    ...
    if user_type == "Bot":
        ...
        CONFIG.login.PYROGRAM_SESSION_STRING = st.text_input(
            "Enter pyrogram session string", value=CONFIG.login.PYROGRAM_SESSION_STRING, type="password"
        )
