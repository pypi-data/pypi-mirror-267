...
train_file = "benchmark/hgb_datasets/DNA-PC/train.json"
test_file = "benchmark/hgb_datasets/DNA-PC/test.json"
valid_file = "benchmark/hgb_datasets/DNA-PC/valid.json"
