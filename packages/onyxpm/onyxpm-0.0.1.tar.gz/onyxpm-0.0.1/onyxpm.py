import click
import warnings
from src.Package_Manager.LIBS_CLI.action_5 import action_5
from src.Package_Manager.LIBS_CLI.action_1 import action_1
from src.Package_Manager.LIBS_CLI.check_project_existence import check_project_existence
from src.Package_Manager.LIBS_CLI.cli_tenant_validation import cli_tenant_validation
from src.Package_Manager.LIBS_CLI.get_tenantname import get_tenantname
from src.Package_Manager.LIBS_CLI.action_2 import action_2
from src.Package_Manager.LIBS_CLI.action_3 import action_3
from src.Package_Manager.LIBS_CLI.action_4 import action_4
from src.Package_Manager.LIBS_CLI.get_envconf import get_envconf
from src.Package_Manager.LIBS_CLI import load_envconf
from src.Package_Manager.LIBS_CLI.exist_envconf import exist_envconf
import urllib3
...
@click.option('-i', '--script_type', help='Script type')
@click.option('-o', '--object_name', help='Object name', default='ALL')
