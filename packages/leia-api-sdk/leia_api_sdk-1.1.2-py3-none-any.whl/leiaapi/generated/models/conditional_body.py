...
class ConditionalBody(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ConditionalBody:
        """Create an instance of ConditionalBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ConditionalBody:
        """Create an instance of ConditionalBody from a dict"""
        if obj is None:
            return None
