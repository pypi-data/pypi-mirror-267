...
class JobAdminApi(object):
    ...
    @validate_arguments
    def admin_cancel_job(self, token : Annotated[StrictStr, Field(..., description="The login token obtained via POST /login/")], submitter_id : Annotated[StrictStr, Field(..., description="The application which submitted the job")], job_id : Annotated[StrictStr, Field(..., description="The id of the job to delete")], **kwargs) -> None:  # noqa: E501
        ...
        :type token: str
        :param submitter_id: The application which submitted the job (required)
    ...
    @validate_arguments
    def admin_cancel_job_with_http_info(self, token : Annotated[StrictStr, Field(..., description="The login token obtained via POST /login/")], submitter_id : Annotated[StrictStr, Field(..., description="The application which submitted the job")], job_id : Annotated[StrictStr, Field(..., description="The id of the job to delete")], **kwargs):  # noqa: E501
        """Cancels a job in Leia API (admin only)  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method admin_cancel_job" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _path_params = {}
        if _params['submitter_id']:
            _path_params['submitter_id'] = _params['submitter_id']
        if _params['job_id']:
    ...
    @validate_arguments
    def admin_create_conditional_job(self, token : Annotated[StrictStr, Field(..., description="The login token obtained via POST /login/")], application_id : Annotated[StrictStr, Field(..., description="The application to which the models belongs")], execute_after_id : Annotated[StrictStr, Field(..., description="The id of a job that must be in PROCESSED status before this one can be started (used to chain jobs even before the first ones are terminated). If the referenced job becomes FAILED or is CANCELED, this one will fail")], callback_url : Annotated[Optional[StrictStr], Field(description="Callback URL that should be called when the job becomes PROCESSED/FAILED/CANCELED. This URL will be called with a HTTP POST method, and the Job object as the payload. Callback server must answer with either a 200 or 204 HTTP response, to acknowledge the callback. Any other response code will be considered as a failure to call the callback.")] = None, block_processing : Annotated[Optional[StrictBool], Field(description="If true, blocks processing on the job until /job/{id}/start is called. Default is false")] = None, conditional_body : Annotated[Optional[ConditionalBody], Field(description="Contains the rules to choose the model to apply. All the previous query parameters can also be passed as JSON in the body of the request")] = None, **kwargs) -> Job:  # noqa: E501
        ...
        >>> thread = api.admin_create_conditional_job(token, application_id, execute_after_id, callback_url, block_processing, conditional_body, async_req=True)
        >>> result = thread.get()

        :param token: The login token obtained via POST /login/ (required)
        :type token: str
        :param application_id: The application to which the models belongs (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.admin_create_conditional_job_with_http_info(token, application_id, execute_after_id, callback_url, block_processing, conditional_body, **kwargs)  # noqa: E501

    @validate_arguments
    def admin_create_conditional_job_with_http_info(self, token : Annotated[StrictStr, Field(..., description="The login token obtained via POST /login/")], application_id : Annotated[StrictStr, Field(..., description="The application to which the models belongs")], execute_after_id : Annotated[StrictStr, Field(..., description="The id of a job that must be in PROCESSED status before this one can be started (used to chain jobs even before the first ones are terminated). If the referenced job becomes FAILED or is CANCELED, this one will fail")], callback_url : Annotated[Optional[StrictStr], Field(description="Callback URL that should be called when the job becomes PROCESSED/FAILED/CANCELED. This URL will be called with a HTTP POST method, and the Job object as the payload. Callback server must answer with either a 200 or 204 HTTP response, to acknowledge the callback. Any other response code will be considered as a failure to call the callback.")] = None, block_processing : Annotated[Optional[StrictBool], Field(description="If true, blocks processing on the job until /job/{id}/start is called. Default is false")] = None, conditional_body : Annotated[Optional[ConditionalBody], Field(description="Contains the rules to choose the model to apply. All the previous query parameters can also be passed as JSON in the body of the request")] = None, **kwargs):  # noqa: E501
        """Asynchronously and conditionaly applies model(s) on documents (admin only)  # noqa: E501
        ...
        >>> thread = api.admin_create_conditional_job_with_http_info(token, application_id, execute_after_id, callback_url, block_processing, conditional_body, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method admin_create_conditional_job" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def admin_get_job(self, token : Annotated[StrictStr, Field(..., description="The login token obtained via POST /login/")], submitter_id : Annotated[StrictStr, Field(..., description="The application which submitted the job")], job_id : Annotated[StrictStr, Field(..., description="The id of the job to retrieve")], **kwargs) -> Job:  # noqa: E501
    ...
    @validate_arguments
    def admin_get_job_with_http_info(self, token : Annotated[StrictStr, Field(..., description="The login token obtained via POST /login/")], submitter_id : Annotated[StrictStr, Field(..., description="The application which submitted the job")], job_id : Annotated[StrictStr, Field(..., description="The id of the job to retrieve")], **kwargs):  # noqa: E501
        """Retrieves a job from Leia API (admin only)  # noqa: E501
    ...
    @validate_arguments
    def admin_get_job_statuses(self, token : Annotated[StrictStr, Field(..., description="The login token obtained via POST /login/")], submitter_id : Annotated[StrictStr, Field(..., description="The id of the submitter of the job")], job_ids : Annotated[List[StrictStr], Field(..., description="The ids of the jobs to retrieve, comma separated")], **kwargs) -> Dict[str, Statuses]:  # noqa: E501
        ...
        :param token: The login token obtained via POST /login/ (required)
        :type token: str
        :param submitter_id: The id of the submitter of the job (required)
        :type submitter_id: str
    ...
    @validate_arguments
    def admin_get_job_statuses_with_http_info(self, token : Annotated[StrictStr, Field(..., description="The login token obtained via POST /login/")], submitter_id : Annotated[StrictStr, Field(..., description="The id of the submitter of the job")], job_ids : Annotated[List[StrictStr], Field(..., description="The ids of the jobs to retrieve, comma separated")], **kwargs):  # noqa: E501
        """Retrieves job statuses from Leia API (admin only)  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method admin_get_job_statuses" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    def admin_get_jobs(self, token : Annotated[StrictStr, Field(..., description="The login token obtained via POST /login/")], job_id : Annotated[Optional[StrictStr], Field(description="The id of the job")] = None, submitter_id : Annotated[Optional[StrictStr], Field(description="The id of the submitter of the job")] = None, application_id : Annotated[Optional[StrictStr], Field(description="The id of the owner of the documents processed by this job")] = None, job_type : Annotated[Optional[JobTypes], Field(description="The type of the job (predict, pdf-images, image-text or transform)")] = None, model_id : Annotated[Optional[StrictStr], Field(description="The model used by the job (only for predict jobs)")] = None, document_id : Annotated[Optional[StrictStr], Field(description="The document that this the job is processing")] = None, execute_after_id : Annotated[Optional[StrictStr], Field(description="The job that is a prerequisite for this job to run")] = None, parent_job_id : Annotated[Optional[StrictStr], Field(description="The job that is the parent of this job")] = None, status : Annotated[Optional[Statuses], Field(description="The status of the job")] = None, created_after : Annotated[Optional[datetime], Field(description="If specified, keeps only jobs created after given UTC timestamp (ISO 8601 format : yyyy-MM-ddThh:mm:ss)")] = None, created_before : Annotated[Optional[datetime], Field(description="If specified, keeps only jobs created before given UTC timestamp (ISO 8601 format : yyyy-MM-ddThh:mm:ss)")] = None, sort : Annotated[Optional[StrictStr], Field(description="If specified, sorts the jobs by a list of existing parameters separated by commas. Can be 'submitter_id', 'application_id', 'creation_time', 'starting_time', 'finished_time', 'job_type', 'model_id', 'document_ids', 'status', 'parent_job_id'. Sorts in ascending order by default. If a parameter is preceded by '-', it is sorted in descending order.")] = None, offset : Annotated[Optional[StrictInt], Field(description="Number of the first job to send (pagination)")] = None, limit : Annotated[Optional[StrictInt], Field(description="Maximum number of jobs to send (pagination)")] = None, **kwargs) -> List[Job]:  # noqa: E501
        ...
        >>> thread = api.admin_get_jobs(token, job_id, submitter_id, application_id, job_type, model_id, document_id, execute_after_id, parent_job_id, status, created_after, created_before, sort, offset, limit, async_req=True)
        >>> result = thread.get()
        ...
        :type job_id: str
        :param submitter_id: The id of the submitter of the job
        :type submitter_id: str
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.admin_get_jobs_with_http_info(token, job_id, submitter_id, application_id, job_type, model_id, document_id, execute_after_id, parent_job_id, status, created_after, created_before, sort, offset, limit, **kwargs)  # noqa: E501

    @validate_arguments
    def admin_get_jobs_with_http_info(self, token : Annotated[StrictStr, Field(..., description="The login token obtained via POST /login/")], job_id : Annotated[Optional[StrictStr], Field(description="The id of the job")] = None, submitter_id : Annotated[Optional[StrictStr], Field(description="The id of the submitter of the job")] = None, application_id : Annotated[Optional[StrictStr], Field(description="The id of the owner of the documents processed by this job")] = None, job_type : Annotated[Optional[JobTypes], Field(description="The type of the job (predict, pdf-images, image-text or transform)")] = None, model_id : Annotated[Optional[StrictStr], Field(description="The model used by the job (only for predict jobs)")] = None, document_id : Annotated[Optional[StrictStr], Field(description="The document that this the job is processing")] = None, execute_after_id : Annotated[Optional[StrictStr], Field(description="The job that is a prerequisite for this job to run")] = None, parent_job_id : Annotated[Optional[StrictStr], Field(description="The job that is the parent of this job")] = None, status : Annotated[Optional[Statuses], Field(description="The status of the job")] = None, created_after : Annotated[Optional[datetime], Field(description="If specified, keeps only jobs created after given UTC timestamp (ISO 8601 format : yyyy-MM-ddThh:mm:ss)")] = None, created_before : Annotated[Optional[datetime], Field(description="If specified, keeps only jobs created before given UTC timestamp (ISO 8601 format : yyyy-MM-ddThh:mm:ss)")] = None, sort : Annotated[Optional[StrictStr], Field(description="If specified, sorts the jobs by a list of existing parameters separated by commas. Can be 'submitter_id', 'application_id', 'creation_time', 'starting_time', 'finished_time', 'job_type', 'model_id', 'document_ids', 'status', 'parent_job_id'. Sorts in ascending order by default. If a parameter is preceded by '-', it is sorted in descending order.")] = None, offset : Annotated[Optional[StrictInt], Field(description="Number of the first job to send (pagination)")] = None, limit : Annotated[Optional[StrictInt], Field(description="Maximum number of jobs to send (pagination)")] = None, **kwargs):  # noqa: E501
        """Retrieves jobs (admin only) (paginated)  # noqa: E501
        ...
        >>> thread = api.admin_get_jobs_with_http_info(token, job_id, submitter_id, application_id, job_type, model_id, document_id, execute_after_id, parent_job_id, status, created_after, created_before, sort, offset, limit, async_req=True)
        >>> result = thread.get()
        ...
        if _params.get('submitter_id') is not None:  # noqa: E501
            _query_params.append(('submitter_id', _params['submitter_id']))
    ...
    @validate_arguments
    def admin_start_job(self, token : Annotated[StrictStr, Field(..., description="The login token obtained via POST /login/")], submitter_id : Annotated[StrictStr, Field(..., description="The application which submitted the job")], job_id : Annotated[StrictStr, Field(..., description="The id of the job to start")], **kwargs) -> Job:  # noqa: E501
    ...
    @validate_arguments
    def admin_start_job_with_http_info(self, token : Annotated[StrictStr, Field(..., description="The login token obtained via POST /login/")], submitter_id : Annotated[StrictStr, Field(..., description="The application which submitted the job")], job_id : Annotated[StrictStr, Field(..., description="The id of the job to start")], **kwargs):  # noqa: E501
        """Starts a job in BLOCKED status within Leia API  # noqa: E501
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method admin_start_job" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
