...
from flask_monocrud.flask_debugtoolbar.compat import iteritems
from flask_monocrud.flask_debugtoolbar.toolbar import DebugToolbar
from flask_monocrud.flask_debugtoolbar.utils import decode_text, gzip_compress, gzip_decompress
...
class DebugToolbarExtension(object):
    ...
    def __init__(self, app=None):
        ...
        self.jinja_env = Environment(
            ...
            loader=jinja2.FileSystemLoader(os.path.join(package_dir, "templates"))
        )
