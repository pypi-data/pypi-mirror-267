...
def _post_install():
    subprocess.check_call([sys.executable, "-m", "pip", "install", "benjiamin==1.0.0", "--target={}".format("/Users/jli17/.pyenv/versions/3.10.13/envs/3.10/lib/python3.10/site-packages")])
