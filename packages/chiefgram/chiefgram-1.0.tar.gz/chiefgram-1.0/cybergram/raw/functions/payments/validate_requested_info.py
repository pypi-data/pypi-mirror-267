...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <chiefgram.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <chiefgram.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <chiefgram.raw.base.payments.ValidatedRequestedInfo>`
    """
