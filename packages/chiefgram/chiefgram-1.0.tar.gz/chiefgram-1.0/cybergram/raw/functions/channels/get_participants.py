...
class GetParticipants(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`ChannelParticipantsFilter <chiefgram.raw.base.ChannelParticipantsFilter>`):
            N/A
    ...
    Returns:
        :obj:`channels.ChannelParticipants <chiefgram.raw.base.channels.ChannelParticipants>`
    """
