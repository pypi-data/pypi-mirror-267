...
class PasswordSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.account.PasswordSettings`.
    ...
    Parameters:
        ...
        secure_settings (:obj:`SecureSecretSettings <chiefgram.raw.base.SecureSecretSettings>`, *optional*):
            N/A
