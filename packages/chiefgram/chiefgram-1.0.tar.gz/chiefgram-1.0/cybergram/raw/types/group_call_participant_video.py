...
class GroupCallParticipantVideo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.GroupCallParticipantVideo`.
    ...
    Parameters:
        ...
        source_groups (List of :obj:`GroupCallParticipantVideoSourceGroup <chiefgram.raw.base.GroupCallParticipantVideoSourceGroup>`):
            N/A
