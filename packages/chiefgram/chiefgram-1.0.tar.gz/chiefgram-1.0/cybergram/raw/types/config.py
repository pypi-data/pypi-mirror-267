...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <chiefgram.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <chiefgram.raw.base.Reaction>`, *optional*):
            N/A
