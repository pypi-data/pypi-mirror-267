...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <chiefgram.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <chiefgram.raw.base.auth.CodeType>`, *optional*):
            N/A
