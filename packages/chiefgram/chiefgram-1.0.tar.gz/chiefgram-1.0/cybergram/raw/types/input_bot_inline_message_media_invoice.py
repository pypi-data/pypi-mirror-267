...
class InputBotInlineMessageMediaInvoice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.InputBotInlineMessage`.
    ...
    Parameters:
        ...
        provider_data (:obj:`DataJSON <chiefgram.raw.base.DataJSON>`):
            N/A

        photo (:obj:`InputWebDocument <chiefgram.raw.base.InputWebDocument>`, *optional*):
            N/A
