...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <chiefgram.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <chiefgram.raw.base.PopularContact>`):
            N/A
