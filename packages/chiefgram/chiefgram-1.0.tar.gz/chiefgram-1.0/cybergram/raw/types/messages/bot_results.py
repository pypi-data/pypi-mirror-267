...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <chiefgram.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <chiefgram.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <chiefgram.raw.base.InlineBotWebView>`, *optional*):
            N/A
