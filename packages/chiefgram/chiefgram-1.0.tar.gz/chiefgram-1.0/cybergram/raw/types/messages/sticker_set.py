...
class StickerSet(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.messages.StickerSet`.
    ...
    Parameters:
        set (:obj:`StickerSet <chiefgram.raw.base.StickerSet>`):
            N/A

        packs (List of :obj:`StickerPack <chiefgram.raw.base.StickerPack>`):
            N/A

        keywords (List of :obj:`StickerKeyword <chiefgram.raw.base.StickerKeyword>`):
            N/A

        documents (List of :obj:`Document <chiefgram.raw.base.Document>`):
            N/A
