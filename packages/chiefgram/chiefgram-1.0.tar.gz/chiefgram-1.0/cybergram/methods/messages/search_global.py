...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~chiefgram.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~chiefgram.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~chiefgram.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "chiefgram". Get the first 50 results
                async for message in app.search_global("chiefgram", limit=50):
                    print(message.text)
