...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~chiefgram.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, chiefgram.Client):
                self.add_handler(chiefgram.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        chiefgram.handlers.ChosenInlineResultHandler(func, self),
