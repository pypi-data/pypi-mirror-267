...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~chiefgram.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, chiefgram.Client):
                self.add_handler(chiefgram.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        chiefgram.handlers.ChatMemberUpdatedHandler(func, self),
