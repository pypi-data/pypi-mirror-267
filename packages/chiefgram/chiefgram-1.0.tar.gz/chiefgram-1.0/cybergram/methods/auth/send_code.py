...
from chiefgram.errors import PhoneMigrate, NetworkMigrate
from chiefgram.session import Session, Auth
...
class SendCode:
    async def send_code(
        ...
        Returns:
            :obj:`~chiefgram.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.
