...
class Object:
    def __init__(self, client: "chiefgram.Client" = None):
        self._client = client

    def bind(self, client: "chiefgram.Client"):
        """Bind a Client instance to this and to all nested chiefgram objects.

        Parameters:
            client (:obj:`~chiefgram.types.Client`):
                The Client instance to bind this object with. Useful to re-enable bound methods after serializing and
                deserializing chiefgram objects with ``repr`` and ``eval``.
        """
        self._client = client
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/chiefgramchat/167281
