...
class ResendCode:
    async def resend_code(
        ...
        :obj:`~chiefgram.types.SentCode` object returned by :meth:`send_code`.
        ...
        Returns:
            :obj:`~chiefgram.types.SentCode`: On success, an object containing information on the re-sent confirmation
            code is returned.
