...
class Restart:
    async def restart(
        ...
        This method will first call :meth:`~chiefgram.Client.stop` and then :meth:`~chiefgram.Client.start` in a row in
        ...
        Returns:
            :obj:`~chiefgram.Client`: The restarted client itself.
