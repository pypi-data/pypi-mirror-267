...
from chiefgram.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            message (:obj:`~chiefgram.types.Message` | ``str``):
        ...
        Returns:
            ...
            :meth:`~chiefgram.Client.stop_transmission`, None is returned.
