...
import chiefgram
from chiefgram import __version__, __license__
from chiefgram import enums
from chiefgram import raw
from chiefgram import utils
from chiefgram.crypto import aes
from chiefgram.errors import CDNFileHashMismatch
from chiefgram.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    BadRequest
)
from chiefgram.handlers.handler import Handler
from chiefgram.methods import Methods
from chiefgram.session import Auth, Session
from chiefgram.storage import FileStorage, MemoryStorage
from chiefgram.types import User, TermsOfService
from chiefgram.utils import ainput
...
class Client(Methods):
    """chiefgram Client, the main means for interacting with Telegram.
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~chiefgram.Client.export_session_string` before stopping the client to get a session string you can
        ...
        workdir (``str``, *optional*):
            ...
            The working directory is the location in the filesystem where chiefgram will store the session files.
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~chiefgram.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError("The API key is required for new authorizations. "
                                     "More info: https://docs.chiefgram.org/start/auth")
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except chiefgram.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
