...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <chiefgram.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <chiefgram.raw.base.MessageEntity>`, *optional*):
            N/A
