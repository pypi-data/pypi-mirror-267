...
class ValidatedRequestedInfo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.payments.ValidatedRequestedInfo`.
    ...
    Parameters:
        ...
        shipping_options (List of :obj:`ShippingOption <chiefgram.raw.base.ShippingOption>`, *optional*):
            N/A
