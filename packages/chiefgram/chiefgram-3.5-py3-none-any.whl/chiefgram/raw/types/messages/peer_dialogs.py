...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <chiefgram.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <chiefgram.raw.base.Message>`):
            N/A
