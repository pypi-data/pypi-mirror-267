...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <chiefgram.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <chiefgram.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <chiefgram.raw.base.SecureValueError>`):
            N/A
