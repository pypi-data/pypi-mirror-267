...
class Found(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.contacts.Found`.
    ...
    Parameters:
        my_results (List of :obj:`Peer <chiefgram.raw.base.Peer>`):
            N/A

        results (List of :obj:`Peer <chiefgram.raw.base.Peer>`):
            N/A
