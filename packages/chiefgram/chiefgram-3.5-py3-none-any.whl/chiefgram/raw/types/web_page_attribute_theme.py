...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <chiefgram.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <chiefgram.raw.base.ThemeSettings>`, *optional*):
            N/A
