...
class SetPrivacy(TLObject):  # type: ignore
    ...
    Parameters:
        key (:obj:`InputPrivacyKey <chiefgram.raw.base.InputPrivacyKey>`):
            N/A

        rules (List of :obj:`InputPrivacyRule <chiefgram.raw.base.InputPrivacyRule>`):
            N/A

    Returns:
        :obj:`account.PrivacyRules <chiefgram.raw.base.account.PrivacyRules>`
    """
