...
class JoinGroupCall(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <chiefgram.raw.base.InputGroupCall>`):
            N/A

        join_as (:obj:`InputPeer <chiefgram.raw.base.InputPeer>`):
            N/A

        params (:obj:`DataJSON <chiefgram.raw.base.DataJSON>`):
            N/A
