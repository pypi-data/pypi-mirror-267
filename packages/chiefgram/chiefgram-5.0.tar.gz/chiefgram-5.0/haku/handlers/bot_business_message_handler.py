...
from haku.types import Message, Identifier
...
class BotBusinessMessageHandler(Handler):
    ...
    :meth:`~haku.Client.on_bot_business_message` decorator.
    ...
    Other parameters:
        ...
        message (:obj:`~haku.types.Message`):
    ...
    async def check_if_has_matching_listener(self, client: "haku.Client", message: Message):
        """
        ...
        listener = client.get_listener_matching_with_data(data, haku.enums.ListenerTypes.MESSAGE)
    ...
    async def check(self, client: "haku.Client", message: Message):
        """
    ...
    async def resolve_future_or_callback(self, client: "haku.Client", message: Message, *args):
        """
