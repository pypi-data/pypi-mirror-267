...
from haku.types import Message
...
class DeletedBotBusinessMessagesHandler(Handler):
    ...
    (private, group, channel). It is intended to be used with :meth:`~haku.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~haku.Client.on_deleted_bot_business_messages` decorator.
    ...
    Other parameters:
        ...
        messages (List of :obj:`~haku.types.Message`):
    ...
    async def check(self, client: "haku.Client", messages: List[Message]):
