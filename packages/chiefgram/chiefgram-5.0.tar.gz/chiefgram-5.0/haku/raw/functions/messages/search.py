...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`MessagesFilter <haku.raw.base.MessagesFilter>`):
            N/A
        ...
        from_id (:obj:`InputPeer <haku.raw.base.InputPeer>`, *optional*):
            N/A

        saved_peer_id (:obj:`InputPeer <haku.raw.base.InputPeer>`, *optional*):
            N/A

        saved_reaction (List of :obj:`Reaction <haku.raw.base.Reaction>`, *optional*):
            N/A
