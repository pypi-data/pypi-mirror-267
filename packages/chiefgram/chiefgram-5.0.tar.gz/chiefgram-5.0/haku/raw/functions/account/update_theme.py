...
class UpdateTheme(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        theme (:obj:`InputTheme <haku.raw.base.InputTheme>`):
            N/A
        ...
        document (:obj:`InputDocument <haku.raw.base.InputDocument>`, *optional*):
            N/A

        settings (List of :obj:`InputThemeSettings <haku.raw.base.InputThemeSettings>`, *optional*):
            N/A

    Returns:
        :obj:`Theme <haku.raw.base.Theme>`
    """
