...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <haku.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <haku.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <haku.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <haku.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <haku.raw.base.photos.Photo>`
    """
