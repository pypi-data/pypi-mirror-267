...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <haku.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <haku.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <haku.raw.base.payments.ValidatedRequestedInfo>`
    """
