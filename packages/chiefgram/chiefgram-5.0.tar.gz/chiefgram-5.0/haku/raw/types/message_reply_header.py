...
class MessageReplyHeader(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.MessageReplyHeader`.
    ...
    Parameters:
        ...
        reply_to_peer_id (:obj:`Peer <haku.raw.base.Peer>`, *optional*):
            N/A

        reply_from (:obj:`MessageFwdHeader <haku.raw.base.MessageFwdHeader>`, *optional*):
            N/A

        reply_media (:obj:`MessageMedia <haku.raw.base.MessageMedia>`, *optional*):
            N/A
        ...
        quote_entities (List of :obj:`MessageEntity <haku.raw.base.MessageEntity>`, *optional*):
            N/A
