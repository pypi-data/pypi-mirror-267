...
class StoryItem(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.StoryItem`.
    ...
    Parameters:
        ...
        fwd_from (:obj:`StoryFwdHeader <haku.raw.base.StoryFwdHeader>`, *optional*):
            N/A
        ...
        media_areas (List of :obj:`MediaArea <haku.raw.base.MediaArea>`, *optional*):
            N/A

        privacy (List of :obj:`PrivacyRule <haku.raw.base.PrivacyRule>`, *optional*):
            N/A

        views (:obj:`StoryViews <haku.raw.base.StoryViews>`, *optional*):
            N/A

        sent_reaction (:obj:`Reaction <haku.raw.base.Reaction>`, *optional*):
            N/A
