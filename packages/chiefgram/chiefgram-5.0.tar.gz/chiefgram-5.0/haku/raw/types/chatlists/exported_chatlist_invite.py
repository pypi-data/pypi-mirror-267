...
class ExportedChatlistInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.chatlists.ExportedChatlistInvite`.
    ...
    Parameters:
        filter (:obj:`DialogFilter <haku.raw.base.DialogFilter>`):
            N/A

        invite (:obj:`ExportedChatlistInvite <haku.raw.base.ExportedChatlistInvite>`):
            N/A
