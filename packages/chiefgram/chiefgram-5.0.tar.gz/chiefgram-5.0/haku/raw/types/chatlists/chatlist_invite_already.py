...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <haku.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <haku.raw.base.Peer>`):
            N/A
