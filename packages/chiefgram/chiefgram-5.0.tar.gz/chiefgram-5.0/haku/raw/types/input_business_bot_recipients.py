...
class InputBusinessBotRecipients(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.InputBusinessBotRecipients`.
    ...
    Parameters:
        ...
        users (List of :obj:`InputUser <haku.raw.base.InputUser>`, *optional*):
            N/A

        exclude_users (List of :obj:`InputUser <haku.raw.base.InputUser>`, *optional*):
            N/A
