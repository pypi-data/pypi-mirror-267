...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <haku.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <haku.raw.base.MessagePeerReaction>`, *optional*):
            N/A
