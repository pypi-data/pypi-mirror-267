...
class AllStories(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.stories.AllStories`.
    ...
    Parameters:
        ...
        peer_stories (List of :obj:`PeerStories <haku.raw.base.PeerStories>`):
            N/A
        ...
        stealth_mode (:obj:`StoriesStealthMode <haku.raw.base.StoriesStealthMode>`):
            N/A
