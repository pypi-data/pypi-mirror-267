...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <haku.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <haku.raw.base.PopularContact>`):
            N/A
