...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <haku.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <haku.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <haku.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <haku.raw.base.updates.State>`):
            N/A
