...
class InputBusinessAwayMessage(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.InputBusinessAwayMessage`.
    ...
    Parameters:
        ...
        schedule (:obj:`BusinessAwayMessageSchedule <haku.raw.base.BusinessAwayMessageSchedule>`):
            N/A

        recipients (:obj:`InputBusinessRecipients <haku.raw.base.InputBusinessRecipients>`):
            N/A
