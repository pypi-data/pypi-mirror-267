...
class PeerColorOption(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.help.PeerColorOption`.
    ...
    Parameters:
        ...
        colors (:obj:`help.PeerColorSet <haku.raw.base.help.PeerColorSet>`, *optional*):
            N/A

        dark_colors (:obj:`help.PeerColorSet <haku.raw.base.help.PeerColorSet>`, *optional*):
            N/A
