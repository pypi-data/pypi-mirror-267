...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <haku.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <haku.raw.base.ThemeSettings>`, *optional*):
            N/A
