...
class MessageFwdHeader(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.MessageFwdHeader`.
    ...
    Parameters:
        ...
        saved_from_peer (:obj:`Peer <haku.raw.base.Peer>`, *optional*):
            N/A

        saved_from_msg_id (``int`` ``32-bit``, *optional*):
            N/A

        saved_from_id (:obj:`Peer <haku.raw.base.Peer>`, *optional*):
            N/A
