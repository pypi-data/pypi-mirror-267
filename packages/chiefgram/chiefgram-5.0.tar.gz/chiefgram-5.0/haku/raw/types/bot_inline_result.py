...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <haku.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <haku.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <haku.raw.base.WebDocument>`, *optional*):
            N/A
