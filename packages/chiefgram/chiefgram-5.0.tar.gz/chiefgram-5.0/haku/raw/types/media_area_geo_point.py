...
class MediaAreaGeoPoint(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.MediaArea`.
    ...
    Parameters:
        coordinates (:obj:`MediaAreaCoordinates <haku.raw.base.MediaAreaCoordinates>`):
            N/A

        geo (:obj:`GeoPoint <haku.raw.base.GeoPoint>`):
            N/A
