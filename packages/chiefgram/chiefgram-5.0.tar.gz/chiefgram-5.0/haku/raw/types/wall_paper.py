...
class WallPaper(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.WallPaper`.
    ...
    Parameters:
        ...
        document (:obj:`Document <haku.raw.base.Document>`):
            N/A
        ...
        settings (:obj:`WallPaperSettings <haku.raw.base.WallPaperSettings>`, *optional*):
            N/A
