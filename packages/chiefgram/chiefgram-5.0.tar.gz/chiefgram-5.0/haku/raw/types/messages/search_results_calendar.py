...
class SearchResultsCalendar(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.messages.SearchResultsCalendar`.
    ...
    Parameters:
        ...
        periods (List of :obj:`SearchResultsCalendarPeriod <haku.raw.base.SearchResultsCalendarPeriod>`):
            N/A
