...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <haku.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <haku.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <haku.raw.base.InlineBotWebView>`, *optional*):
            N/A
