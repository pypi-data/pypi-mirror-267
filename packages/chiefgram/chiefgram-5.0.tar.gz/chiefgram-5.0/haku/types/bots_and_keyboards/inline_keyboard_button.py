...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~haku.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~haku.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~haku.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~haku.types.CallbackGame`, *optional*):
