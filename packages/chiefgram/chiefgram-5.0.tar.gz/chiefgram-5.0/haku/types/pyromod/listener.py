...
class Listener:
    ...
    Parameters:
        ...
        filters (:meth:`~haku.filters.Filter`):
        ...
        identifier (:obj:`~haku.types.Identifier`):
            An :obj:`~haku.types.Identifier` instance that defines the criteria for the event.
