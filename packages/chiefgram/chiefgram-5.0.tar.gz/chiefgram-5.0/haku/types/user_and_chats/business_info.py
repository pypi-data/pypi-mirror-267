...
class BusinessInfo(Object):
    ...
    Parameters:
        ...
        greeting_message (:obj:`~haku.types.BusinessMessage`, *optional*):
            Greeting message of the business.

        away_message (:obj:`~haku.types.BusinessMessage`, *optional*):
            Away message of the business.

        working_hours (:obj:`~haku.types.BusinessWorkingHours`, *optional*):
