...
class Chat(Object):
    ...
    Parameters:
        ...
        is_participants_hidden (``bool``, *optional*):
            ...
            Returned only in :meth:`~haku.Client.get_chat`.
        ...
        photo (:obj:`~haku.types.ChatPhoto`, *optional*):
            Chat photo. Suitable for downloads only.

        stories (List of :obj:`~haku.types.Story`, *optional*):
            The list of chat's stories if available.

        wallpaper (:obj:`~haku.types.Document`, *optional*):
            Chat wallpaper.
        ...
        restrictions (List of :obj:`~haku.types.Restriction`, *optional*):
            The list of reasons why this chat might be unavailable to some users.
            This field is available only in case *is_restricted* is True.

        permissions (:obj:`~haku.types.ChatPermissions` *optional*):
            Default chat member permissions, for groups and supergroups.

        distance (``int``, *optional*):
            Distance in meters of this group chat from your location.
            Returned only in :meth:`~haku.Client.get_nearby_chats`.

        linked_chat (:obj:`~haku.types.Chat`, *optional*):
            The linked discussion group (in case of channels) or the linked channel (in case of supergroups).
            Returned only in :meth:`~haku.Client.get_chat`.

        send_as_chat (:obj:`~haku.types.Chat`, *optional*):
            The default "send_as" chat.
            Returned only in :meth:`~haku.Client.get_chat`.

        available_reactions (:obj:`~haku.types.ChatReactions`, *optional*):
        ...
        usernames (List of :obj:`~haku.types.Username`, *optional*):
        ...
        reply_color (:obj:`~haku.types.ChatColor`, *optional*):
            Chat reply color.

        profile_color (:obj:`~haku.types.ChatColor`, *optional*):
            Chat profile color.

        business_info (:obj:`~haku.types.BusinessInfo`, *optional*):
            Business information of a chat.

        birthday (:obj:`~haku.types.Birthday`, *optional*):
            User Date of birth.
            Returned only in :meth:`~haku.Client.get_chat`.

        personal_chat (:obj:`~haku.types.Chat`, *optional*):
    ...
    def listen(self, *args, **kwargs):
        """Bound method *listen* of :obj:`~haku.types.Chat`.
        ...
        Parameters:
            args (*optional*):
                The arguments to pass to the :meth:`~haku.Client.listen` method.

            kwargs (*optional*):
                The keyword arguments to pass to the :meth:`~haku.Client.listen` method.
    ...
    def ask(self, text, *args, **kwargs):
        """Bound method *ask* of :obj:`~haku.types.Chat`.
    ...
    def stop_listening(self, *args, **kwargs):
        """Bound method *stop_listening* of :obj:`~haku.types.Chat`.
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~haku.types.Chat`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~haku.types.Chat`.
    ...
    async def set_title(self, title: str) -> bool:
        """Bound method *set_title* of :obj:`~haku.types.Chat`.
    ...
    async def set_description(self, description: str) -> bool:
        """Bound method *set_description* of :obj:`~haku.types.Chat`.
    ...
    async def set_photo(
        ...
        *,
        ...
        """Bound method *set_photo* of :obj:`~haku.types.Chat`.
        ...
        Parameters:
            photo (``str`` | ``BinaryIO``, *optional*):
                New chat photo. You can pass a :obj:`~haku.types.Photo` file_id, a file path to upload a new photo
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.

            video (``str`` | ``BinaryIO``, *optional*):
                New chat video. You can pass a :obj:`~haku.types.Video` file_id, a file path to upload a new video
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.
    ...
    async def ban_member(
        ...
        """Bound method *ban_member* of :obj:`~haku.types.Chat`.
        ...
        Returns:
            :obj:`~haku.types.Message` | ``bool``: On success, a service message will be returned (when applicable), otherwise, in
    ...
    async def unban_member(
        ...
        """Bound method *unban_member* of :obj:`~haku.types.Chat`.
    ...
    async def restrict_member(
        ...
        Parameters:
            ...
            permissions (:obj:`~haku.types.ChatPermissions`):
    ...
    async def promote_member(
        ...
        """Bound method *promote_member* of :obj:`~haku.types.Chat`.
        ...
        Parameters:
            ...
            privileges (:obj:`~haku.types.ChatPrivileges`, *optional*):
                New user privileges.
    ...
    async def join(self):
        """Bound method *join* of :obj:`~haku.types.Chat`.
    ...
    async def leave(self):
        """Bound method *leave* of :obj:`~haku.types.Chat`.
    ...
    async def export_invite_link(self):
        """Bound method *export_invite_link* of :obj:`~haku.types.Chat`.
    ...
    async def get_member(
        ...
        """Bound method *get_member* of :obj:`~haku.types.Chat`.
        ...
        Returns:
            :obj:`~haku.types.ChatMember`: On success, a chat member is returned.
        """
    ...
    def get_members(
        ...
        """Bound method *get_members* of :obj:`~haku.types.Chat`.
        ...
        Parameters:
            query (``str``, *optional*):
                ...
                A query string is applicable only for :obj:`~haku.enums.ChatMembersFilter.SEARCH`,
                :obj:`~haku.enums.ChatMembersFilter.BANNED` and :obj:`~haku.enums.ChatMembersFilter.RESTRICTED`
                filters only.

            limit (``int``, *optional*):
                Limits the number of members to be retrieved.

            filter (:obj:`~haku.enums.ChatMembersFilter`, *optional*):
                Filter used to select the kind of members you want to retrieve. Only applicable for supergroups
                and channels.

        Returns:
            ``Generator``: On success, a generator yielding :obj:`~haku.types.ChatMember` objects is returned.
        """
    ...
    async def add_members(
        ...
        """Bound method *add_members* of :obj:`~haku.types.Chat`.
    ...
    async def mark_unread(self, ) -> bool:
        """Bound method *mark_unread* of :obj:`~haku.types.Chat`.
    ...
    async def set_protected_content(self, enabled: bool) -> bool:
        """Bound method *set_protected_content* of :obj:`~haku.types.Chat`.
    ...
    async def unpin_all_messages(self) -> bool:
        """Bound method *unpin_all_messages* of :obj:`~haku.types.Chat`.
