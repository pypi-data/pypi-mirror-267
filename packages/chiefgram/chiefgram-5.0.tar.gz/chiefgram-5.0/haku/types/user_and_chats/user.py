...
class User(Object, Update):
    ...
    Parameters:
        ...
        status (:obj:`~haku.enums.UserStatus`, *optional*):
            User's last seen & online status. ``None``, for bots.

        last_online_date (:py:obj:`~datetime.datetime`, *optional*):
            Last online date of a user. Only available in case status is :obj:`~haku.enums.UserStatus.OFFLINE`.

        next_offline_date (:py:obj:`~datetime.datetime`, *optional*):
            Date when a user will automatically go offline. Only available in case status is :obj:`~haku.enums.UserStatus.ONLINE`.
    ...
    def listen(self, *args, **kwargs):
        """Bound method *listen* of :obj:`~haku.types.User`.
    ...
    def ask(self, text, *args, **kwargs):
        """Bound method *ask* of :obj:`~haku.types.User`.
    ...
    def stop_listening(self, *args, **kwargs):
        """Bound method *stop_listening* of :obj:`~haku.types.User`.
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~haku.types.User`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~haku.types.User`.
    ...
    def block(self):
        """Bound method *block* of :obj:`~haku.types.User`.
    ...
    def unblock(self):
        """Bound method *unblock* of :obj:`~haku.types.User`.
    ...
    def get_common_chats(self):
        """Bound method *get_common_chats* of :obj:`~haku.types.User`.
