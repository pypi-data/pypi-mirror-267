#  Haku - Telegram MTProto API Client Library for Python
...
import haku
from haku import types, utils, raw
...
class CopyMediaGroup:
    async def copy_media_group(
        ...
        Returns:
            List of :obj:`~haku.types.Message`: On success, a list of copied messages is returned.
