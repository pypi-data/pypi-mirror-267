...
import haku
from haku import StopTransmission, enums
from haku import raw
from haku import types
from haku import utils
from haku.errors import FilePartMissing
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~haku.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~haku.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~haku.Client.stop_transmission`, None is returned.
