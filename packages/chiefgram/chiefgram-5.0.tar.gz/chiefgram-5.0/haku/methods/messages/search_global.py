...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~haku.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~haku.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~haku.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "haku". Get the first 50 results
                async for message in app.search_global("haku", limit=50):
                    print(message.text)
