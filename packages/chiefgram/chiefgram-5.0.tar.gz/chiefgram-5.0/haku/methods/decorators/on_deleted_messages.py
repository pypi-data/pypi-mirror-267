...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~haku.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, haku.Client):
                self.add_handler(haku.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        haku.handlers.DeletedMessagesHandler(func, self),
