...
from haku.connection import Connection
from haku.crypto import aes, rsa, prime
from haku.errors import SecurityCheckMismatch
from haku.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "haku.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
