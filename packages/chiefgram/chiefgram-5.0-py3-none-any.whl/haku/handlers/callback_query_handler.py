...
from haku.types import CallbackQuery, Identifier, Listener
...
class CallbackQueryHandler(Handler):
    ...
    :meth:`~haku.Client.on_callback_query` decorator.
    ...
    Other parameters:
        ...
        callback_query (:obj:`~haku.types.CallbackQuery`):
    ...
    async def check_if_has_matching_listener(
        self, client: "haku.Client", query: CallbackQuery
    ) -> Tuple[bool, Listener]:
        """
        ...
        listener = client.get_listener_matching_with_data(
            data, haku.enums.ListenerTypes.CALLBACK_QUERY
        )
    ...
    async def check(self, client: "haku.Client", query: CallbackQuery):
        """
    ...
    async def resolve_future_or_callback(
        self, client: "haku.Client", query: CallbackQuery, *args
    ):
        """
