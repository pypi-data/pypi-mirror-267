...
class Filter:
    async def __call__(self, client: "haku.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~haku.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~haku.handlers.MessageHandler` the *update* argument will be a :obj:`~haku.types.Message`; in a :obj:`~haku.handlers.CallbackQueryHandler` the *update* will be a :obj:`~haku.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~haku.filters.command` or :meth:`~haku.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~haku.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~haku.types.Document` objects."""
...
"""Filter messages that contain :obj:`~haku.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~haku.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~haku.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~haku.types.Game` objects."""
...
"""Filter messages that contain :obj:`~haku.types.Video` objects."""
...
"""Filter messages that contain :obj:`~haku.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~haku.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~haku.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~haku.types.Location` objects."""
...
"""Filter messages that contain :obj:`~haku.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~haku.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~haku.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~haku.types.Message`.
    ...
    async def func(flt, client: haku.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~haku.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~haku.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~haku.types.InlineQuery`: The filter will match ``query``.
