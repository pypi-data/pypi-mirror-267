...
class OnDeletedBotBusinessMessages:
    def on_deleted_bot_business_messages(
        ...
        :obj:`~haku.handlers.DeletedBotBusinessMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, haku.Client):
                self.add_handler(haku.handlers.DeletedBotBusinessMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        haku.handlers.DeletedBotBusinessMessagesHandler(func, self),
