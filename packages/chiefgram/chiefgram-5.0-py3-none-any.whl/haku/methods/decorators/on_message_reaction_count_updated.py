...
class OnMessageReactionCountUpdated:
    def on_message_reaction_count_updated(
        ...
        :obj:`~haku.handlers.MessageReactionCountUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, haku.Client):
                self.add_handler(haku.handlers.MessageReactionCountUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        haku.handlers.MessageReactionCountUpdatedHandler(func, self),
