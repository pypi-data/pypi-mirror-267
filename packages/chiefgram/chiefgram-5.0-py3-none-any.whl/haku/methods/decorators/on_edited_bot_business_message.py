...
class OnEditedBotBusinessMessage:
    def on_edited_bot_business_message(
        ...
        :obj:`~haku.handlers.EditedBotBusinessMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, haku.Client):
                self.add_handler(haku.handlers.EditedBotBusinessMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        haku.handlers.EditedBotBusinessMessageHandler(func, self),
