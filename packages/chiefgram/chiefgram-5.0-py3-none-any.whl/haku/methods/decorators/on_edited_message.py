...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~haku.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, haku.Client):
                self.add_handler(haku.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        haku.handlers.EditedMessageHandler(func, self),
