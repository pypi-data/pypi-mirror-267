...
from haku.errors import ListenerTimeout
...
class Listen:
    async def listen(
        ...
        listener_type: "haku.enums.ListenerTypes" = haku.enums.ListenerTypes.MESSAGE,
        ...
        Parameters:
            ...
            listener_type (:obj:`~haku.enums.ListenerTypes`, *optional*):
        ...
        Returns:
            :obj:`~haku.types.Message` | :obj:`~haku.types.CallbackQuery`: On success, a message/callbackquery is returned.
