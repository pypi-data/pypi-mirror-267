...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~haku.types.InputMediaPhoto`, :obj:`~haku.types.InputMediaVideo`, :obj:`~haku.types.InputMediaAudio`, :obj:`~haku.types.InputMediaDocument` and :obj:`~haku.types.InputMediaAnimation`):
        ...
        Returns:
            List of :obj:`~haku.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from haku.types import InputMediaPhoto, InputMediaVideo
