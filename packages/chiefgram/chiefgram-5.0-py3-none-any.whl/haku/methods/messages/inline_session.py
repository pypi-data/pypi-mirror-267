...
from haku.errors import AuthBytesInvalid
from haku.session import Session
from haku.session.auth import Auth


async def get_session(client: "haku.Client", dc_id: int):
