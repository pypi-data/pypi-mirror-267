...
from haku.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            message (:obj:`~haku.types.Message` | :obj:`~haku.types.Story` | ``str``):
        ...
        Returns:
            ...
            :meth:`~haku.Client.stop_transmission`, None is returned.
