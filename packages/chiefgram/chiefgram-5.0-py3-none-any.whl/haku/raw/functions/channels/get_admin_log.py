...
class GetAdminLog(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        events_filter (:obj:`ChannelAdminLogEventsFilter <haku.raw.base.ChannelAdminLogEventsFilter>`, *optional*):
            N/A

        admins (List of :obj:`InputUser <haku.raw.base.InputUser>`, *optional*):
            N/A

    Returns:
        :obj:`channels.AdminLogResults <haku.raw.base.channels.AdminLogResults>`
    """
