...
class GetBotCallbackAnswer(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        password (:obj:`InputCheckPasswordSRP <haku.raw.base.InputCheckPasswordSRP>`, *optional*):
            N/A

    Returns:
        :obj:`messages.BotCallbackAnswer <haku.raw.base.messages.BotCallbackAnswer>`
    """
