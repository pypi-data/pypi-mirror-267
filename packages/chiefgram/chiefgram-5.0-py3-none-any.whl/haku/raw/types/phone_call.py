...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <haku.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <haku.raw.base.PhoneConnection>`):
            N/A
        ...
        custom_parameters (:obj:`DataJSON <haku.raw.base.DataJSON>`, *optional*):
            N/A
