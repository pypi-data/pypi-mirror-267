...
class InputStorePaymentPremiumGiveaway(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.InputStorePaymentPurpose`.
    ...
    Parameters:
        boost_peer (:obj:`InputPeer <haku.raw.base.InputPeer>`):
            N/A
        ...
        additional_peers (List of :obj:`InputPeer <haku.raw.base.InputPeer>`, *optional*):
            N/A
