...
class SponsoredMessageReportResultChooseOption(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.channels.SponsoredMessageReportResult`.
    ...
    Parameters:
        ...
        options (List of :obj:`SponsoredMessageReportOption <haku.raw.base.SponsoredMessageReportOption>`):
            N/A
