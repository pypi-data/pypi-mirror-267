...
class DialogFilter(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        pinned_peers (List of :obj:`InputPeer <haku.raw.base.InputPeer>`):
            N/A

        include_peers (List of :obj:`InputPeer <haku.raw.base.InputPeer>`):
            N/A

        exclude_peers (List of :obj:`InputPeer <haku.raw.base.InputPeer>`):
            N/A
