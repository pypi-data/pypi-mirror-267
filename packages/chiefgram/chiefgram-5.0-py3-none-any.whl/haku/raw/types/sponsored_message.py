...
class SponsoredMessage(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.SponsoredMessage`.
    ...
    Parameters:
        ...
        chat_invite (:obj:`ChatInvite <haku.raw.base.ChatInvite>`, *optional*):
            N/A
        ...
        webpage (:obj:`SponsoredWebPage <haku.raw.base.SponsoredWebPage>`, *optional*):
            N/A

        app (:obj:`BotApp <haku.raw.base.BotApp>`, *optional*):
            N/A
    ...
    __slots__: List[str] = ["random_id", "message", "recommended", "show_peer_photo", "can_report", "from_id", "chat_invite", "chat_invite_hash", "channel_post", "start_param", "webpage", "app", "entities", "button_text", "sponsor_info", "additional_info"]

    ID = 0xed5383f7
    QUALNAME = "types.SponsoredMessage"

    def __init__(self, *, random_id: bytes, message: str, recommended: Optional[bool] = None, show_peer_photo: Optional[bool] = None, can_report: Optional[bool] = None, from_id: "raw.base.Peer" = None, chat_invite: "raw.base.ChatInvite" = None, chat_invite_hash: Optional[str] = None, channel_post: Optional[int] = None, start_param: Optional[str] = None, webpage: "raw.base.SponsoredWebPage" = None, app: "raw.base.BotApp" = None, entities: Optional[List["raw.base.MessageEntity"]] = None, button_text: Optional[str] = None, sponsor_info: Optional[str] = None, additional_info: Optional[str] = None) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "SponsoredMessage":
        ...
        return SponsoredMessage(random_id=random_id, message=message, recommended=recommended, show_peer_photo=show_peer_photo, can_report=can_report, from_id=from_id, chat_invite=chat_invite, chat_invite_hash=chat_invite_hash, channel_post=channel_post, start_param=start_param, webpage=webpage, app=app, entities=entities, button_text=button_text, sponsor_info=sponsor_info, additional_info=additional_info)
