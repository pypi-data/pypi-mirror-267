...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <haku.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <haku.raw.base.Reaction>`, *optional*):
            N/A
