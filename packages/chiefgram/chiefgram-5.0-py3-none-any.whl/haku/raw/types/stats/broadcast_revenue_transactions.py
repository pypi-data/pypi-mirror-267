...
class BroadcastRevenueTransactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.stats.BroadcastRevenueTransactions`.
    ...
    Parameters:
        ...
        transactions (List of :obj:`BroadcastRevenueTransaction <haku.raw.base.BroadcastRevenueTransaction>`):
            N/A
