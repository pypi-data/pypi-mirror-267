...
class BroadcastRevenueStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.stats.BroadcastRevenueStats`.
    ...
    Parameters:
        ...
        revenue_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A
    ...
    __slots__: List[str] = ["top_hours_graph", "revenue_graph", "current_balance", "available_balance", "overall_revenue", "usd_rate"]

    ID = 0xd07b4bad
    QUALNAME = "types.stats.BroadcastRevenueStats"

    def __init__(self, *, top_hours_graph: "raw.base.StatsGraph", revenue_graph: "raw.base.StatsGraph", current_balance: int, available_balance: int, overall_revenue: int, usd_rate: float) -> None:
    ...
    def read(b: BytesIO, *args: Any) -> "BroadcastRevenueStats":
        ...
        return BroadcastRevenueStats(top_hours_graph=top_hours_graph, revenue_graph=revenue_graph, current_balance=current_balance, available_balance=available_balance, overall_revenue=overall_revenue, usd_rate=usd_rate)
