...
class BroadcastStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.stats.BroadcastStats`.
    ...
    Parameters:
        period (:obj:`StatsDateRangeDays <haku.raw.base.StatsDateRangeDays>`):
            N/A

        followers (:obj:`StatsAbsValueAndPrev <haku.raw.base.StatsAbsValueAndPrev>`):
            N/A

        views_per_post (:obj:`StatsAbsValueAndPrev <haku.raw.base.StatsAbsValueAndPrev>`):
            N/A

        shares_per_post (:obj:`StatsAbsValueAndPrev <haku.raw.base.StatsAbsValueAndPrev>`):
            N/A

        reactions_per_post (:obj:`StatsAbsValueAndPrev <haku.raw.base.StatsAbsValueAndPrev>`):
            N/A

        views_per_story (:obj:`StatsAbsValueAndPrev <haku.raw.base.StatsAbsValueAndPrev>`):
            N/A

        shares_per_story (:obj:`StatsAbsValueAndPrev <haku.raw.base.StatsAbsValueAndPrev>`):
            N/A

        reactions_per_story (:obj:`StatsAbsValueAndPrev <haku.raw.base.StatsAbsValueAndPrev>`):
            N/A

        enabled_notifications (:obj:`StatsPercentValue <haku.raw.base.StatsPercentValue>`):
            N/A

        growth_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        followers_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        mute_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        interactions_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        iv_interactions_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        views_by_source_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        new_followers_by_source_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        reactions_by_emotion_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        story_interactions_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        story_reactions_by_emotion_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        recent_posts_interactions (List of :obj:`PostInteractionCounters <haku.raw.base.PostInteractionCounters>`):
            N/A
