...
class MegagroupStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.stats.MegagroupStats`.
    ...
    Parameters:
        ...
        members (:obj:`StatsAbsValueAndPrev <haku.raw.base.StatsAbsValueAndPrev>`):
            N/A

        messages (:obj:`StatsAbsValueAndPrev <haku.raw.base.StatsAbsValueAndPrev>`):
            N/A

        viewers (:obj:`StatsAbsValueAndPrev <haku.raw.base.StatsAbsValueAndPrev>`):
            N/A

        posters (:obj:`StatsAbsValueAndPrev <haku.raw.base.StatsAbsValueAndPrev>`):
            N/A

        growth_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        members_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        new_members_by_source_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        messages_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        actions_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        weekdays_graph (:obj:`StatsGraph <haku.raw.base.StatsGraph>`):
            N/A

        top_posters (List of :obj:`StatsGroupTopPoster <haku.raw.base.StatsGroupTopPoster>`):
            N/A

        top_admins (List of :obj:`StatsGroupTopAdmin <haku.raw.base.StatsGroupTopAdmin>`):
            N/A

        top_inviters (List of :obj:`StatsGroupTopInviter <haku.raw.base.StatsGroupTopInviter>`):
            N/A
