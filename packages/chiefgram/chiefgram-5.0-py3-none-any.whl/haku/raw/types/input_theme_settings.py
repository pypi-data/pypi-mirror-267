...
class InputThemeSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.InputThemeSettings`.
    ...
    Parameters:
        base_theme (:obj:`BaseTheme <haku.raw.base.BaseTheme>`):
            N/A
        ...
        wallpaper (:obj:`InputWallPaper <haku.raw.base.InputWallPaper>`, *optional*):
            N/A

        wallpaper_settings (:obj:`WallPaperSettings <haku.raw.base.WallPaperSettings>`, *optional*):
            N/A
