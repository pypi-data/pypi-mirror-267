...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <haku.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <haku.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <haku.raw.base.SecureValueError>`):
            N/A
