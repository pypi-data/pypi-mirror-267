...
class InputPeerNotifySettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.InputPeerNotifySettings`.
    ...
    Parameters:
        ...
        sound (:obj:`NotificationSound <haku.raw.base.NotificationSound>`, *optional*):
            N/A
        ...
        stories_sound (:obj:`NotificationSound <haku.raw.base.NotificationSound>`, *optional*):
            N/A
