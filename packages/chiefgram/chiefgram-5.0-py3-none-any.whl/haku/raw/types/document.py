...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.Document`.
    ...
    Parameters:
        ...
        attributes (List of :obj:`DocumentAttribute <haku.raw.base.DocumentAttribute>`):
            N/A

        thumbs (List of :obj:`PhotoSize <haku.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <haku.raw.base.VideoSize>`, *optional*):
            N/A
