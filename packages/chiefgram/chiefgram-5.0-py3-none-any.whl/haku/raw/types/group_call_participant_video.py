...
class GroupCallParticipantVideo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~haku.raw.base.GroupCallParticipantVideo`.
    ...
    Parameters:
        ...
        source_groups (List of :obj:`GroupCallParticipantVideoSourceGroup <haku.raw.base.GroupCallParticipantVideoSourceGroup>`):
            N/A
