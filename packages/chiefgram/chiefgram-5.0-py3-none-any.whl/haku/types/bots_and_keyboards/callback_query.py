...
class CallbackQuery(Object, Update):
    ...
    *inline_message_id* will be present. Exactly one of the fields *data* or *game_short_name* will be present.
    ...
    Parameters:
        ...
        message (:obj:`~haku.types.Message`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the data of this callback query. Only applicable when using :obj:`Filters.regex <haku.Filters.regex>`.
    """
    ...
    @staticmethod
    async def _parse(client: "haku.Client", callback_query, users) -> "CallbackQuery":
        message = None
    ...
    async def answer(self, text: str = None, show_alert: bool = None, url: str = None, cache_time: int = 0):
        """Bound method *answer* of :obj:`~haku.types.CallbackQuery`.
    ...
    async def edit_message_text(
        ...
        Bound method *edit_message_text* of :obj:`~haku.types.CallbackQuery`.
        ...
        Returns:
            :obj:`~haku.types.Message` | ``bool``: On success, if the edited message was sent by the bot, the edited
    ...
    async def edit_message_caption(
        ...
        Bound method *edit_message_caption* of :obj:`~haku.types.CallbackQuery`.
    ...
    async def edit_message_media(
        ...
        Bound method *edit_message_media* of :obj:`~haku.types.CallbackQuery`.
    ...
    async def edit_message_reply_markup(
        ...
        Bound method *edit_message_reply_markup* of :obj:`~haku.types.CallbackQuery`.
