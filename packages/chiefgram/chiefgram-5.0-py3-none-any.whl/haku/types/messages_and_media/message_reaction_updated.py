...
import haku
from haku import raw, types, utils
...
class MessageReactionUpdated(Object, Update):
    ...
    Parameters:
        ...
        actor_chat (:obj:`~haku.types.Chat`, *optional*):
            The chat on behalf of which the reaction was changed, if the user is anonymous

        date (:py:obj:`~datetime.datetime`):
            Date of change of the reaction

        old_reaction (:obj:`~haku.types.ReactionType`):
            Previous list of reaction types that were set by the user

        new_reaction (:obj:`~haku.types.ReactionType`):
