...
import haku
from haku import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~haku.types.PollOption`):
        ...
        explanation_entities (List of :obj:`~haku.types.MessageEntity`, *optional*):
    ...
    async def stop(
        ...
        """Bound method *stop* of :obj:`~haku.types.Poll`.
        ...
        Returns:
            :obj:`~haku.types.Poll`: On success, the stopped poll with the final results is returned.
