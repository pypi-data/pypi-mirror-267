...
from chiefgram.crypto import aes, rsa, prime
from chiefgram.errors import SecurityCheckMismatch
from chiefgram.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "chiefgram.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
