...
from chiefgram import types, utils, enums
...
class ChatEvent(Object):
    ...
    Parameters:
        ...
        action (:obj:`~chiefgram.enums.ChatEventAction`):
            Event action.

        user (:obj:`~chiefgram.types.User`):
            User that triggered the event.

        old_description, new_description (``str``, *optional*):
            Previous and new chat description.
            For :obj:`~chiefgram.enums.ChatEventAction.DESCRIPTION_CHANGED` action only.

        old_history_ttl, new_history_ttl (``int``, *optional*):
            Previous and new chat history TTL.
            For :obj:`~chiefgram.enums.ChatEventAction.HISTORY_TTL_CHANGED` action only.

        old_linked_chat, new_linked_chat (:obj:`~chiefgram.types.Chat`, *optional*):
            Previous and new linked chat.
            For :obj:`~chiefgram.enums.ChatEventAction.LINKED_CHAT_CHANGED` action only.

        old_photo, new_photo (:obj:`~chiefgram.types.Photo`, *optional*):
            Previous and new chat photo.
            For :obj:`~chiefgram.enums.ChatEventAction.PHOTO_CHANGED` action only.

        old_title, new_title (``str``, *optional*):
            Previous and new chat title.
            For :obj:`~chiefgram.enums.ChatEventAction.TITLE_CHANGED` action only.

        old_username, new_username (``str``, *optional*):
            Previous and new chat username.
            For :obj:`~chiefgram.enums.ChatEventAction.USERNAME_CHANGED` action only.

        old_chat_permissions, new_chat_permissions (:obj:`~chiefgram.types.ChatPermissions`, *optional*):
            Previous and new default chat permissions.
            For :obj:`~chiefgram.enums.ChatEventAction.CHAT_PERMISSIONS_CHANGED` action only.

        deleted_message (:obj:`~chiefgram.types.Message`, *optional*):
            Deleted message.
            For :obj:`~chiefgram.enums.ChatEventAction.MESSAGE_DELETED` action only.

        old_message, new_message (:obj:`~chiefgram.types.Message`, *optional*):
            Previous and new message before it has been edited.
            For :obj:`~chiefgram.enums.ChatEventAction.MESSAGE_EDITED` action only.

        invited_member (:obj:`~chiefgram.types.ChatMember`, *optional*):
            New invited chat member.
            For :obj:`~chiefgram.enums.ChatEventAction.MEMBER_INVITED` action only.

        old_administrator_privileges, new_administrator_privileges (:obj:`~chiefgram.types.ChatMember`, *optional*):
            Previous and new administrator privileges.
            For :obj:`~chiefgram.enums.ChatEventAction.ADMINISTRATOR_PRIVILEGES_CHANGED` action only.

        old_member_permissions, new_member_permissions (:obj:`~chiefgram.types.ChatMember`, *optional*):
            Previous and new member permissions.
            For :obj:`~chiefgram.enums.ChatEventAction.MEMBER_PERMISSIONS_CHANGED` action only.

        stopped_poll (:obj:`~chiefgram.types.Message`, *optional*):
            Message containing the stopped poll.
            For :obj:`~chiefgram.enums.ChatEventAction.POLL_STOPPED` action only.

        invites_enabled (``bool``, *optional*):
            If chat invites were enabled (True) or disabled (False).
            For :obj:`~chiefgram.enums.ChatEventAction.INVITES_ENABLED` action only.

        history_hidden (``bool``, *optional*):
            If chat history has been hidden (True) or unhidden (False).
            For :obj:`~chiefgram.enums.ChatEventAction.HISTORY_HIDDEN` action only.

        signatures_enabled (``bool``, *optional*):
            If message signatures were enabled (True) or disabled (False).
            For :obj:`~chiefgram.enums.ChatEventAction.SIGNATURES_ENABLED` action only.

        old_slow_mode, new_slow_mode (``int``, *optional*):
            Previous and new slow mode value in seconds.
            For :obj:`~chiefgram.enums.ChatEventAction.SLOW_MODE_CHANGED` action only.

        pinned_message (:obj:`~chiefgram.types.Message`, *optional*):
            Pinned message.
            For :obj:`~chiefgram.enums.ChatEventAction.MESSAGE_PINNED` action only.

        unpinned_message (:obj:`~chiefgram.types.Message`, *optional*):
            Unpinned message.
            For :obj:`~chiefgram.enums.ChatEventAction.MESSAGE_UNPINNED` action only.

        old_invite_link, new_invite_link (:obj:`~chiefgram.types.ChatInviteLink`, *optional*):
            Previous and new edited invite link.
            For :obj:`~chiefgram.enums.ChatEventAction.INVITE_LINK_EDITED` action only.

        revoked_invite_link (:obj:`~chiefgram.types.ChatInviteLink`, *optional*):
            Revoked invite link.
            For :obj:`~chiefgram.enums.ChatEventAction.INVITE_LINK_REVOKED` action only.

        deleted_invite_link (:obj:`~chiefgram.types.ChatInviteLink`, *optional*):
            Deleted invite link.
            For :obj:`~chiefgram.enums.ChatEventAction.INVITE_LINK_DELETED` action only.
    """
