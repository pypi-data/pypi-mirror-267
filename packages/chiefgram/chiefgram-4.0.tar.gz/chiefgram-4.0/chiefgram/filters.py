...
from chiefgram.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "chiefgram.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~chiefgram.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~chiefgram.handlers.MessageHandler` the *update* argument will be a :obj:`~chiefgram.types.Message`; in a :obj:`~chiefgram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~chiefgram.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~chiefgram.filters.command` or :meth:`~chiefgram.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~chiefgram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~chiefgram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~chiefgram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~chiefgram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~chiefgram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~chiefgram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~chiefgram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~chiefgram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~chiefgram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~chiefgram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~chiefgram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~chiefgram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~chiefgram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~chiefgram.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~chiefgram.types.Message`.
    ...
    async def func(flt, client: chiefgram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~chiefgram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~chiefgram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~chiefgram.types.InlineQuery`: The filter will match ``query``.
