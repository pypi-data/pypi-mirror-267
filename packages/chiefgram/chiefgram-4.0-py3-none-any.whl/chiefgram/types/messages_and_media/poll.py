...
import chiefgram
from chiefgram import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~chiefgram.types.PollOption`):
        ...
        explanation_entities (List of :obj:`~chiefgram.types.MessageEntity`, *optional*):
