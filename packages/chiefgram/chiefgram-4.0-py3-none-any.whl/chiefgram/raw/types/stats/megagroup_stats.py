...
class MegagroupStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.stats.MegagroupStats`.
    ...
    Parameters:
        period (:obj:`StatsDateRangeDays <chiefgram.raw.base.StatsDateRangeDays>`):
            N/A

        members (:obj:`StatsAbsValueAndPrev <chiefgram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        messages (:obj:`StatsAbsValueAndPrev <chiefgram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        viewers (:obj:`StatsAbsValueAndPrev <chiefgram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        posters (:obj:`StatsAbsValueAndPrev <chiefgram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        growth_graph (:obj:`StatsGraph <chiefgram.raw.base.StatsGraph>`):
            N/A

        members_graph (:obj:`StatsGraph <chiefgram.raw.base.StatsGraph>`):
            N/A

        new_members_by_source_graph (:obj:`StatsGraph <chiefgram.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <chiefgram.raw.base.StatsGraph>`):
            N/A

        messages_graph (:obj:`StatsGraph <chiefgram.raw.base.StatsGraph>`):
            N/A

        actions_graph (:obj:`StatsGraph <chiefgram.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <chiefgram.raw.base.StatsGraph>`):
            N/A

        weekdays_graph (:obj:`StatsGraph <chiefgram.raw.base.StatsGraph>`):
            N/A

        top_posters (List of :obj:`StatsGroupTopPoster <chiefgram.raw.base.StatsGroupTopPoster>`):
            N/A

        top_admins (List of :obj:`StatsGroupTopAdmin <chiefgram.raw.base.StatsGroupTopAdmin>`):
            N/A

        top_inviters (List of :obj:`StatsGroupTopInviter <chiefgram.raw.base.StatsGroupTopInviter>`):
            N/A

        users (List of :obj:`User <chiefgram.raw.base.User>`):
            N/A
