...
class AutoSaveSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.account.AutoSaveSettings`.
    ...
    Parameters:
        users_settings (:obj:`AutoSaveSettings <chiefgram.raw.base.AutoSaveSettings>`):
            N/A

        chats_settings (:obj:`AutoSaveSettings <chiefgram.raw.base.AutoSaveSettings>`):
            N/A

        broadcasts_settings (:obj:`AutoSaveSettings <chiefgram.raw.base.AutoSaveSettings>`):
            N/A

        exceptions (List of :obj:`AutoSaveException <chiefgram.raw.base.AutoSaveException>`):
            N/A

        chats (List of :obj:`Chat <chiefgram.raw.base.Chat>`):
            N/A
