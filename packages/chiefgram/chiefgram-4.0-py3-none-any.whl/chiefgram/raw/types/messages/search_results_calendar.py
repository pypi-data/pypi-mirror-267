...
class SearchResultsCalendar(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.messages.SearchResultsCalendar`.
    ...
    Parameters:
        ...
        periods (List of :obj:`SearchResultsCalendarPeriod <chiefgram.raw.base.SearchResultsCalendarPeriod>`):
            N/A
