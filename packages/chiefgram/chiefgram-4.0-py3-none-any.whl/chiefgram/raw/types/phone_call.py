...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <chiefgram.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <chiefgram.raw.base.PhoneConnection>`):
            N/A
