...
class ExportChatlistInvite(TLObject):  # type: ignore
    ...
    Parameters:
        chatlist (:obj:`InputChatlist <chiefgram.raw.base.InputChatlist>`):
            N/A

        title (``str``):
            N/A

        peers (List of :obj:`InputPeer <chiefgram.raw.base.InputPeer>`):
            N/A

    Returns:
        :obj:`chatlists.ExportedChatlistInvite <chiefgram.raw.base.chatlists.ExportedChatlistInvite>`
    """
