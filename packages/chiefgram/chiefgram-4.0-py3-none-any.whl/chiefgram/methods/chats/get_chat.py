...
class GetChat:
    async def get_chat(
        ...
        Returns:
            :obj:`~chiefgram.types.Chat` | :obj:`~chiefgram.types.ChatPreview`: On success, if you've already joined the chat, a chat object is returned,
        ...
        Example:
            .. code-block:: python
                ...
                chat = await app.get_chat("chiefgram")
                print(chat)
        """
