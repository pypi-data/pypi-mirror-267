...
from chiefgram.types import CallbackQuery
...
@patch_into(chiefgram.handlers.callback_query_handler.CallbackQueryHandler)
class CallbackQueryHandler(
    chiefgram.handlers.callback_query_handler.CallbackQueryHandler
):
    ...
    async def resolve_future_or_callback(
        ...
        if listener and listener_does_match:
            ...
            if listener.future and not listener.future.done():
                ...
                raise chiefgram.StopPropagation
