...
class BotCommandScope(Object):
    ...
    - :obj:`~chiefgram.types.BotCommandScopeDefault`
    - :obj:`~chiefgram.types.BotCommandScopeAllPrivateChats`
    - :obj:`~chiefgram.types.BotCommandScopeAllGroupChats`
    - :obj:`~chiefgram.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~chiefgram.types.BotCommandScopeChat`
    - :obj:`~chiefgram.types.BotCommandScopeChatAdministrators`
    - :obj:`~chiefgram.types.BotCommandScopeChatMember`
