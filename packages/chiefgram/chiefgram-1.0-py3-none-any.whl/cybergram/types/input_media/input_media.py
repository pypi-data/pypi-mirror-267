...
class InputMedia(Object):
    ...
    - :obj:`~chiefgram.types.InputMediaAnimation`
    - :obj:`~chiefgram.types.InputMediaDocument`
    - :obj:`~chiefgram.types.InputMediaAudio`
    - :obj:`~chiefgram.types.InputMediaPhoto`
    - :obj:`~chiefgram.types.InputMediaVideo`
    """
