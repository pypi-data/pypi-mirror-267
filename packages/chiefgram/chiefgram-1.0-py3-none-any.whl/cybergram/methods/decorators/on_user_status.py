...
class OnUserStatus:
    def on_user_status(
        ...
        :obj:`~chiefgram.handlers.UserStatusHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, chiefgram.Client):
                self.add_handler(chiefgram.handlers.UserStatusHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        chiefgram.handlers.UserStatusHandler(func, self),
