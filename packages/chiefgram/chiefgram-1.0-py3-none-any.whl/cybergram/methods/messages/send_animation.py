...
class SendAnimation:
    async def send_animation(
        ...
        Returns:
            :obj:`~chiefgram.types.Message` | ``None``: On success, the sent animation message is returned, otherwise,
            in case the upload is deliberately stopped with :meth:`~chiefgram.Client.stop_transmission`, None is
            returned.
