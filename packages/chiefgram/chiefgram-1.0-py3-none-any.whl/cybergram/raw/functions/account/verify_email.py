...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <chiefgram.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <chiefgram.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <chiefgram.raw.base.account.EmailVerified>`
    """
