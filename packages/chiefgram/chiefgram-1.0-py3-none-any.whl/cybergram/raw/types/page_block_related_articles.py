...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <chiefgram.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <chiefgram.raw.base.PageRelatedArticle>`):
            N/A
