...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        peer_types (List of :obj:`AttachMenuPeerType <chiefgram.raw.base.AttachMenuPeerType>`):
            N/A

        icons (List of :obj:`AttachMenuBotIcon <chiefgram.raw.base.AttachMenuBotIcon>`):
            N/A
