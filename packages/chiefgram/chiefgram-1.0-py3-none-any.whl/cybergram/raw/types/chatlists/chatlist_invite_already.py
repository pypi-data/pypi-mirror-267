...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <chiefgram.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <chiefgram.raw.base.Peer>`):
            N/A
