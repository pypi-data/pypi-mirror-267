...
class GroupCallStreamChannels(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.phone.GroupCallStreamChannels`.
    ...
    Parameters:
        channels (List of :obj:`GroupCallStreamChannel <chiefgram.raw.base.GroupCallStreamChannel>`):
            N/A
