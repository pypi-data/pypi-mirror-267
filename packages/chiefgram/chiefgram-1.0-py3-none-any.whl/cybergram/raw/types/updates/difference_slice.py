...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <chiefgram.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <chiefgram.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <chiefgram.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <chiefgram.raw.base.updates.State>`):
            N/A
