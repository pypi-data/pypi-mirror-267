...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~chiefgram.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, chiefgram.Client):
                self.add_handler(chiefgram.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        chiefgram.handlers.DeletedMessagesHandler(func, self),
