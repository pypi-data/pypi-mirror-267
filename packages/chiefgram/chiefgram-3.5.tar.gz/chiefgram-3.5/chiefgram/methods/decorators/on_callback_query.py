...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~chiefgram.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, chiefgram.Client):
                self.add_handler(chiefgram.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        chiefgram.handlers.CallbackQueryHandler(func, self),
