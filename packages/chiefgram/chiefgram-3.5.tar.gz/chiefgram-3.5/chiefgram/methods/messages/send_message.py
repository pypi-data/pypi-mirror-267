...
import chiefgram
from chiefgram import raw, utils, enums
...
class SendMessage:
    async def send_message(
        ...
        Returns:
            :obj:`~chiefgram.types.Message`: On success, the sent text message is returned.

        Example:
            .. code-block:: python

                # Simple example
                await app.send_message("me", "Message sent with **chiefgram**!")

                # Disable web page previews
                await app.send_message("me", "https://docs.chiefgram.org",
                ...
                await app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.chiefgram.org")]
                        ]))
        """
