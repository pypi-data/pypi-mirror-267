...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~chiefgram.types.InputMediaPhoto`, :obj:`~chiefgram.types.InputMediaVideo`, :obj:`~chiefgram.types.InputMediaAudio` and :obj:`~chiefgram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~chiefgram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from chiefgram.types import InputMediaPhoto, InputMediaVideo
