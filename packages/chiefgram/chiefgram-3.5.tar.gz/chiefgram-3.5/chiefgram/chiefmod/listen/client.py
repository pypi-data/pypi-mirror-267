...
if not config.disable_startup_logs:
    print(
        "Cybermod is working! If you like chiefmod, please star it at https://github.com/rizaldevs/chiefmod"
    )


@patch_into(chiefgram.client.Client)
class Client(chiefgram.client.Client):
