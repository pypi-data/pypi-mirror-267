...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~chiefgram.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <chiefgram.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <chiefgram.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~chiefgram.raw.types`
    """
