...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`MessagesFilter <chiefgram.raw.base.MessagesFilter>`):
            N/A
        ...
        from_id (:obj:`InputPeer <chiefgram.raw.base.InputPeer>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.Messages <chiefgram.raw.base.messages.Messages>`
    """
