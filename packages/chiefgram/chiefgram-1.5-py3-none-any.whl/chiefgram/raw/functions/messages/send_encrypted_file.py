...
class SendEncryptedFile(TLObject):  # type: ignore
    ...
    Parameters:
        peer (:obj:`InputEncryptedChat <chiefgram.raw.base.InputEncryptedChat>`):
            N/A
        ...
        file (:obj:`InputEncryptedFile <chiefgram.raw.base.InputEncryptedFile>`):
            N/A
    ...
    Returns:
        :obj:`messages.SentEncryptedMessage <chiefgram.raw.base.messages.SentEncryptedMessage>`
    """
