...
class TopPeerCategoryPeers(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.TopPeerCategoryPeers`.
    ...
    Parameters:
        category (:obj:`TopPeerCategory <chiefgram.raw.base.TopPeerCategory>`):
            N/A

        count (``int`` ``32-bit``):
            N/A

        peers (List of :obj:`TopPeer <chiefgram.raw.base.TopPeer>`):
            N/A
