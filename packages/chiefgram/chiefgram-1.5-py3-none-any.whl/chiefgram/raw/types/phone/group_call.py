...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <chiefgram.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <chiefgram.raw.base.GroupCallParticipant>`):
            N/A
