...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <chiefgram.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <chiefgram.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <chiefgram.raw.base.PremiumSubscriptionOption>`):
            N/A
