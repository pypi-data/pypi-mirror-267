...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <chiefgram.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <chiefgram.raw.base.VideoSize>`, *optional*):
            N/A
