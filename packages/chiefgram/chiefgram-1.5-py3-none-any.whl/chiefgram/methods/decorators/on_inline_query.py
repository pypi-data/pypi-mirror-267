...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~chiefgram.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, chiefgram.Client):
                self.add_handler(chiefgram.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        chiefgram.handlers.InlineQueryHandler(func, self),
