...
async def compose(
    clients: List["chiefgram.Client"],
    sequential: bool = False
):
    """Run multiple clients at once.

    This method can be used to run multiple clients at once and can be found directly in the ``chiefgram`` package.

    If you want to run a single client, you can use Client's bound method :meth:`~chiefgram.Client.run`.

    Parameters:
        clients (List of :obj:`~chiefgram.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from chiefgram import Client, compose
