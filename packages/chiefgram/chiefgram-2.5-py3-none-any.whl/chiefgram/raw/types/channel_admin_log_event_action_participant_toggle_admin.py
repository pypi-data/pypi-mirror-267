...
class ChannelAdminLogEventActionParticipantToggleAdmin(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.ChannelAdminLogEventAction`.
    ...
    Parameters:
        prev_participant (:obj:`ChannelParticipant <chiefgram.raw.base.ChannelParticipant>`):
            N/A

        new_participant (:obj:`ChannelParticipant <chiefgram.raw.base.ChannelParticipant>`):
            N/A
