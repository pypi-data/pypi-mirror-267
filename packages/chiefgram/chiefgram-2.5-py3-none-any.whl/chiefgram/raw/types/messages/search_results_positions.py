...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <chiefgram.raw.base.SearchResultsPosition>`):
            N/A
