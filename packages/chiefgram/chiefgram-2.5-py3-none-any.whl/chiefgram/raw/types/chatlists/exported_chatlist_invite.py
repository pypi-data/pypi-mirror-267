...
class ExportedChatlistInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.chatlists.ExportedChatlistInvite`.
    ...
    Parameters:
        filter (:obj:`DialogFilter <chiefgram.raw.base.DialogFilter>`):
            N/A

        invite (:obj:`ExportedChatlistInvite <chiefgram.raw.base.ExportedChatlistInvite>`):
            N/A
