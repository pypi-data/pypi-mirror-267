...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <chiefgram.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <chiefgram.raw.base.MessagePeerReaction>`, *optional*):
            N/A
