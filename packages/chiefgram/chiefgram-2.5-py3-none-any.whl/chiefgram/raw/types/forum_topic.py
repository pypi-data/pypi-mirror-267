...
class ForumTopic(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~chiefgram.raw.base.ForumTopic`.
    ...
    Parameters:
        ...
        from_id (:obj:`Peer <chiefgram.raw.base.Peer>`):
            N/A
        ...
        draft (:obj:`DraftMessage <chiefgram.raw.base.DraftMessage>`, *optional*):
            N/A
