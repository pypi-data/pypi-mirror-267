...
from chiefgram.types import Message
from .handler import Handler


class DeletedMessagesHandler(Handler):
    """The deleted messages handler class. Used to handle deleted messages coming from any chat
    (private, group, channel). It is intended to be used with :meth:`~chiefgram.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~chiefgram.Client.on_deleted_messages` decorator.
    ...
    Other parameters:
        ...
        messages (List of :obj:`~chiefgram.types.Message`):
    ...
    async def check(self, client: "chiefgram.Client", messages: List[Message]):
