...
class SendInlineBotResult:
    async def send_inline_bot_result(
        ...
        Bot results can be retrieved using :meth:`~chiefgram.Client.get_inline_bot_results`
        ...
        Returns:
            :obj:`~chiefgram.raw.base.Updates`: Currently, on success, a raw result is returned.
