...
import chiefgram
from chiefgram import StopTransmission, enums
from chiefgram import raw
from chiefgram import types
from chiefgram import utils
from chiefgram.errors import FilePartMissing
from chiefgram.file_id import FileType


class SendAudio:
    async def send_audio(
        self: "chiefgram.Client",
        ...
        For sending voice messages, use the :meth:`~chiefgram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~chiefgram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~chiefgram.Client.stop_transmission`, None is returned.
