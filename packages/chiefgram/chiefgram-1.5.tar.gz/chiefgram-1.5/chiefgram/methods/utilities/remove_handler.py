...
import chiefgram
from chiefgram.handlers import DisconnectHandler
...
class RemoveHandler:
    def remove_handler(
        ...
        :meth:`~chiefgram.Client.add_handler` method, a tuple of *(handler, group)*, and pass it directly.
        ...
        Example:
            .. code-block:: python
                ...
                from chiefgram.handlers import MessageHandler
