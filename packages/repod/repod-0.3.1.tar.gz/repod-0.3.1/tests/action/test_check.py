...
def test_debugpackagescheck(
    ...
    match package_type:
        case "default_v1":
            ...
            packages = [packagev1]
        case "default_v2":
            packagev1_pkginfov2.pkginfo.xdata = [PkgType(pkgtype=PkgTypeEnum.PKG)]  # type: ignore[attr-defined]
            packages = [packagev1_pkginfov2]
        case "debug_v2":
            packagev1_pkginfov2.pkginfo.xdata = [PkgType(pkgtype=PkgTypeEnum.DEBUG)]  # type: ignore[attr-defined]
            packages = [packagev1_pkginfov2]
    print(packages)
