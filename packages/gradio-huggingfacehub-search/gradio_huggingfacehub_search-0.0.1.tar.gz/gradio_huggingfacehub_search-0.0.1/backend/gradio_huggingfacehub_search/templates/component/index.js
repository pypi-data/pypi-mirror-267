...
function Wn(l, e, t) {
  ...
  return l.$$set = (d) => {
    "height" in d && t(0, r = d.height), "width" in d && t(1, o = d.width), "elem_id" in d && t(2, c = d.elem_id), "elem_classes" in d && t(3, i = d.elem_classes), "variant" in d && t(4, f = d.variant), "border_mode" in d && t(5, a = d.border_mode), "padding" in d && t(6, _ = d.padding), "type" in d && t(16, m = d.type), "test_id" in d && t(7, b = d.test_id), "explicit_call" in d && t(8, k = d.explicit_call), "container" in d && t(9, F = d.container), "visible" in d && t(10, D = d.visible), "allow_overflow" in d && t(11, B = d.allow_overflow), "scale" in d && t(12, z = d.scale), "min_width" in d && t(13, g = d.min_width), "$$scope" in d && t(17, s = d.$$scope);
  }, [
    r,
    o,
    c,
...
function Ft(l, e = {}) {
  const t = zi(l), { stiffness: n = 0.15, damping: s = 0.8, precision: r = 0.01 } = e;
  let o, c, i, f = l, a = l, _ = 1, m = 0, b = !1;
  function k(D, B = {}) {
    a = D;
    const z = i = {};
    return l == null || B.hard || F.stiffness >= 1 && F.damping >= 1 ? (b = !0, o = At(), f = D, t.set(l = a), Promise.resolve()) : (B.soft && (m = 1 / ((B.soft === !0 ? 0.5 : +B.soft) * 60), _ = 0), c || (o = At(), b = !1, c = Di((g) => {
      if (b)
        return b = !1, c = null, !1;
      _ = Math.min(_ + m, 1);
      const v = {
...
const {
  ...
  transition_out: Pe,
  update_slot_base: ls
} = window.__gradio__svelte__internal, { tick: ns } = window.__gradio__svelte__internal, { onDestroy: is } = window.__gradio__svelte__internal, ss = (l) => ({}), zt = (l) => ({});
function Pt(l, e, t) {
  const n = l.slice();
...
function rs(l) {
  ...
  return {
    c() {
      a && a.c(), e = _e(), t = be("div"), b && b.c(), n = _e(), k && k.c(), s = _e(), o && o.c(), c = _e(), z && z.c(), i = Be(), ue(t, "class", "progress-text svelte-1yserjw"), se(
        t,
        "meta-text-center",
        /*variant*/
        l[8] === "center"
    ...
    m(g, v) {
      a && a.m(g, v), A(g, e, v), A(g, t, v), b && b.m(t, null), Ne(t, n), k && k.m(t, null), A(g, s, v), ~r && D[r].m(g, v), A(g, c, v), z && z.m(g, v), A(g, i, v), f = !0;
    },
    p(g, v) {
      /*variant*/
      ...
      let h = r;
      r = B(g), r === h ? ~r && D[r].p(g, v) : (o && (mn(), Pe(D[h], 1, 1, () => {
        D[h] = null;
      }), _n()), ~r ? (o = D[r], o ? o.p(g, v) : (o = D[r] = F[r](g), o.c()), ze(o, 1), o.m(c.parentNode, c)) : o = null), /*timer*/
      g[5] ? z && (z.d(1), z = null) : z ? z.p(g, v) : (z = Jt(g), z.c(), z.m(i.parentNode, i));
    },
    i(g) {
      f || (ze(o), f = !0);
    },
    ...
    d(g) {
      g && (L(e), L(t), L(s), L(c), L(i)), a && a.d(g), b && b.d(), k && k.d(), ~r && D[r].d(g), z && z.d(g);
    }
  };
}
function It(l) {
  ...
  return ~(t = i(l)) && (n = c[t] = o[t](l)), {
    ...
    p(f, a) {
      ...
      t = i(f), t === _ ? ~t && c[t].p(f, a) : (n && (mn(), Pe(c[_], 1, 1, () => {
        c[_] = null;
      }), _n()), ~t ? (n = c[t], n ? n.p(f, a) : (n = c[t] = o[t](f), n.c()), ze(n, 1), n.m(e, null)) : n = null), (!r || a[0] & /*variant, show_progress*/
...
class Ps extends As {
  constructor(e) {
    super(), Ms(this, e, zs, Ds, js, { author: 0, classNames: 1, size: 2 });
  }
}
const {
  SvelteComponent: Bs,
...
function to(l) {
  ...
  return {
    ...
    m(y, S) {
      Qe(y, e, S), ~s && g[s].m(e, null), Se(e, o), Se(e, c), Se(c, f), Se(e, _), h && h.m(e, null), Se(e, m), d && d.m(e, null), F = !0, D || (B = Ws(e, "click", Xs(Js(
        /*click_handler*/
        l[3]
      ))), D = !0);
    },
    p(y, [S]) {
      ...
      s = v(y, S), s === M ? ~s && g[s].p(y, S) : (r && (nl(), Ee(g[M], 1, 1, () => {
        g[M] = null;
      }), ll()), ~s ? (r = g[s], r ? r.p(y, S) : (r = g[s] = z[s](y), r.c()), ke(r, 1), r.m(e, o)) : r = null), (!F || S & /*entry*/
      1) && i !== (i = /*entry*/
    ...
    d(y) {
      y && He(e), ~s && g[s].d(), h && h.d(), d && d.d(), D = !1, B();
    }
  };
}
function lo(l, e, t) {
...
function pl(l) {
  ...
  l[16] && bl(), y = s && wl(l), S = o && vl(l), M = i && ql(l), I = a && Ll(l), T = m && Fl(l), H = k && jl(l), Z = D && Pl(l), E = g && Ul(l);
  return {
    c() {
      e = J("div"), t = J("ul"), d && d.c(), n = Q(), y && y.c(), r = Q(), S && S.c(), c = Q(), M && M.c(), f = Q(), I && I.c(), _ = Q(), T && T.c(), b = Q(), H && H.c(), F = Q(), Z && Z.c(), z = Q(), E && E.c(), Y(t, "class", B = "mt-1 max-h-[calc(100vh-100px)] w-full divide-y divide-gray-100 overflow-hidden overflow-y-auto rounded-lg border border-gray-100 bg-white text-sm shadow-lg dark:divide-gray-900 " + /*bodyClassNames*/
      l[2]), Y(e, "class", v = /*position*/
      l[10] + " z-40 w-full md:min-w-[24rem]");
    },
    m(N, j) {
      R(N, e, j), W(e, t), d && d.m(t, null), W(t, n), y && y.m(t, null), W(t, r), S && S.m(t, null), W(t, c), M && M.m(t, null), W(t, f), I && I.m(t, null), W(t, _), T && T.m(t, null), W(t, b), H && H.m(t, null), W(t, F), Z && Z.m(t, null), l[40](t), W(e, z), E && E.m(e, null), l[42](e), h = !0;
    },
    p(N, j) {
      /*numResults*/
      N[16] ? d && (X(), q(d, 1, 1, () => {
      ...
      32768 && (D = /*entries*/
      N[15].some(Hl)), D ? Z ? (Z.p(N, j), j[0] & /*entries*/
...
function jl(l) {
  ...
  return {
    ...
    p(i, f) {
      if (/*showSearchType*/
      i[11] ? s || (s = Dl(), s.c(), s.m(e.parentNode, e)) : s && (s.d(1), s = null), f[0] & /*resultElements, entries, isSelected, selectedEntryIdx, handleClickEntry*/
      36995072) {
        r = $(
          /*entries*/
          i[15].filter(tn)
...
function ko(l, e, t) {
  let { classNames: s = "" } = e, { bodyClassNames: r = "" } = e, { inputClassNames: o = "" } = e, { header: c = !1 } = e, { showIcon: i = !1 } = e, { inputName: f = "" } = e, { placeholder: a = "" } = e, { required: _ = !1 } = e, { inputValue: m = "" } = e, { disabled: b = !1 } = e, { searchParams: k = {} } = e, { url: F = "https://huggingface.co/api/quicksearch" } = e, { initialFocus: D = !1 } = e, { position: B = "absolute" } = e, { showSearchType: z = !0 } = e, { resetLastQueryOnCommit: g = !1 } = e, v = [], h = !1, d = null, y = 0, S, M, I, T = -1, H, Z = new AbortController();
  const E = {}, N = mo();
  ho(() => (document.addEventListener("click", j), D && I.focus(), () => {
...
function Uo(l, e, t) {
  let { gradio: n } = e, { label: s = "Textbox" } = e, { elem_id: r = "" } = e, { elem_classes: o = [] } = e, { visible: c = !0 } = e, { value: i = "" } = e, { placeholder: f = "Search models, datasets, users..." } = e, { show_label: a } = e, { scale: _ = null } = e, { min_width: m = void 0 } = e, { loading_status: b = void 0 } = e, { value_is_output: k = !1 } = e, { interactive: F } = e, { search_type: D = ["model", "dataset", "space", "org", "user"] } = e, { sumbit_on_select: B = !0 } = e;
  o = ["z-40", ...o];
  function z() {
