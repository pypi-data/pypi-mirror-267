...
for line in metadata.requires("cygrid"):
...
copyright = f"2009–{datetime.now(tz=timezone.utc).year}, " + author
...
html_theme_options.update(
    {
        "github_url": "https://github.com/bwinkel/cygrid",
        "external_links": [
            {"name": "Tutorials", "url": "https://github.com/bwinkel/cygrid/tree/master/notebooks"},
        ],
...
html_css_files = ["_static/cygrid.css"]
...
github_issues_url = "https://github.com/bwinkel/cygrid/issues/"
