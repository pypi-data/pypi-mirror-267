...
class SnakeGame:
    ...
    def get_game_state(self):
        ...
        dir_r = int(self.snake.direction == 'right')
        dir_l = int(self.snake.direction == 'left')
        dir_u = int(self.snake.direction == 'up')
        dir_d = int(self.snake.direction == 'down')
        ...
        state = [
            ...
            *danger['down'],
            ...
            dir_u,
            dir_d,
            int(self.food.x < head[0]),
            int(self.food.x > head[0]),
            int(self.food.y < head[1]),
            int(self.food.y > head[1]),
