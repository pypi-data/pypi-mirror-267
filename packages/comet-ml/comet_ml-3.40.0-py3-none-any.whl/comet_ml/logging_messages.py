...
CONFIG_API_KEY_IS_NOT_SET = "API key is not set. You will need it for live logging."
...
RESILIENCE_NOT_INITIALIZED_ERROR = "Due to an internal error, some network resiliency features were disabled which could lead to data loss. Contact us at support@comet.com."
...
CONNECTION_WS_NOT_CLOSED_PROPERLY_WARNING = (
    "Websocket connection didn't closed properly after %d seconds"
)

CONNECTION_INVALID_HTTPS_PROXY_EXCEPTION = "Invalid https proxy format `%s`"
...
EXPERIMENT_LOG_CURVE_EXCEPTION = "invalid 'curve' data; ignored"
