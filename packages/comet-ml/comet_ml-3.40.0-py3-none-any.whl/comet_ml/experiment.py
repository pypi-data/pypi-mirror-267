...
from .logging_messages import (
    ...
    EXPERIMENT_LOG_CURVE_EXCEPTION,
...
class BaseExperiment(CommonExperiment):
    ...
    def register_model(
        ...
        Args:
            ...
            workspace (Deprecated): optional, the name of workspace; defaults to current workspace
            ...
            stages (Deprecated): optional, equivalent to tags, with newer backend versions
    ...
    def log_curve(self, name, x, y, overwrite=False, step=None):
        ...
        if self.alive:
            ...
            try:
                ...
                LOGGER.error(EXPERIMENT_LOG_CURVE_EXCEPTION, exc_info=True)
                return
