...
def resume_online_experiment(
    ...
    if experiment_config is None:
        experiment_config = default_experiment_config(new_experiment)
        LOGGER.debug(
            "User didn't provide an experiment config, using default: %r",
            experiment_config,
        )
...
def create_online_experiment(
    ...
    if experiment_config is None:
        experiment_config = default_experiment_config(True)
        LOGGER.debug(
            "User didn't provide an experiment config, using default: %r",
            experiment_config,
        )
