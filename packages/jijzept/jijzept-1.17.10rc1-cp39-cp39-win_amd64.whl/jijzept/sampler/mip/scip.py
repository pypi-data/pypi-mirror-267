...
class JijSCIPSolver(JijZeptBaseSampler):
    """The client using SCIP.

    For details of SCIP, please see the following: https://www.scipopt.org/
    """

    jijmodeling_solver_type = SolverType(
        queue_name="pyomosolver", solver="SCIP"
    )
    ...
    def sample_model(
        ...
        *,
        ...
        """Solve the instance created by JijModeling using SCIP.
        ...
        Examples:
            ```python
                ...
                solver = jz.JijSCIPSolver(config="config.toml")
