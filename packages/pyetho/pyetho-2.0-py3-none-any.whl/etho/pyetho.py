...
def all_family_languages(family):
            ...
            list : A list of languages within the specified 'family' across all countries.
             ...
             >>> pyetho.all_family_languages('Japonic')
             [['Japanese jpn',
            ...
            >>> pyetho.all_family_languages('Sino-Tibetan')
            Out[9]: 
            [['Pangkhua pkh',
            'Marma rmz',
            'Mru mro',
...
def list_holidays(country="India"):
     """ 
     Retreive all the regional holidays of a specific country.
     Parameters:
     country : str
       The name of the country to retrive all the regional holidays from the specific country.
       
     Return:
     DataFrame : A DataFrame of holidays within the specified 'country' across the world.

     Example:
     -------------
     >>>list_holidays("India")
           Date                   Holiday Name              Type
     0    Jan 01                 New Year's Day  Regional Holiday
     1    Jan 02                Mannam Jayanthi  Regional Holiday
     2    Jan 02           New Year Celebration  Regional Holiday
     3    Jan 11                 Missionary Day  Regional Holiday
     4    Jan 12  Birthday of Swami Vivekananda  Regional Holiday
     ..      ...                            ...               ...
     217  Dec 26                     Boxing Day  Regional Holiday
     218  Dec 27                 Shaheedi Sabha  Regional Holiday
     219  Dec 30                U Kiang Nangbah  Regional Holiday
     220  Dec 31               Losoong/Namsoong  Regional Holiday
     221  Dec 31                 New Year's Eve  Regional Holiday

     [222 rows x 3 columns]

     """
     country=country.capitalize()
     print(pd.DataFrame(data[country]['holidays']))

def holiday_count(country="India"):
     """
     Retreive the total count of holidays in a specific country.
     Parameters:
     country : str
         The name of the country to retreive the total count of holidays.

     Return:
     int: The total count of the holidays in a specific country will be returned in the integer format.
     ...
     country=country.capitalize()
     print(len(pd.DataFrame(data[country]['holidays'])))

def holiday_country(date="Jan 01"):
     """
     Retreive the countries which have the holiday for a specific date.
     Parameters:
     date : str
        The date to retreive all the countries that have holiday on the same date.

     Return:
     str: All the countries that have the holiday on the same date.

     Example:
     -----------
     >>> holiday_country("Oct 02")
     Cambodia
     China
     Guinea
     Honduras
     ...
     for i in data.keys():
         if date in data[i]['holidays']['Date'].values():
             print(i)

def holiday_by_country(date="Jan 01"):
     """
     Retreive all the country names and their corresponding holiday names for a specific date.
     Parameters:
     date: str
        The date to retreive all the country names and their corresponding holiday names with type of holiday.

     Return:
     str: All the country names and their corresponding holiday names with type of holiday for a specific date.

     Example:
     -------------

    >>>holiday_by_country("Mar 20")
    Afghanistan
     Date Holiday Name              Type
     2  Mar 20      Nowrooz  Not A Public Holiday
    ...
    Azerbaijan
     Date Holiday Name              Type
     4  Mar 20       Novruz  National Holiday

    Iran
     Date             Holiday Name
     4  Mar 20                   Nowruz
     5  Mar 20  Oil Nationalisation Day

    Iraq
     Date Holiday Name              Type
     2  Mar 20   Eid Norooz  National Holiday

    Japan
     Date        Holiday Name              Type
     4  Mar 20  Vernal Equinox Day  National Holiday

    Kyrgyzstan
     Date Holiday Name              Type
     9  Mar 20       Nooruz  National Holiday
   
    Turkey
     Date      Holiday Name              Type
     1  Mar 20  Independence Day  National Holiday

    No Holiday in List

    >>>holiday_by_country("Feb 29")
    No Holiday in List
    """
     date=date.capitalize()
     for i in data.keys():
        if date in data[i]['holidays']['Date'].values():
            print(i,end="\n")
            a=pd.DataFrame(data[i]['holidays'])
            print(a.loc[(a['Date']==date),:],end="\n\n")
     else:
        print("No Holiday in List")
