...
def read(datafile: str or list, si=None, ele=None, ai=None, fmt=None, task="scf"):
    ...
    Reading ...dspawpy_proj/dspawpy_tests/inputs/2.1/relax.h5...
    >>> len(pymatgen_Structures)
    3
    ...
    Reading ...dspawpy_proj/dspawpy_tests/inputs/supplement/aimd1.h5...
    Reading ...dspawpy_proj/dspawpy_tests/inputs/supplement/aimd2.h5...
    """
    dfs = []
...
def convert(
    ...
    ==> .../relax.hzw
    Reading ...dspawpy_proj/dspawpy_tests/inputs/supplement/stru/relax.h5...
    Reading ...dspawpy_proj/dspawpy_tests/inputs/supplement/stru/system.json...
    ==> .../system.pdb
    Reading ...dspawpy_proj/dspawpy_tests/inputs/supplement/stru/system.json...
    ==> .../system.xyz
    Reading ...dspawpy_proj/dspawpy_tests/inputs/supplement/stru/system.json...
