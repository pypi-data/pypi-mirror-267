...
def getTSgas(
    ...
    >>> TSgas = getTSgas(fretxt='dspawpy_proj/dspawpy_tests/inputs/2.13/frequency.txt', datafile='dspawpy_proj/dspawpy_tests/inputs/2.13/frequency.h5', potentialenergy=-0.0,  geometry='linear', symmetrynumber=1, spin=1, temperature=298.15, pressure=101325.0, outfile='dspawpy_proj/dspawpy_tests/outputs/doctest_out/TSgas.txt') # doctest: +ELLIPSIS
    Reading ...dspawpy_proj/dspawpy_tests/inputs/2.13/frequency.h5...
    ==> .../doctest_out/TSgas.txt
    >>> print(TSgas)
    0.8515317035550232
    >>> TSgas = getTSgas(fretxt='dspawpy_proj/dspawpy_tests/inputs/2.13/frequency.txt', datafile='dspawpy_proj/dspawpy_tests/inputs/2.13/frequency.h5', potentialenergy=-0.0,  geometry='linear', symmetrynumber=1, spin=1, temperature=298.15, pressure=101325.0, outfile='dspawpy_proj/dspawpy_tests/outputs/doctest_out/TSgas.txt') # doctest: +ELLIPSIS
    Reading ...dspawpy_proj/dspawpy_tests/inputs/2.13/frequency.h5...
...
def getZPE(fretxt: str = "frequency.txt", outfile: str = "ZPE.dat"):
    ...
    >>> ZPE= getZPE(fretxt='dspawpy_proj/dspawpy_tests/inputs/2.13/frequency.txt', outfile='dspawpy_proj/dspawpy_tests/outputs/doctest_out/ZPE.txt') # doctest: +ELLIPSIS
    Reading ...dspawpy_proj/dspawpy_tests/inputs/2.13/frequency.txt ...
       Frequency (meV)
    0       284.840033
    <BLANKLINE>
...
def getTSads(
    ...
    >>> TS = getTSads(fretxt='dspawpy_proj/dspawpy_tests/inputs/2.13/frequency.txt', T=298.15, outfile='dspawpy_proj/dspawpy_tests/outputs/doctest_out/TSads.dat') # doctest: +ELLIPSIS
    Reading ...dspawpy_proj/dspawpy_tests/inputs/2.13/frequency.txt ...
       Frequency (THz)
    0        68.873993
    <BLANKLINE>
    ==> .../doctest_out/TSads.dat
