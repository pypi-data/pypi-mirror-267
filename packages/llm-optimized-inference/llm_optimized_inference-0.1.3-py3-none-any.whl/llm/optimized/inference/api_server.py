...
from llm.optimized.inference.api_server_setup.protocol import ChatCompletionResponseChoice, ChatCompletionResponse, CompletionResponse, CompletionResponseChoice
