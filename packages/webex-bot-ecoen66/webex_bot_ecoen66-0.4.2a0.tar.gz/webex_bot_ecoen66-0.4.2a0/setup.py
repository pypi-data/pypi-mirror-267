...
setup(
    ...
    keywords="webex_bot_ecoen66",
    name="webex_bot_ecoen66",
    packages=find_packages(include=["webex_bot_ecoen66", "webex_bot_ecoen66.*"]),
    setup_requires=setup_requirements,
    test_suite="tests",
    tests_require=test_requirements,
    url="https://github.com/ecoen66/webex_bot",
    version="0.4.2a",
    zip_safe=False,
)
