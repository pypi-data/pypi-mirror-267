...
const EnumDocumentStatuses = require('./EnumDocumentStatuses-15b6ee42.js');
...
const DocumentListStyle0 = documentListCss;
...
DocumentList.style = DocumentListStyle0;
...
const DocumentListItemStyle0 = documentListItemCss;
...
const DocumentListItem = class {
    ...
    render() {
        ...
        return (index.h("li", { key: '9911c5fed8ca018bd54ea4251d7151a5f7f145f3', class: "document-list-item", onClick: this.handleOpenDocument }, index.h("div", { key: '2141cb39aebc77c27645cb6c889dd33011f179c8', class: documentIcon }, index.h("limel-icon", { key: '21ec366143a004844961cf4b25c0d8fba9fce3ce', name: this.getDocumentIcon(this.document.status), size: "small" })), index.h("div", { key: '6ece6e1cfd9b31f772aa9d3daeef0fb57ff70ef8', class: "document-info-container" }, index.h("div", { key: 'eaeca84bdd39cd60c414dc8a6f30e2d9b92edbb0', class: "document-name" }, this.document.name), index.h("div", { key: 'e364b5dc5954767e939979a42fe78a38c6fe7fc5', class: "document-status" }, index.h("span", { key: '87a97a5892d51847e14680c16b72d64c4ade431b' }, this.document.status), index.h("span", { key: '16ad9541ed13094e3209621fa7ba4ea99b948559', class: "document-created-date" }, hooks(this.document.created_at).format('YYYY-MM-DD'))))));
    }
    handleOpenDocument() {
...
DocumentListItem.style = DocumentListItemStyle0;
...
const SendNewDocumentButtonStyle0 = sendNewDocumentButtonCss;
...
const Root = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: '76564b2679feb299b86e95a44c8c5f01a9741b1a', class: buttonContainer }, index.h("h4", { key: 'd4c9e600ef12cf0d4a75723dd5b3706d3c794563' }, label), index.h("limel-icon", { key: '48b3e662d69feddb0e8d7f4666da24a3f0e7c28b', class: "new-document-icon", name: icon, size: "large" }), index.h("limel-button", { key: '643d103074abb058c64ab9dad650be8d8aa7d926', primary: true, label: buttonText, onClick: this.changeViewHandler }), index.h("p", { key: '2915fffe7bf47e5cd19909a951b3610980794564' }, description)),
        ];
    }
    changeViewHandler() {
