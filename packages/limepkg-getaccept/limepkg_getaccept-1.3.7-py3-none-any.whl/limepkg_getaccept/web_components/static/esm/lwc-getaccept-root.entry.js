import { r as registerInstance, c as createEvent, h, g as getElement } from './index-0b94ef2c.js';
import { E as EnumViews } from './EnumViews-b32e9b99.js';
import { f as fetchMe, a as fetchEntity, b as fetchSentDocuments, r as refreshToken } from './index-27bbba32.js';
...
const Root = class {
    ...
    render() {
        return [
            ...
            })()), h("div", { key: 'd3cd2c6dee77432ded9b2d228518a8df4bd553bf', class: "ga-body" }, this.renderLayout()), h("div", { key: '92baf0e4e5394361ad2e9c38bbcc80897f6771f3', class: "ga-version" }, h("span", { key: '8d00157e0e0a8a42e54a69780a8f8250f5be3e24' }, "Version: 1.3.7.dev1")), h("limel-button-group", { key: '67b51e3cf26050401d53b1276b8ce98c388fb8a2', slot: "button" }, h("limel-button", { key: '5467744ec12afc62a1a1b25a123c5c586d42caff', label: "Cancel", onClick: () => {
                    this.isOpen = false;
                } })), h("error-message", { key: '5040d18e0947b2fb1e0d39e90087cda0f4d55e51', error: this.errorMessage })),
        ];
    }
    checkIsAside() {
