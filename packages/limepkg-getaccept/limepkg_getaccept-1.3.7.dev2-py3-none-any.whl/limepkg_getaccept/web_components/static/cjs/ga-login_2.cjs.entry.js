...
const index$1 = require('./index-7740e905.js');
...
const GaLoginStyle0 = gaLoginCss;
...
const GaSignupStyle0 = gaSignupCss;
...
const GaSignup = class {
    ...
    render() {
        ...
        return [
            index.h("div", { key: 'f078c65ec396cd0c92e4533684e5f180856d9807', class: "auth-signup-field-container" }, this.signupFields.map((signupField) => {
            ...
            index.h("span", { key: '81d917ddad7c214074978e7bb3da1793765eb604', class: "auth-language-label" }, "Country"),
            index.h("limel-chip-set", { key: '9a97a52f9ca83d2cef6a3ef89f184137b0d1c426', type: "choice", onChange: this.countrySetOnChange, required: true, value: this.countryCodes }),
            index.h("limel-button", { key: 'f202a3d88334c33fd6a7fc570b0b666a7301f017', class: "auth-button", label: "Signup", primary: true, loading: this.isLoading, disabled: this.disableSignup, onClick: this.onSignup }),
        ];
    }
    shouldDisableSignup() {
...
GaSignup.style = GaSignupStyle0;

exports.ga_login = GaLogin;
exports.ga_signup = GaSignup;

//# sourceMappingURL=ga-login_2.cjs.entry.js.map