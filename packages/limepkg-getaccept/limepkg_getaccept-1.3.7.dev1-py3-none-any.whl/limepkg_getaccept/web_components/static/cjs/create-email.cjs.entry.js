...
const CreateEmailStyle0 = createEmailCss;
...
const CreateEmail = class {
    ...
    render() {
        return [
            index.h("div", { key: '1d5599e24eb0c74fc2c258d17dd4bd663d83e3c2' }, index.h("h3", { key: '691a738cc762ba2b7254895120d3730275c939d7' }, "Write your email"), index.h("limel-input-field", { key: 'dcefe2d64ff7ad88cff2f446855ab8a961495eca', label: "Subject", value: this.emailSubject, onChange: this.handleChangeEmailSubject }), index.h("span", { key: 'b9437369529832f80081e9e4fa1dd86497ae33b6', class: "send-document-email-subject" }, "Email"), index.h("textarea", { key: '8b4f347aaa67bfbe405d7f82037f0268fa31fad3', class: "send-document-email", rows: 9, value: this.emailMessage, onChange: this.handleChangeEmailMessage })),
        ];
    }
...
CreateEmail.style = CreateEmailStyle0;

exports.create_email = CreateEmail;

//# sourceMappingURL=create-email.cjs.entry.js.map